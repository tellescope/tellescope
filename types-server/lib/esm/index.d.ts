import { ModelForName, ModelForName_required, RecordInfo, EnduserEngagementTimestamps, ModelName } from "@tellescope/types-models";
export type ObjectId = import('mongodb').ObjectId;
export type ToServerModel<T> = Omit<T, 'id'> & {
    _id: ObjectId;
};
