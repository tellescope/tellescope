...
export var QuestionForField = function (_a) {
    ...
    var File = (_l = customInputs === null || customInputs === void 0 ? void 0 : customInputs['file']) !== null && _l !== void 0 ? _l : FileInput;
    var Files = (_m = customInputs === null || customInputs === void 0 ? void 0 : customInputs['files']) !== null && _m !== void 0 ? _m : FilesInput;
    var Ranking = (_o = customInputs === null || customInputs === void 0 ? void 0 : customInputs['ranking']) !== null && _o !== void 0 ? _o : RankingInput;
    var Rating = (_p = customInputs === null || customInputs === void 0 ? void 0 : customInputs['rating']) !== null && _p !== void 0 ? _p : RatingInput;
    var Address = (_q = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Address']) !== null && _q !== void 0 ? _q : AddressInput;
    var Time = (_s = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Time']) !== null && _s !== void 0 ? _s : TimeInput;
    var Dropdown = (_t = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Dropdown']) !== null && _t !== void 0 ? _t : DropdownInput;
    var DatabaseSelect = (_u = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Database Select']) !== null && _u !== void 0 ? _u : DatabaseSelectInput;
    var Medications = (_v = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Medications']) !== null && _v !== void 0 ? _v : MedicationsInput;
    var RelatedContacts = (_w = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Related Contacts']) !== null && _w !== void 0 ? _w : RelatedContactsInput;
    var Insurance = (_x = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Insurance']) !== null && _x !== void 0 ? _x : InsuranceInput;
    var AppointmentBooking = (_y = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _y !== void 0 ? _y : AppointmentBookingInput;
    var Height = (_z = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _z !== void 0 ? _z : HeightInput;
    var Redirect = (_0 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _0 !== void 0 ? _0 : RedirectInput;
    var HiddenValue = (_1 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _1 !== void 0 ? _1 : HiddenValueInput;
    var Emotii = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _2 !== void 0 ? _2 : EmotiiInput;
    var Allergies = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _3 !== void 0 ? _3 : AllergiesInput;
    var Conditions = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _4 !== void 0 ? _4 : ConditionsInput;
    ...
    _jsxs(Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                _jsxs(Typography, __assign({ component: "h4", style: {
                    ...
                    } }, { children: [field.title, !(field.isOptional || field.type === 'description' || field.type === 'Question Group' || field.type === 'Insurance') ? '*' : ''] })), !field.title && (field.type === 'Question Group' || field.type === 'signature') && !((_5 = form === null || form === void 0 ? void 0 : form.customization) === null || _5 === void 0 ? void 0 : _5.hideLogo) &&
                ...
                _jsx(Flex, __assign({ column: true, style: { marginBottom: 11, marginTop: 3, } }, { children: feedback.map(function (f, i) { return (_jsx(Typography, __assign({ color: "error", style: { fontSize: 20 } }, { children: f }), i)); }) })), field.type === 'file' ? (_jsx(File, { field: field, value: (_6 = file.blobs) === null || _6 === void 0 ? void 0 : _6[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                    ? (_7 = value.answer.value) === null || _7 === void 0 ? void 0 : _7.name
                    : '' }))
                : field.type === 'files' ? (_jsx(Files, { field: field, value: file.blobs, onChange: onAddFile, form: form }))
                    : field.type === 'dateString' ? (_jsx(DateStringInput, { field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                        : field.type === 'Hidden Value' ? (_jsx(HiddenValue, { isSinglePage: isSinglePage, goToNextField: goToNextField, goToPreviousField: goToPreviousField, field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                    ...
                                    : field.type === 'Allergies' ? (_jsx(Allergies, { enduser: enduser, enduserId: enduserId, field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                                        : field.type === 'Conditions' ? (_jsx(Conditions, { enduser: enduser, enduserId: enduserId, field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                                            : field.type === 'Height' ? (_jsx(Height, { field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                : field.type === 'Redirect' ? (_jsx(Redirect, { rootResponseId: rootResponseId, formResponseId: formResponseId, responses: responses, enduser: enduser, groupId: groupId, groupInsance: groupInstance, submit: submit, field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                        ...
                                                                                        : field.type === 'signature' ? (_jsx(Signature, { enduser: enduser, field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                            : field.type === 'multiple_choice' ? (_jsx(MultipleChoice, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                : field.type === 'Dropdown' ? (_jsx(Dropdown, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                    : field.type === 'Database Select' ? (_jsx(DatabaseSelect, { field: field, value: value.answer.value, onChange: onFieldChange, onDatabaseSelect: handleDatabaseSelect, responses: responses, form: form }))
                                                                                                        : field.type === 'Medications' ? (_jsx(Medications, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                            : field.type === 'Insurance' ? (_jsx(Insurance, { field: field, value: value.answer.value, form: form, enduser: enduser, responses: responses, onChange: function (v, fieldId) { return onFieldChange(__assign(__assign({}, v), { relationship: (v === null || v === void 0 ? void 0 : v.relationship) || 'Self' }), fieldId); } }))
                                                                                                                    ...
                                                                                                                    : field.type === 'ranking' ? (_jsx(Ranking, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                        : field.type === 'Table Input' ? (_jsx(TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                            : field.type === 'Time' ? (_jsx(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                : field.type === 'Question Group' ? (_jsx(Flex, __assign({ column: true, flex: 1 }, { children: ((_9 = (_8 = field.options) === null || _8 === void 0 ? void 0 : _8.subFields) !== null && _9 !== void 0 ? _9 : []).map(function (_a) {
                                                                                                                                        var _b;
                                                                                                                                        var id = _a.id;
                                                                                                                                        ...
                                                                                                                                        if (!file)
                                                                                                                                            return null;
                                                                                                                                        return (_jsx(Flex, __assign({ flex: 1 }, { children: _jsx(QuestionForField, { groupId: groupId, groupInstance: groupInstance, customInputs: customInputs, field: match, fields: fields, handleDatabaseSelect: handleDatabaseSelect, enduser: enduser, goToPreviousField: goToPreviousField, isPreviousDisabled: isPreviousDisabled, goToNextField: goToNextField, form: form, formResponseId: formResponseId, rootResponseId: rootResponseId, submit: submit, repeats: repeats, onRepeatsChange: onRepeatsChange, setCustomerId: setCustomerId, value: value, file: file, onAddFile: onAddFile, onFieldChange: onFieldChange, responses: responses, selectedFiles: selectedFiles, validateField: validateField, enduserId: enduserId, spacing: (_b = field.options) === null || _b === void 0 ? void 0 : _b.groupPadding, logicOptions: logicOptions, isInQuestionGroup: true }) }), id));
                                                                                                                                    }) })))
                                                                                                                                    : null, ((_10 = field.options) === null || _10 === void 0 ? void 0 : _10.repeat) && (_jsx(Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? (_jsx(String, { field: field, label: "Repeat", value: (_11 = repeats[field.id]) !== null && _11 !== void 0 ? _11 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? (_jsx(StringLong, { field: field, label: "Repeat", value: (_12 = repeats[field.id]) !== null && _12 !== void 0 ? _12 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? (_jsx(Number, { field: field, label: "Repeat", value: (_13 = repeats[field.id]) !== null && _13 !== void 0 ? _13 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
...
export var TellescopeSinglePageForm = function (_a) {
    var _b;
    var customInputs = _a.customInputs, submitErrorMessage = _a.submitErrorMessage, onAddFile = _a.onAddFile, onFieldChange = _a.onFieldChange, goToNextField = _a.goToNextField, goToPreviousField = _a.goToPreviousField, isNextDisabled = _a.isNextDisabled, isPreviousDisabled = _a.isPreviousDisabled, submit = _a.submit, showSubmit = _a.showSubmit, showSaveDraft = _a.showSaveDraft, submittingStatus = _a.submittingStatus, updating = _a.updating, validateField = _a.validateField, validateResponsesForFields = _a.validateResponsesForFields, formTitle = _a.formTitle, _c = _a.thanksMessage, thanksMessage = _c === void 0 ? DEFAULT_THANKS_MESSAGE : _c, htmlThanksMessage = _a.htmlThanksMessage, submitted = _a.submitted, style = _a.style, onSuccess = _a.onSuccess, isPreview = _a.isPreview, fields = _a.fields, selectedFiles = _a.selectedFiles, responses = _a.responses, isInternalNote = _a.isInternalNote, existingResponses = _a.existingResponses, repeats = _a.repeats, setRepeats = _a.setRepeats, setCustomerId = _a.setCustomerId, rootResponseId = _a.rootResponseId, parentResponseId = _a.parentResponseId, handleDatabaseSelect = _a.handleDatabaseSelect, submittedAt = _a.submittedAt, updatedAt = _a.updatedAt, otherEnduserIds = _a.otherEnduserIds, onBulkErrors = _a.onBulkErrors, enduser = _a.enduser, groupId = _a.groupId, groupInstance = _a.groupInstance, props = __rest(_a, ["customInputs", "submitErrorMessage", "onAddFile", "onFieldChange", "goToNextField", "goToPreviousField", "isNextDisabled", "isPreviousDisabled", "submit", "showSubmit", "showSaveDraft", "submittingStatus", "updating", "validateField", "validateResponsesForFields", "formTitle", "thanksMessage", "htmlThanksMessage", "submitted", "style", "onSuccess", "isPreview", "fields", "selectedFiles", "responses", "isInternalNote", "existingResponses", "repeats", "setRepeats", "setCustomerId", "rootResponseId", "parentResponseId", "handleDatabaseSelect", "submittedAt", "updatedAt", "otherEnduserIds", "onBulkErrors", "enduser", "groupId", "groupInstance"]);
    var list = useListForFormFields(fields, responses, { form: props.form, gender: enduser === null || enduser === void 0 ? void 0 : enduser.gender });
    var includedFieldIds = (Array.from(new Set(__spreadArray(__spreadArray([], list.map(function (f) { return f.id; }), true), (existingResponses !== null && existingResponses !== void 0 ? existingResponses : []).map(function (e) { return e.fieldId; }), true))));
    ...
    return (_jsx(Flex, __assign({ flex: 1, column: true }, { children: submitted
            ? _jsx(ThanksMessage, { htmlThanksMessage: htmlThanksMessage, thanksMessage: thanksMessage, showRestartAtEnd: (_b = props === null || props === void 0 ? void 0 : props.customization) === null || _b === void 0 ? void 0 : _b.showRestartAtEnd })
            : (_jsxs(_Fragment, { children: [_jsx(Flex, __assign({ flex: 1, justifyContent: "center", column: true, style: { marginBottom: 15 } }, { children: list.map(function (activeField, i) {
