...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        ...
        if (this.state.hasError) {
            ...
            return _jsx("h1", { children: (_a = this.props.errorMessage) !== null && _a !== void 0 ? _a : "Something went wrong." });
        }
...
export var stringForError = function (err) {
    var _a, _b;
...
export var parseUniquenessError = function (err, uniquenessMessage) {
    var message = stringForError(err);
    if (message === UNIQUENESS_VIOLATION)
        return uniquenessMessage;
    return message;
};
export var useHandleError = function (props) {
    var uniquenessError = (props !== null && props !== void 0 ? props : {}).uniquenessError;
    var _a = useState(false), loading = _a[0], setLoading = _a[1];
    var _b = useState(''), error = _b[0], setError = _b[1];
    var handleAPIError = useCallback(function (handler) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    err_1 = _b.sent();
                    errorMessage = stringForError(err_1);
                    setError(errorMessage === UNIQUENESS_VIOLATION && uniquenessError
                        ? uniquenessError
                        : errorMessage);
    ...
    var errorDisplay = (error
        ? _jsx(Typography, __assign({ style: { marginTop: 3 }, color: "error" }, { children: error }))
        : null);
    return {
