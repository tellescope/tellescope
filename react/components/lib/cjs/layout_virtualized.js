...
var Image = function (_a) {
    ...
    return (0, jsx_runtime_1.jsx)("img", { src: src, alt: alt, style: __assign(__assign({}, props), style) });
};
exports.Image = Image;
...
var Flex = function (props) {
    ...
    if (props.component === 'span')
        return ((0, jsx_runtime_1.jsx)("span", __assign({ style: style, onClick: (_f = props.onClick) !== null && _f !== void 0 ? _f : props.onPress }, { children: children })));
    return ((0, jsx_runtime_1.jsx)("div", __assign({ style: style, onClick: (_g = props.onClick) !== null && _g !== void 0 ? _g : props.onPress }, { children: children })));
};
exports.Flex = Flex;
...
var List = function (_a) {
    var items = _a.items, hoveredColor = _a.hoveredColor, notHoveredColor = _a.notHoveredColor, emptyComponent = _a.emptyComponent, render = _a.render, renderProps = _a.renderProps, onClick = _a.onClick, reverse = _a.reverse, style = _a.style, rowStyle = _a.rowStyle;
    if (items.length === 0 && emptyComponent)
        return emptyComponent;
    return ((0, jsx_runtime_1.jsx)("div", __assign({ style: __assign({ overflowY: 'auto' }, style) }, { children: (0, jsx_runtime_1.jsx)(exports.Flex, __assign({ flex: 1, column: true, reverse: reverse }, { children: items.map(function (item, i) {
                var _a, _b;
                return hoveredColor
...
var ScrollingList = function (_a) {
    var title = _a.title, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, titleStyle = _a.titleStyle, items = _a.items, emptyText = _a.emptyText, doneLoading = _a.doneLoading, loadMore = _a.loadMore, Item = _a.Item, TitleComponent = _a.TitleComponent, titleActionsComponent = _a.titleActionsComponent, style = _a.style, noWrap = _a.noWrap, header = _a.header, itemContainerStyle = _a.itemContainerStyle;
    var fetchRef = (0, react_1.useRef)(0);
    var titleStyleWithDefaults = __assign({ fontSize: 20, fontWeight: 'bold', marginBottom: 3 }, titleStyle);
    return ((0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, direction: "column", style: style, wrap: noWrap ? 'nowrap' : undefined }, { children: [TitleComponent
                ...
                : ((0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, alignItems: "center", justifyContent: "space-between" }, { children: [typeof title === 'string'
                            ...
                            : title, (0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ item: true }, { children: titleActionsComponent }))] }))), header, (0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ container: true, direction: "column", flexWrap: 'nowrap', style: { minHeight: minHeight, maxHeight: maxHeight, maxWidth: maxWidth, overflow: 'auto' }, onScroll: function (e) {
                ...
                } }, { children: (0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, direction: "column", style: itemContainerStyle }, { children: [items.length === 0
                            ? typeof emptyText === 'string'
                                ? (0, jsx_runtime_1.jsx)(material_1.Typography, { children: emptyText })
                                : emptyText
                            : null, items.map(function (item, index) { return ((0, jsx_runtime_1.jsx)(Item, { item: item, index: index }, item.id)); })] })) }))] })));
};
...
var DraggableList = function (_a) {
    var title = _a.title, maxHeight = _a.maxHeight, maxWidth = _a.maxWidth, minHeight = _a.minHeight, titleStyle = _a.titleStyle, items = _a.items, emptyText = _a.emptyText, doneLoading = _a.doneLoading, loadMore = _a.loadMore, Item = _a.Item, TitleComponent = _a.TitleComponent, titleActionsComponent = _a.titleActionsComponent, style = _a.style, noWrap = _a.noWrap, header = _a.header, itemContainerStyle = _a.itemContainerStyle, onReorder = _a.onReorder, _b = _a.rowHeight, rowHeight = _b === void 0 ? 40 : _b;
    var fetchRef = (0, react_1.useRef)(0);
    var titleStyleWithDefaults = __assign({ fontSize: 20, fontWeight: 'bold', marginBottom: 3 }, titleStyle);
    var _c = (0, react_1.useState)(), optimisticUpdate = _c[0], setOptimisticUpdate = _c[1];
    var dragDisabled = !!optimisticUpdate;
    var listItems = optimisticUpdate || items;
    return ((0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, direction: "column", style: style, wrap: noWrap ? 'nowrap' : undefined }, { children: [TitleComponent
                ? (0, jsx_runtime_1.jsx)(TitleComponent, { title: title, titleStyle: titleStyleWithDefaults })
                : ((0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, alignItems: "center", justifyContent: "space-between" }, { children: [typeof title === 'string'
                            ? ((0, jsx_runtime_1.jsx)(material_1.Typography, __assign({ style: titleStyleWithDefaults }, { children: title })))
                            : title, (0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ item: true }, { children: titleActionsComponent }))] }))), header, (0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ container: true, direction: "column", flexWrap: 'nowrap', style: { maxWidth: maxWidth, overflow: 'hidden' }, onScroll: function (e) {
                    if ((doneLoading === null || doneLoading === void 0 ? void 0 : doneLoading()) || !loadMore)
                        return;
                    var atBottom = e.currentTarget.scrollHeight - e.currentTarget.scrollTop <= e.currentTarget.clientHeight + 5;
                    if (!atBottom)
                    ...
                    loadMore().catch(console.error);
                            ...
                            ? typeof emptyText === 'string'
                                ? (0, jsx_runtime_1.jsx)(material_1.Typography, { children: emptyText })
                                : emptyText
                            : null, (0, jsx_runtime_1.jsx)(react_beautiful_dnd_1.DragDropContext, __assign({ onDragEnd: function (result) { return __awaiter(void 0, void 0, void 0, function () {
                                var updated;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 2:
                                            ...
                                            return [3 /*break*/, 4];
                                        case 3:
                                            setOptimisticUpdate(undefined); // in case of error or success, default back to the controlled input
                                            return [7 /*endfinally*/];
                                        case 4: return [2 /*return*/];
                                    }
                                });
                            }); } }, { children: (0, jsx_runtime_1.jsx)(react_beautiful_dnd_1.Droppable, __assign({ droppableId: "droppable" }, { children: function (provided, snapshot) { return (
                                // <VirtualList
                                ...
                                //       index={index}
                                //       draggableId={listItems[index].id.toString()} 
                                ...
                                //               color={optimisticUpdate ? 'inherit' : "primary"} 
                                //             />
                                //           </Grid>
                                //           <Item key={listItems[index].id} item={listItems[index]} index={index} />
                                //         </Grid>
                                //       )}
                                //     </Draggable>
                                //   )}
                                // />
                                (0, jsx_runtime_1.jsx)("div", __assign({ ref: provided.innerRef }, { children: (0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, direction: "column" }, provided.droppableProps, { sx: getListStyle(snapshot.isDraggingOver) }, { children: [(optimisticUpdate || items).map(function (item, index) { return ((0, jsx_runtime_1.jsx)(react_beautiful_dnd_1.Draggable, __assign({ draggableId: "draggable-".concat(index), index: index, isDragDisabled: dragDisabled }, { children: function (provided, snapshot) { return ((0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, alignItems: "center", wrap: "nowrap", ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { sx: __assign({}, getItemStyle(snapshot.isDragging, provided.draggableProps.style)) }, { children: [(0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ item: true, sx: { width: DRAG_ICON_WIDTH, height: DRAG_ICON_WIDTH, ml: '2px' } }, { children: (0, jsx_runtime_1.jsx)(DragIndicator_1.default, { fontSize: 'small', color: optimisticUpdate ? 'inherit' : "primary" }) })), (0, jsx_runtime_1.jsx)(Item, { item: item, index: index }, item.id)] }))); } }), "draggable-".concat(index))); }), provided.placeholder] })) }))); } })) }))] })) }))] })));
};
exports.DraggableList = DraggableList;
//# sourceMappingURL=layout_virtualized.js.map