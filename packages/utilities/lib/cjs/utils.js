...
var user_is_locked_out = function (u, options) { return ((typeof u.lockedOutUntil === 'number' && (u.lockedOutUntil === 0 || u.lockedOutUntil > Date.now()))
...
exports.user_is_locked_out = user_is_locked_out;
...
var is_truthy = function (f) { return !!f; };
exports.is_truthy = is_truthy;
var is_defined = function (f) { return f !== undefined; };
exports.is_defined = is_defined;
var filter_object = function (o, validator) {
    if (o === void 0) { o = {}; }
    if (validator === void 0) { validator = exports.is_defined; }
    var newObject = {};
    for (var f in o) {
        var value = o[f];
        if (validator(value))
...
var to_object_id = function (s) {
    if (s === void 0) { s = ''; }
    return new objectid_1.ObjectId(s);
};
exports.to_object_id = to_object_id;
var objects_equivalent = function (o1, o2) {
    if (o1 === null || o2 === null)
    ...
    for (var _b = 0, k1_2 = k1; _b < k1_2.length; _b++) { // recurse in case 
        var k = k1_2[_b];
        if (!(0, exports.objects_equivalent)(o1[k], o2[k])) {
            return false;
        }
    }
    return true;
};
exports.objects_equivalent = objects_equivalent;
var user_display_name = function (user) {
    if (!user)
        return '';
...
exports.user_display_name = user_display_name;
var user_is_active = function (user, options) {
    if (!user)
        return null;
...
exports.user_is_active = user_is_active;
var defined_fields = function (o) {
    var filtered = {};
    for (var field in o) {
...
exports.defined_fields = defined_fields;
var truncate_string = function (s, options) {
    var _a, _b;
    if (s === void 0) { s = ''; }
...
exports.truncate_string = truncate_string;
// Helper function to format Stripe subscription interval display
var format_stripe_subscription_interval = function (interval, intervalCount) {
...
exports.format_stripe_subscription_interval = format_stripe_subscription_interval;
var map_object = function (object, handler) { return (Object.keys(object).map(function (key) { return handler(key, object[key]); })); };
exports.map_object = map_object;
var _a = [0, 1, 2, 3], LINK_START = _a[0], LINK_END = _a[1], TEXT_START = _a[2], TEXT_END = _a[3];
var parse_link_template = function (text, startFrom) {
    var start = 0;
    ...
    for (var i = startFrom || 0; i < text.length; i++) {
        ...
        if (state === LINK_START) {
            ...
            else if (!(0, exports.is_whitespace)(char)) { // only allow whitespace between {link} and [linkText]
                start = 0;
                linkChars = [];
...
exports.parse_link_template = parse_link_template;
...
var getTemplatedData = function (text) {
...
exports.getTemplatedData = getTemplatedData;
var build_link_string = function (d) { return "{".concat(d.url, "}[").concat(d.displayName, "]"); };
exports.build_link_string = build_link_string;
var build_form_link_string = function (d) { return "{{forms.".concat(d.id, ".link:").concat(d.displayName, "}}"); };
exports.build_form_link_string = build_form_link_string;
var build_form_group_link_string = function (d) { return "{{form_groups.".concat(d.id, ".link:").concat(d.displayName, "}}"); };
exports.build_form_group_link_string = build_form_group_link_string;
var build_file_link_string = function (d) { return "{{files.".concat(d.id, ".link:").concat(d.displayName, "}}"); };
exports.build_file_link_string = build_file_link_string;
var build_content_link_string = function (d) { return "{{content.".concat(d.id, ".link:").concat(d.displayName, "}}"); };
...
var ensure_https_url = function (url) {
    if (!url)
        return url;
...
exports.ensure_https_url = ensure_https_url;
...
exports.wait = wait;
var sorted_records = function (records, options) {
...
exports.sorted_records = sorted_records;
exports.MONTHS_FULL = [
    'January',
    'February',
    'March',
...
var get_time_values = function (date, options) {
...
var formatted_date = function (date) {
    var _a = (0, exports.get_time_values)(date), dayOfMonth = _a.dayOfMonth, month = _a.month, year = _a.year, hoursAmPm = _a.hoursAmPm, amPm = _a.amPm, minutes = _a.minutes;
    if (isNaN(dayOfMonth)
        || !month
        || isNaN(year)
        || isNaN(hoursAmPm)
...
exports.formatted_date = formatted_date;
var get_add_to_gcal_link = function (event) {
    var start = luxon_1.DateTime.fromMillis(event.startTimeInMS, { zone: 'UTC' });
    var end = luxon_1.DateTime.fromMillis(event.startTimeInMS + event.durationInMinutes * 60 * 1000, { zone: 'UTC' });
...
var formatted_date_hh_mm = function (date) {
    var _a = (0, exports.get_time_values)(date), minutes = _a.minutes, hoursAmPm = _a.hoursAmPm, amPm = _a.amPm;
    return "".concat(hoursAmPm, ":").concat(minutes).concat(amPm);
};
exports.formatted_date_hh_mm = formatted_date_hh_mm;
/** @deprecated uses month name instead of number */
var yyyy_mm_dd = function (date) {
    var _a = (0, exports.get_time_values)(date), dayOfMonth = _a.dayOfMonth, month = _a.month, year = _a.year;
    return "".concat(year, "-").concat(month, "-").concat(dayOfMonth);
};
exports.yyyy_mm_dd = yyyy_mm_dd;
var yyyy_mm_dd_numeric = function (date) {
    var _a = (0, exports.get_time_values)(date), dayOfMonth = _a.dayOfMonth, monthNumber = _a.monthNumber, year = _a.year;
    return "".concat(year, "-").concat(monthNumber, "-").concat(dayOfMonth);
};
exports.yyyy_mm_dd_numeric = yyyy_mm_dd_numeric;
var mm_dd_yyyy = function (date) {
    var _a = (0, exports.get_time_values)(date), dayOfMonth = _a.dayOfMonth, monthNumber = _a.monthNumber, year = _a.year;
...
exports.fullMonth_day_year = fullMonth_day_year;
var time_for_calendar_event = function (event) {
    var start = new Date(event.startTimeInMS);
    var end = new Date(event.startTimeInMS + event.durationInMinutes * 60 * 1000);
    var _a = (0, exports.get_time_values)(start), hoursAmPm = _a.hoursAmPm, minutes = _a.minutes, amPm = _a.amPm;
    var _b = (0, exports.get_time_values)(end), hoursEnd = _b.hoursAmPm, minutesEnd = _b.minutes, amPmEnd = _b.amPm;
...
var sanitize_html_for_cms = function (html) {
    return (0, sanitize_html_1.default)(html, {
        allowedTags: [
...
exports.query_string_for_object = query_string_for_object;
...
var getGoogleClientAPIKey = function () {
    var api = (0, exports.getApiURL)();
    return (api === exports.PROD_API_URL
...
exports.getGoogleClientAPIKey = getGoogleClientAPIKey;
var PUBLIC_ASSET_BUCKET = "tellescope-public-files";
var getBuiltInPublicFileName = function (_a) {
    var _b;
...
exports.getBuiltInPublicFileName = getBuiltInPublicFileName;
var getOrgnizationLogoURL = function (_a) {
    ...
    return ((0, exports.getPublicFileURL)(__assign(__assign({}, args), { version: logoVersion, businessId: businessId !== null && businessId !== void 0 ? businessId : id, name: (0, exports.getBuiltInPublicFileName)({ organizationIds: organizationIds, name: 'logo' }) })));
};
exports.getOrgnizationLogoURL = getOrgnizationLogoURL;
var getOrgnizationFaviconURL = function (_a) {
    ...
    return ((0, exports.getPublicFileURL)(__assign(__assign({}, args), { version: faviconVersion, businessId: businessId !== null && businessId !== void 0 ? businessId : id, name: (0, exports.getBuiltInPublicFileName)({ organizationIds: organizationIds, name: 'favicon' }) })));
};
exports.getOrgnizationFaviconURL = getOrgnizationFaviconURL;
var getPublicFileURL = function (_a) {
    var businessId = _a.businessId, name = _a.name, version = _a.version, apiURL = _a.apiURL;
    var api = apiURL || (0, exports.getApiURL)();
    var ENV_PREFIX = api === exports.PROD_API_URL ? "prod"
        : api === exports.STAGING_API_URL ? "staging"
            : "test";
...
var matches_organization = function (value, orgInfo) {
    var _a, _b, _d, _e;
...
exports.matches_organization = matches_organization;
var is_suborganization = function (_a) {
...
exports.is_suborganization = is_suborganization;
...
//   )
var user_has_record_access = function (user, record) {
    var _a, _b, _d;
    ...
    if (record.organizationIds) {
        if ((0, exports.is_suborganization)({ parent: (_b = user.organizationIds) !== null && _b !== void 0 ? _b : [], child: record.organizationIds })) {
            return true;
        }
    }
    for (var _i = 0, _e = (_d = record.sharedWithOrganizations) !== null && _d !== void 0 ? _d : []; _i < _e.length; _i++) {
        ...
        if ((0, exports.objects_equivalent)(organizationIds, user.organizationIds))
            return true;
    }
    return false;
};
exports.user_has_record_access = user_has_record_access;
var is_table_input_response = function (v) { return (!!(Array.isArray(v) && Array.isArray(v[0]) && v[0][0].label)); };
exports.is_table_input_response = is_table_input_response;
var form_response_value_to_string = function (value, options) {
    var _a, _b, _d, _e, _f, _g;
    if (value === null || value === undefined)
        return '';
    if (value && typeof value === 'string' && (0, exports.is_checkbox_custom_field_value)(value)) {
    ...
    var maybeDate = (((options === null || options === void 0 ? void 0 : options.convertISODate) && typeof value === 'string')
        ? (0, exports.is_full_iso_string_heuristic)(value)
        : undefined);
    if (maybeDate) {
        return (0, exports.formatted_date)(maybeDate);
    }
    if (value instanceof Date) {
        return (0, exports.formatted_date)(value);
    }
...
exports.form_response_value_to_string = form_response_value_to_string;
var is_organization_owner = function (organization, userId) { return (organization.owner // when owner is defined, creator is not relevant / overridden
    ? organization.owner === userId
    : organization.creator === userId); };
exports.is_organization_owner = is_organization_owner;
var update_local_storage = function (key, value) {
    try {
        window.localStorage[key] = value;
    }
    catch (err) { }
};
exports.update_local_storage = update_local_storage;
...
exports.read_local_storage = read_local_storage;
var payment_cost_to_string = function (c) {
    if (c.currency === 'USD') {
        return "$".concat((c.amount / 100).toFixed(2));
    }
    return '';
};
exports.payment_cost_to_string = payment_cost_to_string;
...
var safeJSONParseTemplate = function (s) { return (0, exports.safeJSONParse)(s === null || s === void 0 ? void 0 : s.replace(/\{\{[^{}]*\}\}/g, '0')); };
exports.safeJSONParseTemplate = safeJSONParseTemplate;
var timezone_for_enduser = function (e) { return (e.timezone
    ? e.timezone
    : (e.state
        ? types_models_1.USA_STATE_TO_TIMEZONE[e.state]
        : undefined)); };
exports.timezone_for_enduser = timezone_for_enduser;
var sanitize_html = function (t) { return (0, sanitize_html_1.default)(t, { allowedTags: [], allowedAttributes: {} }); };
exports.sanitize_html = sanitize_html;
...
var plaintext_for_managed_content_record = function (record) {
    var _a;
    if (record.type === 'PDF')
        return null;
    ...
    if (!((_a = record.blocks) === null || _a === void 0 ? void 0 : _a.length)) {
        var legacy = record.textContent || (record.htmlContent ? (0, exports.sanitize_html)(record.htmlContent) : '');
        return legacy || null;
    }
    return (record
        .blocks
        ...
        : b.type === 'h2'
            ...
            : (b.type === 'html' || b.type === 'raw-html')
                ? (0, exports.sanitize_html)(b.info.html)
                : ''); })
        .join('\n'));
};
exports.plaintext_for_managed_content_record = plaintext_for_managed_content_record;
// https://stackoverflow.com/questions/2450954/how-to-randomize-shuffle-a-javascript-array
var shuffle_array_in_place = function (array) {
    var _a;
...
exports.shuffle_array_in_place = shuffle_array_in_place;
var evaluate_conditional_logic = function (conditions, evaluate) {
    ...
    if (key === '$and') {
        ...
        for (var _i = 0, andConditions_1 = andConditions; _i < andConditions_1.length; _i++) {
            ...
            if (!(0, exports.evaluate_conditional_logic)(c, evaluate)) {
                return false;
            }
        }
        return true;
...
exports.evaluate_conditional_logic = evaluate_conditional_logic;
var evaluate_string_field_comparison = function (fieldValue, operator) {
    var _a, _b;
...
exports.evaluate_string_field_comparison = evaluate_string_field_comparison;
var evaluate_conditional_logic_for_medication_title = function (title, conditions) { return (0, exports.evaluate_conditional_logic)(conditions, function (key, value) {
    return key === 'title' ? (0, exports.evaluate_string_field_comparison)(title, value) : true;
}); };
exports.evaluate_conditional_logic_for_medication_title = evaluate_conditional_logic_for_medication_title;
var get_conditional_logic_values = function (conditions) {
    var key = Object.keys(conditions)[0];
    if (key === '$and') {
        var andConditions = conditions[key];
        return andConditions.flatMap(exports.get_conditional_logic_values);
    }
    else if (key === '$or') {
        var orConditions = conditions[key];
        return orConditions.flatMap(exports.get_conditional_logic_values);
    }
    else if (key === 'condition') {
...
exports.get_conditional_logic_values = get_conditional_logic_values;
var replace_keys_and_values_in_object = function (value, replacer) {
    ...
    if (value && typeof value === 'object' && value.constructor === Object) {
        ...
        var newValue = {};
        for (var k in value) {
            newValue[(0, exports.replace_keys_and_values_in_object)(k, replacer)] = (0, exports.replace_keys_and_values_in_object)(value[k], replacer);
        }
        return newValue;
    }
    return value;
};
exports.replace_keys_and_values_in_object = replace_keys_and_values_in_object;
// console.log(
...
//   )
// )
var age_for_dob_mmddyyyy = function (mmddyyyy) {
...
var get_enduser_field_value_for_key = function (enduser, key) {
    ...
    if (key === "Healthie ID") {
        return (enduser.source === constants_1.HEALTHIE_TITLE && enduser.externalId
            ? enduser.externalId
            : (_11 = (_10 = enduser.references) === null || _10 === void 0 ? void 0 : _10.find(function (r) { return r.type === constants_1.HEALTHIE_TITLE; })) === null || _11 === void 0 ? void 0 : _11.id);
    }
    ...
    return ((key === 'Age' && typeof value === 'object')
        ? (function () {
            if (!enduser.dateOfBirth)
                return false;
            var age = (0, exports.age_for_dob_mmddyyyy)(enduser.dateOfBirth);
            if (age === '')
                return false;
                        ...
                        : typeof value === 'object'
                            ? (function () {
                                ...
                                if (k === '$contains' || k === '$doesNotContain') {
                                    var enduserValue = ((_e = (_d = enduser.fields) === null || _d === void 0 ? void 0 : _d[key]) !== null && _e !== void 0 ? _e : (0, exports.get_enduser_field_value_for_key)(enduser, key));
                                ...
                                if (dateOperator) {
                                    ...
                                    var eDateField = (_l = (_k = enduser.fields) === null || _k === void 0 ? void 0 : _k[key]) !== null && _l !== void 0 ? _l : (0, exports.get_enduser_field_value_for_key)(enduser, key);
                                    if (!eDateField)
                                        return false;
...
exports.YYYY_MM_DD_to_MM_DD_YYYY = YYYY_MM_DD_to_MM_DD_YYYY;
var MM_DD_YYYY_to_YYYY_MM_DD = function (MMDDYYYY, delimiter) {
    if (delimiter === void 0) { delimiter = '-'; }
    var _a = MMDDYYYY.split(delimiter), mm = _a[0], dd = _a[1], yyyy = _a[2];
    return "".concat(yyyy, "-").concat(mm, "-").concat(dd);
};
exports.MM_DD_YYYY_to_YYYY_MM_DD = MM_DD_YYYY_to_YYYY_MM_DD;
var get_recent_engagement_date = function (e) {
    var dates = [];
...
exports.get_recent_engagement_date = get_recent_engagement_date;
var get_recent_outbound_communication_date = function (e) {
    var dates = [];
...
exports.get_recent_outbound_communication_date = get_recent_outbound_communication_date;
...
exports.get_next_reminder_timestamp = get_next_reminder_timestamp;
var capture_is_supported = function () {
    try {
...
exports.capture_is_supported = capture_is_supported;
var batch_array = function (array, size) {
    var batches = [];
...
exports.batch_array = batch_array;
var calculate_form_scoring = function (_a) {
    var _b, _d;
...
exports.calculate_form_scoring = calculate_form_scoring;
// don't change order without updating responses_satisfy_conditions calculations
exports.FORM_LOGIC_CALCULATED_FIELDS = ['Calculated: BMI', 'Calculated: Age', 'Calculated: Score', 'Gender', 'State'];
exports.FORM_LOGIC_URL_PARAMETER = 'URL Logic Parameter';
var calculate_bmi = function (e) {
    var _a, _b, _d, _e;
...
var responses_satisfy_conditions = function (responses, conditions, options) {
    var _a, _b;
    var key = Object.keys(conditions)[0]; // string is form id
    if (key === '$and') {
        var andConditions = conditions[key];
        for (var _i = 0, andConditions_2 = andConditions; _i < andConditions_2.length; _i++) {
            ...
            if (!(0, exports.responses_satisfy_conditions)(responses, c, options)) {
                return false;
            }
        }
        return true;
        ...
        var answer = (fieldIdOrCalculated_1 === exports.FORM_LOGIC_CALCULATED_FIELDS[0] // bmi
            ? (function () {
                var _a, _b, _d, _e;
                var h = (((_a = responses.find(function (r) { return r.answer.type === 'number' && r.answer.value && r.computedValueKey === 'Height'; })) === null || _a === void 0 ? void 0 : _a.answer)
                    || ((_b = responses.find(function (r) { return r.answer.type === 'Height' && r.answer.value && r.computedValueKey === 'Height'; })) === null || _b === void 0 ? void 0 : _b.answer));
            ...
            : fieldIdOrCalculated_1 === exports.FORM_LOGIC_CALCULATED_FIELDS[1] // age
                ? (function () {
                    var _a, _b, _d;
                    ...
                    if (!dob)
                        return undefined;
                    try {
                        var age = (0, exports.age_for_dob_mmddyyyy)(dob);
                ...
                : fieldIdOrCalculated_1 === exports.FORM_LOGIC_CALCULATED_FIELDS[2] // score
                    ? (function () {
                        var form = options === null || options === void 0 ? void 0 : options.form;
                        if (!form)
                            return undefined;
                        var scores = (0, exports.calculate_form_scoring)({ response: { responses: options.activeResponses || responses }, form: form });
                    ...
                    : fieldIdOrCalculated_1 === exports.FORM_LOGIC_CALCULATED_FIELDS[3] // gender
                        ? (function () {
                            var _a, _b, _d;
                        ...
                        : fieldIdOrCalculated_1 === exports.FORM_LOGIC_CALCULATED_FIELDS[4] // state
                            ? (function () {
                                var _a, _b, _d;
                            ...
                            : fieldIdOrCalculated_1 === exports.FORM_LOGIC_URL_PARAMETER
            ...
            if (condition === '$lt' || condition === '$gt') {
                if (conditionValue_1 === '$now') {
                    ...
                    if (answer.type === 'dateString' && answer.value) {
                        var number_2 = new Date((0, exports.MM_DD_YYYY_to_YYYY_MM_DD)((0, exports.mm_dd_yyyy)(new Date()))).getTime();
                        var answerNumber_2 = new Date((0, exports.MM_DD_YYYY_to_YYYY_MM_DD)(answer.value)).getTime();
                        if (condition === '$lt') {
...
exports.responses_satisfy_conditions = responses_satisfy_conditions;
var weighted_round_robin = function (_a) {
...
exports.weighted_round_robin = weighted_round_robin;
var validate_insurance_for_eligibility = function (enduser) {
    var _a, _b, _d;
...
exports.validate_insurance_for_eligibility = validate_insurance_for_eligibility;
var validate_organization_for_candid = function (organization) {
    var _a, _b, _d, _e, _f;
    if (!organization)
...
exports.validate_organization_for_candid = validate_organization_for_candid;
var validate_provider_for_candid = function (user) {
    if (!user)
...
exports.validate_provider_for_candid = validate_provider_for_candid;
var validate_enduser_for_candid = function (enduser) {
    if (!enduser)
...
exports.validate_enduser_for_candid = validate_enduser_for_candid;
var json_error_string = function (s) {
    try {
...
exports.json_error_string = json_error_string;
var validate_enduser_for_gogo = function (enduser) {
    if (!enduser)
        return "Enduser is required";
    if (!enduser.fname)
        return "First name is required";
...
exports.validate_enduser_for_gogo = validate_enduser_for_gogo;
var validate_enduser_for_smart_meter = function (enduser) {
    if (!enduser)
        return "Enduser is required";
    if (!enduser.fname)
        return "First name is required";
...
exports.validate_enduser_for_smart_meter = validate_enduser_for_smart_meter;
var validate_enduser_for_dose_spot = function (enduser) {
    var _a, _b;
    if (!enduser)
        return "Enduser is required";
    if (!enduser.fname)
...
exports.validate_enduser_for_dose_spot = validate_enduser_for_dose_spot;
var validate_enduser_for_script_sure = function (enduser) {
    if (!enduser)
        return "Enduser is required";
    if (!enduser.fname)
        return "First name is required";
...
exports.validate_enduser_for_script_sure = validate_enduser_for_script_sure;
var validate_enduser_for_develop_health = function (enduser, insuranceType) {
    if (!enduser)
        return "Enduser is required";
    if (!enduser.fname)
        return "First name is required";
...
exports.validate_enduser_for_develop_health = validate_enduser_for_develop_health;
var validate_user_for_develop_health = function (user) {
    if (!user)
...
exports.validate_user_for_develop_health = validate_user_for_develop_health;
var validate_organization_for_develop_health = function (organization) {
    var _a, _b, _d, _e;
    if (!organization)
        return "Organization is required";
    if (!organization.billingOrganizationName)
...
exports.validate_organization_for_develop_health = validate_organization_for_develop_health;
...
var field_can_autoadvance = function (_a) {
...
exports.field_can_autoadvance = field_can_autoadvance;
var field_can_autosubmit = function (_a) {
    var type = _a.type, options = _a.options;
    if (type === 'Appointment Booking')
        return true;
    if (type === 'Stripe')
...
exports.field_can_autosubmit = field_can_autosubmit;
var satisfies_vital_comparison = function (comparison, value) {
...
exports.satisfies_vital_comparison = satisfies_vital_comparison;
exports.SMS_UNSUBSCRIBE_KEYWORDS = ['stop', 'stopall', 'unsubscribe', 'end', 'quit', 'cancel'];
var classification_for_vital = function (v, configurations) {
    var _a, _b, _d;
...
exports.classification_for_vital = classification_for_vital;
// ,'High','Low','Very High','Very Low','Critical High','Critical Low'
var color_for_classification = function (c, ifNoMatch) { return (c === 'Target' ? '#44cc4466'
    : c === 'Low' ? '#cccc4466'
        : c === 'High' ? '#cccc4466'
                ...
                : c === 'Very Low' ? '#cc444466'
                    : c === 'Critical High' ? 'violet'
                        : c === 'Critical Low' ? 'violet'
                            : ifNoMatch); };
exports.color_for_classification = color_for_classification;
var is_out_of_office = function (blocks, date, zone, outOfOfficeBlocks) {
    var _a, _b;
    ...
    if (blocks.length === 0)
        return false;
    var nowInTimezone = luxon_1.DateTime.fromJSDate(date, { zone: zone });
...
exports.get_utm_params = get_utm_params;
var append_current_utm_params = function (targetURL) {
    try {
        var params = new URL(window.location.href).searchParams;
        var utmParams_1 = {};
        ...
        if ((0, exports.object_is_empty)(utmParams_1)) {
            return targetURL;
        }
...
exports.replace_medication_template_values = replace_medication_template_values;
var replace_order_template_values = function (s, order) {
    var _a;
    if (!order)
        return s;
    if (typeof s !== 'string')
...
var replace_sms_template_values = function (s, sms) {
    if (!sms)
        return s;
    if (typeof s !== 'string')
        return s; // e.g. Date value
...
exports.replace_sms_template_values = replace_sms_template_values;
var get_secret_names = function (s) {
    var titles = [];
    if (typeof s !== 'string')
        return titles;
...
exports.get_secret_names = get_secret_names;
var replace_secret_values = function (s, integrations) {
    if (!integrations)
        return s;
    if (typeof s !== 'string')
        return s; // e.g. Date value
...
exports.display_time_for_seconds = display_time_for_seconds;
var is_full_iso_string_heuristic = function (d) {
    try {
        if (d.length < 12)
...
exports.is_full_iso_string_heuristic = is_full_iso_string_heuristic;
var skip_due_date_as_needed = function (toSkip) { return function (dueDateInMS) {
    if (!dueDateInMS)
        return dueDateInMS;
...
exports.skip_due_date_as_needed = skip_due_date_as_needed;
var get_flattened_fields = function (objects, options) {
    ...
    for (var _i = 0, objects_1 = objects; _i < objects_1.length; _i++) {
        ...
        for (var rootField in o) {
            ...
            var nestedFields = (0, exports.get_flattened_fields)([value], __assign(__assign({}, options), { includeObjectRoot: false, ignore: [], depth: depth + 1 }));
...
var value_for_dotted_key = function (v, key, o) {
    ...
    if ((o === null || o === void 0 ? void 0 : o.handleArray) && keys.length >= 2 && Array.isArray(value[keys[0]])) {
        return (0, exports.value_for_dotted_key)(value[keys[0]], keys.slice(1).join('.'), o);
    }
...
exports.add_value_for_dotted_key = add_value_for_dotted_key;
exports.INVALID_PREPOPULATION_TYPES = [
    'file',
    'files',
    'description',
    'Question Group',
...
exports.get_prepopulated_responses = get_prepopulated_responses;
var downloadFile = function (data, options) {
...
var is_timezone = function (value) { return (typeof value === 'string' && types_models_1.TIMEZONES.includes(value)); };
exports.is_timezone = is_timezone;
var enduser_address_string = function (e) { return ("".concat(e.addressLineOne ? e.addressLineOne : '').concat(e.addressLineTwo ? " ".concat(e.addressLineTwo) : '').concat(e.addressLineOne || e.addressLineTwo ? ', ' : '').concat(e.city ? "".concat(e.city, ", ") : '').concat(e.state ? "".concat(e.state).concat(e.zipCode ? ', ' : '') : '').concat(e.zipCode ? e.zipCode : '').concat(e.zipPlusFour && e.zipCode ? "-".concat(e.zipPlusFour) : '')); };
exports.enduser_address_string = enduser_address_string;
var enduser_insurance_string = function (i) { return !i ? '' : ("".concat(i.payerName).concat(i.memberId ? " (".concat(i.memberId, ")") : '')); };
exports.enduser_insurance_string = enduser_insurance_string;
var should_show_unsubmitted_form_response_for_interval = function (fr) {
    if (!fr.createdAt)
        return false;
...
exports.should_show_unsubmitted_form_response_for_interval = should_show_unsubmitted_form_response_for_interval;
var get_canvas_id = function (v) {
    var _a, _b;
    return ((v.source === constants_1.CANVAS_TITLE && v.externalId)
        ? v.externalId
        : (_b = (_a = v.references) === null || _a === void 0 ? void 0 : _a.find(function (r) { return r.type === constants_1.CANVAS_TITLE; })) === null || _b === void 0 ? void 0 : _b.id);
};
exports.get_canvas_id = get_canvas_id;
...
exports.to_human_readable_phone_number = to_human_readable_phone_number;
var enrich_doxy_url = function (url, e) {
    var _a, _b;
    if (!e)
        return url;
    ...
    return ("".concat(url, "?username=").concat(e.fname || '').concat(e.fname && ' ').concat(e.lname || '', "&autocheckin=false&pid=").concat(((_b = (_a = e.references) === null || _a === void 0 ? void 0 : _a.find(function (r) { return r.type === constants_1.HEALTHIE_TITLE; })) === null || _b === void 0 ? void 0 : _b.id) || e.id));
};
exports.enrich_doxy_url = enrich_doxy_url;
var is_checkbox_custom_field_value = function (value) {
    var _a;
    if (!value)
        return false;
    if (typeof value !== 'string')
...
exports.is_checkbox_custom_field_value = is_checkbox_custom_field_value;
var get_care_team_primary = function (e) {
    var _a;
    if (!e)
        return;
...
exports.get_care_team_primary = get_care_team_primary;
var emit_gtm_event = function (event) {
    try {
...
exports.get_snippet_keys = get_snippet_keys;
// Replace snippet templates with their values, supporting both {{snippet:key}} and {{snippet.key}} syntax
var replace_snippet_template_values = function (s, snippets) {
...
exports.replace_snippet_template_values = replace_snippet_template_values;
var resolve_integration_id = function (e, integrationTitle) {
    var _a, _b;
...
var slot_violates_calendar_event_limits = function (_a) {
    ...
    var relevantLimits = calendarEventLimits.filter(function (limit) {
        return limit.templateId === templateId
    ...
    var _loop_5 = function (limit) {
        ...
        var allTemplateIds = __spreadArray([limit.templateId], (limit.otherTemplateIds || []), true);
        ...
        var userTemplateEvents = existingEvents.filter(function (e) {
            var _a;
            return allTemplateIds.includes((_a = e.templateId) !== null && _a !== void 0 ? _a : '') &&
...
function calculateTimeTrackDuration(timestamps, closedAt) {
    var totalMS = 0;
    var lastStart = null;
...
exports.calculateTimeTrackDuration = calculateTimeTrackDuration;
...
function constructT2BaseURL(isStaging) {
    return "https://".concat(isStaging ? 'staging-' : '', "app.tellescope.com");
}
exports.constructT2BaseURL = constructT2BaseURL;
