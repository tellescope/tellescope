...
test('parses ISO string correctly', function () {
    var result = (0, utils_js_1.parse_date_string)('2024-01-15T10:00:00Z');
...
test('parses MM-DD-YYYY string correctly', function () {
    var result = (0, utils_js_1.parse_date_string)('01-15-2024');
    assertNotNull(result);
    assertEqual(result.getFullYear(), 2024);
    assertEqual(result.getMonth(), 0); // January = 0
    assertEqual(result.getDate(), 15);
...
test('returns null for invalid date string', function () {
    var result = (0, utils_js_1.parse_date_string)('invalid-date');
    assertEqual(result, null);
});
test('returns null for empty string', function () {
    var result = (0, utils_js_1.parse_date_string)('');
    assertEqual(result, null);
});
// Test calculate_days_between_dates
console.log('\nTesting calculate_days_between_dates:');
test('calculates days between two ISO dates', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('2024-01-15T00:00:00Z', '2024-01-25T00:00:00Z');
    assertEqual(days, 10);
});
test('calculates days between two MM-DD-YYYY dates', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('01-15-2024', '01-25-2024');
    assertEqual(days, 10);
});
test('calculates days between ISO and MM-DD-YYYY', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('2024-01-15T00:00:00Z', '01-25-2024');
    assertEqual(days, 10);
});
test('calculates days between MM-DD-YYYY and ISO', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('01-15-2024', '2024-01-25T00:00:00Z');
    assertEqual(days, 10);
});
test('returns absolute value (order does not matter)', function () {
    var days1 = (0, utils_js_1.calculate_days_between_dates)('2024-01-25T00:00:00Z', '2024-01-15T00:00:00Z');
    var days2 = (0, utils_js_1.calculate_days_between_dates)('2024-01-15T00:00:00Z', '2024-01-25T00:00:00Z');
    assertEqual(days1, days2);
    assertEqual(days1, 10);
});
test('handles $now for date1', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('$now', '2024-01-15T00:00:00Z');
...
test('handles $now for date2', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('2024-01-15T00:00:00Z', '$now');
    // Should be many days since 2024-01-15
    if (days < 200) {
        throw new Error("Expected large number of days, got ".concat(days));
    }
...
test('handles both $now (should be 0)', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('$now', '$now');
    assertEqual(days, 0);
});
test('works with Date objects', function () {
    var date1 = new Date('2024-01-15');
    var date2 = new Date('2024-01-25');
    var days = (0, utils_js_1.calculate_days_between_dates)(date1, date2);
    assertEqual(days, 10);
});
test('throws error for invalid date1', function () {
    try {
        (0, utils_js_1.calculate_days_between_dates)('invalid-date', '2024-01-25T00:00:00Z');
...
test('throws error for invalid date2', function () {
    try {
        (0, utils_js_1.calculate_days_between_dates)('2024-01-15T00:00:00Z', 'invalid-date');
        throw new Error('Should have thrown an error');
    }
    catch (error) {
...
test('calculates 30 days correctly', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('2024-01-01T00:00:00Z', '2024-01-31T00:00:00Z');
    assertEqual(days, 30);
});
test('calculates 365 days for a full year', function () {
    var days = (0, utils_js_1.calculate_days_between_dates)('2024-01-01T00:00:00Z', '2025-01-01T00:00:00Z');
