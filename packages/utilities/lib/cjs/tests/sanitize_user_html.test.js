...
exports.sanitize_user_html_tests = void 0;
...
var sanitize_user_html_tests = function () {
    ...
    for (var _i = 0, xssPayloads_1 = xssPayloads; _i < xssPayloads_1.length; _i++) {
        ...
        var out = (0, utils_1.sanitize_user_html)(payload);
        check(name_1, neutralized(out), "got: ".concat(out));
    }
    console.log("sanitize_user_html — preserves legitimate customization HTML");
    var out_heading = (0, utils_1.sanitize_user_html)("<h1>Welcome</h1><h3 style=\"color:#333\">Sub</h3>");
    check('headings + style kept', out_heading.includes('<h1>') && out_heading.includes('<h3') && lower(out_heading).includes('color'));
    var out_table = (0, utils_1.sanitize_user_html)("<table><thead><tr><th>H</th></tr></thead><tbody><tr><td style=\"padding:4px\" colspan=\"2\">cell</td></tr></tbody></table>");
    check('table structure kept', out_table.includes('<table') && out_table.includes('<td') && out_table.includes('colspan'));
    var out_list = (0, utils_1.sanitize_user_html)("<ul><li>a</li><li>b</li></ul><ol start=\"3\"><li>c</li></ol>");
    check('lists kept', out_list.includes('<ul') && out_list.includes('<li') && out_list.includes('<ol'));
    var out_link = (0, utils_1.sanitize_user_html)("<a href=\"https://example.com\">link</a>");
    ...
    var out_img = (0, utils_1.sanitize_user_html)("<img src=\"https://cdn.example.com/a.png\" alt=\"pic\" width=\"200\">");
    check('http image kept', out_img.includes('src="https://cdn.example.com/a.png"') && out_img.includes('alt="pic"'));
    var out_dataimg = (0, utils_1.sanitize_user_html)("<img src=\"data:image/png;base64,iVBORw0KGgo=\">");
    check('data: image kept', out_dataimg.includes('data:image/png'));
    var out_format = (0, utils_1.sanitize_user_html)("<p><strong>b</strong> <em>i</em> <u>u</u> <span style=\"font-size:14px\">s</span></p><blockquote>q</blockquote>");
    ...
    var out_mixed = (0, utils_1.sanitize_user_html)("<p>Hello <b>name</b></p><img src=x onerror=\"steal()\">");
...
exports.sanitize_user_html_tests = sanitize_user_html_tests;
if (require.main === module) {
    try {
        (0, exports.sanitize_user_html_tests)();
        process.exit(0);
    }
    catch (err) {
