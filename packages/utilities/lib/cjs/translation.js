...
exports.translationLanguageCodeForLanguage = exports.collectFormTranslationSourceStrings = exports.decodeTranslationMapFromStorage = exports.encodeTranslationMapForStorage = exports.generateBatchTranslationSystemPrompt = exports.generateTranslationSystemPrompt = exports.languageLabelForCode = exports.TRANSLATION_LANGUAGES = void 0;
...
var languageLabelForCode = function (code) { var _a, _b; return (_b = (_a = exports.TRANSLATION_LANGUAGES.find(function (l) { return l.code === code; })) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : code; };
...
var generateBatchTranslationSystemPrompt = function (targetLanguageLabel) {
...
exports.generateBatchTranslationSystemPrompt = generateBatchTranslationSystemPrompt;
...
var encodeTranslationMapForStorage = function (map) {
    return JSON.stringify(map).replace(/[&<>]/g, function (c) { return "\\u".concat(c.charCodeAt(0).toString(16).padStart(4, '0')); });
};
exports.encodeTranslationMapForStorage = encodeTranslationMapForStorage;
var decodeTranslationMapFromStorage = function (value) {
    try {
...
exports.decodeTranslationMapFromStorage = decodeTranslationMapFromStorage;
...
var collectFormTranslationSourceStrings = function (form, fields) {
...
exports.collectFormTranslationSourceStrings = collectFormTranslationSourceStrings;
