...
import { DEFAULT_AI_SUMMARY_DATA_SOURCE_LIMIT, MAX_AI_SUMMARY_INPUT_TOKENS, } from "@tellescope/constants";
/* ---------------------------------- formatters ---------------------------------- */
...
export var buildAISummarySourceFilter = function (_a) {
    ...
    var effectiveLimit = (_c = ds.limit) !== null && _c !== void 0 ? _c : DEFAULT_AI_SUMMARY_DATA_SOURCE_LIMIT;
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    enduser = _c;
                    profileBlock = enduser ? enduserProfileToText(enduser) : '';
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        ...
                                        _a = buildAISummarySourceFilter({ ds: ds, enduserId: enduserId, mapEntry: m }), mdbFilter = _a.mdbFilter, effectiveLimit = _a.effectiveLimit;
                                        _d.label = 1;
                                    case 1:
                                        _d.trys.push([1, 3, , 4]);
                                    ...
                                    case 3:
                                        ...
                                        return [2 /*return*/, {
                                                type: ds.type,
                                                label: (_c = DATA_SOURCE_LABELS[ds.type]) !== null && _c !== void 0 ? _c : ds.type,
                                                lookbackMS: ds.lookbackMS,
                                                limit: effectiveLimit,
                                                records: [],
                                                formattedLines: [],
