 ...
 */
export var DEFAULT_IFRAME_SANDBOX = 'allow-scripts allow-same-origin allow-forms allow-popups allow-popups-to-escape-sandbox allow-presentation';
/**
 ...
 */
export var sanitize_user_html_with_iframes = function (html) {
    if (typeof html !== 'string' || !html)
        return '';
    return sanitizeHtml(html, {
        allowedTags: [
...
export var decode_email_for_display = function (content, _a) {
    var inbound = _a.inbound;
    return (inbound === true ? URIDecodeEmail(content) : content);
};
...
export var replace_tag_template_values_for_enduser = function (tags, enduser, options) {
    if (options === void 0) { options = {}; }
...
export var replace_enduser_template_values = function (s, enduser, options) {
    if (options === void 0) { options = {}; }
    if (!enduser)
        return s;
    if (typeof s !== 'string')
...
export var get_prepopulated_responses = function (fields, enduser, existingResponses, options) { return (fields
    .filter(function (v) {
    var _a, _b;
