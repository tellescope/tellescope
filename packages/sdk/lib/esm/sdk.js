...
var Session = /** @class */ (function (_super) {
    ...
    function Session(o) {
        ...
        queries.endusers.rename_stored_custom_fields = function (a) { return _this._PATCH("/v1".concat(schema.endusers.customActions.rename_stored_custom_fields.path), a); };
        queries.endusers.load_inbox_data = function (a) { return _this._GET("/v1/".concat(schema.endusers.customActions.load_inbox_data.path), a); };
        ...
        queries.users.play_phone_message = function (a) { return _this._POST("/v1/".concat(schema.users.customActions.play_phone_message.path), a); };
        queries.users.get_linked_accounts = function () { return _this._GET("/v1/".concat(schema.users.customActions.get_linked_accounts.path)); };
        ...
        queries.form_responses.create_canvas_note = function (args) { return _this._POST("/v1".concat(schema.form_responses.customActions.create_canvas_note.path), args); };
        ...
        queries.files.push = function (a) { return _this._POST("/v1".concat(schema.files.customActions.push.path), a); };
        ...
        queries.integrations.load_redacted = function (args) { return _this._GET("/v1".concat(schema.integrations.customActions.load_redacted.path), args); };
        queries.integrations.update_settings = function (args) { return _this._POST("/v1".concat(schema.integrations.customActions.update_settings.path), args); };
        ...
        queries.calendar_events.out_of_office = function (a) { return _this._GET("/v1".concat(schema.calendar_events.customActions.out_of_office.path), a); };
        ...
        queries.analytics_frames.custom_aggregation = function (a) { return _this._POST("/v1".concat(schema.analytics_frames.customActions.custom_aggregation.path), a); };
        ...
        queries.inbox_threads.build_threads = function (a) { return _this._POST("/v1/".concat(schema.inbox_threads.customActions.build_threads.path), a); };
        queries.inbox_threads.load_threads = function (a) { return _this._GET("/v1/".concat(schema.inbox_threads.customActions.load_threads.path), a); };
        queries.inbox_threads.reset_threads = function (a) { return _this._POST("/v1/".concat(schema.inbox_threads.customActions.reset_threads.path), a !== null && a !== void 0 ? a : {}); };
        ...
        queries.ticket_threads.send_message = function (a) { return _this._POST("/v1".concat(schema.ticket_threads.customActions.send_message.path), a); };
        queries.ticket_threads.update_status = function (a) { return _this._PATCH("/v1".concat(schema.ticket_threads.customActions.update_status.path), a); };
        ...
        queries.tickets.bulk_assign = function (a) { return _this._PATCH("/v1/".concat(schema.tickets.customActions.bulk_assign.path), a); };
        ...
        queries.enduser_medications.create_scriptsure_order = function (args) { return _this._POST("/v1".concat(schema.enduser_medications.customActions.create_scriptsure_order.path), args); };
        ...
        queries.ai_conversations.generate_ai_decision = function (args) { return _this._POST("/v1".concat(schema.ai_conversations.customActions.generate_ai_decision.path), args); };
        queries.automated_actions.process = function (args) { return _this._POST("/v1".concat(schema.automated_actions.customActions.process.path), args); };
        _this.api = queries;
        return _this;
    }
    return Session;
