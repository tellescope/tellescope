...
export var get_sha256 = function (s) {
    if (s === void 0) { s = ''; }
...
var user1 = new Session({ host: host, enableSocketLogging: VERBOSE });
var user2 = new Session({ host: host, enableSocketLogging: VERBOSE });
...
var enduserSDK = new EnduserSession({ host: host, businessId: businessId, enableSocketLogging: VERBOSE });
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4 /*yield*/, wait(undefined, AWAIT_SOCKET_DURATION)];
            case 1:
                _e.sent();
            ...
            case 3:
                _e.sent();
                assert(objects_equivalent(e, (_a = socket_events === null || socket_events === void 0 ? void 0 : socket_events[0]) === null || _a === void 0 ? void 0 : _a[0]), 'inconsistent socket create', 'socket create');
            ...
            case 5:
                _e.sent();
                assert(((_c = (_b = socket_events[1]) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.fname) === 'Gary', 'inconsistent socket update', 'socket update');
            ...
            case 7:
                _e.sent();
                assert(((_d = socket_events[2]) === null || _d === void 0 ? void 0 : _d[0]) === e.id, 'inconsistent socket delete', 'socket delete');
            ...
            case 9:
                _e.sent();
                assert(objects_equivalent(es, socket_events === null || socket_events === void 0 ? void 0 : socket_events[3]), 'inconsistent socket create many', 'socket create many');
                return [2 /*return*/];
        }
    });
}); };
var sub_organization_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                e = _e.sent();
                return [4 /*yield*/, wait(undefined, AWAIT_SOCKET_DURATION * 3)];
            case 2:
                _e.sent();
                assert(objects_equivalent(e, (_a = root_events === null || root_events === void 0 ? void 0 : root_events[0]) === null || _a === void 0 ? void 0 : _a[0]), 'access error', 'root gets sub');
                assert(objects_equivalent(e, (_b = sub_events === null || sub_events === void 0 ? void 0 : sub_events[0]) === null || _b === void 0 ? void 0 : _b[0]), 'access error', 'sub gets sub');
            ...
            case 4:
                _e.sent();
                assert(objects_equivalent(e2, (_c = root_events === null || root_events === void 0 ? void 0 : root_events[1]) === null || _c === void 0 ? void 0 : _c[0]), 'access error', 'root confirmation on shared');
                assert(objects_equivalent(e2, (_d = sub_events === null || sub_events === void 0 ? void 0 : sub_events[1]) === null || _d === void 0 ? void 0 : _d[0]), 'access error', 'sub gets sub shared');
                assert(other_sub_events.length === 0, 'got access incorrectly', 'other sub no access');
                assert(sub_sub_events.length === 0, 'got access incorrectly', 'sub sub no access');
...
var access_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 10:
                _d.sent();
                assert(user1Events.length === 6 && !!user1Events.find(function (r) { return (r === null || r === void 0 ? void 0 : r.id) === sharedChat2.id; }), 'bad chats other', 'verify chat received');
                assert(nonAdminEvents.length === 3 && !!nonAdminEvents.find(function (e) { return e.id === sharedChat.id; }), 'bad chats self, non-admin', 'push valid for non-admin default access');
            ...
            case 13:
                _d.sent();
                assert(!!user1Events.find(function (e) { return e.id === unassignedEnduser.id; }) && !!user1Events.find(function (e) { return e.id === assignedEnduser.id; }), 'admin did not get endusers', 'admin got assigned and unassigned endusers');
                assert(!nonAdminEvents.find(function (e) { return e.id === unassignedEnduser.id; }) && !!nonAdminEvents.find(function (e) { return e.id === assignedEnduser.id; }), 'non-admin got incorrect endusers', 'non-admin got assigned enduser');
            ...
            case 20:
                _d.sent();
                assert((!!user1Events.find(function (e) { return e.id === roomUnassigned.id; })
                ...
                assert((!nonAdminEvents.find(function (e) { return e.id === roomUnassigned.id; }) // shouldn't get as non-admin
                ...
                assert((!!enduserEvents.find(function (e) { return e.id === roomUnassigned.id; })
            ...
            case 23:
                _d.sent();
                assert(!!enduserEvents.find(function (e) { return e.id === userMessage.id; }), 'enduser did not get message', 'enduser got message from user');
                assert(!!user1Events.find(function (e) { return e.id === enduserMessage.id; }), 'user did not get message', 'user got message from enduser');
                assert(!nonAdminEvents.find(function (e) { return e.id === enduserMessage.id; }) && !nonAdminEvents.find(function (e) { return e.id === userMessage.id; }), 'non-admin got unexpected message', 'non-admin correctly did not get message from enduser or user');
            ...
            case 27:
                _d.sent();
                assert(!!enduserEvents.find(function (e) { return e.id === userMessage.id; }) && !!enduserEvents.find(function (e) { return e.id === nonAdminMessage.id; }), 'enduser did not get message', 'enduser got message from user');
                assert(!!user1Events.find(function (e) { return e.id === enduserMessage.id; }) && !!user1Events.find(function (e) { return e.id === nonAdminMessage.id; }), 'user did not get messages', 'user got messages');
                assert(!!nonAdminEvents.find(function (e) { return e.id === enduserMessage.id; }) && !!nonAdminEvents.find(function (e) { return e.id === userMessage.id; }), 'non-admin didnt get messages', 'non-admin got message from user and enduser');
            ...
            case 32:
                nonAdminMessage = _d.sent();
                return [4 /*yield*/, wait(undefined, AWAIT_SOCKET_DURATION * 2)];
            case 33:
                _d.sent();
                assert(!!enduserEvents.find(function (e) { return e.id === userMessage.id; }) && !!enduserEvents.find(function (e) { return e.id === nonAdminMessage.id; }), 'enduser did not get messages', 'enduser got messages from users');
                assert(!!user1Events.find(function (e) { return e.id === enduserMessage.id; }) && !!user1Events.find(function (e) { return e.id === nonAdminMessage.id; }), 'user did not get messages', 'user got messages');
                assert(!!nonAdminEvents.find(function (e) { return e.id === enduserMessage.id; }) && !!nonAdminEvents.find(function (e) { return e.id === userMessage.id; }), 'non-admin didnt get messages', 'non-admin got message from user and enduser');
                _b = (_a = Promise).all;
...
var enduser_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                _a.sent();
                assert(!!userEvents.find(function (e) { return e.id === messageToUser.id; }), 'no message on socket for user', 'push message to user');
                assert(!!enduserEvents.find(function (e) { return e.id === messageToEnduser.id; }), 'no message on socket for enduser', 'push message to enduser');
                return [4 /*yield*/, user1.api.tickets.createOne({ enduserId: PLACEHOLDER_ID, title: "For Noone" })]; // should not get pushed to enduser
            case 10:
            ...
            case 13:
                _a.sent();
                assert(!!userEvents.find(function (t) { return t.id === ticketFromEnduser.id; }), 'no ticket on socket for user', 'push ticket to user');
                assert(!!enduserEvents.find(function (t) { return t.id === ticketForEnduser.id; }), 'no ticket on socket for enduser', 'push ticket to enduser');
                assert(!enduserEvents.find(function (t) { return t.id === unusedTicket.id; }), 'enduser got an orgwide ticket', 'enduser does not receive org-wide ticket');
            ...
            case 17:
                // test enduser logout
                _a.sent();
                return [4 /*yield*/, async_test("verify enduser logout works", function () { return enduserSDK.api.chats.getOne({}); }, { shouldError: true, onError: function (e) { return e === 'Unauthenticated'; } }
...
var deauthentication_tests = function (byTimeout) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    log_header("Unauthenticated Tests ".concat(byTimeout ? '- With Timeout, requires Worker' : '- With Manual Logout'));
                ...
                case 7:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 8: return [4 /*yield*/, wait(undefined, TEST_SESSION_DURATION * 1000 + SESSION_TIMEOUT_DELAY)];
                case 9:
                    _a.sent();
                    _a.label = 10;
                ...
                case 12:
                    _a.sent();
                    assert(enduserEvents.find(function (c) { return c.id === badChatEnduser.id; }) === undefined, 'enduser got message after logout on socket', 'enduser logged out');
                ...
                case 15:
                    _a.sent();
                    return [4 /*yield*/, wait(undefined, TEST_SESSION_DURATION * 1000 + SESSION_TIMEOUT_DELAY)];
                case 16:
                    _a.sent();
                    return [3 /*break*/, 19];
                case 17: return [4 /*yield*/, wait(undefined, AWAIT_SOCKET_DURATION)];
                case 18:
                    _a.sent();
                    _a.label = 19;
                ...
                case 21:
                    _a.sent();
                    assert(userEvents.find(function (e) { return e.id === badChat.id; }) === undefined, 'user got message after logout', 'user logged out');
...
export var notification_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, wait(undefined, AWAIT_SOCKET_DURATION)]; // wait for socket connections
            case 5:
            ...
            case 10:
                _a.sent();
                cleanup_cache();
                return [4 /*yield*/, notification_tests()];
            case 11:
                _a.sent();
                cleanup_cache();
