...
var enduser_tests = function (queries) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var e1, e2, eToDup1, eToDup2, endusersToCleanup;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    log_header("Enduser");
                ...
                case 16:
                    _a.sent();
                    // Test updating references field (CU-86e011kjq)
                    return [4 /*yield*/, async_test("update-enduser references", function () {
                            var _a;
                            return queries.updateOne((_a = e1.id) !== null && _a !== void 0 ? _a : '', {
                ...
                case 17:
                    // Test updating references field (CU-86e011kjq)
                    _a.sent();
                    return [4 /*yield*/, async_test("get-enduser verify references update", function () { var _a; return queries.getOne((_a = e1.id) !== null && _a !== void 0 ? _a : ''); }, { onResult: function (e) { var _a; return ((_a = e.references) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.references[0].type === 'Healthie' && e.references[0].id === 'Healthie-123'; } })];
                case 18:
                    _a.sent();
                    return [4 /*yield*/, async_test("update-enduser references with optional fields", function () {
                            var _a;
                            return queries.updateOne((_a = e1.id) !== null && _a !== void 0 ? _a : '', {
                ...
                case 19:
                    _a.sent();
                    return [4 /*yield*/, async_test("get-enduser verify references with optional fields", function () { var _a; return queries.getOne((_a = e1.id) !== null && _a !== void 0 ? _a : ''); }, { onResult: function (e) {
                                var _a;
                                return (((_a = e.references) === null || _a === void 0 ? void 0 : _a.length) === 1
                ...
                case 27:
                    _a.sent();
                    return [4 /*yield*/, queries.getSome({
                            mdbFilter: {
                                email: { $in: [
                                        'editedtest1@gmail.com',
                                        'test2@gmail.com',
                                        'test3@gmail.com',
                                        'dup1@tellescope.com',
                                        'dup2@tellescope.com',
                ...
                case 28:
                    endusersToCleanup = _a.sent();
                    return [4 /*yield*/, Promise.all(endusersToCleanup.map(function (e) { return queries.deleteOne(e.id); }))];
                case 29:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var assign_care_team_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test("No care team added", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return !((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.length) && !e.primaryAssignee; } })];
            case 8:
                _a.sent();
            ...
            case 10:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test("Care team added", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.length) === 1 && !e.primaryAssignee; } })];
            case 11:
                _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, import("@tellescope/utilities")
            ...
            case 1:
                ...
                // Test parse_date_string
                return [4 /*yield*/, async_test("parse_date_string: ISO format with time", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var result;
                        return __generator(this, function (_a) {
            ...
            case 2:
                // Test parse_date_string
                _b.sent();
                return [4 /*yield*/, async_test("parse_date_string: YYYY-MM-DD format", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var result;
                        return __generator(this, function (_a) {
            ...
            case 3:
                _b.sent();
                return [4 /*yield*/, async_test("parse_date_string: MM-DD-YYYY format", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var result;
                        return __generator(this, function (_a) {
            ...
            case 4:
                _b.sent();
                // Test calculate_days_between_dates
                return [4 /*yield*/, async_test("calculate_days_between_dates: ISO to ISO (10 days)", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            ...
            case 5:
                // Test calculate_days_between_dates
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates: ISO with time to MM-DD-YYYY", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            ...
            case 6:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates: YYYY-MM-DD to YYYY-MM-DD", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, calculate_days_between_dates('2024-01-15', '2024-01-25')];
                    }); }); }, { onResult: function (days) { return days === 10; } })];
            case 7:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates: MM-DD-YYYY to MM-DD-YYYY", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, calculate_days_between_dates('01-15-2024', '01-25-2024')];
                    }); }); }, { onResult: function (days) { return days === 10; } })];
            case 8:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates: Order doesn't matter (absolute value)", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 9:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates: 30 days", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, calculate_days_between_dates('2024-01-01', '2024-01-31')];
                    }); }); }, { onResult: function (days) { return days === 30; } })];
            case 10:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates: with $now", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var days;
                        return __generator(this, function (_a) {
            ...
            case 11:
                _b.sent();
                // Test resolve_date_value
                return [4 /*yield*/, async_test("resolve_date_value: resolves $now", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, resolve_date_value('$now') === '$now'];
                    }); }); }, { onResult: function (r) { return r === true; } })];
            case 12:
                // Test resolve_date_value
                _b.sent();
                return [4 /*yield*/, async_test("resolve_date_value: resolves field reference", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields;
                        return __generator(this, function (_a) {
            ...
            case 13:
                _b.sent();
                return [4 /*yield*/, async_test("resolve_date_value: returns hardcoded date when field not found", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields;
                        return __generator(this, function (_a) {
            ...
            case 14:
                _b.sent();
                // Test calculate_days_between_dates_from_enduser
                return [4 /*yield*/, async_test("calculate_days_between_dates_from_enduser: resolves field references", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields;
                        return __generator(this, function (_a) {
            ...
            case 15:
                // Test calculate_days_between_dates_from_enduser
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates_from_enduser: mixes field reference and hardcoded", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields;
                        return __generator(this, function (_a) {
            ...
            case 16:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_days_between_dates_from_enduser: works with $now", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields, days;
                        return __generator(this, function (_a) {
                            fields = { startDate: '2024-01-15' };
            ...
            case 17:
                _b.sent();
                // Test calculate_date_difference_for_set_fields (the all-in-one function)
                return [4 /*yield*/, async_test("calculate_date_difference_for_set_fields: successful calculation", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields, options;
                        return __generator(this, function (_a) {
                            fields = { startDate: '2024-01-15', endDate: '2024-01-25' };
            ...
            case 18:
                // Test calculate_date_difference_for_set_fields (the all-in-one function)
                _b.sent();
                return [4 /*yield*/, async_test("calculate_date_difference_for_set_fields: returns empty string on missing options", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields;
                        return __generator(this, function (_a) {
                            fields = { startDate: '2024-01-15' };
            ...
            case 19:
                _b.sent();
                return [4 /*yield*/, async_test("calculate_date_difference_for_set_fields: returns empty string on invalid date", function () { return __awaiter(void 0, void 0, void 0, function () {
                        var fields, options;
                        return __generator(this, function (_a) {
            ...
            case 25:
                ...
                return [4 /*yield*/, async_test("Set fields on appointment created", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) {
                            var _a, _b, _c;
            ...
            case 28:
                _b.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test("Set fields on tag added", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) {
                            var _a, _b;
            ...
            case 35:
                _b.sent();
                return [4 /*yield*/, async_test("Date Difference: calculate days between two custom fields (ISO and MM-DD-YYYY)", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) {
                            var _a, _b, _c;
            ...
            case 38:
                _b.sent();
                return [4 /*yield*/, async_test("Date Difference: calculate days with $now", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return Number((_a = e.fields) === null || _a === void 0 ? void 0 : _a.daysSinceStart) > 600; } } // Should be many days since 2024-01-15
                    )];
            case 39:
                _b.sent();
            ...
            case 41:
                _b.sent();
                return [4 /*yield*/, async_test("Date Difference: calculate days with hardcoded dates", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return Number((_a = e.fields) === null || _a === void 0 ? void 0 : _a.hardcodedDays) === 30; } })
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                _a.sent();
                // Wait for trigger to process and check if fields were set correctly
                return [4 /*yield*/, wait(undefined, 1000)]; // allow triggers to happen
            case 7:
                // Wait for trigger to process and check if fields were set correctly
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test("Set fields from form response template variables (trigger action)", function () { return sdk.api.endusers.getOne(enduser.id); }, { onResult: function (e) {
                            var _a, _b;
...
var fields_changed_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('No trigger on create', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })];
            case 7:
                _a.sent();
            ...
            case 9:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('No trigger on unrelated fields', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
            ...
            case 12:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on fname change', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.tags.includes('1'); } })
            ...
            case 15:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on custom field change', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.tags.includes('3') && e.tags.includes('1'); } })
            ...
            case 18:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on fname and custom field change', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 3 && e.tags.includes('2') && e.tags.includes('3') && e.tags.includes('1'); } })
            ...
            case 21:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('No trigger on fname and custom fields change', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 3 && e.tags.includes('2') && e.tags.includes('3') && e.tags.includes('1'); } })
            ...
            case 24:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on fname and custom fields change', function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 4 && e.tags.includes('4') && e.tags.includes('2') && e.tags.includes('3') && e.tags.includes('1'); } })
            ...
            case 27:
                t6 = _a.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: 'Insurance Test' })];
            case 28:
                e2 = _a.sent();
            ...
            case 29:
                _a.sent(); // allow triggers to happen
                // changing insurance payer name should trigger t5
                return [4 /*yield*/, sdk.api.endusers.updateOne(e2.id, { insurance: { payerName: 'Blue Cross' } })];
            case 30:
                // changing insurance payer name should trigger t5
                _a.sent();
                return [4 /*yield*/, wait(undefined, 500)]; // allow triggers to happen
            case 31:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on insurance payer name change', function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.tags.includes('5'); } })
                    // changing secondary insurance payer name should trigger t6
                ];
            case 32:
                _a.sent();
                // changing secondary insurance payer name should trigger t6
                return [4 /*yield*/, sdk.api.endusers.updateOne(e2.id, { insuranceSecondary: { payerName: 'Aetna' } })];
            case 33:
                // changing secondary insurance payer name should trigger t6
                _a.sent();
                return [4 /*yield*/, wait(undefined, 500)]; // allow triggers to happen
            case 34:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on secondary insurance payer name change', function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.tags.includes('5') && e.tags.includes('6'); } })
                    // changing both insurance payer names should trigger both t5 and t6
                ];
            case 35:
                _a.sent();
                // changing both insurance payer names should trigger both t5 and t6
                return [4 /*yield*/, sdk.api.endusers.updateOne(e2.id, {
            ...
            case 37:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger on both insurance payer names change', function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.tags.includes('5') && e.tags.includes('6'); } })];
            case 38:
                _a.sent();
                return [2 /*return*/, Promise.all([
                        sdk.api.endusers.deleteOne(e1.id),
...
var trigger_events_api_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger event fired (real trigger)', function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Trigger Events API Test')); } })];
            case 5:
                _a.sent();
                return [4 /*yield*/, sdk.api.automation_triggers.trigger_events({
                        triggers: [{
            ...
            case 7:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, async_test('Trigger event fired (placeholder trigger)', function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Placeholder Action')); } })];
            case 8:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e.id),
...
var public_form_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 15:
                enduser2 = _b.sent();
                assert(((_a = enduser2.fields) === null || _a === void 0 ? void 0 : _a['utm_source']) === "testsource", 'UTM not preserved', 'UTM preserved after refresh');
            ...
            case 16:
                _b.sent();
                return [4 /*yield*/, async_test('enduser can update UTM', function () { return sdk.api.endusers.getOne(enduser2.id); }, { onResult: function (e) { var _a; return ((_a = e.fields) === null || _a === void 0 ? void 0 : _a['utm_source']) === "testsource_updated"; } })];
            case 17:
                _b.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.forms.deleteOne(form.id),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 10:
                _a.sent();
                // Run cascade delete tests
                return [4 /*yield*/, database_cascade_delete_tests({ sdk: sdk, sdkNonAdmin: sdkNonAdmin })];
            case 11:
                // Run cascade delete tests
                _a.sent();
                return [2 /*return*/];
...
var field_equals_trigger_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 20:
                _a.sent();
                return [4 /*yield*/, async_test("Number field triggers on create", function () { return sdk.api.endusers.getSome({ ids: [enum1.id, enum1s.id, enum2.id, enum2s.id] }); }, {
            ...
            case 25:
                _a.sent();
                return [4 /*yield*/, async_test("Number field triggers on update", function () { return sdk.api.endusers.getSome({ ids: [enum1.id, enum1s.id, enum2.id, enum2s.id] }); }, {
...
export var relationships_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var e1, e2, e3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 5:
                // allow side effects to propagate
                _a.sent();
                return [4 /*yield*/, async_test("Relationships set correctly on create", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.relationships) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.relationships[0].type === 'Child' && e.relationships[0].id === e2.id; } })];
            case 6:
                _a.sent();
                return [4 /*yield*/, async_test("Relationships set correctly on update", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.relationships) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.relationships[1].type === 'Care Recipient' && e.relationships[1].id === e3.id; } })];
            case 7:
                _a.sent();
                return [4 /*yield*/, async_test("Relationships set correctly on update (multiple relationships)", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return ((_a = e.relationships) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.relationships[1].type === 'Grandparent' && e.relationships[1].id === e3.id; } })];
            case 8:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e1.id),
...
export var switch_to_related_contacts_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 6:
                _b.sent();
                return [4 /*yield*/, async_test("Related contact got tags", function () { return pollForResults(function () { return sdk.api.endusers.getOne(parent.id); }, function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Success')); }, 50, 200); }, passOnAnyResult)];
            case 7:
                _b.sent();
                return [2 /*return*/, Promise.all([
...
var group_mms_active_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                _b.sent();
                return [4 /*yield*/, wait(undefined, 250)]; // wait for side effects
            case 5:
            ...
            case 7:
                ...
                return [4 /*yield*/, async_test("Incoming timestamp is set for sender", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !!r.recentInboundGroupMMSAt; } })];
            case 8:
                _b.sent();
                return [4 /*yield*/, async_test("Incoming timestamp is not set for other participant", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 9:
                _b.sent();
                return [4 /*yield*/, async_test("Incoming timestamp is not set for non-participant", function () { return sdk.api.endusers.getOne(e3.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 10:
                _b.sent();
                return [4 /*yield*/, sdk.api.group_mms_conversations.send_message({
                        conversationId: groupMMS1.id,
            ...
            case 12:
                _b.sent(); // wait for side effects
                return [4 /*yield*/, async_test("Outgoing timestamp is set for sender", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (r) { return !!r.recentOutboundGroupMMSAt && !!r.recentInboundGroupMMSAt; } })];
            case 13:
                _b.sent();
                return [4 /*yield*/, async_test("Outgoing timestamp is set for other participant", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (r) { return !!r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 14:
                _b.sent();
                return [4 /*yield*/, async_test("Outgoing timestamp is not set for non participant", function () { return sdk.api.endusers.getOne(e3.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 15:
                _b.sent();
                return [4 /*yield*/, async_test("Active count incremented by 1 for inbound group MMS", function () { return sdk.api.endusers.get_engagement_statistics({}); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 16:
                _b.sent();
                return [4 /*yield*/, async_test("Active count incremented by 1 for inbound group MMS with from", function () { return sdk.api.endusers.get_engagement_statistics({ range: { from: preSend } }); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 17:
                _b.sent();
                return [4 /*yield*/, async_test("Active count incremented by 1 for inbound group MMS with to", function () { return sdk.api.endusers.get_engagement_statistics({ range: { to: postSend } }); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 18:
                _b.sent();
                return [4 /*yield*/, async_test("Active count incremented by 1 for inbound group MMS with from and to", function () { return sdk.api.endusers.get_engagement_statistics({ range: { from: preSend, to: postSend } }); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 19:
                _b.sent();
                return [4 /*yield*/, async_test("Active count not incremented by 1 for inbound group MMS with old from", function () { return sdk.api.endusers.get_engagement_statistics({ range: { from: postSend } }); }, { onResult: function (r) { return r.count === initialActiveCount; } })];
            case 20:
                _b.sent();
                return [4 /*yield*/, async_test("Active count not incremented by 1 for inbound group MMS with old to", function () { return sdk.api.endusers.get_engagement_statistics({ range: { to: preSend } }); }, { onResult: function (r) { return r.count === initialActiveCount; } })];
            case 21:
                _b.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e1.id),
...
var enduser_access_tags_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 54:
                _a.sent();
                return [4 /*yield*/, async_test("Non-admin can't update scriptSurePrescriberId", function () { return sdkNonAdmin.api.users.updateOne(sdkNonAdmin.userInfo.id, { scriptSurePrescriberId: 'test-id' }); }, handleAnyError)];
            case 55:
                _a.sent();
                return [4 /*yield*/, async_test("Non-admin can't update scriptSurePrescriberId (with other updates)", function () { return sdkNonAdmin.api.users.updateOne(sdkNonAdmin.userInfo.id, { scriptSurePrescriberId: 'test-id', bio: '' }); }, handleAnyError)];
            case 56:
                _a.sent();
                return [4 /*yield*/, async_test("Admin can update scriptSurePrescriberId", function () { return sdk.api.users.updateOne(sdkNonAdmin.userInfo.id, { scriptSurePrescriberId: 'admin-set-id' }); }, { onResult: function (u) { return u.scriptSurePrescriberId === 'admin-set-id'; } })
                    // cleanup
                ];
            case 57:
                _a.sent();
...
export var enduser_conditional_logic_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var requiredPlaceholders, MS_PER_DAY, formatDateMMDDYYYY, now, twentyDaysAgo, sevenDaysAgo, sevenDaysFromNow, twentyDaysFromNow, specificDate, beforeSpecificDate;
    return __generator(this, function (_a) {
        log_header("Enduser Conditional Logic Tests");
        requiredPlaceholders = {
            businessId: '', creator: '', hashedPassword: '', lastActive: '', lastLogout: '', updatedAt: new Date(),
        };
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [] }), {}), 'Conditional logic error', 'blank upcoming events with blank condition');
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [] }), { "$and": [] }), 'Conditional logic error', 'blank upcoming events with empty and condition');
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [] }), {
        ...
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [{ startTimeInMS: Date.now() - 10000 }] }), {
        ...
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [{ startTimeInMS: Date.now() - 100000 }] }), {
        ...
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [{ startTimeInMS: Date.now() - 100 }] }), {
            "$and": [{ "condition": { "__upcomingEvents__": { "$gt": "0", "$fromOffset": -10000, "$toOffset": 3600000 } } }]
        }), 'Conditional logic error', 'Past event inside of window');
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { _upcomingEvents: [{ startTimeInMS: Date.now() + 1000000 }] }), {
        ...
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { Number: "1" } }), {
            "$and": [{ "condition": { "Number": "1" } }]
        }), 'Type coercion error', 'Number string matches string field');
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { Number: "2" } }), {
            "$and": [{ "condition": { "Number": "1" } }]
        ...
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'patient-type-1' }), {
        ...
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { customTypeId: undefined }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'undefined customTypeId should match empty string (both default)');
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { customTypeId: null }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'null customTypeId should match empty string (both default)');
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { customTypeId: '' }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'empty string customTypeId should match empty string');
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'specific-type' }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        ...
        now = new Date();
        twentyDaysAgo = new Date(now.getTime() - (20 * MS_PER_DAY));
        sevenDaysAgo = new Date(now.getTime() - (7 * MS_PER_DAY));
        sevenDaysFromNow = new Date(now.getTime() + (7 * MS_PER_DAY));
        twentyDaysFromNow = new Date(now.getTime() + (20 * MS_PER_DAY));
        // Test: Date more than 14 days before now (negative offset)
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { appointmentDate: formatDateMMDDYYYY(twentyDaysAgo) } }), { "$and": [{ "condition": { "appointmentDate": { "$before": "$now", "$offsetMs": -14 * MS_PER_DAY } } }] }), 'Date offset conditional logic error', '20 days ago should be before (now - 14 days)');
        // Test: Date NOT more than 14 days before now
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { appointmentDate: formatDateMMDDYYYY(sevenDaysAgo) } }), { "$and": [{ "condition": { "appointmentDate": { "$before": "$now", "$offsetMs": -14 * MS_PER_DAY } } }] }), 'Date offset conditional logic error', '7 days ago should NOT be before (now - 14 days)');
        // Test: Date more than 14 days after now (positive offset)
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { futureDate: formatDateMMDDYYYY(twentyDaysFromNow) } }), { "$and": [{ "condition": { "futureDate": { "$after": "$now", "$offsetMs": 14 * MS_PER_DAY } } }] }), 'Date offset conditional logic error', '20 days from now should be after (now + 14 days)');
        // Test: Date NOT more than 14 days after now
        assert(!evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { futureDate: formatDateMMDDYYYY(sevenDaysFromNow) } }), { "$and": [{ "condition": { "futureDate": { "$after": "$now", "$offsetMs": 14 * MS_PER_DAY } } }] }), 'Date offset conditional logic error', '7 days from now should NOT be after (now + 14 days)');
        // Test: Backward compatibility - $before without $offsetMs still works
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { pastDate: formatDateMMDDYYYY(sevenDaysAgo) } }), { "$and": [{ "condition": { "pastDate": { "$before": "$now" } } }] }), 'Date offset conditional logic error', 'Existing $before without $offsetMs should still work');
        // Test: Backward compatibility - $after without $offsetMs still works
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { futureDate: formatDateMMDDYYYY(sevenDaysFromNow) } }), { "$and": [{ "condition": { "futureDate": { "$after": "$now" } } }] }), 'Date offset conditional logic error', 'Existing $after without $offsetMs should still work');
        specificDate = new Date('2025-03-01');
        beforeSpecificDate = new Date(specificDate.getTime() - (20 * MS_PER_DAY));
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { testDate: formatDateMMDDYYYY(beforeSpecificDate) } }), { "$and": [{ "condition": { "testDate": { "$before": "2025-03-01", "$offsetMs": -14 * MS_PER_DAY } } }] }), 'Date offset conditional logic error', 'Date should be before (specific date - 14 days)');
        // Test: Key order independence - $offsetMs before $before should work
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { testDate: formatDateMMDDYYYY(twentyDaysAgo) } }), { "$and": [{ "condition": { "testDate": { "$offsetMs": -14 * MS_PER_DAY, "$before": "$now" } } }] }), 'Date offset key order error', '$offsetMs before $before should still work (key order independence)');
        // Test: Key order independence - $offsetMs before $after should work
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { testDate: formatDateMMDDYYYY(twentyDaysFromNow) } }), { "$and": [{ "condition": { "testDate": { "$offsetMs": 14 * MS_PER_DAY, "$after": "$now" } } }] }), 'Date offset key order error', '$offsetMs before $after should still work (key order independence)');
        // Test: Date object field (not just string) should work with $before
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { dateField: twentyDaysAgo } }), // Date object, not string
        { "$and": [{ "condition": { "dateField": { "$before": "$now", "$offsetMs": -14 * MS_PER_DAY } } }] }), 'Date object field error', 'Date object field should work with $before (not just string)');
        // Test: ISO string date field should work
        assert(evaluate_conditional_logic_for_enduser_fields(__assign(__assign({}, requiredPlaceholders), { fields: { dateField: twentyDaysAgo.toISOString() } }), // ISO string
        { "$and": [{ "condition": { "dateField": { "$before": "$now", "$offsetMs": -14 * MS_PER_DAY } } }] }), 'ISO string date field error', 'ISO string date field should work with $before');
        return [2 /*return*/];
    });
}); };
export var cancel_upcoming_appointments_journey_action_test = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, async_test("Upcoming event is cancelled, past appointment is not", function () { return pollForResults(sdk.api.calendar_events.getSome, function (es) { return (!!es.find(function (e) { return e.id === e1.id && !e.cancelledAt; }) // past event should not be cancelled
...
var bulk_update_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                e2 = _d.sent();
                return [4 /*yield*/, async_test("primaryAssignee (set initial)", function () { return sdk.api.endusers.bulk_update({ ids: [e1.id], primaryAssignee: PLACEHOLDER_ID }); }, {
                        onResult: function (_a) {
                            ...
                            return (rest.length === 0
                                ...
                                && ((_c = u.assignedTo) === null || _c === void 0 ? void 0 : _c[0]) === PLACEHOLDER_ID);
                        }
                    })];
            case 3:
                _d.sent();
                return [4 /*yield*/, async_test("primaryAssignee (set to another)", function () { return sdk.api.endusers.bulk_update({ ids: [e1.id], primaryAssignee: sdk.userInfo.id }); }, {
                        onResult: function (_a) {
                            var _b;
...
var input_modifier_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, wait(undefined, 500)]; // allows for background deletion of form responses
            case 5:
...
var updatedAt_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                e = _b.sent();
                return [4 /*yield*/, wait(undefined, 500)]; // some background stuff may run and change updatedAt again
            case 2:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                // start with reset dates  
                _b.sent();
                return [4 /*yield*/, async_test('build threads for empty range', function () { return sdk.api.inbox_threads.build_threads({ from: start, to: start }); }, { onResult: function (_a) {
                            var alreadyBuilt = _a.alreadyBuilt;
                            return alreadyBuilt;
                        } })];
            case 4:
                _b.sent();
                return [4 /*yield*/, async_test('load threads (none built yet)', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
            ...
            case 12:
                ...
                return [4 /*yield*/, async_test('build initial 1-message threads', function () { return sdk.api.inbox_threads.build_threads({ from: from, to: new Date() }); }, { onResult: function (_a) {
                            var alreadyBuilt = _a.alreadyBuilt;
                            return !alreadyBuilt;
                        } })];
            case 13:
                _b.sent();
                return [4 /*yield*/, async_test('load threads', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return (threads.length === 5
                                && threads.some(function (t) { var _a; return t.type === 'Email' && t.emailMessageId === email.messageId && !object_is_empty((_a = t.readBy) !== null && _a !== void 0 ? _a : {}); })
                                && threads.some(function (t) { var _a; return t.type === 'SMS' && t.threadId === sms.id && !object_is_empty((_a = t.readBy) !== null && _a !== void 0 ? _a : {}); })
                                && threads.some(function (t) { var _a; return t.type === 'GroupMMS' && t.threadId === groupMMS.id && !object_is_empty((_a = t.readBy) !== null && _a !== void 0 ? _a : {}); })
            ...
            case 43:
                ...
                // filter phone calls since those always create new threads
                _b.sent();
                return [4 /*yield*/, async_test('re-build threads minus initial set', function () { return sdk.api.inbox_threads.build_threads({ from: beforeSecondThreads, to: new Date() }); }, { onResult: function (_a) {
                            var alreadyBuilt = _a.alreadyBuilt;
                            return !alreadyBuilt;
                        } })];
            case 44:
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 3:
                ...
                // test access
                return [4 /*yield*/, async_test('admin can load all threads', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 5;
                        } })];
            case 4:
                // test access
                _g.sent();
                return [4 /*yield*/, async_test('non-admin can load no threads', function () { return sdkNonAdmin.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 0;
                        } })];
            case 5:
                _g.sent();
                return [4 /*yield*/, async_test('non-admin cant load threads by specifying other userId', function () { return sdkNonAdmin.api.inbox_threads.load_threads({ userIds: [sdk.userInfo.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 0;
                        } })];
            case 6:
                _g.sent();
                return [4 /*yield*/, async_test('non-admin cant load threads by specifying enduserIds', function () { return sdkNonAdmin.api.inbox_threads.load_threads({ enduserIds: [e1.id, e2.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 0;
                        } })];
            case 7:
                _g.sent();
                return [4 /*yield*/, async_test('admin limit', function () { return sdk.api.inbox_threads.load_threads({ limit: 1 }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 1;
                        } })];
            case 8:
                _g.sent();
                return [4 /*yield*/, async_test('admin timestamp filter', function () { return sdk.api.inbox_threads.load_threads({ lastTimestamp: new Date(1) }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 1;
                        } })];
            case 9:
                _g.sent();
                return [4 /*yield*/, async_test('admin enduserIds filter', function () { return sdk.api.inbox_threads.load_threads({ enduserIds: [e1.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 4;
                        } })];
            case 10:
                _g.sent();
                return [4 /*yield*/, async_test('admin excludeIds filter', function () { return sdk.api.inbox_threads.load_threads({ excludeIds: [email.id, phone.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 3;
                        } })];
            case 11:
                _g.sent();
                return [4 /*yield*/, async_test('admin userIds self filter', function () { return sdk.api.inbox_threads.load_threads({ userIds: [sdk.userInfo.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
...
var get_next_reminder_timestamp_tests = function () {
    ...
    assert(get_next_reminder_timestamp({ attendees: [], startTimeInMS: startTimeInMS }) === -1, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, no reminders');
    assert(get_next_reminder_timestamp({ attendees: [], startTimeInMS: startTimeInMS, reminders: [] }) === -1, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, empty reminders');
    assert(get_next_reminder_timestamp({ attendees: [], startTimeInMS: startTimeInMS, reminders: [{ type: 'Remove From Journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: 0, didRemind: true }] }) === -1, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, didRemind true');
    assert(get_next_reminder_timestamp({ attendees: [], startTimeInMS: startTimeInMS, reminders: [{ type: 'add-to-journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: 0 }] }) === -1, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, add-to-journey no attendees');
    assert(get_next_reminder_timestamp({ attendees: [], startTimeInMS: startTimeInMS, reminders: [{ type: 'Remove From Journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: 0 }] }) === startTimeInMS, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, Remove From Journey');
    assert(get_next_reminder_timestamp({ attendees: [{ id: '', type: 'enduser' }], startTimeInMS: startTimeInMS, reminders: [{ type: 'add-to-journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: 0 }] }) === startTimeInMS, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, add-to-journey with attendees');
    assert(get_next_reminder_timestamp({ attendees: [{ id: '', type: 'enduser' }], startTimeInMS: startTimeInMS, reminders: [{ type: 'add-to-journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: 0 }] }) === startTimeInMS, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, Remove from Journey with attendees');
    assert(get_next_reminder_timestamp({ attendees: [{ id: '', type: 'enduser' }], startTimeInMS: startTimeInMS, reminders: [{ type: 'add-to-journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: -1000 }] }) === startTimeInMS + 1000, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, start time in future');
    assert(get_next_reminder_timestamp({ attendees: [{ id: '', type: 'enduser' }], startTimeInMS: startTimeInMS, reminders: [{ type: 'add-to-journey', info: { journeyId: PLACEHOLDER_ID }, msBeforeStartTime: 1000 }] }) === startTimeInMS - 1000, 'invalid get_next_reminder_timestamp', 'get_next_reminder_timestamp with no attendees, start time in past');
    assert(get_next_reminder_timestamp({ attendees: [{ id: '', type: 'enduser' }], startTimeInMS: startTimeInMS, reminders: [
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                // form (may) need at least 1 question for future endpoints to work
                _a.sent();
                enduserSDKPublic = new EnduserSession({ host: host, businessId: form.businessId });
            ...
            case 3:
                ...
                return [4 /*yield*/, wait(undefined, 500)]; // wait for IP to be set
            case 4:
                _a.sent(); // wait for IP to be set
                async_test('IP Set on Enduser creation', function () { return sdk.api.endusers.getOne(enduserId); }, { onResult: function (result) { var _a; return !!((_a = result.fields) === null || _a === void 0 ? void 0 : _a.IP); } });
            ...
            case 6:
                // should match and update in place
                _a.sent();
                async_test('IP Set on update', function () { return sdk.api.endusers.getOne(enduserId); }, { onResult: function (result) { var _a, _b; return !!((_a = result.fields) === null || _a === void 0 ? void 0 : _a.IP) && ((_b = result.fields) === null || _b === void 0 ? void 0 : _b.otherField) === 'Set' && result.id === enduserId; } });
                return [4 /*yield*/, Promise.all([
                        sdk.api.forms.deleteOne(form.id),
    ...
    return __generator(this, function (_l) {
        switch (_l.label) {
            case 0:
                ...
                return [4 /*yield*/, async_test("email-image tracking endpoint is live", function () { return axios.get("".concat(apiUrl, "/email-image/")); }, { onResult: function (result) { return result.data === TRACK_OPEN_IMAGE.toString('utf-8'); } })];
            case 1:
                _l.sent();
            ...
            case 12:
                _l.sent();
                return [4 /*yield*/, enduser_conditional_logic_tests()];
            case 13:
                _l.sent();
            ...
            case 102:
                ...
                _l.label = 103;
            case 103:
                if (!(_i < _b.length)) return [3 /*break*/, 106];
                _c = _b[_i];
                if (!(_c in _a)) return [3 /*break*/, 105];
                n = _c;
            ...
            case 106:
                ...
                _l.label = 107;
            case 107:
                if (!(_h < _f.length)) return [3 /*break*/, 112];
                _g = _f[_h];
                if (!(_g in _d)) return [3 /*break*/, 111];
                t = _g;
                _l.label = 108;
            case 108:
                _l.trys.push([108, 110, , 111]);
