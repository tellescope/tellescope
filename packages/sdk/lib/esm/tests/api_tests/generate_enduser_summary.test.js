...
export var generate_enduser_summary_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    log_header("Generate Patient Summary (journey action) Tests");
                    enduserId = '';
                    journeyId = '';
                    automationStepId = '';
                    automatedActionId = '';
                ...
                case 6:
                    result_1 = _b.sent();
                    return [4 /*yield*/, async_test("generateEnduserSummary action is recognized (not unimplemented)", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, result_1];
                        }); }); }, { onResult: function (r) { return (r === null || r === void 0 ? void 0 : r.unimplemented) !== true; } })];
                case 7:
                    _b.sent();
                    if (!result_1.success) return [3 /*break*/, 10];
                    return [4 /*yield*/, async_test("aiSummary + aiSummaryUpdatedAt persisted on enduser after successful generation", function () { return sdk.api.endusers.getOne(enduserId); }, { onResult: function (e) { return (typeof e.aiSummary === 'string'
                                && e.aiSummary.length > 0
                                && !!e.aiSummaryUpdatedAt); } })];
                case 8:
                    _b.sent();
                    return [4 /*yield*/, async_test("ai_conversation tagged with enduserId (first-class, queryable)", function () { return sdk.api.ai_conversations.getSome({ filter: { enduserId: enduserId } }); }, { onResult: function (convos) { return convos.length > 0 && convos.every(function (c) { return c.enduserId === enduserId; }); } })];
                case 9:
                    _b.sent();
                    return [3 /*break*/, 11];
                case 10:
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, generate_enduser_summary_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
