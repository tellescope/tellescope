 ...
 */
export var message_assignment_trigger_tests = function (_a) {
    var sdk = _a.sdk;
...
if (require.main === module) {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setup_tests(sdk_1, sdk_1)]; // Use same SDK for both admin and non-admin (simplified for this test)
                case 1:
                    _a.sent(); // Use same SDK for both admin and non-admin (simplified for this test)
                    return [4 /*yield*/, message_assignment_trigger_tests({ sdk: sdk_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
