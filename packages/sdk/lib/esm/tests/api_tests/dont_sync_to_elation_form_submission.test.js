...
export var dont_sync_to_elation_form_submission_tests = function (_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, async_test("submit_form_response accepts dontSyncToElation: true", function () { return sdk.api.form_responses.submit_form_response({
                ...
                case 7:
                    ...
                    return [4 /*yield*/, async_test("submit_form_response without dontSyncToElation still succeeds", function () { return sdk.api.form_responses.submit_form_response({
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, dont_sync_to_elation_form_submission_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
