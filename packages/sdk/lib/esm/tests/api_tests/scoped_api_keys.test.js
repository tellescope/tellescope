        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                ...
                case 8:
                    ...
                    assert(headerResult.status === 200 && !!((_j = headerResult.data) === null || _j === void 0 ? void 0 : _j.formResponseId), "scoped key header auth failed: ".concat(headerResult.status, " ").concat(JSON.stringify(headerResult.data)), "scoped key authenticates the form-ingestion webhook via header");
                ...
                case 9:
                    pathResult = _o.sent();
                    assert(pathResult.status === 200 && !!((_l = pathResult.data) === null || _l === void 0 ? void 0 : _l.formResponseId), "scoped key path auth failed: ".concat(pathResult.status, " ").concat(JSON.stringify(pathResult.data)), "scoped key authenticates the form-ingestion webhook via path segment");
                    if ((_m = pathResult.data) === null || _m === void 0 ? void 0 : _m.formResponseId)
                        formResponseIds.push(pathResult.data.formResponseId);
                    scopedSession_1 = new Session({ host: host, apiKey: scoped_1.key });
                ...
                case 10:
                    ...
                    assert(!!(uploadedFile_1 === null || uploadedFile_1 === void 0 ? void 0 : uploadedFile_1.id), "scoped key prepare_file_upload returned no file", "scoped key can call POST /prepare-file-upload");
                    if (uploadedFile_1 === null || uploadedFile_1 === void 0 ? void 0 : uploadedFile_1.id)
                        fileIds.push(uploadedFile_1.id);
                    return [4 /*yield*/, async_test("scoped key can call POST /files/confirm-upload", function () { return scopedSession_1.api.files.confirm_file_upload({ id: uploadedFile_1.id }); }, { onResult: function () { return true; } })
                ...
                case 11:
                    ...
                    blockedFileEndpoints = [
                        ['GET /v1/files (readMany)', function () { return axios.get("".concat(host, "/v1/files"), { headers: { Authorization: "API_KEY ".concat(scoped_1.key) } }); }],
                        ['GET /v1/file/:id (read one)', function () { return axios.get("".concat(host, "/v1/file/000000000000000000000000"), { headers: { Authorization: "API_KEY ".concat(scoped_1.key) } }); }],
                        ['DELETE /v1/file/:id (destructive)', function () { return axios.delete("".concat(host, "/v1/file/000000000000000000000000"), { headers: { Authorization: "API_KEY ".concat(scoped_1.key) } }); }],
                        ['POST /v1/files/send-fax (/files/* sibling)', function () { return axios.post("".concat(host, "/v1/files/send-fax"), {}, { headers: { Authorization: "API_KEY ".concat(scoped_1.key) } }); }],
                        ['POST /v1/files/ocr (/files/* sibling)', function () { return axios.post("".concat(host, "/v1/files/ocr"), {}, { headers: { Authorization: "API_KEY ".concat(scoped_1.key) } }); }],
                        ['POST /v1/files/push (/files/* sibling)', function () { return axios.post("".concat(host, "/v1/files/push"), {}, { headers: { Authorization: "API_KEY ".concat(scoped_1.key) } }); }],
                    ];
                ...
                case 12:
                    ...
                    return [4 /*yield*/, async_test("scoped key blocked on ".concat(label), call, { shouldError: true, onError: function (e) { var _a, _b; return ((_a = e.response) === null || _a === void 0 ? void 0 : _a.status) === 401 || ((_b = e.response) === null || _b === void 0 ? void 0 : _b.status) === 403; } })];
                case 13:
                    _o.sent();
                    _o.label = 14;
                case 14:
                ...
                case 22:
                    otherSdk_1 = new (_d.apply(Session, [void 0, (_h.authToken = (_o.sent()).authToken,
                            _h)]))();
                ...
                case 30:
                    ...
                    // =============================================
                    return [4 /*yield*/, async_test("unscoped key authenticates a legacy non-/v1 route", function () { return axios.get("".concat(host, "/API-keys-for-user?apiKey=").concat(encodeURIComponent(unscopedKeyValue_1))); }, { onResult: function (r) { return r.status === 200; } })];
                case 31:
                    // =============================================
                    // (g) Legacy non-/v1 funnel (app.js requireLoginAndAccess → is_logged_in_API_key with NO requestPath).
                    // Proves scoped keys fail closed on every non-/v1 caller (also stands in for the Medplum webhook path),
                    ...
                    // =============================================
                    _o.sent();
                    return [4 /*yield*/, async_test("scoped key rejected on a legacy non-/v1 route (fail closed, no requestPath)", function () { return axios.get("".concat(host, "/API-keys-for-user?apiKey=").concat(encodeURIComponent(scoped_1.key))); }, { shouldError: true, onError: function (e) { var _a; return ((_a = e.response) === null || _a === void 0 ? void 0 : _a.status) === 401; } })
                        // =============================================
                ...
                case 33:
                    ...
                    // (i) Transport independence: the scope gate applies whether the key is in the header or the ?apiKey= query.
                    // =============================================
                    return [4 /*yield*/, async_test("scoped key via ?apiKey= query param still rejected on a disallowed /v1 endpoint", function () { return axios.get("".concat(host, "/v1/endusers?apiKey=").concat(encodeURIComponent(scoped_1.key))); }, { shouldError: true, onError: function (e) { var _a, _b; return ((_a = e.response) === null || _a === void 0 ? void 0 : _a.status) === 401 || ((_b = e.response) === null || _b === void 0 ? void 0 : _b.status) === 403; } })];
                case 34:
                    // =============================================
                    // (i) Transport independence: the scope gate applies whether the key is in the header or the ?apiKey= query.
                    // =============================================
                    _o.sent();
                    return [4 /*yield*/, async_test("unscoped key via ?apiKey= query param still authenticates /v1 (regression)", function () { return axios.get("".concat(host, "/v1/test-authenticated?apiKey=").concat(encodeURIComponent(unscopedKeyValue_1))); }, { onResult: function (r) { return r.status === 200; } })
                        // =============================================
