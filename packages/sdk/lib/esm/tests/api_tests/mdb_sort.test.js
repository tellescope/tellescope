...
export var mdb_sort_tests = function (_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, async_test('mdbSort-fname-ascending', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        results = _a.sent();
                                        assert(results.length === 4, 'Expected 4 endusers', "Got ".concat(results.length));
                ...
                case 3:
                    ...
                    _b.sent();
                    // Test 2: Sort by fname descending (reverse alphabetical order)
                    return [4 /*yield*/, async_test('mdbSort-fname-descending', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.endusers.getSome({
                ...
                case 4:
                    ...
                    _b.sent();
                    // Test 3: Multi-field sort (fname ascending, then lname ascending for ties)
                    return [4 /*yield*/, async_test('mdbSort-multi-field', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.endusers.getSome({
                ...
                case 5:
                    ...
                    _b.sent();
                    // Test 4: mdbSort combined with mdbFilter
                    return [4 /*yield*/, async_test('mdbSort-with-mdbFilter', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.endusers.getSome({
                                    ...
                                    case 1:
                                        results = _a.sent();
                                        assert(results.length === 2, 'Expected 2 Alice endusers', "Got ".concat(results.length));
                ...
                case 6:
                    ...
                    // Note: filter is ignored when mdbFilter is present, so both id scoping and keyset cursor
                    // must be expressed in mdbFilter.
                    return [4 /*yield*/, async_test('mdbSort-keyset-pagination', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 7:
                    ...
                    _b.sent();
                    // Test 6: mdbSort with projection (ensure both work together)
                    return [4 /*yield*/, async_test('mdbSort-with-projection', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.endusers.getSome({
                                    ...
                                    case 1:
                                        ...
                                        assert(results[0].email === undefined, 'email should NOT be present');
                                        return [2 /*return*/, results];
                                }
                            });
                        }); }, { onResult: function () { return true; } })
                ...
                case 8:
                    ...
                    _b.sent();
                    // Test 7: Non-admin access with mdbSort (RBA still applies)
                    return [4 /*yield*/, async_test('non-admin-mdbSort', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results, fnames;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 9:
                    ...
                    _b.sent();
                    // Test 8: mdbSort fallback behavior (no mdbSort uses sortBy default)
                    return [4 /*yield*/, async_test('no-mdbSort-fallback', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.endusers.getSome({
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, mdb_sort_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
