...
export var load_threads_autobuild_tests = function (_a) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 19:
                    ...
                    assert(!!((_b = threadWithDraft === null || threadWithDraft === void 0 ? void 0 : threadWithDraft.draftMessageIds) === null || _b === void 0 ? void 0 : _b.includes(draftSms.id)), "Should include draft message ID");
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, load_threads_autobuild_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
