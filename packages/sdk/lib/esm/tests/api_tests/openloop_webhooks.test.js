...
export var openloop_webhooks_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, async_test('V1: unknown patient returns 404', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, async_test('V1: order_confirmation creates EnduserOrder with correct fields', function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        assert(order.title === 'Test Med 10mg', "title mismatch: ".concat(order.title));
                                        assert(order.status === 'confirmed', "status mismatch: ".concat(order.status));
                                        assert(order.description === '456 Oak Ave', "description mismatch: ".concat(order.description));
                                        assert(order.instructions === 'Take daily with food', "instructions mismatch: ".concat(order.instructions));
                                        assert(order.frequency === 'w12', "frequency mismatch: ".concat(order.frequency));
                                        assert(order.fill === '2', "fill mismatch: ".concat(order.fill));
                                        assert(order.sku === 'sku-abc', "sku mismatch (should be lowercased): ".concat(order.sku));
                    ...
                    return [4 /*yield*/, async_test('V1: order_confirmation idempotency - same order not duplicated', function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        orders = _a.sent();
                                        assert(orders.length === 1, "Expected 1 order after duplicate, got ".concat(orders.length));
                                        // $setOnInsert means fields should NOT have changed
                                        assert(orders[0].title === 'Test Med 10mg', "title should not change on duplicate: ".concat(orders[0].title));
                                        assert(orders[0].fill === '2', "fill should not change on duplicate: ".concat(orders[0].fill));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        orders = _a.sent();
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        assert(orders[0].title === 'OpenLoop: FallbackPharmacy', "title mismatch: ".concat(orders[0].title));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })
                ...
                case 9:
                    ...
                    return [4 /*yield*/, async_test('V1: order_shipped updates existing confirmed order', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res, orders, order;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: 
                                    ...
                                    case 3:
                                        ...
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        order = orders[0];
                                        assert(order.status === 'shipped', "status mismatch: ".concat(order.status));
                                        assert(order.tracking === 'TRACK-ABC', "tracking mismatch: ".concat(order.tracking));
                                        assert(order.shippedDate === '07-09-2024', "shippedDate mismatch (expected MM-DD-YYYY): ".concat(order.shippedDate));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        order = orders[0];
                                        assert(order.title === 'Updated Title From Ship', "title mismatch: ".concat(order.title));
                                        assert(order.sku === 'new-sku-123', "sku mismatch (should be lowercased): ".concat(order.sku));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        order = orders[0];
                                        assert(order.status === 'shipped', "status mismatch: ".concat(order.status));
                                        assert(order.title === 'Direct Ship Med', "title mismatch: ".concat(order.title));
                                        assert(order.tracking === 'TRACK-NEW', "tracking mismatch: ".concat(order.tracking));
                                        assert(order.fill === '3', "fill mismatch: ".concat(order.fill));
                                        assert(order.sku === 'direct-sku', "sku mismatch: ".concat(order.sku));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 4:
                                        orders = _a.sent();
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        assert(orders[0].tracking === 'TRACK-SECOND', "tracking should be updated: ".concat(orders[0].tracking));
                                        assert(orders[0].shippedDate === '07-15-2024', "shippedDate should be updated: ".concat(orders[0].shippedDate));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                ...
                case 14:
                    ...
                    return [4 /*yield*/, async_test('V1: same orderNumber for different endusers creates separate orders', function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        res1 = _a.sent();
                                        assert(res1.status === 200, "enduser1 confirm failed: ".concat(res1.status));
                                        return [4 /*yield*/, postV1(makeV1Confirmation({
                                    ...
                                    case 2:
                                        res2 = _a.sent();
                                        assert(res2.status === 200, "enduser2 confirm failed: ".concat(res2.status));
                                        return [4 /*yield*/, sdk.api.enduser_orders.getSome({
                                                filter: { source: 'OpenLoop', externalId: sharedOrderNum }
                                            })];
                                    case 3:
                                        orders = _a.sent();
                                        assert(orders.length === 2, "Expected 2 separate orders, got ".concat(orders.length));
                                        enduserIds = orders.map(function (o) { return o.enduserId; }).sort();
                                        expected = [enduser1.id, enduser2.id].sort();
                                        assert(enduserIds[0] === expected[0] && enduserIds[1] === expected[1], "Orders should belong to different endusers: ".concat(JSON.stringify(enduserIds), " vs ").concat(JSON.stringify(expected)));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })
                ...
                case 15:
                    ...
                    return [4 /*yield*/, async_test('V2: missing patientId returns 400', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 18:
                    ...
                    return [4 /*yield*/, async_test('V2: prescription-created creates order with correct fields', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var res, orders, order;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        order = orders[0];
                                        assert(order.enduserId === enduser1.id, 'enduserId mismatch');
                                        assert(order.status === 'created', "status mismatch: ".concat(order.status));
                                        assert(order.title === 'Lisinopril 10mg', "title mismatch: ".concat(order.title));
                                        assert(order.fill === '2', "fill mismatch: ".concat(order.fill));
                                        assert(order.sku === 'lis-010', "sku mismatch (should be lowercased): ".concat(order.sku));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        order = orders[0];
                                        assert(order.status === 'shipped', "status mismatch: ".concat(order.status));
                                        assert(order.carrier === 'USPS', "carrier mismatch: ".concat(order.carrier));
                                        assert(order.tracking === 'V2-TRACK-001', "tracking mismatch: ".concat(order.tracking));
                                        assert(order.shippedDate === '2024-02-20', "shippedDate mismatch: ".concat(order.shippedDate));
                                        assert(order.pharmacy === 'CVS', "pharmacy mismatch: ".concat(order.pharmacy));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        ...
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        order = orders[0];
                                        assert(order.status === 'cancelled', "status mismatch: ".concat(order.status));
                                        assert(order.cancelledDate === '2024-03-01', "cancelledDate mismatch: ".concat(order.cancelledDate));
                                        assert(order.cancellationReason === 'Patient request', "cancellationReason mismatch: ".concat(order.cancellationReason));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        orders = _a.sent();
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        assert(orders[0].status === 'refunded', "status mismatch: ".concat(orders[0].status));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })
                ...
                case 23:
                    ...
                    return [4 /*yield*/, async_test('V2: idempotency - same id and patientId does not create duplicate', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return [4 /*yield*/, async_test('V2: same id for different patients creates separate orders', function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        res1 = _a.sent();
                                        assert(res1.status === 200, "enduser1 create failed: ".concat(res1.status));
                                        return [4 /*yield*/, postV2(makeV2Payload('prescription-created', {
                                                id: sharedV2Id,
                                                patientId: healthieId2,
                                            }))];
                                    case 2:
                                        res2 = _a.sent();
                                        assert(res2.status === 200, "enduser2 create failed: ".concat(res2.status));
                                        return [4 /*yield*/, sdk.api.enduser_orders.getSome({
                                    ...
                                    case 3:
                                        ...
                                        enduserIds = orders.map(function (o) { return o.enduserId; }).sort();
                                        expected = [enduser1.id, enduser2.id].sort();
                                        assert(enduserIds[0] === expected[0] && enduserIds[1] === expected[1], "Orders should belong to different endusers");
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })
                ...
                case 25:
                    ...
                    return [4 /*yield*/, async_test('V2: sequential status progression through full lifecycle', function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        res = _a.sent();
                                        assert(res.status === 200, "".concat(step.eventType, " failed: ").concat(res.status));
                                        return [4 /*yield*/, sdk.api.enduser_orders.getSome({
                                                filter: { source: 'OpenLoop', externalId: lifecycleId }
                                            })];
                                    case 3:
                                        orders = _a.sent();
                                        assert(orders.length === 1, "Expected 1 order at ".concat(step.eventType, ", got ").concat(orders.length));
                                        assert(orders[0].status === step.expectedStatus, "After ".concat(step.eventType, ": expected status '").concat(step.expectedStatus, "', got '").concat(orders[0].status, "'"));
                                        _a.label = 4;
                                    case 4:
                                        _i++;
                                        return [3 /*break*/, 1];
                ...
                case 26:
                    ...
                    return [4 /*yield*/, async_test('V2: optional fields not written when absent', function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        assert(orders.length === 1, "Expected 1 order, got ".concat(orders.length));
                                        order = orders[0];
                                        assert(order.carrier === undefined, "carrier should be undefined, got: ".concat(order.carrier));
                                        assert(order.tracking === undefined, "tracking should be undefined, got: ".concat(order.tracking));
                                        assert(order.pharmacy === undefined, "pharmacy should be undefined, got: ".concat(order.pharmacy));
                                        assert(order.cancelledDate === undefined, "cancelledDate should be undefined, got: ".concat(order.cancelledDate));
                                        assert(order.cancellationReason === undefined, "cancellationReason should be undefined, got: ".concat(order.cancellationReason));
                                        return [2 /*return*/, true];
                                }
                            });
                        }); }, { onResult: function (r) { return r === true; } })];
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, openloop_webhooks_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
