...
export var bulk_assignment_tests = function (_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    // Test 1: Add care team members with specific customTypeId
                    return [4 /*yield*/, async_test("bulk_assignment: Add care team with specific customTypeId", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: customTypeId,
                            addIds: [user1.id],
                        }); }, {
                            onResult: function (r) {
                ...
                case 7:
                    ...
                    _b.sent();
                    // Test 2: Add care team members with undefined customTypeId (should match empty string AND missing)
                    return [4 /*yield*/, async_test("bulk_assignment: Add care team with undefined customTypeId (matches empty and missing)", function () { return sdk.api.endusers.bulk_assignment({
                ...
                case 8:
                    ...
                    _b.sent();
                    // Test 3: Add care team members with empty string customTypeId
                    return [4 /*yield*/, async_test("bulk_assignment: Add care team with empty string customTypeId", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: '',
                            addIds: [user1.id],
                        }); }, {
                            onResult: function (r) {
                ...
                case 9:
                    ...
                    _b.sent();
                    // Test 4: Remove care team members with existingAssignment filter
                    return [4 /*yield*/, async_test("bulk_assignment: Remove care team with existingAssignment filter (All Of)", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: undefined,
                            existingAssignment: {
                                qualifier: 'All Of',
                ...
                case 10:
                    ...
                    _b.sent();
                    // Test 5: Add care team members with existingAssignment filter (One Of)
                    return [4 /*yield*/, async_test("bulk_assignment: Add with existingAssignment filter (One Of)", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: undefined,
                            existingAssignment: {
                                qualifier: 'One Of',
                                values: [user1.id],
                ...
                case 11:
                    ...
                    _b.sent();
                    // Test 6: Add care team members with custom field filter (array field)
                    return [4 /*yield*/, async_test("bulk_assignment: Add with custom field filter (array value)", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: undefined,
                            field: 'Building',
                ...
                case 12:
                    ...
                    _b.sent();
                    // Test 7: Remove care team members with combined filters
                    return [4 /*yield*/, async_test("bulk_assignment: Remove with combined filters (customTypeId + field + existingAssignment)", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: '',
                            field: 'Building',
                            existingFieldValue: 'Building A',
                            existingAssignment: {
                ...
                case 13:
                    ...
                    _b.sent();
                    // Test 8: Error when neither addIds nor removeIds provided
                    return [4 /*yield*/, async_test("bulk_assignment: Error when no addIds or removeIds", function () { return sdk.api.endusers.bulk_assignment({
                            customTypeId: customTypeId,
                        }); }, handleAnyError)
                        // Cleanup
                    ];
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, bulk_assignment_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
