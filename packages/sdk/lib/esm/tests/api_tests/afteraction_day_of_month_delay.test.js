...
export var afteraction_day_of_month_delay_tests = function (_a) {
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    calculateExpectedDelayTime = function (dayOfMonth, hour, minute) {
                        ...
                        var targetDate = DateTime.fromObject({
                            year: now.year,
                            month: now.month,
                            day: dayOfMonth,
                            hour: hour,
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    // Clear any existing out-of-office blocks first
                    _f.sent();
                    tomorrow = DateTime.now().setZone('America/New_York').plus({ days: 1 });
                ...
                case 5:
                    ...
                    return [4 /*yield*/, wait(undefined, 2000)]; // 2 seconds to ensure worker sees the blocks
                case 6:
                    // Wait for database consistency and worker polling cycle
                ...
                case 30:
                    ...
                    return [4 /*yield*/, wait(undefined, 1000)]; // 1 second for DB to fully persist and index
                case 31:
                    // Wait for database consistency before triggering journey
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, afteraction_day_of_month_delay_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
