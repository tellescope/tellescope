...
export var chats_analytics_tests = function (_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, async_test("Chats analytics - total count (no filter)", function () { return sdk.api.analytics_frames.get_result_for_query({
                ...
                case 8:
                    ...
                    _b.sent();
                    // Test 2: Direction = Inbound (senderId === enduserId)
                    return [4 /*yield*/, async_test("Chats analytics - direction Inbound", function () { return sdk.api.analytics_frames.get_result_for_query({
                ...
                case 9:
                    ...
                    _b.sent();
                    // Test 3: Direction = Outbound (senderId !== enduserId)
                    return [4 /*yield*/, async_test("Chats analytics - direction Outbound", function () { return sdk.api.analytics_frames.get_result_for_query({
                ...
                case 10:
                    ...
                    _b.sent();
                    // Test 4: Chat Tags - One Of qualifier
                    return [4 /*yield*/, async_test("Chats analytics - Chat Tags One Of", function () { return sdk.api.analytics_frames.get_result_for_query({
                ...
                case 11:
                    ...
                    _b.sent();
                    // Test 5: Chat Tags - All Of qualifier
                    return [4 /*yield*/, async_test("Chats analytics - Chat Tags All Of", function () { return sdk.api.analytics_frames.get_result_for_query({
                ...
                case 12:
                    ...
                    _b.sent();
                    // Test 6: Combined direction + tags filter
                    return [4 /*yield*/, async_test("Chats analytics - Inbound + Chat Tags", function () { return sdk.api.analytics_frames.get_result_for_query({
                ...
                case 13:
                    ...
                    _b.sent();
                    // Test 7: Chat Tags grouping
                    return [4 /*yield*/, async_test("Chats analytics - Chat Tags grouping", function () { return sdk.api.analytics_frames.get_result_for_query({
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, chats_analytics_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
