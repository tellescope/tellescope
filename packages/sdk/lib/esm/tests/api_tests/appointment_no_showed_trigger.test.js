...
export var appointment_no_showed_trigger_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, async_test("No initial triggers before no-show", function () { return sdk.api.endusers.getOne(enduser1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })];
                case 10:
                    _b.sent();
                ...
                case 12:
                    _b.sent();
                    return [4 /*yield*/, async_test("Update to no-showed triggers automation (Any + By Title)", function () { return sdk.api.endusers.getOne(enduser1.id); }, { onResult: function (e) {
                                var _a;
                ...
                case 17:
                    _b.sent();
                    return [4 /*yield*/, async_test("Template-based no-showed appointment triggers automation (Any + By Template)", function () { return sdk.api.endusers.getOne(enduser2.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2
                                    && e.tags.includes('No-Show - Any')
                ...
                case 22:
                    _b.sent();
                    return [4 /*yield*/, async_test("No-show with non-matching title fires only the Any trigger", function () { return sdk.api.endusers.getOne(enduser3.id); }, { onResult: function (e) {
                                var _a;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, appointment_no_showed_trigger_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
