...
export var form_started_trigger_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _b.sent();
                    return [4 /*yield*/, async_test("Default trigger fires on public form start", function () { return sdk.api.endusers.getOne(enduserId1); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('default-trigger')); } })
                ...
                case 9:
                    enduser2 = _b.sent();
                    return [4 /*yield*/, async_test("Default trigger does NOT fire on formsort draft", function () { return sdk.api.endusers.getOne(enduser2.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('default-trigger')); } })
                ...
                case 13:
                    _b.sent();
                    return [4 /*yield*/, async_test("prepare_form_response does NOT trigger Form Started (no sources field)", function () { return sdk.api.endusers.getOne(enduserForPrepare1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('default-trigger')); } })];
                case 14:
                    _b.sent();
                ...
                case 19:
                    _b.sent();
                    return [4 /*yield*/, async_test("prepare_form_response does NOT trigger Form Started (with sources field)", function () { return sdk.api.endusers.getOne(enduserForPrepare2.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('prepare-sources-trigger')); } })];
                case 20:
                    _b.sent();
                ...
                case 24:
                    _b.sent();
                    return [4 /*yield*/, async_test("Public Form source trigger fires on public form start", function () { return sdk.api.endusers.getOne(enduserId3); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('public-only-trigger')); } })];
                case 25:
                    _b.sent();
                ...
                case 29:
                    _b.sent();
                    return [4 /*yield*/, async_test("Formsort source trigger does NOT fire on public form start", function () { return sdk.api.endusers.getOne(enduserId4); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('formsort-trigger')); } })
                ...
                case 33:
                    enduser5 = _b.sent();
                    return [4 /*yield*/, async_test("Formsort source trigger fires on formsort draft", function () { return sdk.api.endusers.getOne(enduser5.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('formsort-trigger')); } })];
                case 34:
                    _b.sent();
                ...
                case 38:
                    _b.sent();
                    return [4 /*yield*/, async_test("Both sources trigger fires on public form start", function () { return sdk.api.endusers.getOne(enduserId7); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('both-trigger')); } })
                ...
                case 42:
                    enduser8 = _b.sent();
                    return [4 /*yield*/, async_test("Both sources trigger fires on formsort draft", function () { return sdk.api.endusers.getOne(enduser8.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('both-trigger')); } })];
                case 43:
                    _b.sent();
                ...
                case 48:
                    enduser9 = _b.sent();
                    return [4 /*yield*/, async_test("Formsort trigger fires on first draft", function () { return sdk.api.endusers.getOne(enduser9.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('once-trigger')); } })
                ...
                case 52:
                    _b.sent();
                    return [4 /*yield*/, async_test("Formsort trigger does NOT fire on subsequent draft update", function () { return sdk.api.endusers.getOne(enduser9.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('once-trigger')); } })];
                case 53:
                    _b.sent();
                ...
                case 58:
                    enduser10 = _b.sent();
                    return [4 /*yield*/, async_test("Immediately finalized formsort does NOT trigger Form Started", function () { return sdk.api.endusers.getOne(enduser10.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('finalized-trigger')); } })];
                case 59:
                    _b.sent();
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, form_started_trigger_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
