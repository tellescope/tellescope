        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 13:
                    _b.sent();
                    // Test 6: Non-admin can still aggregate models they have access to (endusers)
                    return [4 /*yield*/, async_test("Custom aggregation - non-admin can access permitted models", function () { return sdkNonAdmin.api.analytics_frames.custom_aggregation({
                            modelName: 'endusers',
                            aggregation: [
                                { $match: { fname: 'CustomAgg' } },
                                { $count: 'total' }
                ...
                case 14:
                    ...
                    _b.sent();
                    // Test 7: Non-admin is blocked from aggregating models with No Access
                    return [4 /*yield*/, async_test("Custom aggregation - non-admin blocked from No Access models", function () { return sdkNonAdmin.api.analytics_frames.custom_aggregation({
