    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 39:
                    _b.sent();
                    nowForBooking = DateTime.now().setZone('America/New_York');
                ...
                case 40:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: availability shows slots before any bookings', function () { return Promise.resolve(availabilityBeforeBooking_1); }, { onResult: function (r) {
                                var userBlocks = r.availabilityBlocks.filter(function (b) { return b.userId === sdk.userInfo.id; });
                ...
                case 42:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: first booking succeeds with calendarEventLimits', function () { return Promise.resolve(booking1Response_1); }, { onResult: function (r) {
                                var _a;
                ...
                case 45:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: second booking on same day succeeds (under limit of 2)', function () { return Promise.resolve(booking2Response_1); }, { onResult: function (r) {
                                var _a;
                                if (!r || !((_a = r.createdEvent) === null || _a === void 0 ? void 0 : _a.id)) {
                ...
                case 47:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: third booking on same day fails (limit of 2 reached)', function () { return enduserSession_1.api.calendar_events.book_appointment({
                            userId: sdk.userInfo.id,
                            calendarEventTemplateId: template.id,
                ...
                case 49:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: booking on different day succeeds (new daily limit)', function () { return Promise.resolve(booking3Response_1); }, { onResult: function (r) {
                                var _a;
                                if (!r || !((_a = r.createdEvent) === null || _a === void 0 ? void 0 : _a.id)) {
                ...
                case 58:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: weekly limit - first booking succeeds', function () { return Promise.resolve(weeklyBooking1Response_1); }, { onResult: function (r) {
                                var _a;
                ...
                case 61:
                    ...
                    return [4 /*yield*/, async_test('book_appointment: weekly limit - second booking in same week succeeds', function () { return Promise.resolve(weeklyBooking2Response_1); }, { onResult: function (r) {
                                var _a;
                                if (!((_a = r === null || r === void 0 ? void 0 : r.createdEvent) === null || _a === void 0 ? void 0 : _a.id)) {
                ...
                case 63:
                    _b.sent();
                    return [4 /*yield*/, async_test('book_appointment: weekly limit - third booking in same week fails', function () { return enduserSession_1.api.calendar_events.book_appointment({
                            userId: sdk.userInfo.id,
                            calendarEventTemplateId: template.id,
