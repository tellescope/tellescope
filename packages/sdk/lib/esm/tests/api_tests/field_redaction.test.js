        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, async_test("getOne - all redactable fields should be absent for redacted role", function () { return sdkNonAdmin.api.phone_calls.getOne(testPhoneCall.id); }, {
                            onResult: function (r) {
                ...
                case 8:
                    ...
                    return [4 /*yield*/, async_test("getOne (admin) - all fields should be visible", function () { return sdk.api.phone_calls.getOne(testPhoneCall.id); }, {
                            onResult: function (r) {
                ...
                case 21:
                    ...
                    return [4 /*yield*/, async_test("getSome - redacted fields should be absent on readMany results", function () { return sdkNonAdmin.api.phone_calls.getSome(); }, {
                            onResult: function (r) {
                ...
                case 23:
                    ...
                    return [4 /*yield*/, async_test("updateOne - response should not contain redacted fields", function () { return sdkNonAdmin.api.phone_calls.updateOne(testPhoneCall.id, { note: 'updated by redaction test' }); }, {
                            onResult: function (r) {
                                var redacted = lacksFields(r, __spreadArray([], ALL_REDACTABLE_FIELDS, true));
                                if (!redacted) {
                                    var leaked = ALL_REDACTABLE_FIELDS.filter(function (f) { return f in r && r[f] !== undefined; });
                ...
                case 25:
                    ...
                    return [4 /*yield*/, async_test("createOne - response should not contain redacted fields", function () { return sdkNonAdmin.api.phone_calls.createOne({
                            enduserId: testEnduser.id,
                            inbound: false,
                            from: '+15551111111',
                            to: '+15552222222',
                ...
                case 35:
                    ...
                    return [4 /*yield*/, async_test("bulk_load - redacted fields should be absent", function () { return sdkNonAdmin.bulk_load({ load: [{ model: 'phone_calls', options: { limit: 100 } }] }); }, {
                            onResult: function (r) {
                ...
                case 37:
                    ...
                    return [4 /*yield*/, async_test("getByIds - redacted fields should be absent", function () { return sdkNonAdmin.api.phone_calls.getByIds({ ids: [testPhoneCall.id] }); }, {
                            onResult: function (r) {
                ...
                case 39:
                    ...
                    return [4 /*yield*/, async_test("load_inbox_data - phone_calls should have redacted fields absent", function () { return sdkNonAdmin.api.endusers.load_inbox_data({ enduserIds: [testEnduser.id] }); }, {
                            onResult: function (r) {
                ...
                case 53:
                    ...
                    return [4 /*yield*/, async_test("enduser read - phone_calls fieldRedactions should not affect enduser fields", function () { return sdkNonAdmin.api.endusers.getOne(testEnduser.id); }, {
                            onResult: function (r) {
                ...
                case 54:
                    ...
                    ;
                    return [4 /*yield*/, async_test("data-sync - redacted fields should be absent in parsed data", function () { return sdkNonAdmin.sync({ from: syncFrom_1 }); }, {
                            onResult: function (r) {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, field_redaction_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
