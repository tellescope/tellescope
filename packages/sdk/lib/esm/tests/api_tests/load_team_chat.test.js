        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 13:
                    ...
                    _k.sent();
                    // Test 1: Basic loading - rooms where user is in userIds
                    return [4 /*yield*/, async_test("Loads room where user is in userIds", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 14:
                    ...
                    _k.sent();
                    // Test 2: Creator access
                    return [4 /*yield*/, async_test("Loads room where user is creator", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 15:
                    ...
                    _k.sent();
                    // Test 3: Care team access
                    return [4 /*yield*/, async_test("Loads room where user is on care team for aboutEnduserId", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 16:
                    ...
                    _k.sent();
                    // Test 4: Returns endusers for aboutEnduserId
                    return [4 /*yield*/, async_test("Returns endusers for aboutEnduserId display", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 17:
                    ...
                    _k.sent();
                    // Test 5: Access exclusion - no access room should be excluded for non-admin
                    return [4 /*yield*/, async_test("Excludes rooms user has no access to", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 18:
                    ...
                    _k.sent();
                    // Test 6: No care team access exclusion
                    return [4 /*yield*/, async_test("Excludes rooms where user is not on care team for aboutEnduserId", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 19:
                    ...
                    _k.sent();
                    // Test 7: Closed rooms excluded by default
                    return [4 /*yield*/, async_test("Excludes closed rooms by default", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 20:
                    ...
                    _k.sent();
                    // Test 8: Closed rooms included with showClosed=true
                    return [4 /*yield*/, async_test("Includes closed rooms when showClosed=true", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({ showClosed: true }); }, {
                            onResult: function (r) { return r.chat_rooms.some(function (room) { return room.id === closedRoom.id; }); }
                        })
                ...
                case 21:
                    ...
                    _k.sent();
                    // Test 9: External type excluded
                    return [4 /*yield*/, async_test("Excludes external type rooms", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 24:
                    ...
                    // Test 11: Admin also filtered to rooms they're involved in
                    // (Admins who need all rooms can use standard GET endpoints)
                    return [4 /*yield*/, async_test("Admin does NOT see rooms they're not involved in", function () { return sdk.api.chat_rooms.load_team_chat({}); }, {
                ...
                case 25:
                    ...
                    _k.sent();
                    // Test 12: Pagination with limit
                    return [4 /*yield*/, async_test("Respects limit parameter", function () { return sdk.api.chat_rooms.load_team_chat({ limit: 2 }); }, {
                ...
                case 41:
                    ...
                    return [4 /*yield*/, async_test("Assigned enduser access: sees room but not unassigned enduser", function () { return sdkAssignedAccess.api.chat_rooms.load_team_chat({}); }, {
                            onResult: function (r) {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, load_team_chat_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
