    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, wait(undefined, POLL_INTERVAL_MS)];
            case 3:
                _a.sent();
                return [3 /*break*/, 1];
...
export var webhook_error_handling_tests = function (_a) {
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, async_test('configure webhook', function () { return sdk.api.webhooks.configure({ url: ENOTFOUND_URL, secret: TEST_SECRET }); }, { shouldError: false, onResult: function () { return true; } })];
                case 3:
                    _j.sent();
                ...
                case 7:
                    ...
                    assert(typeof (enotfoundLog === null || enotfoundLog === void 0 ? void 0 : enotfoundLog.response) === 'string' && enotfoundLog.response.length > 0, "expected string error message response, got: ".concat(JSON.stringify(enotfoundLog === null || enotfoundLog === void 0 ? void 0 : enotfoundLog.response)), 'ENOTFOUND log has error message as response');
                    assert((enotfoundLog === null || enotfoundLog === void 0 ? void 0 : enotfoundLog.responseCode) === undefined, 'unexpected responseCode for ENOTFOUND', 'ENOTFOUND log has no responseCode');
                    _b = assert;
                ...
                case 11:
                    log400 = _j.sent();
                    assert((log400 === null || log400 === void 0 ? void 0 : log400.responseCode) === 400, "expected responseCode 400, got ".concat(log400 === null || log400 === void 0 ? void 0 : log400.responseCode), 'HTTP 400 responseCode recorded');
                    _c = assert;
                ...
                case 15:
                    log500 = _j.sent();
                    assert((log500 === null || log500 === void 0 ? void 0 : log500.responseCode) === 500, "expected responseCode 500, got ".concat(log500 === null || log500 === void 0 ? void 0 : log500.responseCode), 'HTTP 500 responseCode recorded');
                    _d = assert;
                ...
                case 19:
                    successLog = _j.sent();
                    assert((successLog === null || successLog === void 0 ? void 0 : successLog.responseCode) === 200, "expected responseCode 200, got ".concat(successLog === null || successLog === void 0 ? void 0 : successLog.responseCode), 'success responseCode recorded');
                    assert(successIntegrityVerified, 'integrity check failed on success delivery', 'success delivery integrity verified');
                    return [4 /*yield*/, wait(undefined, 1000)]; // allow any (erroneous) counter update to land before checking
                case 20:
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, webhook_error_handling_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
