 ...
 */
export var managed_content_enduser_access_tests = function (_a) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 16:
                    ...
                    return [4 /*yield*/, async_test('assignmentType All - visible to enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                ...
                case 17:
                    ...
                    _d.sent();
                    // Test 2: Direct enduserId assignment - visible to assigned enduser
                    return [4 /*yield*/, async_test('direct enduserId - visible to assigned enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({
                ...
                case 18:
                    ...
                    _d.sent();
                    // Test 3: Direct enduserId assignment - NOT visible to other enduser
                    return [4 /*yield*/, async_test('direct enduserId - NOT visible to other enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 19:
                    ...
                    _d.sent();
                    // Test 4: By Tags with matching tags - visible to enduser
                    return [4 /*yield*/, async_test('By Tags match - visible to enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({
                ...
                case 20:
                    ...
                    _d.sent();
                    // Test 5: By Tags with non-matching tags - NOT visible to enduser
                    return [4 /*yield*/, async_test('By Tags no match - NOT visible to enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({
                ...
                case 21:
                    ...
                    _d.sent();
                    // Test 6: Content without assignment criteria - NOT visible to enduser
                    return [4 /*yield*/, async_test('no assignment criteria - NOT visible to enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({
                ...
                case 22:
                    ...
                    _d.sent();
                    // Test 7: Manual assignment via ManagedContentRecordAssignment - visible to enduser
                    return [4 /*yield*/, async_test('manual assignment - visible to assigned enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({
                ...
                case 23:
                    ...
                    _d.sent();
                    // Test 8: Manual assignment - NOT visible to other enduser
                    return [4 /*yield*/, async_test('manual assignment - NOT visible to other enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, otherEnduserSDK.api.managed_content_records.getSome({
                ...
                case 24:
                    ...
                    _d.sent();
                    // Test 9: Content shared via CalendarEvent - visible to event attendee
                    return [4 /*yield*/, async_test('event sharedContentIds - visible to attendee', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({
                ...
                case 25:
                    ...
                    _d.sent();
                    // Test 10: Content shared via CalendarEvent - NOT visible to non-attendee
                    return [4 /*yield*/, async_test('event sharedContentIds - NOT visible to non-attendee', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, otherEnduserSDK.api.managed_content_records.getSome({
                ...
                case 26:
                    ...
                    _d.sent();
                    // Test 11: User session can see ALL content (no filtering applied)
                    return [4 /*yield*/, async_test('user session - sees all content (no filtering)', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 27:
                    ...
                    _d.sent();
                    // Test 12: Count total visible records for enduser
                    return [4 /*yield*/, async_test('enduser - correct total visible count', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results, testRecords;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, enduserSDK.api.managed_content_records.getSome({})
                ...
                case 28:
                    ...
                    _d.sent();
                    // Test 13: Other enduser sees only assignmentType: 'All'
                    return [4 /*yield*/, async_test('other enduser - sees only All assignment type', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var results, testRecords;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, otherEnduserSDK.api.managed_content_records.getSome({})
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, managed_content_enduser_access_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
