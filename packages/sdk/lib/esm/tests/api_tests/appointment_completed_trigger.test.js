...
export var appointment_completed_trigger_tests = function (_a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 19:
                    ...
                    return [4 /*yield*/, async_test("Appointment created as completed triggers automation", function () { return sdk.api.endusers.getOne(enduser1.id); }, { onResult: function (e) {
                                var _a;
                ...
                case 22:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("Cancelled appointment with completedAt does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser2.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } } // No tags should be added
                        )
                ...
                case 25:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("Rescheduled appointment with completedAt does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser3.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } } // No tags should be added
                        )
                ...
                case 28:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("No-show appointment with completedAt does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser4.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } } // No tags should be added
                        )
                ...
                case 31:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("Template-based completed appointment triggers automation", function () { return sdk.api.endusers.getOne(enduser5.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2
                                    && e.tags.includes('Completed - Any')
                ...
                case 34:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("Template-based cancelled appointment with completedAt does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser6.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } } // No tags should be added
                        )
                ...
                case 37:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("Appointment with all status flags does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser7.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } } // No tags should be added
                        )
                ...
                case 40:
                    _b.sent(); // allow triggers to happen
                    return [4 /*yield*/, async_test("Clean completed appointment triggers automation", function () { return sdk.api.endusers.getOne(enduser8.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2
                                    && e.tags.includes('Completed - Any')
                                    && e.tags.includes('Completed - By Title');
                ...
                case 43:
                    ...
                    return [4 /*yield*/, async_test("No initial triggers for incomplete appointment", function () { return sdk.api.endusers.getOne(updateEnduser1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 46:
                    ...
                    return [4 /*yield*/, async_test("Update to completed triggers automation", function () { return sdk.api.endusers.getOne(updateEnduser1.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2
                                    && e.tags.includes('Completed - Any')
                                    && e.tags.includes('Completed - By Title');
                ...
                case 51:
                    _b.sent(); // allow update triggers to happen
                    return [4 /*yield*/, async_test("Update cancelled event to completed does NOT trigger automation", function () { return sdk.api.endusers.getOne(updateEnduser2.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 56:
                    _b.sent(); // allow update triggers to happen
                    return [4 /*yield*/, async_test("Update rescheduled event to completed does NOT trigger automation", function () { return sdk.api.endusers.getOne(updateEnduser3.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 61:
                    _b.sent(); // allow update triggers to happen
                    return [4 /*yield*/, async_test("Update no-show event to completed does NOT trigger automation", function () { return sdk.api.endusers.getOne(updateEnduser4.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 66:
                    _b.sent(); // allow update triggers to happen
                    return [4 /*yield*/, async_test("Update to add both completed and cancelled does NOT trigger automation", function () { return sdk.api.endusers.getOne(updateEnduser5.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                        // Cleanup
                    ];
                case 67:
                    _b.sent();
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, appointment_completed_trigger_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
