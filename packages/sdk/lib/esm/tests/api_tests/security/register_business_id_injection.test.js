 ...
 */
export var register_business_id_injection_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    before = _b.sent();
                    assert(before === null, "precondition failed: ".concat(email1, " already present in victim org"), 'precondition: victim org has no such user');
                ...
                case 4:
                    ...
                    _b.label = 5;
                case 5:
                    assert(!injectedIntoVictimOrg, "\u274C EXPLOIT CONFIRMED: anonymous POST /v1/users/register with businessId=".concat(victimBusinessId, " created user ")
                    ...
                    return [4 /*yield*/, wait(undefined, 1200)
                        // ==================================================================================
                ...
                case 11:
                    ...
                    _b.label = 12;
                case 12:
                    assert(!duplicateInVictimOrg, "\u274C EXPLOIT CONFIRMED: same email ".concat(email2, " registered into a second org \u2014 duplicate user ")
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, register_business_id_injection_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
