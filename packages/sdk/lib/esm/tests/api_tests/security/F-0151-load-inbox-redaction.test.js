 ...
 */
export var load_inbox_redaction_tests = function (_a) {
    var sdk = _a.sdk;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    seeded = _d.sent();
                    emailId = seeded.id;
                    return [4 /*yield*/, async_test('F-0151: load_inbox_data does not leak enduser.hashedPassword to staff', function () { return sdk.api.endusers.load_inbox_data({ enduserIds: [enduser_1.id] }); }, {
                            onResult: function (r) {
                                var _a;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, load_inbox_redaction_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
