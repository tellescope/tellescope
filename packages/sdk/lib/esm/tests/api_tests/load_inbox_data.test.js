    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 76:
                    sdkNoAccess = new (_c.apply(Session, [void 0, (_e.authToken = (_g.sent()).authToken,
                            _e)]))();
                ...
                case 86:
                    ...
                    return [4 /*yield*/, sdk.api.users.generate_auth_token({ id: roleTestUser.id })];
                case 87:
                    sdkDefaultAccess = new (_d.apply(Session, [void 0, (_f.authToken = (_g.sent()).authToken,
                            _f)]))();
                ...
                case 110:
                    ...
                    return [4 /*yield*/, async_test("PhoneNumber filter: SMS messages filtered by phoneNumber", function () { return sdk.api.endusers.load_inbox_data({ phoneNumber: testPhone1 }); }, { onResult: function (r) { return (r.sms_messages.length === 1
                ...
                case 111:
                    _g.sent();
                    return [4 /*yield*/, async_test("PhoneNumber filter: Inbound calls filtered by 'to' field", function () { return sdk.api.endusers.load_inbox_data({ phoneNumber: testPhone3 }); }, { onResult: function (r) { return (r.phone_calls.length === 1
                ...
                case 112:
                    _g.sent();
                    return [4 /*yield*/, async_test("PhoneNumber filter: No matches returns empty results", function () { return sdk.api.endusers.load_inbox_data({ phoneNumber: '+15555555559' }); }, { onResult: function (r) { return (r.sms_messages.length === 0
                                && r.phone_calls.length === 0); } })];
                case 113:
                    _g.sent();
                    return [4 /*yield*/, async_test("PhoneNumber filter: Combined with enduserIds filter", function () { return sdk.api.endusers.load_inbox_data({ phoneNumber: testPhone1, enduserIds: [e.id] }); }, { onResult: function (r) { return (r.sms_messages.length === 1
                                && r.sms_messages[0].id === smsWithPhone1.id
                                && r.phone_calls.length === 1
                                && r.phone_calls[0].id === callInboundPhone1.id); } })];
                case 114:
                    _g.sent();
                    return [4 /*yield*/, async_test("PhoneNumber filter: Combined with enduserIds filter (no match)", function () { return sdk.api.endusers.load_inbox_data({ phoneNumber: testPhone1, enduserIds: [e2.id] }); }, { onResult: function (r) { return (r.sms_messages.length === 0
                                && r.phone_calls.length === 0); } })];
                case 115:
                    _g.sent();
                    return [4 /*yield*/, async_test("PhoneNumber filter: SMS and phone calls filtered correctly", function () { return sdk.api.endusers.load_inbox_data({ phoneNumber: testPhone1 }); }, { onResult: function (r) { return (r.sms_messages.length === 1 // SMS correctly filtered
                                && r.phone_calls.length === 1 // Phone calls correctly filtered
                            ); } })];
                case 116:
                    _g.sent();
                    return [4 /*yield*/, async_test("No phoneNumber filter: All messages load normally", function () { return sdk.api.endusers.load_inbox_data({}); }, { onResult: function (r) { return (
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, load_inbox_data_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
