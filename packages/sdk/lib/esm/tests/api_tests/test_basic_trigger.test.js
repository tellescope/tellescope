...
export var test_basic_trigger_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    log_header("Basic Trigger Test - Add Tags Action");
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 6, 7, 17]);
                    // Test 1: Setup - Create enduser
                    return [4 /*yield*/, async_test('setup - create test enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 3:
                    ...
                    _b.sent();
                    // Test 3: Create trigger with Add Tags action (known working action)
                    return [4 /*yield*/, async_test('create trigger - add tags action', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var trigger;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 4:
                    ...
                    _b.sent();
                    // Test 4: Submit form and verify tag is added
                    return [4 /*yield*/, async_test('submit form - verify tag added to enduser', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, test_basic_trigger_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
