...
export var concurrent_build_threads_tests = function (_a) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 6:
                    ...
                    assert(enduserThreads.length === 1, "Expected 1 SMS thread for enduser, found ".concat(enduserThreads.length, ". ") +
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, concurrent_build_threads_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
