...
// ============================================================
export var time_tracks_resubmit_tests = function (_a) {
    var sdk = _a.sdk, sdkNonAdmin = _a.sdkNonAdmin;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_r) {
            switch (_r.label) {
                ...
                case 3:
                    _r.sent();
                    return [4 /*yield*/, wait(undefined, 2000)]; // allow side-effect handler to run
                case 4:
                ...
                case 7:
                    ...
                    assert(((_f = refetched.reviewHistory) === null || _f === void 0 ? void 0 : _f.length) === 1, "F2: reviewHistory should have 1 entry, got ".concat((_g = refetched.reviewHistory) === null || _g === void 0 ? void 0 : _g.length));
                    assert(((_h = refetched.reviewHistory) === null || _h === void 0 ? void 0 : _h[0].reviewApproved) === false, "F2: reviewHistory should preserve reviewApproved false");
                    assert(((_j = refetched.reviewHistory) === null || _j === void 0 ? void 0 : _j[0].reviewNote) === rejectionNote, "F2: reviewHistory should preserve original reviewNote");
                    assert(((_k = refetched.reviewHistory) === null || _k === void 0 ? void 0 : _k[0].reviewedByUserId) === sdkNonAdmin.userInfo.id, "F2: reviewHistory should preserve reviewedByUserId");
                    assert(!!((_l = refetched.reviewHistory) === null || _l === void 0 ? void 0 : _l[0].resubmittedAt), "F2: reviewHistory should record resubmittedAt");
                    assert(((_m = refetched.reviewHistory) === null || _m === void 0 ? void 0 : _m[0].resubmittedByUserId) === sdk.userInfo.id, "F2: reviewHistory should record resubmittedByUserId");
                ...
                case 20:
                    ...
                    assert(((_o = afterSecondResubmit.reviewHistory) === null || _o === void 0 ? void 0 : _o.length) === 2, "F7: reviewHistory should have 2 entries, got ".concat((_p = afterSecondResubmit.reviewHistory) === null || _p === void 0 ? void 0 : _p.length));
                    assert(((_q = afterSecondResubmit.reviewHistory) === null || _q === void 0 ? void 0 : _q[1].reviewNote) === "Still not right", "F7: second reviewHistory entry should preserve second rejection note");
                ...
                case 21:
                    ...
                    assert(!!pendingMatches.find(function (t) { return t.id === track_2.id; }), "F8: Pending filter should match resubmitted track");
                    return [4 /*yield*/, sdk.api.time_tracks.getSome({
                            mdbFilter: { reviewedAt: { $exists: true, $ne: '' }, reviewApproved: false }
                        })];
                case 22:
                    rejectedMatches = _r.sent();
                    assert(!rejectedMatches.find(function (t) { return t.id === track_2.id; }), "F8: Rejected filter should exclude resubmitted track");
...
// ============================================================
export var time_tracks_appointment_duration_tests = function (_a) {
    var sdk = _a.sdk, sdkNonAdmin = _a.sdkNonAdmin;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 9:
                    _d.sent();
                    return [4 /*yield*/, wait(undefined, 1500)]; // allow side effects to run
                case 10:
                    _d.sent(); // allow side effects to run
                    return [4 /*yield*/, sdk.api.calendar_events.getOne(event_1.id)];
                case 11:
                    eventAfterClose = _d.sent();
                    assert(eventAfterClose.actualDuration === 30, "F1: actualDuration should be 30, got ".concat(eventAfterClose.actualDuration));
                ...
                case 16:
                    ...
                    assert(eventAfterSecond.actualDuration === 40, "F2: actualDuration should be 40 (30 + 10), got ".concat(eventAfterSecond.actualDuration));
                ...
                case 21:
                    ...
                    assert(eventBeforeLink.actualDuration === 40, "F3: actualDuration should still be 40 before activity link, got ".concat(eventBeforeLink.actualDuration));
                    return [4 /*yield*/, sdk.api.time_tracks.updateOne(track3.id, {
                ...
                case 24:
                    ...
                    assert(eventAfterLink.actualDuration === 45, "F3: actualDuration should be 45 (30 + 10 + 5) after post-close link, got ".concat(eventAfterLink.actualDuration));
                ...
                case 27:
                    ...
                    assert(eventAfterCorrection.actualDuration === 55, "F4: actualDuration should be 55 (30 + 20 + 5) after correction, got ".concat(eventAfterCorrection.actualDuration));
                ...
                case 34:
                    ...
                    assert(!event2AfterClose.actualDuration, "F5: actualDuration should stay unset when setting is disabled, got ".concat(event2AfterClose.actualDuration));
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    _a.sent();
                    return [4 /*yield*/, time_tracks_resubmit_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, time_tracks_appointment_duration_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 9:
                    _a.sent();
                    return [2 /*return*/];
            }
