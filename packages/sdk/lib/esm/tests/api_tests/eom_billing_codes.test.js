...
export var eom_billing_codes_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    log_header("EOM FormResponse Billing Codes Tests");
                ...
                case 2:
                    ...
                    return [4 /*yield*/, async_test('updateOne accepts billingCodes and diagnosisCodes', function () { return sdk.api.form_responses.updateOne(formResponse.id, {
                            billingCodes: [
                                {
                                    code: 'G0019',
                                    quantity: 1,
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, async_test('getOne returns persisted billingCodes/diagnosisCodes', function () { return sdk.api.form_responses.getOne(formResponse.id); }, { onResult: function (r) {
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, async_test('updateOne rejects billingCode with non-string code', function () { return sdk.api.form_responses.updateOne(formResponse.id, {
                            billingCodes: [{ code: 12345, quantity: 1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 5:
                    _b.sent();
                    return [4 /*yield*/, async_test('updateOne rejects billingCode with negative quantity', function () { return sdk.api.form_responses.updateOne(formResponse.id, {
                            billingCodes: [{ code: 'G0019', quantity: -1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, async_test('updateOne rejects diagnosisCode with non-string code', function () { return sdk.api.form_responses.updateOne(formResponse.id, {
                            diagnosisCodes: [{ code: 12345 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 7:
                    _b.sent();
                    return [4 /*yield*/, async_test('updateOne can clear billingCodes/diagnosisCodes with empty arrays', function () { return sdk.api.form_responses.updateOne(formResponse.id, {
                            billingCodes: [],
                            diagnosisCodes: [],
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, eom_billing_codes_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
