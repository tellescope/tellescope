 ...
 */
export var ai_decision_summary_config_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    log_header("AI Decision — aiSummaryConfiguration payload");
                ...
                case 4:
                    ...
                    return [4 /*yield*/, async_test("generate_ai_decision accepts aiSummaryConfiguration payload", function () { return sdk.api.ai_conversations.generate_ai_decision({
                ...
                case 5:
                    ...
                    _b.sent();
                    // 2. legacy payload still validates (back-compat)
                    return [4 /*yield*/, async_test("generate_ai_decision still accepts legacy prompt/sources payload", function () { return sdk.api.ai_conversations.generate_ai_decision({
                            enduserId: enduser.id,
                            automationStepId: decisionStep.id,
                            outcomes: ['needs_followup', 'no_action'],
                ...
                case 6:
                    ...
                    _b.sent();
                    // 3. malformed aiSummaryConfiguration (invalid data source type) rejected by the validator
                    return [4 /*yield*/, async_test("generate_ai_decision rejects an invalid aiSummaryConfiguration data source", function () { return sdk.api.ai_conversations.generate_ai_decision({
                            enduserId: enduser.id,
                            automationStepId: decisionStep.id,
                            outcomes: ['needs_followup', 'no_action'],
                            aiSummaryConfiguration: {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, ai_decision_summary_config_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
