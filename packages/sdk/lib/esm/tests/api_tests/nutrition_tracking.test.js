        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    throw err_1;
                case 4: return [4 /*yield*/, async_test('USDA search (enduser): non-empty foods with fdcId/description, totalHits > 0', function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, async_test('USDA food detail (enduser): matching single food by fdcId', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'food',
                ...
                case 6:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA search (staff session) also succeeds', function () { return sdk.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'search',
                            query: JSON.stringify({ keywords: 'cheddar cheese' }),
                ...
                case 7:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA search: missing keywords rejected', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'search',
                ...
                case 8:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA search: 1-char keywords rejected', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'search',
                ...
                case 9:
                    _d.sent();
                    // ---- rigorous output-format validation ----
                    return [4 /*yield*/, async_test('USDA format: every search result matches the contract shape exactly (no extra fields)', function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, searchResult];
                        }); }); }, { onResult: function (r) { return r.data.foods.every(function (f) { return is_valid_food_summary(f) && is_plausible_per_100g(f); }); } })];
                case 10:
                    // ---- rigorous output-format validation ----
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA format: no api_key or raw USDA payload fields leak into the response', function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, searchResult];
                        }); }); }, { onResult: function (r) {
                ...
                case 11:
                    ...
                    // extraction must actually populate macros across the result set (catches a broken
                    // nutrient-number mapping, which the undefined-tolerant shape checks above would miss)
                    return [4 /*yield*/, async_test('USDA format: macro extraction populated for nearly all results', function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, searchResult];
                        }); }); }, { onResult: function (r) {
                ...
                case 12:
                    ...
                    return [4 /*yield*/, async_test('USDA format: a result matches full-fat cheddar\'s realistic per-100g values', function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, fullFatCheddar];
                        }); }); }, { onResult: function (f) { return !!f; } })];
                case 13:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA format: food detail (abridged shape) yields same values as search (search shape) for same fdcId', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'food',
                ...
                case 14:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA format: pageSize honored (5 -> exactly 5 valid foods)', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'search',
                ...
                case 15:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA format: oversized pageSize clamped to at most 50', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'search',
                ...
                case 16:
                    _d.sent();
                    return [4 /*yield*/, async_test('USDA format: non-numeric food id rejected', function () { return enduserSDK.api.integrations.proxy_read({
                            integration: 'USDA',
                            type: 'food',
                            id: '../foods/search',
                        }); }, { shouldError: true, onError: function () { return true; } })];
...
export var nutrition_tracking_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, authenticate_enduser_via_token(sdk, enduserSDK_1, { email: enduserAEmail })];
                case 6:
                    _d.sent();
                    enduserSDKB_1 = new EnduserSession({ host: host, businessId: businessId });
                    return [4 /*yield*/, authenticate_enduser_via_token(sdk, enduserSDKB_1, { email: enduserBEmail })
                        // ---- Requirement 3: daily nutrition targets (enduser-readable and -writable) ----
                    ];
                case 7:
                    _d.sent();
                    // ---- Requirement 3: daily nutrition targets (enduser-readable and -writable) ----
                    return [4 /*yield*/, async_test('targets: enduser sets all six daily nutrition targets on own record', function () { return enduserSDK_1.api.endusers.updateOne(enduserA_1.id, __assign({}, NUTRITION_TARGETS)); }, { onResult: function (e) { return Object.entries(NUTRITION_TARGETS).every(function (_a) {
                ...
                case 8:
                    // ---- Requirement 3: daily nutrition targets (enduser-readable and -writable) ----
                    _d.sent();
                    return [4 /*yield*/, async_test('targets: enduser reads all six targets back (no redaction)', function () { return enduserSDK_1.api.endusers.getOne(enduserA_1.id); }, { onResult: function (e) { return Object.entries(NUTRITION_TARGETS).every(function (_a) {
                                var field = _a[0], value = _a[1];
                                return e[field] === value;
                            }); } })];
                case 9:
                    _d.sent();
                    return [4 /*yield*/, async_test('targets: staff can read targets', function () { return sdk.api.endusers.getOne(enduserA_1.id); }, { onResult: function (e) { return Object.entries(NUTRITION_TARGETS).every(function (_a) {
                                var field = _a[0], value = _a[1];
                                return e[field] === value;
                            }); } })];
                case 10:
                    _d.sent();
                    return [4 /*yield*/, async_test('targets: staff can write targets', function () { return sdk.api.endusers.updateOne(enduserA_1.id, { dailyCalorieTarget: 2000, dailyWaterTarget: 3000 }); }, { onResult: function (e) { return e.dailyCalorieTarget === 2000 && e.dailyWaterTarget === 3000; } })];
                case 11:
                    _d.sent();
                    return [4 /*yield*/, async_test('targets: negative values rejected', function () { return enduserSDK_1.api.endusers.updateOne(enduserA_1.id, { dailyProteinTarget: -10 }); }, { shouldError: true, onError: function () { return true; } })
                ...
                case 13:
                    ...
                    return [4 /*yield*/, async_test('components: enduser round-trips observation with macros + coded food item', function () { return enduserSDK_1.api.enduser_observations.getOne(withComponents_1.id); }, { onResult: function (o) {
                ...
                case 15:
                    ...
                    return [4 /*yield*/, async_test('components: observation without components still works (back-compat)', function () { return enduserSDK_1.api.enduser_observations.getOne(withoutComponents_1.id); }, { onResult: function (o) { return o.components === undefined && o.measurement.value === 180; } })
                        // ---- Requirement 4: creatorOnly update/delete ----
                    ];
                case 16:
                    _d.sent();
                    // ---- Requirement 4: creatorOnly update/delete ----
                    return [4 /*yield*/, async_test('creatorOnly: enduser updates own observation', function () { return enduserSDK_1.api.enduser_observations.updateOne(withoutComponents_1.id, { measurement: { value: 178, unit: 'lbs' } }); }, { onResult: function (o) { return o.measurement.value === 178; } })];
                case 17:
                    // ---- Requirement 4: creatorOnly update/delete ----
                    _d.sent();
                    return [4 /*yield*/, async_test('creatorOnly: enduser deletes own observation', function () { return enduserSDK_1.api.enduser_observations.deleteOne(withoutComponents_1.id); }, { shouldError: false, onResult: function () { return true; } })
                ...
                case 19:
                    ...
                    return [4 /*yield*/, async_test('creatorOnly: enduser cannot update staff-created observation', function () { return enduserSDK_1.api.enduser_observations.updateOne(staffCreated_1.id, { measurement: { value: 1, unit: 'lbs' } }); }, { shouldError: true, onError: function () { return true; } })];
                case 20:
                    _d.sent();
                    return [4 /*yield*/, async_test('creatorOnly: enduser cannot delete staff-created observation', function () { return enduserSDK_1.api.enduser_observations.deleteOne(staffCreated_1.id); }, { shouldError: true, onError: function () { return true; } })];
                case 21:
                    _d.sent();
                    return [4 /*yield*/, async_test('creatorOnly: enduser can still read staff-created observation', function () { return enduserSDK_1.api.enduser_observations.getOne(staffCreated_1.id); }, { onResult: function (o) { return o.id === staffCreated_1.id && o.measurement.value === 182; } })
                        // Staff sessions unaffected by creatorOnly (applies to enduser sessions only)
                    ];
                case 22:
                    _d.sent();
                    // Staff sessions unaffected by creatorOnly (applies to enduser sessions only)
                    return [4 /*yield*/, async_test('staff unchanged: staff updates enduser-created observation', function () { return sdk.api.enduser_observations.updateOne(withComponents_1.id, { measurement: { value: 500, unit: 'kcal' } }); }, { onResult: function (o) { return o.measurement.value === 500; } })];
                case 23:
                    // Staff sessions unaffected by creatorOnly (applies to enduser sessions only)
                    _d.sent();
                    return [4 /*yield*/, async_test('staff unchanged: staff deletes enduser-created observation', function () { return sdk.api.enduser_observations.deleteOne(withComponents_1.id); }, { shouldError: false, onResult: function () { return true; } })
                ...
                case 25:
                    ...
                    return [4 /*yield*/, async_test("cross-enduser: enduser B cannot update enduser A's observation", function () { return enduserSDKB_1.api.enduser_observations.updateOne(enduserACreated_1.id, { measurement: { value: 1, unit: 'lbs' } }); }, { shouldError: true, onError: function () { return true; } })];
                case 26:
                    _d.sent();
                    return [4 /*yield*/, async_test("cross-enduser: enduser B cannot delete enduser A's observation", function () { return enduserSDKB_1.api.enduser_observations.deleteOne(enduserACreated_1.id); }, { shouldError: true, onError: function () { return true; } })];
                case 27:
                    _d.sent();
                    return [4 /*yield*/, async_test("cross-enduser: enduser A's observation still exists (admin verify)", function () { return sdk.api.enduser_observations.getOne(enduserACreated_1.id); }, { onResult: function (o) { return o.id === enduserACreated_1.id && o.measurement.value === 179; } })
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, nutrition_tracking_tests({ sdk: sdk_1, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
