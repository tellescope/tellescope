    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                    ...
                    postEvent = function (event, info) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    res = _a.sent();
                                    assert(res.status === 200, "Beluga webhook (".concat(event, ") expected 200, got ").concat(res.status));
                                    return [4 /*yield*/, wait(undefined, 250)]; // webhook upsert + trigger + Set Fields
                                case 2:
                ...
                case 7:
                    _b.sent();
                    return [4 /*yield*/, async_test("Block C: PACKAGE_IN_TRANSIT fires 'In Transit' trigger with trackingUrl preferred over tracking", function () { return sdk.api.endusers.getOne(enduser.id); }, { onResult: function (e) {
                                var _a, _b, _c, _d;
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, async_test("Block C: PACKAGE_OUT_FOR_DELIVERY sets order status 'Out for Delivery'", getOrder, { onResult: function (o) { return (o === null || o === void 0 ? void 0 : o.status) === 'Out for Delivery'; } })];
                case 10:
                    _b.sent();
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, async_test("Block C: PACKAGE_DELIVERED sets status 'Delivered' and stores deliveredDate", getOrder, { onResult: function (o) { return !!((o === null || o === void 0 ? void 0 : o.status) === 'Delivered'
                ...
                case 13:
                    _b.sent();
                    return [4 /*yield*/, async_test("Block C: PACKAGE_DELIVERY_FAILED sets order status 'Delivery Failed'", getOrder, { onResult: function (o) { return (o === null || o === void 0 ? void 0 : o.status) === 'Delivery Failed'; } })];
                case 14:
                    _b.sent();
                    return [3 /*break*/, 27];
                case 15:
