...
export var enduser_observations_acknowledge_basic_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var testEnduser, testObservations, observationIds_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Enduser Observations Acknowledge Basic Tests");
                // Authenticate
            ...
            case 6:
                ...
                _a.sent();
                // Test 3: Bulk set exclusion flags
                return [4 /*yield*/, async_test('acknowledge - bulk set exclusion flags', function () { return __awaiter(void 0, void 0, void 0, function () {
                        var observations;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, sdk.api.enduser_observations.acknowledge({
...
if (require.main === module) {
    enduser_observations_acknowledge_basic_tests()
        .then(function () {
