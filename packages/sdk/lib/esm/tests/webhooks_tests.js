...
import { objects_equivalent, object_is_empty } from "@tellescope/utilities";
...
var sdk = new Session({ host: 'http://localhost:8080' });
var sdkSub = new Session({ host: 'http://localhost:8080' });
var nonAdminSdk = new Session({ host: 'http://localhost:8080' });
var app = express();
        ...
        switch (_a.label) {
            case 0:
                if (isSubscribed === false)
                    return [2 /*return*/];
                return [4 /*yield*/, wait(undefined, CHECK_WEBHOOK_DELAY_MS)]; // wait for hook to post
            case 1:
...
var chats_tests = function (isSubscribed) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Chats Tests, isSubscribed=".concat(isSubscribed));
            ...
            case 3:
                ...
                return [4 /*yield*/, check_next_webhook(function (_a) {
                        ...
                        return (objects_equivalent(record, chat) &&
...
var meetings_tests = function (isSubscribed) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Meetings Tests, isSubscribed=".concat(isSubscribed));
            ...
            case 8:
                ...
                assert(!!endedMeeting && endedMeeting.status === 'ended' && !!endedMeeting.endedAt, 'Meeting missing updated values on end', 'Meeting ended correctly');
...
var endusers_tests = function (isSubscribed) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Endusers Tests, isSubscribed=".concat(isSubscribed));
            ...
            case 5:
                ...
                return [4 /*yield*/, check_next_webhook(function (a) {
                        ...
                        return (objects_equivalent((_h = (_g = a.updates) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.recordBeforeUpdate, enduser)
                            && objects_equivalent((_k = (_j = a.updates) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.update, update));
...
var sub_organization_tests = function (isSubscribed) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Sub organization Tests, isSubscribed=".concat(isSubscribed));
                if (!isSubscribed) return [3 /*break*/, 2];
            ...
            case 3:
                ...
                return [4 /*yield*/, check_next_webhook(function (a) {
                        ...
                        return (objects_equivalent(webhookEnduser, enduserSub));
...
var form_response_tests = function (isSubscribed) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Form Response Tests, isSubscribed=".concat(isSubscribed));
                if (!isSubscribed) return [3 /*break*/, 2];
...
var calendar_event_reminders_tests = function (isSubscribed) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                log_header("Calendar Event Reminders, isSubscribed=".concat(isSubscribed));
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, async_test('First reminder progress', function () { return sdk.api.calendar_events.getOne(calendarEvent.id); }, { onResult: function (c) {
                            var _a;
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, async_test('First reminder progress pending', function () { return sdk.api.calendar_events.getOne(calendarEvent.id); }, { onResult: function (c) {
                            var _a;
                            return (c.nextReminderInMS === c.startTimeInMS - secondRemindAt
                                && ((_a = c.reminders) === null || _a === void 0 ? void 0 : _a.filter(function (r) { return r.didRemind; }).length) === 1
                                && c.startTimeInMS === calendarEvent.startTimeInMS // ensure this isn't changed in background
            ...
            case 9:
                _a.sent();
                return [4 /*yield*/, async_test('Second reminder progress', function () { return sdk.api.calendar_events.getOne(calendarEvent.id); }, { onResult: function (c) {
                            var _a;
            ...
            case 12:
                _a.sent();
                return [4 /*yield*/, async_test('Second reminder progress pending', function () { return sdk.api.calendar_events.getOne(calendarEvent.id); }, { onResult: function (c) {
                            var _a;
                            return (c.nextReminderInMS === c.startTimeInMS - thirdRemindAt
                                && ((_a = c.reminders) === null || _a === void 0 ? void 0 : _a.filter(function (r) { return r.didRemind; }).length) === 2
                                && c.startTimeInMS === calendarEvent.startTimeInMS // ensure this isn't changed in background
            ...
            case 17:
                _a.sent();
                return [4 /*yield*/, async_test('Reminders are done processing', function () { return sdk.api.calendar_events.getOne(calendarEvent.id); }, { onResult: function (c) {
                            var _a, _b;
...
var run_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 4:
                _k.sent();
                return [4 /*yield*/, async_test('configure webhook is admin only', function () { return nonAdminSdk.api.webhooks.configure({ url: webhookURL, secret: TEST_SECRET }); }, { shouldError: true, onError: function (e) { return e.message === "Inaccessible" || e.message === "Admin access only"; } })];
            case 5:
                _k.sent();
                return [4 /*yield*/, async_test('update webhook is admin only', function () { return nonAdminSdk.api.webhooks.update({ subscriptionUpdates: fullSubscription }); }, { shouldError: true, onError: function (e) { return e.message === "Inaccessible" || e.message === "Admin access only"; } })];
            case 6:
                _k.sent();
                return [4 /*yield*/, async_test('configure webhook', function () { return sdk.api.webhooks.configure({ url: webhookURL, secret: TEST_SECRET }); }, { onResult: function (_) { return true; } })];
            case 7:
                _k.sent();
                return [4 /*yield*/, async_test('configure webhook (overwrite)', function () { return sdk.api.webhooks.configure({ url: webhookURL, secret: TEST_SECRET }); }, { onResult: function () { return true; } }
            ...
            case 8:
                _k.sent();
                return [4 /*yield*/, async_test('get initial webhook configuration', function () { return sdk.api.webhooks.get_configuration({}); }, { onResult: function (r) { var _a; return r.url === webhookURL && object_is_empty((_a = r.subscriptions) !== null && _a !== void 0 ? _a : {}); } })];
            case 9:
                _k.sent();
                return [4 /*yield*/, async_test('update webhook (set empty subscription)', function () { return sdk.api.webhooks.update({ subscriptionUpdates: {} }); }, { onResult: function (_) { return true; } })];
            case 10:
                _k.sent();
                return [4 /*yield*/, async_test('update webhook (set partial subscription)', function () { return sdk.api.webhooks.update({ subscriptionUpdates: { chats: { create: true } } }); }, { onResult: function (_) { return true; } })];
            case 11:
                _k.sent();
                return [4 /*yield*/, async_test('update webhook (set subscriptions)', function () { return sdk.api.webhooks.update({ subscriptionUpdates: fullSubscription }); }, { onResult: function (_) { return true; } })];
            case 12:
                _k.sent();
                return [4 /*yield*/, async_test('update webhook invalid model', function () { return sdk.api.webhooks.update({ subscriptionUpdates: { notAModel: { create: false } } }); }, { shouldError: true, onError: function (e) { return e.message === "Error parsing field subscriptionUpdates: Got unexpected field(s) [notAModel]"; } })];
            case 13:
                _k.sent();
                return [4 /*yield*/, async_test('get initial webhook configuration after updates', function () { return sdk.api.webhooks.get_configuration({}); }, { onResult: function (r) { return r.url === webhookURL && objects_equivalent(r.subscriptions, fullSubscription); } })];
            case 14:
                _k.sent();
            ...
            case 21:
                ...
                return [4 /*yield*/, async_test('update webhook (set subscriptions empty)', function () { return sdk.api.webhooks.update({ subscriptionUpdates: __assign({}, emptySubscription) }); }, { onResult: function (_) { return true; } })];
            case 22:
                _k.sent();
