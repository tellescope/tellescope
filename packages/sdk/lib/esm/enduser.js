...
var EnduserSession = /** @class */ (function (_super) {
    ...
    function EnduserSession(o) {
        ...
        _this.begin_login_flow = function (a) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.POST("/v1/".concat(schema.endusers.publicActions.begin_login_flow.path), __assign(__assign({}, a), { businessId: this.businessId, organizationIds: this.organizationIds }))];
        ...
        _this.register = function (args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (this.POST("/v1".concat(schema.endusers.publicActions.register.path), __assign(__assign({}, args), { businessId: this.businessId, organizationIds: this.organizationIds })))];
            });
        }); };
        _this.request_password_reset = function (args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (this.POST("/v1".concat(schema.endusers.publicActions.request_password_reset.path), __assign(__assign({}, args), { businessId: this.businessId, organizationIds: this.organizationIds })))];
            });
        }); };
        _this.reset_password = function (args) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (this.POST("/v1".concat(schema.endusers.publicActions.reset_password.path), __assign(__assign({}, args), { businessId: this.businessId, organizationIds: this.organizationIds })))];
            });
        }); };
        ...
        _this.api.calendar_events.get_appointment_availability = function (a) { return _this._GET("/v1".concat(schema.calendar_events.customActions.get_appointment_availability.path), a); };
        _this.api.calendar_events.book_appointment = function (a) { return _this._POST("/v1".concat(schema.calendar_events.customActions.book_appointment.path), a); };
        _this.api.calendar_events.session_for_public_appointment_booking = function (a) { return _this._POST("/v1".concat(schema.calendar_events.publicActions.session_for_public_appointment_booking.path), a); };
        _this.api.calendar_events.details_for_appointment_booking_page = function (a) { return _this._GET("/v1".concat(schema.calendar_events.publicActions.details_for_appointment_booking_page.path), a); };
        _this.api.calendar_events.session_for_join_link = function (a) { return _this._GET("/v1".concat(schema.calendar_events.publicActions.session_for_join_link.path), a); };
        _this.api.calendar_events.stripe_details = function (a) { return _this._GET("/v1".concat(schema.calendar_events.customActions.stripe_details.path), a); };
        _this.api.calendar_events.download_ics_file = function (a) { return _this._GET("/v1".concat(schema.calendar_events.customActions.download_ics_file.path), a, true, { responseType: 'arraybuffer' }); };
        _this.api.chat_rooms.display_info = function (a) { return _this._GET("/v1".concat(schema.chat_rooms.customActions.display_info.path), a); };
        _this.api.chat_rooms.mark_read = function (a) { return _this._POST("/v1".concat(schema.chat_rooms.customActions.mark_read.path), a); };
        _this.api.endusers.logout = function () { return _this._POST('/v1/logout-enduser'); };
        _this.api.endusers.unsubscribe = function (a) { return _this._POST("/v1".concat(schema.endusers.publicActions.unsubscribe.path), a); };
        _this.api.endusers.get_otp_methods = function (a) { return _this._GET("/v1".concat(schema.endusers.publicActions.get_otp_methods.path), a); };
        _this.api.endusers.send_otp = function (a) { return _this._POST("/v1".concat(schema.endusers.publicActions.send_otp.path), a); };
        _this.api.endusers.verify_otp = function (a) { return _this._POST("/v1".concat(schema.endusers.publicActions.verify_otp.path), a); };
        _this.api.endusers.current_session_info = function () { return _this._GET("/v1".concat(schema.endusers.customActions.current_session_info.path)); };
        _this.api.endusers.add_to_journey = function (a) { return _this._POST("/v1".concat(schema.endusers.customActions.add_to_journey.path), a); };
        _this.api.endusers.set_password = function (a) { return _this._POST("/v1".concat(schema.endusers.customActions.set_password.path), a); };
        ...
        _this.api.meetings.join_meeting_for_event = function (a) { return _this._POST("/v1".concat(schema.meetings.customActions.join_meeting_for_event.path), a); };
        _this.api.organizations = {
            get_theme: function (a) { return _this._GET("/v1/".concat(schema.organizations.publicActions.get_theme.path), a); }
        };
        _this.api.form_fields.load_choices_from_database = function (args) { return _this._GET("/v1".concat(schema.form_fields.customActions.load_choices_from_database.path), args); };
        _this.api.form_fields.booking_info = function (args) { return _this._GET("/v1".concat(schema.form_fields.customActions.booking_info.path), args); };
        // this.api.form_fields.load_payers = args => this._GET(`/v1${schema.form_fields.customActions.load_payers.path}`, args)
        _this.api.form_responses.prepare_form_response = function (args) { return _this._POST("/v1".concat(schema.form_responses.customActions.prepare_form_response.path), args); };
        _this.api.form_responses.session_for_public_form = function (args) { return _this._POST("/v1".concat(schema.form_responses.publicActions.session_for_public_form.path), args); };
        _this.api.form_responses.submit_form_response = function (args) { return _this._PATCH("/v1".concat(schema.form_responses.customActions.submit_form_response.path), args); };
        ...
        _this.api.post_likes.createOne = function (args) { return _this._POST("/v1".concat(schema.post_likes.customActions.create.path), args); };
        _this.api.post_likes.unlike_post = function (args) { return _this._POST("/v1".concat(schema.post_likes.customActions.unlike_post.path), args); };
        _this.api.managed_content_records.search = function (args) { return _this._POST("/v1".concat(schema.managed_content_records.customActions.search.path), args); };
        _this.api.forms.public_form_details = function (args) { return _this._GET("/v1".concat(schema.forms.publicActions.public_form_details.path), args); };
        _this.api.sms_messages = {
            leave_message: function (args) { return _this._POST("/v1".concat(schema.sms_messages.publicActions.leave_message.path), args); }
        };
        _this.api.appointment_booking_pages.validate_access_token = function (args) { return _this._GET("/v1".concat(schema.appointment_booking_pages.publicActions.validate_access_token.path), args); };
