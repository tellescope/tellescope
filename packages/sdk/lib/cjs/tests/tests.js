    ...
    return __generator(this, function (_l) {
        switch (_l.label) {
            ...
            case 99:
                ...
                _l.label = 100;
            case 100:
                if (!(_i < _b.length)) return [3 /*break*/, 103];
                _c = _b[_i];
                if (!(_c in _a)) return [3 /*break*/, 102];
                n = _c;
            ...
            case 103:
                ...
                _l.label = 104;
            case 104:
                if (!(_h < _f.length)) return [3 /*break*/, 109];
                _g = _f[_h];
                if (!(_g in _d)) return [3 /*break*/, 108];
                t = _g;
                _l.label = 105;
            case 105:
                _l.trys.push([105, 107, , 108]);
