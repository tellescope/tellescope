...
exports.ticket_reminder_tests = exports.cancel_upcoming_appointments_journey_action_test = exports.enduser_conditional_logic_tests = exports.form_conditional_logic_tests = exports.enduser_orders_tests = exports.formsort_tests = exports.switch_to_related_contacts_tests = exports.relationships_tests = exports.alternate_phones_tests = exports.ticket_queue_tests = exports.no_chained_triggers_tests = exports.role_based_access_permissions_tests = exports.self_serve_appointment_booking_tests = exports.filter_by_date_tests = exports.databases_tests = exports.calendar_event_RSVPs_tests = exports.meetings_tests = exports.automationSameJourneyTests = exports.formsSubmittedNoUnsubmittedTest = exports.formsUnsubmittedTest = exports.formsUnsubmittedCancelConditionTest = exports.formUnsubmittedCancelConditionTest = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("o1 get o2", function () { return sdk.api.endusers.getOne(e2.id); }, recordNotFound)];
            case 3:
                /* Test global uniqueness, create must be enabled for users model */
                // await sdk.api.users.createOne({ email }).catch(console.error)
                // await sdk.api.users.createSome([{ email }, { email }]).catch(console.error)
                ...
                // await sdk.api.users.updateOne(userId, { email: sdkOtherEmail }).catch(console.error)
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("o2 get o1", function () { return sdkOther.api.endusers.getOne(e1.id); }, recordNotFound)];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("o1 get many", function () { return sdk.api.endusers.getSome(); }, { onResult: function (es) { return es.length === 1; } })];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("o2 get many", function () { return sdkOther.api.endusers.getSome(); }, { onResult: function (es) { return es.length === 1; } })];
            case 6:
                _a.sent();
                update = { fname: "billy" };
                return [4 /*yield*/, (0, testing_1.async_test)("o1 update o2", function () { return sdk.api.endusers.updateOne(e2.id, update); }, recordNotFound)];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("o2 update o1", function () { return sdkOther.api.endusers.updateOne(e1.id, update); }, recordNotFound)];
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("o1 delete o2", function () { return sdk.api.endusers.deleteOne(e2.id); }, recordNotFound)];
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("o2 delete o1", function () { return sdkOther.api.endusers.deleteOne(e1.id); }, recordNotFound)];
            case 10:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("root get root", function () { return sdk.api.endusers.getOne(rootEnduser.id); }, testing_1.passOnAnyResult)];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get root error", function () { return sdkSub.api.endusers.getOne(rootEnduser.id); }, testing_1.handleAnyError)];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("other sub get root error", function () { return sdkOtherSub.api.endusers.getOne(rootEnduser.id); }, testing_1.handleAnyError)];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("subsub get root error", function () { return sdkSubSub.api.endusers.getOne(rootEnduser.id); }, testing_1.handleAnyError)];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get sub", function () { return sdk.api.endusers.getOne(subEnduser.id); }, testing_1.passOnAnyResult)];
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get sub", function () { return sdkSub.api.endusers.getOne(subEnduser.id); }, testing_1.passOnAnyResult)];
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("other sub get sub error", function () { return sdkOtherSub.api.endusers.getOne(subEnduser.id); }, testing_1.handleAnyError)];
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("subsub get sub error", function () { return sdkSubSub.api.endusers.getOne(subEnduser.id); }, testing_1.handleAnyError)];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get subsub", function () { return sdk.api.endusers.getOne(subSubEnduser.id); }, testing_1.passOnAnyResult)];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get subsub", function () { return sdkSub.api.endusers.getOne(subSubEnduser.id); }, testing_1.passOnAnyResult)];
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("other sub get sub sub error", function () { return sdkOtherSub.api.endusers.getOne(subSubEnduser.id); }, testing_1.handleAnyError)];
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("subsub get subsub", function () { return sdkSubSub.api.endusers.getOne(subSubEnduser.id); }, testing_1.passOnAnyResult)];
            case 15:
                _a.sent();
            ...
            case 18:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser cannot update organizationIds", function () { return enduserSDK.api.endusers.updateOne(enduserSDK.userInfo.id, { organizationIds: [] }); }, testing_1.handleAnyError)];
            case 19:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("users cannot update organizationIds", function () { return sdk.api.users.updateOne(sdk.userInfo.id, { organizationIds: [] }); }, testing_1.handleAnyError)];
            case 20:
                _a.sent();
            ...
            case 27:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get sub adjusted", function () { return sdk.api.endusers.getOne(rootEnduser.id); }, testing_1.passOnAnyResult)];
            case 28:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get sub adjusted", function () { return sdkSub.api.endusers.getOne(rootEnduser.id); }, testing_1.passOnAnyResult)];
            case 29:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("other sub get sub adjusted error", function () { return sdkOtherSub.api.endusers.getOne(rootEnduser.id); }, testing_1.handleAnyError)];
            case 30:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("subsub get sub adjusted error", function () { return sdkSubSub.api.endusers.getOne(rootEnduser.id); }, testing_1.handleAnyError)];
            case 31:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("push behavior for organization ids (don't push by default)", function () { return sdk.api.endusers.updateOne(rootEnduser.id, { organizationIds: subEnduser.organizationIds }); }, { onResult: function (e) { var _a, _b; return ((_a = e.organizationIds) === null || _a === void 0 ? void 0 : _a.length) === ((_b = subEnduser.organizationIds) === null || _b === void 0 ? void 0 : _b.length); } })];
            case 32:
                _a.sent();
...
var sub_organization_enduser_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 8:
                rootTicket = _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get root", function () { return sdk.api.endusers.getOne(enduserSDK.userInfo.id); }, testing_1.passOnAnyResult)];
            case 9:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get root error", function () { return sdkSub.api.endusers.getOne(enduserSDK.userInfo.id); }, testing_1.handleAnyError)];
            case 10:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get sub", function () { return sdk.api.endusers.getOne(subEnduserSDK.userInfo.id); }, testing_1.passOnAnyResult)];
            case 11:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get sub", function () { return sdkSub.api.endusers.getOne(subEnduserSDK.userInfo.id); }, testing_1.passOnAnyResult)];
            case 12:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get root ticket", function () { return sdk.api.tickets.getOne(rootTicket.id); }, testing_1.passOnAnyResult)];
            case 13:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get root ticket error", function () { return sdkSub.api.tickets.getOne(rootTicket.id); }, testing_1.handleAnyError)];
            case 14:
                _d.sent();
            ...
            case 18:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get root after update", function () { return sdkSub.api.endusers.getOne(enduserSDK.userInfo.id); }, testing_1.passOnAnyResult)];
            case 19:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get sub", function () { return sdk.api.endusers.getOne(subEnduserSDK.userInfo.id); }, testing_1.passOnAnyResult)];
            case 20:
            ...
            case 21:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("root get root ticket after update", function () { return sdk.api.tickets.getOne(rootTicketAfterUpdate.id); }, testing_1.passOnAnyResult)];
            case 22:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("sub get root ticket after update", function () { return sdkSub.api.tickets.getOne(rootTicketAfterUpdate.id); }, testing_1.passOnAnyResult)];
            case 23:
                _d.sent();
                return [4 /*yield*/, Promise.all([
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 1000)]; // sort struggles when all 6 documents created in the same second
            case 3:
            ...
            case 5:
                es = _c.sent();
                (0, testing_1.assert)(es.length === 3, 'threadKey got duplicates', 'threadKey no duplicates (length, old)');
                (0, testing_1.assert)(new Set(es.map(function (e) { return e.type; })).size === 3, 'threadKey got duplicates', 'threadKey no duplicates explicit');
                (0, testing_1.assert)(es.find(function (e) { return e.id === e1.id; }) !== undefined, 'threadKey got duplicates', 'threadKey no duplicates (key 1, old)');
                (0, testing_1.assert)(es.find(function (e) { return e.id === e2.id; }) !== undefined, 'threadKey got duplicates', 'threadKey no duplicates (key 2, old)');
                (0, testing_1.assert)(es.find(function (e) { return e.id === e3.id; }) !== undefined, 'threadKey got duplicates', 'threadKey no duplicates (key 3, old)');
                return [4 /*yield*/, sdk.api.engagement_events.getSome({ threadKey: 'type', sort: 'newFirst' })];
            case 6:
                es = _c.sent();
                (0, testing_1.assert)(es.length === 3, 'threadKey got duplicates', 'threadKey no duplicates (length, new)');
                (0, testing_1.assert)(new Set(es.map(function (e) { return e.type; })).size === 3, 'threadKey got duplicates', 'threadKey no duplicates explicit');
...
var badInputTests = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("_-prefixed fields are not allowed", function () { return sdk.api.notes.createOne({ enduserId: constants_1.PLACEHOLDER_ID, fields: { "_notallowed": 'hello' } }); }, { shouldError: true, onError: function (e) { return e.message === "Error parsing field fields: Fields that start with '_' are not allowed"; } })];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by filter", function () { return sdk.api.endusers.getSome({ filter: { email: 'filtertests@tellescope.com' } }); }, { onResult: function (es) { return es.length === 1 && es[0].id === enduser.id; } })];
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by _exists filter", function () { return sdk.api.endusers.getSome({ filter: { fname: { _exists: true } } }); }, { onResult: function (es) { return es.length === 1 && es[0].id === enduser.id; } })];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by _exists filter (findOne)", 
            ...
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by compound filter", function () { return sdk.api.endusers.getSome({ filter: { email: 'filtertests@tellescope.com', fname: 'test' } }); }, { onResult: function (es) { return es.length === 1 && es[0].id === enduser.id; } })];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("nothing found by invalid compound filter", function () { return sdk.api.endusers.getSome({ filter: { email: 'filtertests@tellescope.com', fname: 'nottest' } }); }, { onResult: function (es) { return es.length === 0; } })];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("nothing found for invalid filter", function () { return sdk.api.endusers.getSome({ filter: { email: 'doesnotexist@tellescope.com' } }); }, { onResult: function (es) { return es.length === 0; } })];
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by nested filter", function () { return sdk.api.endusers.getSome({ filter: { fields: { field1: 'value1' } } }); }, { onResult: function (es) { return es.length === 1 && es[0].id === enduser.id; } })];
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("nothing found by invalid nested filter", function () { return sdk.api.endusers.getSome({ filter: { fields: { field1: 'not a nested field value' } } }); }, { onResult: function (es) { return es.length === 0; } })];
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by compound nested filter", function () { return sdk.api.endusers.getSome({ filter: { fields: { field1: 'value1', field2: 'value2' } } }); }, { onResult: function (es) { return es.length === 1 && es[0].id === enduser.id; } })];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("nothing found by compound invalid nested filter", function () { return sdk.api.endusers.getSome({ filter: { fields: { field1: 'not a nested field value', field2: 'value2' } } }); }, { onResult: function (es) { return es.length === 0; } })];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("find enduser by compound nested filter with non-nested field as well", function () { return sdk.api.endusers.getSome({ filter: { email: 'filtertests@tellescope.com', fields: { field1: 'value1', field2: 'value2' } } }); }, { onResult: function (es) { return es.length === 1 && es[0].id === enduser.id; } })];
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("nothing found for compound nested filter with non-nested field as well", function () { return sdk.api.endusers.getSome({ filter: { email: 'doesnotexist@tellescope.com', fields: { field1: 'value1', field2: 'value2' } } }); }, { onResult: function (es) { return es.length === 0; } })];
            case 14:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                (0, testing_1.assert)(!!enduser, '', 'Updated phone number');
                return [4 /*yield*/, sdk.api.endusers.deleteOne(enduser.id)];
            case 4:
                _a.sent();
                return [2 /*return*/];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("create-".concat(singularName, " (missing a required field)"), function () { return queries.createOne({}); }, { shouldError: true, onError: function (e) { return e.message.endsWith('is required') || e.message.includes('Value not provided'); } })];
                case 4:
                    _c.sent();
                    _c.label = 5;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("send-sms (multiple)", function () { return queries.createSome([testSMS, testSMS]); }, { onResult: function (t) { return !!t; } })];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, sdk.api.endusers.deleteOne(me.id)];
                case 7:
...
var chat_room_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 13:
                _k.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non admin can't get room without enduser", function () { return sdkNonAdmin.api.chat_rooms.getOne({ id: room.id }); }, testing_1.handleAnyError)];
            case 14:
                _k.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non admin can't get chats from room without enduser", function () { return sdkNonAdmin.api.chats.getSome({ filter: { roomId: room.id } }); }, testing_1.handleAnyError)];
            case 15:
                _k.sent();
                return [4 /*yield*/, sdk.api.endusers.updateOne(enduser.id, { assignedTo: [sdkNonAdmin.userInfo.id] })];
            case 16:
                _k.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non admin can get room with enduser", function () { return sdkNonAdmin.api.chat_rooms.getOne(room.id); }, testing_1.passOnAnyResult)];
            case 17:
                _k.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non admin can get chats from room with enduser", function () { return sdkNonAdmin.api.chats.getSome({ filter: { roomId: room.id } }); }, testing_1.passOnAnyResult)];
            case 18:
                _k.sent();
            ...
            case 24:
                _k.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("create-chat (join successful)", function () { return sdk2.api.chats.createOne({ roomId: emptyRoom.id, message: 'test' }); }, testing_1.passOnAnyResult)];
            case 25:
                _k.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 14:
                ...
                //   { shouldError: true, onError: e => e.message === 'You do not have permission to access this resource' }
                // )
                return [4 /*yield*/, (0, testing_1.async_test)("delete-chat not allowed", function () { return sdk2.api.chats.deleteOne(chat.id); }, testing_1.handleAnyError)
                    // currently disabled endpoint altogether
                    // await async_test(
...
var users_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Users Tests");
                randomFieldValue = crypto_1.default.randomBytes(32).toString('hex').toUpperCase() // uppercase so name parsing doesn't cause case change
                ;
                randomFieldNumber = Math.random();
                return [4 /*yield*/, sdk.api.users.createOne({ email: 'created@tellescope.com', verifiedEmail: true })];
            case 1:
                created = _a.sent();
                (0, testing_1.assert)(created.verifiedEmail, 'user not created with verified email', 'user created, with verifiedEmail');
            ...
            case 2:
                _a.sent();
                /* Update user tests */
                return [4 /*yield*/, (0, testing_1.async_test)("update user (non-admin, other user)", function () { return sdkNonAdmin.api.users.updateOne(sdk.userInfo.id, { fname: randomFieldValue }); }, testing_1.handleAnyError)];
            case 3:
                /* Update user tests */
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("verify no update", function () { return sdk.api.users.getOne(sdk.userInfo.id); }, { onResult: function (u) { return u.fname !== randomFieldValue; } })];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("update user (non-admin, self)", function () { return sdkNonAdmin.api.users.updateOne(sdkNonAdmin.userInfo.id, { fname: 'Updated' }); }, { onResult: function (u) { return u.id === sdkNonAdmin.userInfo.id && u.fname === "Updated"; } })];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("verify user update with admin get", function () { return sdk.api.users.getOne(sdkNonAdmin.userInfo.id); }, { onResult: function (u) { return u.id === sdkNonAdmin.userInfo.id && u.fname === "Updated"; } })
            ...
            case 6:
                ...
                // NOT Supported behavior any more
                // assert(sdkNonAdmin.userInfo.fname === 'Updated', 'refresh_session not called on self after update', 'sdk updated on user update')
                return [4 /*yield*/, (0, testing_1.async_test)("update user (admin, other user)", function () { return sdk.api.users.updateOne(sdkNonAdmin.userInfo.id, { fname: 'Non' }); }, // change back
            ...
            case 7:
                ...
                _a.sent();
                // sdkNonAdmin.userInfo.fname = 'Non' // update back in sdk instance as well
                return [4 /*yield*/, (0, testing_1.async_test)("verify user update with admin get", function () { return sdk.api.users.getOne(sdkNonAdmin.userInfo.id); }, { onResult: function (u) { return u.id === sdkNonAdmin.userInfo.id && u.fname === "Non"; } })];
            case 8:
                // sdkNonAdmin.userInfo.fname = 'Non' // update back in sdk instance as well
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("update user (custom fields)", function () { return sdk.api.users.updateOne(sdk.userInfo.id, { fields: { boolean: true, f1: randomFieldValue, f2: randomFieldNumber, f3: { object: randomFieldValue } } }); }, // change back
...
var calendar_events_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                (0, testing_1.log_header)("Calendar Events");
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: email })];
            case 1:
                id = (_b.sent()).id;
            ...
            case 2:
                ...
                enduserSDK = new sdk_1.EnduserSession({ host: host, authToken: authToken, enduser: enduser, businessId: sdk.userInfo.businessId });
                return [4 /*yield*/, sdk.api.calendar_events.createOne({
            ...
            case 5:
                publicEvent = _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("user can access own event", function () { return sdk.api.calendar_events.getOne(event.id); }, { onResult: function (e) { return e && e.id === event.id; } })];
            case 6:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("user can access public event", function () { return sdk.api.calendar_events.getOne(publicEvent.id); }, { onResult: function (e) { return e && e.id === publicEvent.id; } })
            ...
            case 7:
                ...
                //   { onResult: e => e && e.id === event.id }
                // ) 
                return [4 /*yield*/, (0, testing_1.async_test)("user can access own events and public events", function () { return sdk.api.calendar_events.getSome(); }, { onResult: function (es) { return es && es.length === 3; } })];
            case 8:
                // TODO: implement support for publicRead for users, 
                // await async_test(
                //   `non-creator, non-admin user can access public event`,
                ...
                // ) 
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("user can access own event with enduser attendee", function () { return sdk.api.calendar_events.getOne(eventWithEnduser.id); }, { onResult: function (e) { return e && e.id === eventWithEnduser.id; } })];
            case 9:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can't access uninvited event", function () { return enduserSDK.api.calendar_events.getOne(event.id); }, { shouldError: true, onError: function (e) { return e.message === "Could not find a record for the given id"; } })];
            case 10:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access event as attendee", function () { return enduserSDK.api.calendar_events.getOne(eventWithEnduser.id); }, { onResult: function (e) { return e && e.id === eventWithEnduser.id; } })];
            case 11:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access public event", function () { return enduserSDK.api.calendar_events.getOne(publicEvent.id); }, { onResult: function (e) { return e && e.id === publicEvent.id; } })];
            case 12:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access own events and public events", function () { return enduserSDK.api.calendar_events.getSome(); }, { onResult: function (es) { return es && es.length === 2; } })];
            case 13:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser cannot update publicEvent ", function () { return enduserSDK.api.calendar_events.updateOne(publicEvent.id, { title: "CHANGED " }); }, testing_1.handleAnyError)];
            case 14:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser cannot delete publicEvent", function () { return enduserSDK.api.calendar_events.deleteOne(publicEvent.id); }, testing_1.handleAnyError)];
            case 15:
                _b.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(enduser.id),
...
var ticketEventTests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 16:
                _c.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Tickets automatically created", function () { return pollForResults(sdk.api.tickets.getSome, function (tickets) { return (tickets === null || tickets === void 0 ? void 0 : tickets.length) === 2; }, 500, 15); }, testing_1.passOnAnyResult)];
            case 17:
                _c.sent();
...
var removeFromJourneyTests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 10:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Sequenced action triggered", function () { return pollForResults(function () { return sdk.api.endusers.getOne(enduser.id); }, function (e) { var _a; return ((_a = e.journeys) === null || _a === void 0 ? void 0 : _a[journey.id]) === 'Delayed Step'; }, TEST_DELAY, 15); }, testing_1.passOnAnyResult)];
            case 11:
                _b.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.journeys.deleteOne(journey.id),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 10:
                ...
                // allow fast followup to trigger
                return [4 /*yield*/, (0, testing_1.async_test)("formUnsubmitted event with short delay is triggered", function () { return pollForResults(function () { return sdk.api.endusers.getOne(enduser.id); }, function (e) { var _a; return ((_a = e === null || e === void 0 ? void 0 : e.journeys) === null || _a === void 0 ? void 0 : _a[journey.id]) === 'triggered again'; }, 1000, 20); }, testing_1.passOnAnyResult)
...
var formsUnsubmittedCancelConditionTest = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 19:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("formResponses triggered after both forms submitted", function () { return pollForResults(function () { return sdk.api.endusers.getOne(enduser.id); }, function (e) { var _a; return ((_a = e === null || e === void 0 ? void 0 : e.journeys) === null || _a === void 0 ? void 0 : _a[journey.id]) === 'formsSubmitted'; }, 500, 10); }, testing_1.passOnAnyResult)];
            case 20:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.forms.deleteOne(form.id),
...
var formsUnsubmittedTest = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                form_responses = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("formsUnsubmitted handler worked", function () { return pollForResults(function () { return sdk.api.endusers.getOne(enduser.id); }, function (e) { var _a; return ((_a = e === null || e === void 0 ? void 0 : e.journeys) === null || _a === void 0 ? void 0 : _a[journey.id]) === 'triggered'; }, 1000, 10); }, testing_1.passOnAnyResult)
                    // trigger cancel conditions
                ];
            case 10:
                _a.sent();
...
var addToJourneyTests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Add / Re-add to Journey");
                return [4 /*yield*/, sdk.api.journeys.createOne({ title: 'test journey' })];
            case 1:
                journey = _a.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: 'test@tellescope.com' })];
            ...
            case 8:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser correctly added and re-added", function () { return pollForResults(sdk.api.automated_actions.getSome, function (es) { return (es.length === 4
                    ...
                    ); }, 250, 40); }, testing_1.passOnAnyResult)];
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser throttle journey add working", function () { return sdk.api.endusers.add_to_journey({ enduserIds: [enduser.id], journeyId: journey.id, throttle: true }); }, testing_1.handleAnyError)];
            case 10:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.journeys.deleteOne(journey.id),
...
var directAutomatedActionTest = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                action = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser status set by manual automated action", function () { return pollForResults(function () { return sdk.api.endusers.getOne(enduser.id); }, function (e) { var _a; return ((_a = e.journeys) === null || _a === void 0 ? void 0 : _a[constants_1.PLACEHOLDER_ID]) === 'Working'; }, 1000, 10); }, testing_1.passOnAnyResult)];
            case 3:
                _a.sent();
...
var order_status_equals_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Automation Trigger Tests (Order Status Equals)");
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
...
var appointment_cancelled_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Automation Trigger Tests (Appointment Cancelled)");
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
            ...
            case 2:
                t2 = _a.sent();
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
                        event: { type: 'Appointment Cancelled', info: { templateIds: [constants_1.PLACEHOLDER_ID] } },
            ...
            case 7:
                event1 = _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 500)]; // allow triggers to happen (nothing should trigger til cancelled)
            case 8:
            ...
            case 12:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("Any cancel", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 1
            ...
            case 16:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("By title", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2
                                && e.tags.includes('By Any')
            ...
            case 17:
                _a.sent();
                return [4 /*yield*/, sdk.api.calendar_events.createOne({ title: 'Title', templateId: constants_1.PLACEHOLDER_ID, durationInMinutes: 30, startTimeInMS: Date.now(), attendees: [{ type: 'enduser', id: e.id }] })];
            case 18:
                event4 = _a.sent();
            ...
            case 20:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("By templateId", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 3
                                && e.tags.includes('By Any')
                                && e.tags.includes('By Title')
            ...
            case 24:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("By enduser", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 4
                                && e.tags.includes('By Any')
                                && e.tags.includes('By Title')
            ...
            case 28:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("By user", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 5
                                && e.tags.includes('By Any')
                                && e.tags.includes('By Title')
            ...
            case 29:
                _a.sent();
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
                        event: { type: 'Appointment Cancelled', info: { excludeTemplateIds: [constants_1.PLACEHOLDER_ID] } },
            ...
            case 33:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("Dont trigger when excluded templateId is provided", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 5
                                && e.tags.includes('By Any')
                                && e.tags.includes('By Title')
            ...
            case 37:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("Do trigger when excluded templateId is not provided", function () { return sdk.api.endusers.getOne(e.id); }, { onResult: function (e) {
                            var _a;
                            return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 6
                                && e.tags.includes('By Any')
                                && e.tags.includes('By Title')
...
var appointment_created_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Automation Trigger Tests (Appointment Created)");
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
            ...
            case 2:
                t2 = _a.sent();
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
                        event: { type: 'Appointment Created', info: { templateIds: [constants_1.PLACEHOLDER_ID] } },
                        action: { type: 'Add Tags', info: { tags: ['By templateId'] } },
                        status: 'Active',
                        title: "By templateId"
                    })];
            ...
            case 13:
                _a.sent();
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
                        event: { type: 'Appointment Created', info: { excludeTemplateIds: [constants_1.PLACEHOLDER_ID] } },
                        action: { type: 'Add Tags', info: { tags: ['By excluded templateId'] } },
                        status: 'Active',
                        title: "By excluded templateId"
                    })];
...
var assign_care_team_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Automation Trigger Tests (Assign Care Team)");
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({}) === undefined, 'get_care_team_primary failed', 'get_care_team_primary missing');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ assignedTo: [] }) === undefined, 'get_care_team_primary failed', 'get_care_team_primary empty');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ primaryAssignee: '1' }) === undefined, 'get_care_team_primary failed', 'get_care_team_primary missing (with primaryAssignee)');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ assignedTo: [], primaryAssignee: '1' }) === undefined, 'get_care_team_primary failed', 'get_care_team_primary empty (with primaryAssignee)');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ assignedTo: ['1', '2', '3'] }) === '1', 'get_care_team_primary failed', 'get_care_team_primary included');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ assignedTo: ['1', '2'], primaryAssignee: '3' }) === '1', 'get_care_team_primary failed', 'get_care_team_primary included');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ assignedTo: ['1', '2'], primaryAssignee: '2' }) === '2', 'get_care_team_primary failed', 'get_care_team_primary included');
                (0, testing_1.assert)((0, utilities_1.get_care_team_primary)({ assignedTo: ['1', '2'], primaryAssignee: '1' }) === '1', 'get_care_team_primary failed', 'get_care_team_primary included');
                return [4 /*yield*/, sdk.api.users.updateOne(sdk.userInfo.id, { tags: ['Assignment'] }, { replaceObjectFields: true })];
            case 1:
                _a.sent();
                return [4 /*yield*/, sdk.api.automation_triggers.createOne({
                        title: 't1',
            ...
            case 5:
                e1 = _a.sent();
                return [4 /*yield*/, sdk.api.endusers.updateOne(e1.id, { tags: ['No Match'] })];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 500)]; // allow triggers to happen
            case 7:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("No care team added", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return !((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.length) && !e.primaryAssignee; } })];
            case 8:
                _a.sent();
            ...
            case 10:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("Care team added", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.length) === 1 && !e.primaryAssignee; } })];
            case 11:
                _a.sent();
                return [4 /*yield*/, sdk.api.endusers.updateOne(e1.id, { assignedTo: [], tags: ['Trigger Primary'] }, { replaceObjectFields: true })];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 500)]; // allow triggers to happen
            case 13:
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("Care team added and set as primary", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.primaryAssignee === e.assignedTo[0]; } })];
            case 14:
                _a.sent();
                return [4 /*yield*/, Promise.all([
            ...
            case 25:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Set fields on appointment created", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) {
                            ...
                            return ((_a = e.fields) === null || _a === void 0 ? void 0 : _a.test) === 'Test'
                                && ((_b = e.fields) === null || _b === void 0 ? void 0 : _b.test2) === new Date(a1.startTimeInMS).toISOString()
...
var form_response_set_fields_trigger_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var enduser, form, field, trigger, accessCode, testResponseValue;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Set Fields from Form Response - Trigger Action");
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: "setfields-trigger@tellescope.com" })
                    // Create test form with a field that has an externalId
                ];
            case 1:
                enduser = _a.sent();
                return [4 /*yield*/, sdk.api.forms.createOne({ title: 'Set Fields Trigger Test Form' })];
            case 2:
                form = _a.sent();
                return [4 /*yield*/, sdk.api.form_fields.createOne({
                        formId: form.id,
            ...
            case 5:
                accessCode = (_a.sent()).accessCode;
                testResponseValue = 'Test Form Response Value';
                return [4 /*yield*/, sdk.api.form_responses.submit_form_response({
                        accessCode: accessCode,
                        responses: [{
                                fieldId: field.id,
            ...
            case 6:
                _a.sent();
                // Wait for trigger to process and check if fields were set correctly
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 1000)]; // allow triggers to happen
            case 7:
                // Wait for trigger to process and check if fields were set correctly
                _a.sent(); // allow triggers to happen
                return [4 /*yield*/, (0, testing_1.async_test)("Set fields from form response template variables (trigger action)", function () { return sdk.api.endusers.getOne(enduser.id); }, { onResult: function (e) {
                            var _a, _b;
                            return ((_a = e.fields) === null || _a === void 0 ? void 0 : _a.trigger_form_response_value) === testResponseValue
                                && ((_b = e.fields) === null || _b === void 0 ? void 0 : _b.trigger_static_field) === "Static Value";
                        }
                    })
                    // Cleanup
                ];
...
var form_response_set_fields_journey_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var enduser, form, field, accessCode, formResponse, journey;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Set Fields from Form Response - Journey Action");
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: "setfields-journey@tellescope.com" })
                    // Create test form with a field that has an externalId
                ];
            case 1:
                enduser = _a.sent();
                return [4 /*yield*/, sdk.api.forms.createOne({ title: 'Set Fields Journey Test Form' })];
            case 2:
                form = _a.sent();
                return [4 /*yield*/, sdk.api.form_fields.createOne({
                        formId: form.id,
            ...
            case 5:
                formResponse = (_a.sent()).formResponse;
                return [4 /*yield*/, sdk.api.journeys.createOne({ title: 'Test Journey for Set Fields' })];
            case 6:
                journey = _a.sent();
                return [4 /*yield*/, sdk.api.automated_actions.createOne({
                        action: {
            ...
            case 7:
                _a.sent();
                // Poll for the automated action to be processed (up to 10 seconds)
                return [4 /*yield*/, (0, testing_1.async_test)("Set fields from form response template variables (journey action)", function () { return pollForResults(function () { return sdk.api.endusers.getOne(enduser.id); }, function (e) { var _a, _b; return ((_a = e.fields) === null || _a === void 0 ? void 0 : _a.journey_form_value) === 'Journey Test Value' && ((_b = e.fields) === null || _b === void 0 ? void 0 : _b.journey_static) === "Journey Static"; }, 500, // 500ms interval
                    20 // 20 iterations = 10 seconds
                    ); }, {
                        onResult: function (e) {
                            var _a, _b;
                            return ((_a = e.fields) === null || _a === void 0 ? void 0 : _a.journey_form_value) === 'Journey Test Value'
                                && ((_b = e.fields) === null || _b === void 0 ? void 0 : _b.journey_static) === "Journey Static";
                        }
                    })
                    // Cleanup
                ];
...
var meetings_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser can access public meeting, not private meeting", enduserSDK.api.meetings.my_meetings, { onResult: function (ms) { return ms.length === 1 && !!ms.find(function (m) { return m.id === publicMeeting.id; }); } })];
            case 8:
                _a.sent();
                return [4 /*yield*/, Promise.all([
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("user_logs earch disabled", function () { return sdk.api.user_logs.getSome({ search: { query: 'john' } }); }, testing_1.handleAnyError)];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                (0, testing_1.assert)(!!ticketNotifications.find(function (n) { var _a; return (_a = n.relatedRecords) === null || _a === void 0 ? void 0 : _a.find(function (r) { return r.id === ticket.id; }); }), 'No ticket notification', 'Got notification for new new ticket');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 10:
                // unassigned to enduser access tests
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Unassigned non-admin can't access enduser without being assigned", function () { return sdkNonAdmin.api.endusers.getOne(e.id); }, testing_1.handleAnyError)];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for enduser ticket bad", function () { return sdkNonAdmin.api.tickets.getOne(adminTicket.id); }, testing_1.handleAnyError)];
            case 12:
                _a.sent();
            ...
            case 15:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-admin for own ticket", function () { return sdkNonAdmin.api.tickets.getOne(ticketCreatedByNonAdmin.id); }, testing_1.passOnAnyResult)];
            case 16:
                _a.sent();
            ...
            case 18:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for email bad", function () { return sdkNonAdmin.api.emails.getOne(email.id); }, testing_1.handleAnyError)];
            case 19:
                _a.sent();
            ...
            case 20:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for sms bad", function () { return sdkNonAdmin.api.sms_messages.getOne(sms.id); }, testing_1.handleAnyError)];
            case 21:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("admin for calendar", function () { return sdk.api.calendar_events.getOne(calendarEvent.id); }, testing_1.passOnAnyResult)];
            case 22:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for calendar bad", function () { return sdkNonAdmin.api.calendar_events.getOne(calendarEvent.id); }, testing_1.handleAnyError)];
            case 23:
                _a.sent();
            ...
            case 24:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for chat room bad", function () { return sdkNonAdmin.api.chat_rooms.getOne(chatRoom.id); }, testing_1.handleAnyError)];
            case 25:
                _a.sent();
            ...
            case 26:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for chat message bad", function () { return sdkNonAdmin.api.chats.getOne(chatMessage.id); }, testing_1.handleAnyError)];
            case 27:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("[bulk] non-admin for chat message bad", function () { return sdkNonAdmin.bulk_load({ load: [{ model: 'chats' }] }); }, 
                    ...
                    testing_1.handleAnyError // throws error in this case in enforceForeignAccessConstraints because there are no accessible chats
                    )];
            case 28:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-admin for chats", function () { return sdkNonAdmin.api.chats.getSome({ filter: { roomId: chatRoom.id } }); }, testing_1.handleAnyError)];
            case 29:
                _a.sent();
            ...
            case 30:
                _a.sent();
                // unassigned update / delete coverage
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for enduser ticket update bad", function () { return sdkNonAdmin.api.tickets.updateOne(adminTicket.id, { title: 'updated' }); }, testing_1.handleAnyError)];
            case 31:
                // unassigned update / delete coverage
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for enduser ticket delete bad", function () { return sdkNonAdmin.api.tickets.deleteOne(adminTicket.id); }, testing_1.handleAnyError)
                    // set assignees
                ];
            case 32:
                _a.sent();
            ...
            case 33:
                ...
                _a.sent();
                // assigned access tests
                return [4 /*yield*/, (0, testing_1.async_test)("Admin / creator can access enduser while assigned", function () { return sdk.api.endusers.getOne(e.id); }, testing_1.passOnAnyResult)];
            case 34:
                // assigned access tests
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Unassigned non-admin can access enduser while assigned", function () { return sdkNonAdmin.api.endusers.getOne(e.id); }, testing_1.passOnAnyResult)];
            case 35:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for enduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(adminTicket.id); }, testing_1.passOnAnyResult)];
            case 36:
                _a.sent();
            ...
            case 38:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for email", function () { return sdkNonAdmin.api.emails.getOne(email.id); }, testing_1.passOnAnyResult)];
            case 39:
                _a.sent();
            ...
            case 40:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for sms", function () { return sdkNonAdmin.api.sms_messages.getOne(sms.id); }, testing_1.passOnAnyResult)];
            case 41:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for calendar", function () { return sdkNonAdmin.api.calendar_events.getOne(calendarEvent.id); }, testing_1.passOnAnyResult)];
            case 42:
                _a.sent();
            ...
            case 43:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for chat room", function () { return sdkNonAdmin.api.chat_rooms.getOne(chatRoom.id); }, testing_1.passOnAnyResult)];
            case 44:
                _a.sent();
            ...
            case 45:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for chat message", function () { return sdkNonAdmin.api.chats.getOne(chatMessage.id); }, testing_1.passOnAnyResult)];
            case 46:
                _a.sent();
            ...
            case 48:
                _a.sent();
                // update / delete coverage for assigned tickets
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin assigned enduser ticket update find", function () { return sdkNonAdmin.api.tickets.updateOne(adminTicket.id, { title: 'updated' }); }, testing_1.passOnAnyResult)];
            case 49:
                // update / delete coverage for assigned tickets
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin for enduser ticket delete still bad", function () { return sdkNonAdmin.api.tickets.deleteOne(adminTicket.id); }, testing_1.handleAnyError)
                    // cleanup
                ];
            case 50:
                _a.sent();
...
var status_update_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Enduser Status Updates");
            ...
            case 4:
                // status update on enduser is a side effect
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("status update", function () { return sdk.api.endusers.getOne(enduser.id); }, {
...
var community_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                (0, testing_1.log_header)("Community");
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: email })];
            case 1:
                enduser = _d.sent();
                return [4 /*yield*/, sdk.api.endusers.set_password({ id: enduser.id, password: password }).catch(console.error)];
            ...
            case 6:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser access privateForum error", function () { return enduserSDK.api.forums.getOne(privateForum.id); }, testing_1.handleAnyError)];
            case 7:
                _d.sent();
            ...
            case 9:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("enduser post private\u00A0errors", function () { return enduserSDK.api.forum_posts.createOne({ title: 'title', forumId: privateForum.id, htmlContent: 'enduser', textContent: 'enduser' }); }, testing_1.handleAnyError)];
            case 10:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access single post for forumId", function () { return enduserSDK.api.forum_posts.getOne({ forumId: forum.id }); }, testing_1.passOnAnyResult)];
            case 11:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access self post by id", function () { return enduserSDK.api.forum_posts.getOne(enduserPost.id); }, testing_1.passOnAnyResult)];
            case 12:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access other post by id", function () { return enduserSDK.api.forum_posts.getOne(userPost.id); }, testing_1.passOnAnyResult)];
            case 13:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access posts", function () { return enduserSDK.api.forum_posts.getSome({ filter: { forumId: forum.id } }); }, { onResult: function (r) { return r.length === 2; } })];
            case 14:
                _d.sent();
            ...
            case 16:
                userComment = _d.sent();
                (0, testing_1.assert)(!!enduserSelfComment, 'enduser comment failed', 'enduser comment successful');
                (0, testing_1.assert)(!!userComment, 'user comment failed', 'user comment successful');
                return [4 /*yield*/, (0, testing_1.async_test)("enduser can access post comments", function () { return enduserSDK.api.post_comments.getSome({ filter: { forumId: forum.id, postId: enduserPost.id } }); }, { onResult: function (r) { return r.length === 2; } })];
            case 17:
                _d.sent();
                return [4 /*yield*/, enduserSDK.api.post_likes.createOne({ forumId: forum.id, postId: enduserPost.id })];
            case 18:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("double-like not allowed", function () { return enduserSDK.api.post_likes.createOne({ forumId: forum.id, postId: enduserPost.id }); }, testing_1.handleAnyError)];
            case 19:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 50)];
            case 20:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("post and like counts on create", function () { return sdk.api.forum_posts.getOne(enduserPost.id); }, { onResult: function (p) { return p.numComments === 2 && p.numLikes === 1; } })];
            case 21:
                _d.sent();
            ...
            case 26:
                ...
                (0, testing_1.assert)(!!userSelfPostComment, 'user private post comment failed', 'user private post comment successful');
                return [4 /*yield*/, (0, testing_1.async_test)("enduser comment private\u00A0errors", function () { return enduserSDK.api.post_comments.createOne({ forumId: privateForum.id, postId: userSelfPost.id, htmlContent: 'enduser', textContent: 'enduser' }); }, testing_1.handleAnyError)];
            case 27:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private post by id', function () { return enduserSDK.api.forum_posts.getOne(userSelfPost.id); }, testing_1.handleAnyError)];
            case 28:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private post by filter', function () { return enduserSDK.api.forum_posts.getOne({ forumId: privateForum.id }); }, testing_1.handleAnyError)];
            case 29:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private comment by id', function () { return enduserSDK.api.post_comments.getOne(userSelfPostComment.id); }, testing_1.handleAnyError)];
            case 30:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private comment by filter (forum id)', function () { return enduserSDK.api.post_comments.getOne({ forumId: privateForum.id }); }, testing_1.handleAnyError)];
            case 31:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private comment by filter (post id)', function () { return enduserSDK.api.post_comments.getOne({ postId: userSelfPost.id }); }, testing_1.handleAnyError)];
            case 32:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private comment by filter (forum and post id)', function () { return enduserSDK.api.post_comments.getOne({ forumId: privateForum.id, postId: userSelfPost.id }); }, testing_1.handleAnyError)];
            case 33:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private posts', function () { return enduserSDK.api.forum_posts.getSome({ filter: { forumId: privateForum.id } }); }, testing_1.handleAnyError)];
            case 34:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot access private comments', function () { return enduserSDK.api.post_comments.getSome({ filter: { forumId: privateForum.id } }); }, testing_1.handleAnyError)];
            case 35:
                _d.sent();
                _b = (_a = Promise).all;
                return [4 /*yield*/, sdk.api.endusers.deleteOne(enduser.id)];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('non-public form blocked', function () { return enduserSDK.api.form_responses.session_for_public_form(submitInfoNonPublic); }, testing_1.handleAnyError)];
            case 4:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('no questions form blocked', function () { return enduserSDK.api.form_responses.session_for_public_form(submitInfo); }, testing_1.handleAnyError)];
            case 5:
                _b.sent();
                return [4 /*yield*/, sdk.api.form_fields.createOne({
                        formId: form.id,
            ...
            case 10:
                ...
                // assert((enduserSDK.userInfo as any).allowedPaths.length === 3, 'allowed paths not preserved', 'allowed paths preserved after refresh')
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot use non-allowed path', function () { return enduserSDK.api.endusers.updateOne(enduserSDK.userInfo.id, { fields: { testFiedl: 'testValue' } }); }, testing_1.handleAnyError)];
            case 11:
                // assert((enduserSDK.userInfo as any).allowedPaths.length === 3, 'allowed paths not preserved', 'allowed paths preserved after refresh')
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser can submit public form', function () { return enduserSDK.api.form_responses.submit_form_response({ accessCode: responseInfo.accessCode, responses: [testResponse] }); }, testing_1.passOnAnyResult)
...
var calendar_event_RSVPs_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot delete user RSVP', function () { return enduserSDK.api.calendar_event_RSVPs.deleteOne(userRSVP.id); }, testing_1.handleAnyError)];
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('user cannot delete enduser RSVP', function () { return sdk.api.calendar_event_RSVPs.deleteOne(enduserRSVP.id); }, testing_1.handleAnyError)];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot update user RSVP', function () { return enduserSDK.api.calendar_event_RSVPs.updateOne(userRSVP.id, { status: 'Maybe' }); }, testing_1.handleAnyError)];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('user cannot update enduser RSVP', function () { return sdk.api.calendar_event_RSVPs.updateOne(enduserRSVP.id, { status: 'Maybe' }); }, testing_1.handleAnyError)];
            case 13:
                _a.sent();
            ...
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser can delete own RSVP', function () { return enduserSDK.api.calendar_event_RSVPs.deleteOne(enduserRSVP.id); }, testing_1.passOnAnyResult)];
            case 15:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('user can delete own RSVP', function () { return sdk.api.calendar_event_RSVPs.deleteOne(userRSVP.id); }, testing_1.passOnAnyResult)];
            case 16:
                _a.sent();
...
exports.calendar_event_RSVPs_tests = calendar_event_RSVPs_tests;
var post_comments_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Post Comments");
                return [4 /*yield*/, enduserSDK.register({ email: 'rsvps@tellescope.com', password: "testenduserpassword" })];
            case 1:
                _a.sent();
                return [4 /*yield*/, enduserSDK.authenticate('rsvps@tellescope.com', "testenduserpassword")];
...
var databases_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var database, databaseNoRead, databaseRecord;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Databases");
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('numRecords incremented', function () { return sdk.api.databases.getOne(database.id); }, { onResult: function (c) { return c.numRecords === 1; } })];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('Non admin can access correctly', function () { return sdkNonAdmin.api.databases.getOne(database.id); }, testing_1.passOnAnyResult)
                    // await async_test(
            ...
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('numRecords decremented', function () { return sdk.api.databases.getOne(database.id); }, { onResult: function (c) { return c.numRecords === 0; } })];
            case 9:
                _a.sent();
                return [4 /*yield*/, Promise.all([
...
var filter_by_date_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var enduser1, now, enduser2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Filter by Dates");
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: 'deleteme@tellescope.com' })];
            case 1:
                enduser1 = _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 2000)]; // ensure meaningful delay in createdAt timestamp
            case 2:
            ...
            case 3:
                enduser2 = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('Filtered by from', function () { return sdk.api.endusers.getSome({ from: now }); }, { onResult: function (es) { return (es.length === 1
...
var self_serve_appointment_booking_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 15:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('30 minute slots for state restriction (called as user)', function () { return sdk.api.calendar_events.get_appointment_availability({
                        calendarEventTemplateId: event30min.id,
                        from: new Date(Date.now() - 10000),
                        to: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000),
                        restrictedByState: true,
            ...
            case 64:
                ...
                (0, testing_1.assert)(originalMultiHostAppt.attendees.filter(function (a) { return a.type === 'user'; }).length === 2, 'Original appointment should have 2 user attendees', 'Original multi-host appointment created');
                return [4 /*yield*/, enduserSDK.api.calendar_events.book_appointment({
                        calendarEventTemplateId: templatePreserveHosts.id,
            ...
            case 65:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('[reschedule] replaceHostOnReschedule: false preserves all user attendees', function () { return sdk.api.calendar_events.getOne(rescheduledPreserveHosts.id); }, { onResult: function (event) {
                            var userAttendees = event.attendees.filter(function (a) { return a.type === 'user'; });
                            var hasOriginalHost = userAttendees.some(function (a) { return a.id === sdk.userInfo.id; });
                            var hasNewHost = userAttendees.some(function (a) { return a.id === sdkNonAdmin.userInfo.id; });
                            if (userAttendees.length !== 2) {
                                console.log("Expected 2 user attendees, got ".concat(userAttendees.length));
                                return false;
                            }
                            if (!hasOriginalHost) {
            ...
            case 68:
                ...
                (0, testing_1.assert)(originalForReplace.attendees.filter(function (a) { return a.type === 'user'; }).length === 2, 'Original appointment should have 2 user attendees', 'Original multi-host appointment for replace test created');
                return [4 /*yield*/, enduserSDK.api.calendar_events.book_appointment({
                        calendarEventTemplateId: templateReplaceHosts.id,
            ...
            case 69:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('[reschedule] replaceHostOnReschedule: true replaces user attendees with new host only', function () { return sdk.api.calendar_events.getOne(rescheduledReplaceHosts.id); }, { onResult: function (event) {
                            var userAttendees = event.attendees.filter(function (a) { return a.type === 'user'; });
                            var hasOriginalHost = userAttendees.some(function (a) { return a.id === sdk.userInfo.id; });
                            var hasNewHost = userAttendees.some(function (a) { return a.id === sdkNonAdmin.userInfo.id; });
                            if (userAttendees.length !== 1) {
                                console.log("Expected 1 user attendee, got ".concat(userAttendees.length));
                                return false;
                            }
                            if (hasOriginalHost) {
            ...
            case 70:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('[reschedule] replaceHostOnReschedule: true preserves enduser attendees', function () { return sdk.api.calendar_events.getOne(rescheduledReplaceHosts.id); }, { onResult: function (event) {
                            var enduserAttendees = event.attendees.filter(function (a) { return a.type === 'enduser'; });
                            if (enduserAttendees.length !== 1) {
                                console.log("Expected 1 enduser attendee, got ".concat(enduserAttendees.length));
                                return false;
                            }
            ...
            case 71:
                _a.sent();
                // Test 3: Verify old event is marked as rescheduled
                return [4 /*yield*/, (0, testing_1.async_test)('[reschedule] original event marked as rescheduled', function () { return sdk.api.calendar_events.getOne(originalForReplace.id); }, { onResult: function (event) { return !!event.rescheduledAt; } })];
            case 72:
                // Test 3: Verify old event is marked as rescheduled
                _a.sent();
                return [4 /*yield*/, Promise.all([
...
var role_based_access_permissions_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Role Based Access Permission (Custom Roles)");
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('non-root admin can read', function () { return sdkSub.api.role_based_access_permissions.getOne(rbap.id); }, testing_1.passOnAnyResult)];
            case 4:
                _a.sent();
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('non-root admin blocked update', function () { return sdkSub.api.role_based_access_permissions.updateOne(rbap.id, { role: 'updated' }); }, testing_1.handleAnyError)];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('non-root admin blocked delete', function () { return sdkSub.api.role_based_access_permissions.deleteOne(rbap.id); }, testing_1.handleAnyError)];
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('enduser read access restriction working', function () { return sdkNonAdmin.api.endusers.getSome(); }, testing_1.handleAnyError)
                    // cleanup
                ];
            case 9:
                _a.sent();
...
var run_autoreply_test = function (title, _a) {
    var expectingAutoreply = _a.expectingAutoreply, autoreplyText = _a.autoreplyText;
    return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Main test', function () { return pollForResults(function () { return sdk.api.chats.getSome({ filter: { roomId: room.id } }); }, function (cs) { return (expectingAutoreply
                            ...
                            : cs.length === 2); }, 25, 10); }, testing_1.passOnAnyResult)];
                case 9:
                    _b.sent();
...
var auto_reply_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var today, oooMessage, activeBlockInfo, activeWithRange, inactiveEarly, inactiveLate, wrongDayBlockInfo, wrongEntityTypeBlockInfo, wrongEntityIdInfo, wrongTimeBlockInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            ...
            case 4:
                _a.sent();
                today = new Date();
                oooMessage = "Custom out of office reply";
                return [4 /*yield*/, sdk.api.organizations.updateOne(sdk.userInfo.businessId, {
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, run_autoreply_test('Organization OOO overlap', { expectingAutoreply: true, autoreplyText: oooMessage })];
            case 7:
                _a.sent();
                return [4 /*yield*/, sdk.api.organizations.updateOne(sdk.userInfo.businessId, {
                        outOfOfficeHours: [
            ...
            case 8:
                _a.sent();
                return [4 /*yield*/, run_autoreply_test('Organization OOO no overlap', { expectingAutoreply: false })
                    // cleanup
                ];
            case 9:
                _a.sent();
            ...
            case 11:
                _a.sent();
                return [4 /*yield*/, run_autoreply_test('Organization no OOO blocks', { expectingAutoreply: false })
...
var merge_enduser_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 7:
                _f.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Source is deleted", function () { return sdk.api.endusers.getOne(source.id); }, testing_1.handleAnyError)];
            case 8:
                _f.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Destination merged", function () { return sdk.api.endusers.getOne(destination.id); }, { onResult: function (e) {
                            var _a, _b, _c, _d, _f, _g, _h, _j;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 14:
                ...
                _b.sent();
                // test trigger cleaned up on journey delete
                return [4 /*yield*/, (0, testing_1.async_test)("Trigger cleaned up by journey deletion", function () { return pollForResults(sdk.api.automation_triggers.getSome, function (results) { return !results.find(function (r) { return r.id === trigger.id; }); }, 100, 10); }, testing_1.passOnAnyResult)
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Duplicate updates 1", function () { return sdk.api.endusers.updateOne(e1.id, { fields: { Test: 'Trigger' } }); }, testing_1.passOnAnyResult)];
            case 2:
                // prevent duplicate updates to same enduser
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Duplicate updates 2", function () { return sdk.api.endusers.updateOne(e1.id, { fields: { Test: 'Trigger' } }); }, testing_1.passOnAnyResult)];
            case 3:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Duplicate updates 3", function () { return sdk.api.endusers.updateOne(e1.id, { fields: { Test: 'Trigger' } }); }, testing_1.passOnAnyResult)];
            case 4:
                _d.sent();
            ...
            case 6:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Duplicate updates other enduser (should not again)", function () { return sdk.api.endusers.updateOne(e2.id, { fields: { Test: 'Trigger' } }); }, testing_1.passOnAnyResult)];
            case 7:
                _d.sent();
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Appropriate Automated Actions are cancelled on incoming message", function () { return pollForResults(sdk.api.automated_actions.getSome, function (actions) { return (!!actions.find(function (a) {
                        ...
                        && !!actions.find(function (a) {
                            return a.journeyId === jDontRemove.id
                                ...
                                && a.enduserId === e2.id
                                && a.status === 'active';
                        })); }, 50, 400); }, testing_1.passOnAnyResult)];
            case 12:
                _f.sent();
            ...
            case 13:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("handle_incoming_communication test for other enduser", function () { return pollForResults(sdk.api.automated_actions.getSome, function (actions) { return (!!actions.find(function (a) {
                        return a.journeyId === jRemove.id
                            ...
                            && a.enduserId === e2.id
                            && a.status === 'cancelled';
                    })); }, 100, 25); }, testing_1.passOnAnyResult)];
            case 14:
                _f.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e1.id),
...
var pdf_generation = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                fr = _a.sent();
                axios_1.default.get("http://localhost:8080/v1/form-responses/generate-pdf?id=".concat(fr.id), {
...
var mfa_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                enduser = _c.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("API Key Auth does not require MFA", function () { return sdkMfaApiKey.api.endusers.deleteOne(enduser.id); }, testing_1.passOnAnyResult)];
            case 4:
                _c.sent();
            ...
            case 6:
                e = _c.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("API-key generated token does not require MFA", function () { return sdkMfa.api.endusers.deleteOne(e.id); }, testing_1.passOnAnyResult)];
            case 7:
                _c.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 9:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Journey and tags set", function () { return pollForResults(sdk.api.endusers.getSome, function (es) { return (es.filter(function (e) { var _a, _b; return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Tag')) && ((_b = e.journeys) === null || _b === void 0 ? void 0 : _b[journey.id]) !== undefined; }).length === 4); }, 200, 25); }, testing_1.passOnAnyResult)];
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Background action queued for journey", function () { return pollForResults(sdk.api.automated_actions.getSome, function (as) { return (as.filter(function (a) { return a.automationStepId === step.id && endusers.find(function (e) { return e.id === a.enduserId; }); }).length === 4); }, 200, 25); }, testing_1.passOnAnyResult)];
            case 11:
                _a.sent();
...
var ticket_queue_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-Admin ticket access (specified queue, no access)", function () { return sdkNonAdmin.api.tickets.getSome({ filter: { queueId: queueUnshared.id } }); }, testing_1.handleAnyError)];
            case 12:
                _a.sent();
            ...
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket can't be double-assigned ticket to self", function () { return sdk.api.tickets.assign_from_queue({ ticketId: ticket.id }); }, testing_1.handleAnyError)];
            case 15:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-Admin ticket cannot assign ticket to self when can't access queue", function () { return sdkNonAdmin.api.tickets.assign_from_queue({ ticketId: ticketUnshared.id }); }, testing_1.handleAnyError)];
            case 16:
                _a.sent();
            ...
            case 17:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Queue caches number of tickets on assignment", function () { return pollForResults(function () { return sdk.api.ticket_queues.getOne(queue.id); }, function (q) { return q.count === 0; }, 50, 10); }, testing_1.passOnAnyResult)];
            case 18:
                _a.sent();
            ...
            case 24:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket queue empty for no state match", function () { return sdk.api.tickets.assign_from_queue({ queueId: queue.id }); }, { shouldError: true, onError: function (e) { return e.message === "Queue is empty"; } })];
            case 25:
                _a.sent();
                return [4 /*yield*/, sdk.api.users.updateOne(sdk.userInfo.id, { credentialedStates: [{ state: 'AK' }] })];
            case 26:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket restricted by state", function () { return sdk.api.tickets.assign_from_queue({ queueId: queue.id }); }, { onResult: function (r) { return r.ticket.id === stateTicket.id; } })];
            case 27:
                _a.sent();
            ...
            case 29:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket queue empty for no tags match", function () { return sdk.api.tickets.assign_from_queue({ queueId: queue.id }); }, { shouldError: true, onError: function (e) { return e.message === "Queue is empty"; } })];
            case 30:
                _a.sent();
                return [4 /*yield*/, sdk.api.users.updateOne(sdk.userInfo.id, { tags: ['A'] }, { replaceObjectFields: true })];
            case 31:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket queue empty for partial tags match", function () { return sdk.api.tickets.assign_from_queue({ queueId: queue.id }); }, { shouldError: true, onError: function (e) { return e.message === "Queue is empty"; } })];
            case 32:
                _a.sent();
                return [4 /*yield*/, sdk.api.users.updateOne(sdk.userInfo.id, { tags: ['A', 'B'] }, { replaceObjectFields: true })];
            case 33:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket by all of tags", function () { return sdk.api.tickets.assign_from_queue({ queueId: queue.id }); }, { onResult: function (r) { return r.ticket.id === allTagsTicket.id; } })];
            case 34:
                _a.sent();
            ...
            case 40:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket by all of tags", function () { return sdk.api.tickets.assign_from_queue({ queueId: queue.id }); }, { onResult: function (r) { return r.ticket.id === oneTagTicket.id; } })];
            case 41:
                _a.sent();
                return [4 /*yield*/, Promise.all([
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("alternatePhones automatically populated with custom fields on create and update", function () { return pollForResults(function () { return sdk.api.endusers.getOne(e.id); }, function (e) {
                    ...
                    }, 50, 20); }, testing_1.passOnAnyResult)];
            case 3:
                _a.sent();
                return [4 /*yield*/, sdk.api.endusers.deleteOne(e.id)];
            case 4:
...
var relationships_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var e1, e2, e3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Relationships Tests");
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: 'To Relate' })];
            case 1:
                e1 = _a.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: 'Related', relationships: [{ type: 'Parent', id: e1.id }] })];
            case 2:
                e2 = _a.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: 'To Update' })];
            case 3:
                e3 = _a.sent();
                return [4 /*yield*/, sdk.api.endusers.updateOne(e3.id, { relationships: [{ type: 'Caregiver', id: e1.id }, { type: 'Grandchild', id: e2.id }] })
            ...
            case 5:
                // allow side effects to propagate
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Relationships set correctly on create", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.relationships) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.relationships[0].type === 'Child' && e.relationships[0].id === e2.id; } })];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Relationships set correctly on update", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (e) { var _a; return ((_a = e.relationships) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.relationships[1].type === 'Care Recipient' && e.relationships[1].id === e3.id; } })];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Relationships set correctly on update (multiple relationships)", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (e) { var _a; return ((_a = e.relationships) === null || _a === void 0 ? void 0 : _a.length) === 2 && e.relationships[1].type === 'Grandparent' && e.relationships[1].id === e3.id; } })];
            case 8:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e1.id),
...
exports.relationships_tests = relationships_tests;
var switch_to_related_contacts_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 6:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Related contact got tags", function () { return pollForResults(function () { return sdk.api.endusers.getOne(parent.id); }, function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Success')); }, 50, 200); }, testing_1.passOnAnyResult)];
            case 7:
                _b.sent();
                return [2 /*return*/, Promise.all([
...
var formsort_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("FormSort Tests");
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Partial no contact", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 0; } })];
            case 3:
                _a.sent();
            ...
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Partial email", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 2; } })];
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Partial email", sdk.api.endusers.getSome, { onResult: function (r) { return r.length === 2; } })];
            case 10:
                _a.sent();
                return [4 /*yield*/, postToFormsort({ answers: [emailAnswer], responder_uuid: "2", finalized: true })];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Submitted email", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 2; } })];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Submitted email", sdk.api.endusers.getSome, { onResult: function (r) { return r.length === 2; } })];
            case 13:
                _a.sent();
                return [4 /*yield*/, postToFormsort({ answers: [emailAnswer], responder_uuid: "3", finalized: true })];
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Matched email", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 3; } })];
            case 15:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Matched email", sdk.api.endusers.getSome, { onResult: function (r) { return r.length === 2; } })];
            case 16:
                _a.sent();
                return [4 /*yield*/, postToFormsort({ answers: [emailAnswer], responder_uuid: "4", finalized: false, matchByName: true })];
            case 17:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Email no name partial", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 3; } })];
            case 18:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Email no name partial", sdk.api.endusers.getSome, { onResult: function (r) { return r.length === 2; } })];
            case 19:
                _a.sent();
            ...
            case 20:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Email with name partial", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 4; } })];
            case 21:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Email with name partial", sdk.api.endusers.getSome, { onResult: function (r) { return r.length === 3; } })];
            case 22:
                _a.sent();
            ...
            case 23:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Email with name match partial", sdk.api.form_responses.getSome, { onResult: function (r) { return r.length === 5; } })];
            case 24:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Email with name match partial", sdk.api.endusers.getSome, { onResult: function (r) { return r.length === 3; } })];
            case 25:
                _a.sent();
...
var agent_record_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                (0, testing_1.log_header)("AgentRecord Tests");
            ...
            case 3:
                ...
                sdkOther = new sdk_1.Session({ host: host });
                return [4 /*yield*/, sdkOther.authenticate(email2, password2)];
            case 4:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("AgentRecord create blocked", function () { return sdkOther.api.agent_records.createOne({ title: 'test', description: '', type: 'Article' }); }, { shouldError: true, onError: function (e) { return true; } })];
            case 5:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("AgentRecord create many blocked", function () { return sdkOther.api.agent_records.createSome([{ title: 'test', description: '', type: 'Article' }, { title: 'test', description: '', type: 'Article' }]); }, { shouldError: true, onError: function (e) { return true; } })];
            case 6:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("AgentRecord update blocked", function () { return sdkOther.api.agent_records.updateOne(r1.id, { title: 'updated' }); }, { shouldError: true, onError: function (e) { return true; } })];
            case 7:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("AgentRecord delete blocked", function () { return sdkOther.api.agent_records.deleteOne(r1.id); }, { shouldError: true, onError: function (e) { return true; } })];
            case 8:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("AgentRecord read access allowed in a different organizatino", function () { return sdkSub.api.agent_records.getSome(); }, { onResult: function (r) { return !!r.find(function (r) { return r.businessId !== sdkSub.userInfo.businessId; }); } })];
            case 9:
                _b.sent();
                return [4 /*yield*/, Promise.all([
        ...
        switch (_a.label) {
            ...
            case 9:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Waitlist adds to Journey", function () { return pollForResults(function () { return sdk.api.endusers.getSome(); }, function (es) {
                    ...
                    }, 25, 10); }, testing_1.passOnAnyResult)];
            case 10:
                _a.sent();
                return [4 /*yield*/, sdk.api.endusers.deleteOne(e3.id)];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Deleting enduser removes from Waitlist", function () { return pollForResults(function () { return sdk.api.waitlists.getOne(list.id); }, function (w) { return w.enduserIds.length === 2; }, 25, 10); }, testing_1.passOnAnyResult)];
            case 12:
                _a.sent();
                return [4 /*yield*/, sdk.api.endusers.merge({ sourceEnduserId: e4.id, destinationEnduserId: e5.id })];
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Deleting enduser via merge removes from Waitlist", function () { return pollForResults(function () { return sdk.api.waitlists.getOne(list.id); }, function (w) { return w.enduserIds.length === 1; }, 25, 10); }, testing_1.passOnAnyResult)];
            case 14:
                _a.sent();
                return [2 /*return*/, (Promise.all([
...
var configurations_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Configurations Tests");
                return [4 /*yield*/, sdk.api.configurations.createOne({ type: 'testing', value: '<script>hello</script>!!!' })];
            case 1:
                c = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Configurations strips html tags", function () { return sdk.api.configurations.getOne(c.id); }, { onResult: function (r) { return r.value === '!!!'; } })];
            case 2:
                _a.sent();
...
var group_mms_active_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, e1, e2, e3, initialActiveCount, groupMMS1, preSend, postSend;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                (0, testing_1.log_header)("Group MMS Tests");
                return [4 /*yield*/, sdk.api.endusers.createSome([{}, {}, {},])];
            case 1:
                _a = (_b.sent()).created, e1 = _a[0], e2 = _a[1], e3 = _a[2];
                return [4 /*yield*/, sdk.api.endusers.get_engagement_statistics({})];
            case 2:
                initialActiveCount = (_b.sent()).count;
            ...
            case 4:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 250)]; // wait for side effects
            case 5:
                _b.sent(); // wait for side effects
                return [4 /*yield*/, sdk.api.group_mms_conversations.send_message({
                        conversationId: groupMMS1.id,
                        sender: e1.id,
                        message: "Hello again from enduser!",
                        logOnly: true,
                    })];
            case 6:
                _b.sent();
            ...
            case 7:
                _b.sent(); // wait for side effects
                postSend = new Date(Date.now() + 1000);
                return [4 /*yield*/, (0, testing_1.async_test)("Incoming timestamp is set for sender", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !!r.recentInboundGroupMMSAt; } })];
            case 8:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Incoming timestamp is not set for other participant", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 9:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Incoming timestamp is not set for non-participant", function () { return sdk.api.endusers.getOne(e3.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 10:
                _b.sent();
                return [4 /*yield*/, sdk.api.group_mms_conversations.send_message({
                        conversationId: groupMMS1.id,
            ...
            case 12:
                _b.sent(); // wait for side effects
                return [4 /*yield*/, (0, testing_1.async_test)("Outgoing timestamp is set for sender", function () { return sdk.api.endusers.getOne(e1.id); }, { onResult: function (r) { return !!r.recentOutboundGroupMMSAt && !!r.recentInboundGroupMMSAt; } })];
            case 13:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Outgoing timestamp is set for other participant", function () { return sdk.api.endusers.getOne(e2.id); }, { onResult: function (r) { return !!r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 14:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Outgoing timestamp is not set for non participant", function () { return sdk.api.endusers.getOne(e3.id); }, { onResult: function (r) { return !r.recentOutboundGroupMMSAt && !r.recentInboundGroupMMSAt; } })];
            case 15:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Active count incremented by 1 for inbound group MMS", function () { return sdk.api.endusers.get_engagement_statistics({}); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 16:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Active count incremented by 1 for inbound group MMS with from", function () { return sdk.api.endusers.get_engagement_statistics({ range: { from: preSend } }); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 17:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Active count incremented by 1 for inbound group MMS with to", function () { return sdk.api.endusers.get_engagement_statistics({ range: { to: postSend } }); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 18:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Active count incremented by 1 for inbound group MMS with from and to", function () { return sdk.api.endusers.get_engagement_statistics({ range: { from: preSend, to: postSend } }); }, { onResult: function (r) { return r.count === initialActiveCount + 1; } })];
            case 19:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Active count not incremented by 1 for inbound group MMS with old from", function () { return sdk.api.endusers.get_engagement_statistics({ range: { from: postSend } }); }, { onResult: function (r) { return r.count === initialActiveCount; } })];
            case 20:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Active count not incremented by 1 for inbound group MMS with old to", function () { return sdk.api.endusers.get_engagement_statistics({ range: { to: preSend } }); }, { onResult: function (r) { return r.count === initialActiveCount; } })];
            case 21:
                _b.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e1.id),
...
var tests = {
    ...
    calendar_event_RSVPs: exports.calendar_event_RSVPs_tests,
    chats: chat_tests,
    ...
    time_tracks: function () { return NO_TEST; },
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                // start with disabled setting an no tags on non-admin (include avatar here as a hack to avoid rate limiting with duplicated updates)
                return [4 /*yield*/, sdk.api.users.updateOne(sdkNonAdmin.userInfo.id, { tags: [], avatar: '' }, { replaceObjectFields: true })];
            case 6:
                // start with disabled setting an no tags on non-admin (include avatar here as a hack to avoid rate limiting with duplicated updates)
                _a.sent();
            ...
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Setting disabled, matchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(matchEnduser.id); }, testing_1.handleAnyError)];
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Setting disabled, dontMatchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(dontMatchEnduser.id); }, testing_1.handleAnyError)];
            case 11:
                _a.sent();
            ...
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Setting disabled, matchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(matchTicket.id); }, testing_1.handleAnyError)];
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Setting disabled, dontMatchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(dontMatchTicket.id); }, testing_1.handleAnyError)];
            case 15:
                _a.sent();
            ...
            case 20:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enable setting, matchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(matchEnduser.id); }, testing_1.handleAnyError)];
            case 21:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enable setting, dontMatchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(dontMatchEnduser.id); }, testing_1.handleAnyError)];
            case 22:
                _a.sent();
            ...
            case 24:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enable setting, matchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(matchTicket.id); }, testing_1.handleAnyError)];
            case 25:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("enable setting, dontMatchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(dontMatchTicket.id); }, testing_1.handleAnyError)];
            case 26:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("tickets filter enduser valid", function () { return sdkNonAdmin.api.tickets.getSome({ filter: { enduserId: matchEnduser.id } }); }, {
                        onResult: function (r) { return r.length === 0; }
            ...
            case 32:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("disable setting, matchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(matchEnduser.id); }, testing_1.handleAnyError)];
            case 33:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("disable setting, dontMatchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(dontMatchEnduser.id); }, testing_1.handleAnyError)];
            case 34:
                _a.sent();
            ...
            case 36:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("disable setting, matchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(matchTicket.id); }, testing_1.handleAnyError)];
            case 37:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("disable setting, dontMatchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(dontMatchTicket.id); }, testing_1.handleAnyError)];
            case 38:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("tickets filter enduser valid", function () { return sdkNonAdmin.api.tickets.getSome({ filter: { enduserId: matchEnduser.id } }); }, {
                        onResult: function (r) { return r.length === 0; }
            ...
            case 43:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("access matchEnduser", function () { return sdkNonAdmin.api.endusers.getOne(matchEnduser.id); }, testing_1.passOnAnyResult)];
            case 44:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("access dontMatchEnduser bad", function () { return sdkNonAdmin.api.endusers.getOne(dontMatchEnduser.id); }, testing_1.handleAnyError)];
            case 45:
                _a.sent();
            ...
            case 47:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("access, matchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(matchTicket.id); }, testing_1.passOnAnyResult)];
            case 48:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("access, dontMatchEnduser ticket", function () { return sdkNonAdmin.api.tickets.getOne(dontMatchTicket.id); }, testing_1.handleAnyError)];
            case 49:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("tickets filter enduser valid", function () { return sdkNonAdmin.api.tickets.getSome({ filter: { enduserId: matchEnduser.id } }); }, {
            ...
            case 51:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-admin can't update tags", function () { return sdkNonAdmin.api.users.updateOne(sdkNonAdmin.userInfo.id, { tags: ['new tag'] }); }, testing_1.handleAnyError)];
            case 52:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent();
                // validate setting empty is allowed
                return [4 /*yield*/, (0, testing_1.async_test)("Setting empty is still allowed", function () { return sdk.api.endusers.updateOne(e.id, { assignedTo: [] }, { replaceObjectFields: true }); }, testing_1.passOnAnyResult)];
            case 5:
                // validate setting empty is allowed
                _a.sent();
                return [4 /*yield*/, Promise.all([
...
var marketing_email_unsubscribe_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                e = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-marketing email good", function () { return sdk.api.emails.createOne({ logOnly: true, subject: '', enduserId: e.id, textContent: '', HTMLContent: '' }); }, testing_1.passOnAnyResult)];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Marketing email good when subscribed", function () { return sdk.api.emails.createOne({ logOnly: true, isMarketing: true, subject: '', enduserId: e.id, textContent: '', HTMLContent: '' }); }, testing_1.passOnAnyResult)
                    // attempt to push duplicates of each
                ];
            case 3:
                _a.sent();
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Marketing email bad when unsubscribed", function () { return sdk.api.emails.createOne({ logOnly: true, isMarketing: true, subject: '', enduserId: e.id, textContent: '', HTMLContent: '' }); }, testing_1.handleAnyError)];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Marketing email bad when unsubscribed (bulk)", function () { return sdk.api.emails.createSome([{ logOnly: true, isMarketing: true, subject: '', enduserId: e.id, textContent: '', HTMLContent: '' }]); }, testing_1.handleAnyError)];
            case 8:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e.id),
...
var enduser_conditional_logic_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        (0, testing_1.assert)((0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'patient-type-1' }), {
            "$and": [{ "condition": { "customTypeId": "patient-type-1" } }]
        }), 'CustomTypeId conditional logic error', 'customTypeId should match exactly');
        (0, testing_1.assert)(!(0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'patient-type-1' }), {
            "$and": [{ "condition": { "customTypeId": "patient-type-2" } }]
        }), 'CustomTypeId conditional logic error', 'customTypeId should not match different value');
        (0, testing_1.assert)(!(0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'patient-type-1' }), {
            "$and": [{ "condition": { "customTypeId": { "$ne": "patient-type-1" } } }]
        }), 'CustomTypeId conditional logic error', 'customTypeId should not match with $ne operator');
        (0, testing_1.assert)((0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'patient-type-1' }), {
            "$and": [{ "condition": { "customTypeId": { "$ne": "patient-type-2" } } }]
        }), 'CustomTypeId conditional logic error', 'customTypeId should match with $ne operator for different value');
        // Test default type (Patient) handling - all falsey values should be treated as default
        (0, testing_1.assert)((0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: undefined }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'undefined customTypeId should match empty string (both default)');
        (0, testing_1.assert)((0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: null }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'null customTypeId should match empty string (both default)');
        (0, testing_1.assert)((0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: '' }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'empty string customTypeId should match empty string');
        (0, testing_1.assert)(!(0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'specific-type' }), {
            "$and": [{ "condition": { "customTypeId": "" } }]
        }), 'CustomTypeId default type error', 'specific type should not match default type');
        (0, testing_1.assert)((0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: 'specific-type' }), {
            "$and": [{ "condition": { "customTypeId": { "$ne": "" } } }]
        }), 'CustomTypeId default type error', 'specific type should not equal default type with $ne');
        (0, testing_1.assert)(!(0, utilities_1.evaluate_conditional_logic_for_enduser_fields)(__assign(__assign({}, requiredPlaceholders), { customTypeId: undefined }), {
            "$and": [{ "condition": { "customTypeId": { "$ne": "" } } }]
        }), 'CustomTypeId default type error', 'undefined customTypeId should equal default type (both default), so $ne should be false');
        return [2 /*return*/];
    });
}); };
        ...
        switch (_a.label) {
            ...
            case 6:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Upcoming event is cancelled, past appointment is not", function () { return pollForResults(sdk.api.calendar_events.getSome, function (es) { return (!!es.find(function (e) { return e.id === e1.id && !e.cancelledAt; }) // past event should not be cancelled
                    ...
                    ); }, 50, 100); }, testing_1.passOnAnyResult)];
            case 7:
                _a.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(enduser.id),
...
var ticket_reminder_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Ticket Reminder Tests");
                toDelete = [];
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Empty reminders", function () { return sdk.api.tickets.createOne({ title: title, reminders: [] }); }, { onResult: function (t) { toDelete.push(t); return t.nextReminderInMS === -1; } })];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("No due date", function () { return sdk.api.tickets.createOne({ title: title, reminders: [{ msBeforeDueDate: 0, didRemind: true }] }); }, { onResult: function (t) { toDelete.push(t); return t.nextReminderInMS === -1; } })];
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("One reminder", function () { return sdk.api.tickets.createOne({ title: title, dueDateInMS: dueDateInMS, reminders: [{ msBeforeDueDate: 0, didRemind: true }] }); }, { onResult: function (t) { toDelete.push(t); return withLeeway(t.dueDateInMS, dueDateInMS - Date.now()); } })];
            case 4:
                _a.sent();
            ...
            case 5:
                ...
                (0, testing_1.assert)(tToUpdate.nextReminderInMS === -1, 'bad cache', 'update ticket starts with no nextReminderInMS');
                return [4 /*yield*/, sdk.api.tickets.updateOne(tToUpdate.id, { dueDateInMS: dueDateInMS })];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Setting due date sets nextReminderInMS", function () { return pollForResults(function () { return sdk.api.tickets.getOne(tToUpdate.id); }, function (t) { return withLeeway(t.dueDateInMS, dueDateInMS - Date.now()); }, 25, 10); }, testing_1.passOnAnyResult)];
            case 7:
                _a.sent();
                return [4 /*yield*/, sdk.api.tickets.updateOne(tToUpdate.id, { dueDateInMS: '' })];
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Unsetting due date sets nextReminderInMS", function () { return pollForResults(function () { return sdk.api.tickets.getOne(tToUpdate.id); }, function (t) { return t.nextReminderInMS === -1; }, 25, 10); }, testing_1.passOnAnyResult)];
            case 9:
                _a.sent();
            ...
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Correct reminder picked when multiple due date sets nextReminderInMS", function () { return pollForResults(function () { return sdk.api.tickets.getOne(tToUpdate.id); }, function (t) { return withLeeway(t.dueDateInMS, dueDateInMS - Date.now() - 7000); }, 25, 10); }, testing_1.passOnAnyResult)
            ...
            case 12:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Reminder processed right away", function () { return pollForResults(function () { return sdk.api.tickets.getOne(tToRemind.id); }, function (t) {
                        var _a, _b, _c, _d;
                    ...
                    }, 100, 100); }, testing_1.passOnAnyResult)];
            case 13:
                _a.sent();
...
var bulk_update_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    var e1, e2, _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                (0, testing_1.log_header)("Bulk Update Tests");
                return [4 /*yield*/, sdk.api.endusers.createOne({})];
            case 1:
                e1 = _d.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({})];
            case 2:
                e2 = _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("primaryAssignee (set initial)", function () { return sdk.api.endusers.bulk_update({ ids: [e1.id], primaryAssignee: constants_1.PLACEHOLDER_ID }); }, {
                        onResult: function (_a) {
                            var _b, _c;
                            var _d = _a.updated, u = _d[0], rest = _d.slice(1);
                            return (rest.length === 0
                                && u.id === e1.id
                                && u.primaryAssignee === constants_1.PLACEHOLDER_ID
                                && ((_b = u.assignedTo) === null || _b === void 0 ? void 0 : _b.length) === 1
                                && ((_c = u.assignedTo) === null || _c === void 0 ? void 0 : _c[0]) === constants_1.PLACEHOLDER_ID);
                        }
                    })];
            case 3:
                _d.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("primaryAssignee (set to another)", function () { return sdk.api.endusers.bulk_update({ ids: [e1.id], primaryAssignee: sdk.userInfo.id }); }, {
                        onResult: function (_a) {
                            var _b;
                            var _c = _a.updated, u = _c[0], rest = _c.slice(1);
                            return (rest.length === 0
                                && u.id === e1.id
                                && u.primaryAssignee === sdk.userInfo.id
                                && ((_b = u.assignedTo) === null || _b === void 0 ? void 0 : _b.length) === 2
                                && u.assignedTo.includes(constants_1.PLACEHOLDER_ID)
...
var bulk_read_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("bulk id lookup limited to 1000 (success)", function () { return sdk.api.endusers.getByIds({ ids: Array.from(Array(1000).keys()).map(function () { return endusers[0].id; }) }); }, testing_1.passOnAnyResult)];
            case 3:
                _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Authenticated", createdUserSDK.test_authenticated, testing_1.passOnAnyResult)];
            case 6:
                _b.sent();
            ...
            case 8:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("De-authenticated after deletion", createdUserSDK.test_authenticated, testing_1.handleAnyError)];
            case 9:
                _b.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({})];
            case 10:
            ...
            case 11:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser Authenticated", function () { return enduserSDK.api.endusers.getSome(); }, testing_1.passOnAnyResult)];
            case 12:
                _b.sent();
                return [4 /*yield*/, sdk.api.endusers.deleteOne(enduser.id)];
            case 13:
            ...
            case 14:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser De-authenticated after deletion", function () { return enduserSDK.api.endusers.getSome(); }, testing_1.handleAnyError)];
            case 15:
                _b.sent();
                return [2 /*return*/];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("API Key is authenticated", sdkMfaApiKey.test_authenticated, testing_1.passOnAnyResult)];
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("API Key lock to future date", function () { return sdk.api.users.updateOne(sdkMfaApiKeyUserId, { lockedOutUntil: 0 }); }, testing_1.passOnAnyResult)];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 250)];
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("API Key is de-authenticated when locked", sdkMfaApiKey.test_authenticated, testing_1.handleAnyError)];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("API Key unlock to -1", function () { return sdk.api.users.updateOne(sdkMfaApiKeyUserId, { lockedOutUntil: -1 }); }, testing_1.passOnAnyResult)];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("API Key is authenticated", sdkMfaApiKey.test_authenticated, testing_1.passOnAnyResult)];
            case 6:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("users cannot update own lock status", function () { return sdk.api.users.updateOne(sdk.userInfo.id, { lockedOutUntil: -1 }); }, testing_1.handleAnyError)];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin can't lock out others", function () { return sdkNonAdmin.api.users.updateOne(sdk.userInfo.id, { lockedOutUntil: Date.now() }); }, testing_1.handleAnyError)];
            case 8:
                _a.sent();
            ...
            case 10:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin is authenticated (-1)", sdkNonAdmin.test_authenticated, testing_1.passOnAnyResult)];
            case 11:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("admin lock to past date", function () { return sdk.api.users.updateOne(nonAdminId, { lockedOutUntil: Date.now() - 1000 }); }, testing_1.passOnAnyResult)];
            case 12:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin is authenticated (past date)", sdkNonAdmin.test_authenticated, testing_1.passOnAnyResult)];
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("admin lock to 0 (indefinite)", function () { return sdk.api.users.updateOne(nonAdminId, { lockedOutUntil: 0 }); }, testing_1.passOnAnyResult)];
            case 14:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 250)];
            case 15:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin is de-authenticated when locked to 0", sdkNonAdmin.test_authenticated, testing_1.handleAnyError)];
            case 16:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("non-admin can't authenciate when locked to 0", function () { return sdkNonAdmin.authenticate(nonAdminEmail, nonAdminPassword); }, testing_1.handleAnyError)];
            case 17:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("admin unlock to -1", function () { return sdk.api.users.updateOne(nonAdminId, { lockedOutUntil: -1 }); }, testing_1.passOnAnyResult)];
            case 18:
...
var sync_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 19:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Sub organization still 0", function () { return sdkSub.sync({ from: from }); }, { onResult: function (_a) {
                            var results = _a.results;
                            return results.length === 0;
                        } })];
            case 20:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Other organization still 0", function () { return sdkOther.sync({ from: from }); }, { onResult: function (_a) {
                            var results = _a.results;
                            return results.filter(function (e) { return e.modelName === 'endusers' && e.data !== 'deleted'; }).length === 0;
                        } })];
            case 21:
            ...
            case 31:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Non-admin can access ticket (and enduser) after enduser assignment", function () { return sdkNonAdmin.sync({ from: from }); }, {
                        onResult: function (_a) {
                            var results = _a.results;
...
var sync_tests_with_access_tags = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Data Sync with Access Tags");
                matchTag = 'Access';
                return [4 /*yield*/, sdk.api.users.updateOne(sdkNonAdmin.userInfo.id, { tags: [matchTag] }, { replaceObjectFields: true })];
            case 1:
                _a.sent();
            ...
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Access tags non-admin assignment, granted access to enduser and ticket", function () { return sdkNonAdmin.sync({ from: from }); }, {
                        onResult: function (_a) {
                            var results = _a.results;
                            return (results.length === 2
                                && results.filter(function (r) { return r.modelName === 'tickets' && r.recordId === t.id; }).length === 1
            ...
            case 13:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Removed access tags non-admin, revoked access to enduser and ticket", function () { return sdkNonAdmin.sync({ from: from }); }, { onResult: function (_a) {
                            var results = _a.results;
                            return results.length === 0;
                        } })];
            case 14:
            ...
            case 20:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.wait)(undefined, 1000)]; // ensure delete does not appear in next sync, sdkNonAdmin connected
            case 21:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser register", function () { return enduserSDK.register({ email: 'test@tellescope.com', password: 'testpassWord12345!' }); }, testing_1.passOnAnyResult)];
            case 1:
                _a.sent();
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Enduser duplicate register (same response, no ability to enumerate contacts)", function () { return enduserSDK.register({ email: 'test@tellescope.com', password: 'testpassWord12345!' }); }, testing_1.passOnAnyResult)];
            case 4:
                _a.sent();
                            ...
                            switch (_c.label) {
                                ...
                                case 8:
                                    ...
                                    return [4 /*yield*/, (0, testing_1.async_test)(title, function () { return pollForResults(function () { return sdk.api.endusers.getOne(e.id); }, function (e) {
                                        ...
                                        }, 50, 10, shouldTrigger); }, testing_1.passOnAnyResult)];
                                case 9:
                                    _c.sent();
                                    if (!enduserConfigurations.length) return [3 /*break*/, 11];
                                    return [4 /*yield*/, (0, testing_1.async_test)(title + ' other enduser', function () { return pollForResults(function () { return sdk.api.endusers.getOne(e2.id); }, function (e) {
                                            var _a;
                                            // console.log(title, e.tags, (!!e.tags?.includes("Triggered")) === shouldTrigger)
                                            return (!!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes("Triggered"))) === otherEnduserShouldTrigger;
                                        }, 50, 10, otherEnduserShouldTrigger); }, testing_1.passOnAnyResult)];
                                case 10:
                                    _c.sent();
                                    _c.label = 11;
...
var superadmin_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Superadmin Tests");
                return [4 /*yield*/, (0, testing_1.async_test)("switch tenant is limited", function () { return sdk.change_tenant({ all: true }); }, testing_1.handleAnyError)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
var mdb_filter_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("MongoDB Filter Tests");
                return [4 /*yield*/, sdk.api.endusers.createOne({
                        fname: 'Test',
                        lname: 'Testson',
                        tags: ["tag1", "tag2"],
            ...
            case 2:
                otherEnduser = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("$and", function () { return sdk.api.endusers.getOne('', { $and: [{ fname: 'Test' }, { lname: 'Testson' }, { 'fields.custom': 1 }, { 'fields.nested.custom': 2 }] }); }, { onResult: function (e) { return e.id === enduser.id; } })];
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("$and (list)", function () { return sdk.api.endusers.getSome({ mdbFilter: { $and: [{ fname: 'Test' }, { lname: 'Testson' }, { 'fields.custom': 1 }, { 'fields.nested.custom': 2 }] } }); }, { onResult: function (e) { return e.length === 1 && e[0].id === enduser.id; } })];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("$and no match", function () { return sdk.api.endusers.getOne('', { $and: [{ fname: 'Not Test' }, { lname: 'Testson' }] }); }, testing_1.handleAnyError)];
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("$and no match (list)", function () { return sdk.api.endusers.getSome({ mdbFilter: { $and: [{ fname: 'Not Test' }, { lname: 'Testson' }] } }); }, { onResult: function (e) { return e.length === 0; } })];
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("bad query", function () { return sdk.api.endusers.getOne('', { $bad: 'query' }); }, { shouldError: true, onError: function (e) { return e.message === "unknown top level operator: $bad. If you have a field name that starts with a '$' symbol, consider using $getField or $setField."; } })];
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("bad query (list)", function () { return sdk.api.endusers.getSome({ mdbFilter: { $bad: 'query' } }); }, { shouldError: true, onError: function (e) { return e.message === "unknown top level operator: $bad. If you have a field name that starts with a '$' symbol, consider using $getField or $setField."; } })];
            case 8:
                _a.sent();
                return [2 /*return*/, Promise.all([
                        sdk.api.endusers.deleteOne(enduser.id),
...
var uniqueness_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 15:
                _c.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Duplicates allowed via _overrideUnique: true", function () { return sdk.api.endusers.getSome({ filter: { email: email } }); }, { onResult: function (v) { return v.length === 5; } })];
            case 16:
                _c.sent();
                return [4 /*yield*/, Promise.all([
                        sdk.api.endusers.deleteOne(e.id),
...
var calendar_event_care_team_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Calendar Event Care Team Test");
                return [4 /*yield*/, sdk.api.endusers.createOne({})];
            case 1:
                e = _a.sent();
                userId = sdk.userInfo.id;
            ...
            case 3:
                ev2 = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("User assigned on event create", function () { return pollForResults(function () { return sdk.api.endusers.getOne(e.id); }, function (e) { var _a; return !!((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.includes(userId)); }, 50, 10); }, testing_1.passOnAnyResult)];
            case 4:
                _a.sent();
                return [4 /*yield*/, sdk.api.endusers.updateOne(e.id, { assignedTo: [] }, { replaceObjectFields: true })];
            case 5:
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("User assigned on add to event", function () { return pollForResults(function () { return sdk.api.endusers.getOne(e.id); }, function (e) { var _a; return !!((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.includes(userId)); }, 50, 10); }, testing_1.passOnAnyResult)];
            case 7:
                _a.sent();
                return [4 /*yield*/, sdk.api.endusers.updateOne(e.id, { assignedTo: [] }, { replaceObjectFields: true })];
            case 8:
            ...
            case 9:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("User not assinged on non-attendee event change", function () { return pollForResults(function () { return sdk.api.endusers.getOne(e.id); }, function (e) { var _a; return !((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.includes(userId)); }, 1000, 1); }, testing_1.passOnAnyResult)];
            case 10:
                _a.sent();
                return [2 /*return*/, Promise.all([
                        sdk.api.endusers.deleteOne(e.id),
...
var ticket_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                t = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Ticket tags coerced to empty array", function () { return sdk.api.tickets.getOne(t.id); }, { onResult: function (t) { return Array.isArray(t.tags) && t.tags.length === 0; } })];
            case 5:
                _a.sent();
...
var fromEmailOverride_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("fromEmailOvrride");
                return [4 /*yield*/, sdk.api.endusers.createOne({ email: 'test@tellescope.com' })];
            case 1:
                enduser = _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride missing", function () { return sdk.api.emails.createOne({
                        logOnly: true,
                        subject: 'test',
                        enduserId: enduser.id,
                        textContent: '',
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride missing bulk", function () { return sdk.api.emails.createSome([{
                            logOnly: true,
                            subject: 'test',
                            enduserId: enduser.id,
                            textContent: '',
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride My Email", function () { return sdk.api.emails.createOne({
                        logOnly: true,
                        subject: 'test',
                        enduserId: enduser.id,
                        textContent: '',
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride My Email (bulk)", function () { return sdk.api.emails.createSome([{
                            logOnly: true,
                            subject: 'test',
                            enduserId: enduser.id,
                            textContent: '',
            ...
            case 5:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride test@", function () { return sdk.api.emails.createOne({
                        logOnly: true,
                        subject: 'test',
                        enduserId: enduser.id,
                        textContent: '',
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride test@ bulk", function () { return sdk.api.emails.createSome([{
                            logOnly: true,
                            subject: 'test',
                            enduserId: enduser.id,
                            textContent: '',
            ...
            case 7:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride fail@", function () { return sdk.api.emails.createOne({
                        logOnly: true,
                        subject: 'test',
                        enduserId: enduser.id,
                        textContent: '',
            ...
            case 8:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("fromEmailOverride fail@ bulk", function () { return sdk.api.emails.createSome([{
                            logOnly: true,
                            subject: 'test',
                            enduserId: enduser.id,
                            textContent: '',
...
var get_templated_message_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Get Templated Message Tests");
...
var file_source_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("File Source Tests");
                return [4 /*yield*/, sdk.api.files.prepare_file_upload({
                        name: 'test',
            ...
            case 1:
                f = (_a.sent()).file;
                return [4 /*yield*/, (0, testing_1.async_test)("No filter returns value", function () { return sdk.api.files.getSome({}); }, { onResult: function (r) { return r.length === 1 && r[0].id === f.id; } })];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Filter by source returns value", function () { return sdk.api.files.getSome({ filter: { source: 'test' } }); }, { onResult: function (r) { return r.length === 1 && r[0].id === f.id; } })];
            case 3:
                _a.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Filter by differnt source returns no value", function () { return sdk.api.files.getSome({ filter: { source: 'other' } }); }, { onResult: function (r) { return r.length === 0; } })];
            case 4:
                _a.sent();
...
var replace_enduser_template_values_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, testing_1.log_header)("Replace Enduser Template Values Tests");
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: "Test", lname: "User", fields: { CustomField: "Enduser" } })];
            case 1:
                enduser = _a.sent();
                (0, testing_1.assert)((0, utilities_1.replace_enduser_template_values)('', enduser) === '', 'fail blank', 'blank');
                (0, testing_1.assert)((0, utilities_1.replace_enduser_template_values)('test', enduser) === 'test', 'fail test', 'test');
                (0, testing_1.assert)((0, utilities_1.replace_enduser_template_values)('{{enduser.fname}}', enduser) === 'Test', 'fail fname', 'fname');
                (0, testing_1.assert)((0, utilities_1.replace_enduser_template_values)('{{enduser.unknown}}', enduser) === '{{enduser.unknown}}', 'fail unknown', 'unknown');
                (0, testing_1.assert)((0, utilities_1.replace_enduser_template_values)('{{enduser.CustomField}}', enduser) === 'Enduser', 'fail CustomField', 'CustomField');
        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                deleteBuiltThreads = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var allBuiltThreadsForCleanup;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, sdk.api.inbox_threads.load_threads({})];
                            case 1:
                                allBuiltThreadsForCleanup = (_a.sent()).threads;
                                return [4 /*yield*/, Promise.all(allBuiltThreadsForCleanup.map(function (t) { return sdk.api.inbox_threads.deleteOne(t.id); }))];
                            case 2:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                start = new Date();
                i = 0 // to prevent rate limits for identical updates
                ;
                ...
                resetThreadsAndDates = function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, resetThreadBuildingDates()];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, deleteBuiltThreads()];
                            case 2:
                                _a.sent();
                                return [2 /*return*/];
                        }
            ...
            case 3:
                // start with reset dates  
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('build threads for empty range', function () { return sdk.api.inbox_threads.build_threads({ from: start, to: start }); }, { onResult: function (_a) {
                            var alreadyBuilt = _a.alreadyBuilt;
                            return alreadyBuilt;
                        } })];
            case 4:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('load threads (none built yet)', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
            ...
            case 5:
                _b.sent();
                readBy = (_a = {}, _a[sdk.userInfo.id] = new Date(), _a);
                defaultEmail = {
                    logOnly: true,
                    subject: 'Test Email',
                ...
                return [4 /*yield*/, sdk.api.emails.createOne(__assign(__assign({}, defaultEmail), { enduserId: e.id, readBy: readBy }))];
            case 6:
                email = _b.sent();
                return [4 /*yield*/, sdk.api.sms_messages.createOne(__assign(__assign({}, defaultSMS), { enduserId: e.id, readBy: readBy }))];
            case 7:
                sms = _b.sent();
                return [4 /*yield*/, sdk.api.group_mms_conversations.createOne({
                        enduserIds: [e.id],
            ...
            case 8:
                groupMMS = _b.sent();
                return [4 /*yield*/, sdk.api.phone_calls.createOne({ readBy: readBy, enduserId: e.id, inbound: true, isVoicemail: true, from: '+15555555554', to: '+15555555555' })];
            case 9:
                call = _b.sent();
                return [4 /*yield*/, sdk.api.chat_rooms.createOne({ enduserIds: [e.id], userIds: [], title: 'Thread Build Chat Room' })];
            case 10:
                room = _b.sent();
            ...
            case 12:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('build initial 1-message threads', function () { return sdk.api.inbox_threads.build_threads({ from: from, to: new Date() }); }, { onResult: function (_a) {
                            var alreadyBuilt = _a.alreadyBuilt;
                            return !alreadyBuilt;
                        } })];
            case 13:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('load threads', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return (threads.length === 5
                                && threads.some(function (t) { var _a; return t.type === 'Email' && t.emailMessageId === email.messageId && !(0, utilities_1.object_is_empty)((_a = t.readBy) !== null && _a !== void 0 ? _a : {}); })
                                && threads.some(function (t) { var _a; return t.type === 'SMS' && t.threadId === sms.id && !(0, utilities_1.object_is_empty)((_a = t.readBy) !== null && _a !== void 0 ? _a : {}); })
                                && threads.some(function (t) { var _a; return t.type === 'GroupMMS' && t.threadId === groupMMS.id && !(0, utilities_1.object_is_empty)((_a = t.readBy) !== null && _a !== void 0 ? _a : {}); })
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('re-load threads with no duplication across endusers', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            ...
                            return (threads.length === 15
                                ...
                                && threads.filter(function (t) {
                                    return t.enduserIds.length === 1 && t.enduserIds.includes(e.id)
                                        && (0, utilities_1.object_is_empty)(t.readBy || {});
                                }).length === 5
                                && threads.filter(function (t) { return t.enduserIds.length === 1 && t.enduserIds.includes(e2.id); }).length === 5);
                        } })
                    // test adding separate threads for the first enduser
                                ...
                                && threads.filter(function (t) {
                                    return t.enduserIds.length === 1 && t.enduserIds.includes(e.id)
                                        && (Object.keys(t.readBy || {}).length === 0 // defaults to unread
                                            || Object.values(t.readBy || {}).filter(function (r) { return !r; }).length > 0);
            ...
            case 43:
                ...
                // filter phone calls since those always create new threads
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('re-build threads minus initial set', function () { return sdk.api.inbox_threads.build_threads({ from: beforeSecondThreads, to: new Date() }); }, { onResult: function (_a) {
                            var alreadyBuilt = _a.alreadyBuilt;
                            return !alreadyBuilt;
                        } })];
            case 44:
            ...
            case 54:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('Test outbound timestamp and preview', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return (threads.length === 16 // only the new call should result in a new thread
                                &&
                                    threads
                                        .filter(function (t) {
...
var inbox_threads_loading_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                (0, testing_1.log_header)("Inbox Thread Loading Tests");
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: 'Test', lname: 'Testson' })];
            case 1:
                e1 = _g.sent();
                return [4 /*yield*/, sdk.api.endusers.createOne({ fname: 'Test2', lname: 'Testson2', assignedTo: [sdk.userInfo.id] })];
            case 2:
                e2 = _g.sent();
                defaultThreadFields = {
                    assignedTo: [],
                ...
                return [4 /*yield*/, sdk.api.inbox_threads.createSome([
                        __assign(__assign({}, defaultThreadFields), { title: 'Email', type: 'Email', threadId: '1' }),
                        __assign(__assign({}, defaultThreadFields), { title: 'SMS', type: 'SMS', threadId: '2', assignedTo: [sdk.userInfo.id] }),
                        __assign(__assign({}, defaultThreadFields), { title: 'Phone', type: 'Phone', threadId: '3', enduserIds: [e2.id] }),
                        __assign(__assign({}, defaultThreadFields), { title: 'Chat', type: 'Chat', threadId: '4', timestamp: new Date(0) }),
                        __assign(__assign({}, defaultThreadFields), { title: 'GroupMMS', type: 'GroupMMS', inboxStatus: "Resolved", threadId: '5' }),
                    ])];
            case 3:
                threads = (_g.sent()).created;
                email = threads[0], sms = threads[1], phone = threads[2], chat = threads[3], groupMMS = threads[4];
                // test access
                return [4 /*yield*/, (0, testing_1.async_test)('admin can load all threads', function () { return sdk.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 5;
                        } })];
            case 4:
                // test access
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('non-admin can load no threads', function () { return sdkNonAdmin.api.inbox_threads.load_threads({}); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 0;
                        } })];
            case 5:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('non-admin cant load threads by specifying other userId', function () { return sdkNonAdmin.api.inbox_threads.load_threads({ userIds: [sdk.userInfo.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 0;
                        } })];
            case 6:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('non-admin cant load threads by specifying enduserIds', function () { return sdkNonAdmin.api.inbox_threads.load_threads({ enduserIds: [e1.id, e2.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 0;
                        } })];
            case 7:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('admin limit', function () { return sdk.api.inbox_threads.load_threads({ limit: 1 }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 1;
                        } })];
            case 8:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('admin timestamp filter', function () { return sdk.api.inbox_threads.load_threads({ lastTimestamp: new Date(1) }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 1;
                        } })];
            case 9:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('admin enduserIds filter', function () { return sdk.api.inbox_threads.load_threads({ enduserIds: [e1.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 4;
                        } })];
            case 10:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('admin excludeIds filter', function () { return sdk.api.inbox_threads.load_threads({ excludeIds: [email.id, phone.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
                            return threads.length === 3;
                        } })];
            case 11:
                _g.sent();
                return [4 /*yield*/, (0, testing_1.async_test)('admin userIds self filter', function () { return sdk.api.inbox_threads.load_threads({ userIds: [sdk.userInfo.id] }); }, { onResult: function (_a) {
                            var threads = _a.threads;
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var apiUrl, fields, err_1, n, _a, _b, _c, _i, returnValidation, t, _d, _f, _g, _h, err_2;
    var _j, _k;
    return __generator(this, function (_l) {
        switch (_l.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, testing_1.async_test)("email-image tracking endpoint is live", function () { return axios_1.default.get("".concat(apiUrl, "/email-image/")); }, { onResult: function (result) { return result.data === TRACK_OPEN_IMAGE.toString('utf-8'); } })];
            case 1:
                _l.sent();
            ...
            case 4:
                _l.sent();
                fields = (0, utilities_1.get_flattened_fields)([
                    { otherField: '', insurance: { payerName: '' }, },
                    { insurance: { payerName: '' }, },
                    { insurance: {}, insuranceSecondary: {}, },
                    { insurance: {}, insuranceSecondary: { memberId: '' }, },
                ]);
                (0, testing_1.assert)((0, utilities_2.objects_equivalent)(fields, ['otherField', 'insurance.payerName', 'insuranceSecondary.memberId']), 'flattened object fields fail', 'flattened object fields');
                return [4 /*yield*/, Promise.all([
            ...
            case 100:
                ...
                _l.label = 101;
            case 101:
                if (!(_i < _b.length)) return [3 /*break*/, 104];
                _c = _b[_i];
                if (!(_c in _a)) return [3 /*break*/, 103];
                n = _c;
            ...
            case 104:
                ...
                _l.label = 105;
            case 105:
                if (!(_h < _f.length)) return [3 /*break*/, 110];
                _g = _f[_h];
                if (!(_g in _d)) return [3 /*break*/, 109];
                t = _g;
                _l.label = 106;
            case 106:
                _l.trys.push([106, 108, , 109]);
