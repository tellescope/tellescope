...
var switch_to_related_contacts_tests = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 6:
                _b.sent();
                return [4 /*yield*/, (0, testing_1.async_test)("Related contact got tags", function () { return pollForResults(function () { return sdk.api.endusers.getOne(parent.id); }, function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Success')); }, 50, 100); }, testing_1.passOnAnyResult)];
            case 7:
                _b.sent();
                return [2 /*return*/, Promise.all([
    ...
    return __generator(this, function (_l) {
        switch (_l.label) {
            ...
            case 87:
                ...
                _l.label = 88;
            case 88:
                if (!(_i < _b.length)) return [3 /*break*/, 91];
                _c = _b[_i];
                if (!(_c in _a)) return [3 /*break*/, 90];
                n = _c;
            ...
            case 91:
                ...
                _l.label = 92;
            case 92:
                if (!(_h < _f.length)) return [3 /*break*/, 97];
                _g = _f[_h];
                if (!(_g in _d)) return [3 /*break*/, 96];
                t = _g;
                _l.label = 93;
            case 93:
                _l.trys.push([93, 95, , 96]);
