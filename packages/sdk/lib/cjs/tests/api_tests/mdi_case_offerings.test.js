...
exports.mdi_case_offerings_tests = void 0;
...
var resolve_case_offerings = function (offerings, responses) { return (offerings.filter(function (o) {
    if (!o.conditions || is_empty_conditions(o.conditions))
        return true;
    return (0, utilities_1.evaluate_conditional_logic)(o.conditions, function (key, value) { var _a; return (0, utilities_1.evaluate_string_field_comparison)((_a = responses.find(function (r) { return r.externalId === key; })) === null || _a === void 0 ? void 0 : _a.value, value); });
})); };
...
var mdi_case_offerings_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("MDI Case Offerings Tests");
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, , 18, 21]);
                    // --- Schema round-trip tests ---
                    return [4 /*yield*/, (0, testing_1.async_test)("Create form with mdiCaseOfferings mixing unconditional and conditional entries", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 2:
                    // --- Schema round-trip tests ---
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Backwards-compat: existing flat { offering_id } config still validates", function () { return __awaiter(void 0, void 0, void 0, function () {
                            var flat, fetched;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Save nested CompoundFilter conditions on an offering and read back", function () { return __awaiter(void 0, void 0, void 0, function () {
                            var nested, fetched;
                            var _a, _b;
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Resolver returns exactly the matching subset plus unconditional offerings", function () { return __awaiter(void 0, void 0, void 0, function () {
                            var resolved;
                ...
                case 5:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Send none: when conditions match nothing, only unconditional offerings remain", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 6:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Backwards compat: all-unconditional config sends everything", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 7:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Empty/blank conditions object is treated as unconditional (always sent)", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 8:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("$or conditions: offering sent when any branch matches", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("$contains operator narrows offerings by substring match", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 10:
                    _b.sent();
                    // --- height/weight conversion tests ---
                    return [4 /*yield*/, (0, testing_1.async_test)("enduser_height_to_cm converts Inches → integer centimeters", function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                ...
                case 11:
                    // --- height/weight conversion tests ---
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("enduser_weight_to_kg converts Pounds → kilograms (float, 2dp)", function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                ...
                case 12:
                    _b.sent();
                    // --- case_questions exclusion tests ---
                    return [4 /*yield*/, (0, testing_1.async_test)("case_questions exclude patient-mapped fields but keep non-mapped clinical answers", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 13:
                    ...
                    _b.sent();
                    // --- displayed_options tests ---
                    return [4 /*yield*/, (0, testing_1.async_test)("multiple_choice response + matching field by _id → displayed_options equals field choices", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 14:
                    // --- displayed_options tests ---
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Dropdown response + matching field by externalId → displayed_options equals field choices", function () { return __awaiter(void 0, void 0, void 0, function () {
                            var fields, response, opts;
                            return __generator(this, function (_a) {
                                fields = [
                ...
                case 15:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("string/number response → displayed_options undefined even with field choices present", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 16:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("multiple_choice response with no matching field → displayed_options undefined (question still kept)", function () { return __awaiter(void 0, void 0, void 0, function () {
...
exports.mdi_case_offerings_tests = mdi_case_offerings_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.mdi_case_offerings_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
