        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 23:
                    ...
                    _k.sent();
                    // Test 10b: Room with empty string aboutEnduserId works (doesn't crash)
                    return [4 /*yield*/, (0, testing_1.async_test)("Handles room with empty string aboutEnduserId gracefully", function () { return sdkNonAdmin.api.chat_rooms.load_team_chat({}); }, {
