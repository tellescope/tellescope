...
exports.eom_procedure_codes_tests = void 0;
...
var eom_procedure_codes_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    (0, testing_1.log_header)("EOM FormResponse Procedure Codes Tests");
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('updateOne accepts procedureCodes and diagnosisCodes on FormResponse', function () { return sdk.api.form_responses.updateOne(formResponse_1.id, {
                ...
                case 5:
                    // ---------- FormResponse-level field tests (existing behavior) ----------
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('getOne returns persisted procedureCodes/diagnosisCodes', function () { return sdk.api.form_responses.getOne(formResponse_1.id); }, { onResult: function (r) {
                ...
                case 6:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('updateOne rejects FormResponse procedureCode with non-string code', function () { return sdk.api.form_responses.updateOne(formResponse_1.id, {
                            procedureCodes: [{ code: 12345, units: 1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 7:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('updateOne rejects FormResponse procedureCode with negative units', function () { return sdk.api.form_responses.updateOne(formResponse_1.id, {
                            procedureCodes: [{ code: 'G0019', units: -1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 8:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('updateOne rejects FormResponse diagnosisCode with non-string code', function () { return sdk.api.form_responses.updateOne(formResponse_1.id, {
                            diagnosisCodes: [{ code: 12345 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 9:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('updateOne can clear procedureCodes/diagnosisCodes with empty arrays via replaceObjectFields', function () { return sdk.api.form_responses.updateOne(formResponse_1.id, {
                            procedureCodes: [],
                            diagnosisCodes: [],
                ...
                case 10:
                    _c.sent();
                    // ---------- Form-level field validators ----------
                    return [4 /*yield*/, (0, testing_1.async_test)('forms.createOne accepts valid procedureCodes/diagnosisCodes', function () { return sdk.api.forms.createOne({
                ...
                case 11:
                    // ---------- Form-level field validators ----------
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('forms.createOne rejects procedureCode with non-string code', function () { return sdk.api.forms.createOne({
                            title: 'EOM Bad Form',
                            procedureCodes: [{ code: 12345, units: 1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 12:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('forms.createOne rejects procedureCode with negative units', function () { return sdk.api.forms.createOne({
                            title: 'EOM Bad Form',
                            procedureCodes: [{ code: 'G0019', units: -1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 13:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('forms.createOne rejects diagnosisCode with non-string code', function () { return sdk.api.forms.createOne({
                            title: 'EOM Bad Form',
                            diagnosisCodes: [{ code: 12345 }],
                        }); }, { shouldError: true, onError: function () { return true; } })
                ...
                case 15:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('prepare_form_response copies procedureCodes/diagnosisCodes from Form when no args', function () { return sdk.api.form_responses.prepare_form_response({
                ...
                case 16:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('persisted FormResponse retains Form codes after prepare', function () { return sdk.api.form_responses.getOne(preparedFromFormResponseId_1); }, { onResult: function (r) {
                                var _a, _b, _c, _d, _e;
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('prepare_form_response args override Form defaults', function () { return sdk.api.form_responses.prepare_form_response({
                            formId: formWithCodes_1.id,
                            enduserId: enduser.id,
                ...
                case 18:
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('persisted overridden FormResponse retains override codes', function () { return sdk.api.form_responses.getOne(overridePreparedResponseId_1); }, { onResult: function (r) {
                                var _a, _b, _c, _d;
                ...
                case 20:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('prepare_form_response with args on a Form lacking codes uses the args', function () { return sdk.api.form_responses.prepare_form_response({
                ...
                case 21:
                    _c.sent();
                    // ---------- prepare with no defaults and no args yields no codes ----------
                    return [4 /*yield*/, (0, testing_1.async_test)('prepare_form_response with no codes anywhere produces FormResponse without codes', function () { return sdk.api.form_responses.prepare_form_response({
                            formId: formWithoutCodes_1.id,
                            enduserId: enduser.id,
                        }); }, { onResult: function (r) {
                                createdFormResponseIds.push(r.response.id);
                ...
                case 22:
                    ...
                    _c.sent();
                    // ---------- prepare rejects bad code shapes ----------
                    return [4 /*yield*/, (0, testing_1.async_test)('prepare_form_response rejects procedureCode with non-string code', function () { return sdk.api.form_responses.prepare_form_response({
                            formId: formWithoutCodes_1.id,
                            enduserId: enduser.id,
                            procedureCodes: [{ code: 12345, units: 1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
                case 23:
                    // ---------- prepare rejects bad code shapes ----------
                    _c.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('prepare_form_response rejects procedureCode with negative units', function () { return sdk.api.form_responses.prepare_form_response({
                            formId: formWithoutCodes_1.id,
                            enduserId: enduser.id,
                            procedureCodes: [{ code: 'G0019', units: -1 }],
                        }); }, { shouldError: true, onError: function () { return true; } })];
...
exports.eom_procedure_codes_tests = eom_procedure_codes_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.eom_procedure_codes_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
