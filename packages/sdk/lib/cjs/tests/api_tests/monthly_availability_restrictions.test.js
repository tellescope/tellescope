...
exports.monthly_availability_restrictions_tests = void 0;
...
var monthly_availability_restrictions_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Monthly Availability Restrictions Tests");
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Regular availability generates blocks for all Mondays', function () { return Promise.resolve(regularAvailability_1); }, { onResult: function (r) {
                                ...
                                for (var _i = 0, testUserBlocks_1 = testUserBlocks; _i < testUserBlocks_1.length; _i++) {
                                    ...
                                    var blockDate = luxon_1.DateTime.fromMillis(block.startTimeInMS).setZone('America/New_York');
                ...
                case 7:
                    // Test 2: Monthly restriction to first Monday only
                    _b.sent();
                    longFromDate = luxon_1.DateTime.now().setZone('America/New_York').plus({ days: 1 }).startOf('day') // Tomorrow
                    ;
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Monthly restriction to first Monday generates fewer blocks', function () { return Promise.resolve(firstMondayOnlyAvailability_1); }, { onResult: function (r) {
                ...
                case 11:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Monthly restriction to 1st and 3rd Monday generates correct blocks', function () { return Promise.resolve(firstAndThirdMondayAvailability_1); }, { onResult: function (r) {
                ...
                case 14:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Monthly restriction works for weekend days (Saturday)', function () { return Promise.resolve(secondSaturdayAvailability_1); }, { onResult: function (r) {
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Monthly restriction handles 5th occurrence gracefully', function () { return Promise.resolve(fifthMondayAvailability_1); }, { onResult: function (r) {
                ...
                case 19:
                    // Test 6: Timezone-agnostic testing (West Coast)
                    _b.sent();
                    pacificFromDate = luxon_1.DateTime.now().setZone('America/Los_Angeles').plus({ days: 1 }).startOf('day');
                ...
                case 20:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Monthly restriction works correctly across different timezones', function () { return Promise.resolve(timezoneTestAvailability_1); }, { onResult: function (r) {
                                ...
                                for (var _i = 0, testUserBlocks_6 = testUserBlocks; _i < testUserBlocks_6.length; _i++) {
                                    ...
                                    var blockDate = luxon_1.DateTime.fromMillis(block.startTimeInMS).setZone('America/Los_Angeles');
                ...
                case 22:
                    ...
                    // Test the same restriction in Eastern time to verify consistency
                    _b.sent();
                    easternFromDate = luxon_1.DateTime.now().setZone('America/New_York').plus({ days: 1 }).startOf('day');
                ...
                case 23:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('Monthly restriction calculations are consistent across timezones', function () { return Promise.resolve(crossTimezoneTestAvailability_1); }, { onResult: function (r) {
                                var testUserBlocks = r.availabilityBlocks.filter(function (block) { return block.userId === sdk.userInfo.id; });
...
exports.monthly_availability_restrictions_tests = monthly_availability_restrictions_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.monthly_availability_restrictions_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
