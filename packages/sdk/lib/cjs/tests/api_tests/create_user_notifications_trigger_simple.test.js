...
exports.create_user_notifications_trigger_simple_tests = void 0;
...
var create_user_notifications_trigger_simple_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Create User Notifications Trigger - Simple Test");
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 6, 7, 22]);
                    // Test 1: Setup - Create enduser assigned to the authenticated user
                    return [4 /*yield*/, (0, testing_1.async_test)('setup - create test enduser assigned to authenticated user', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                ...
                case 3:
                    ...
                    _b.sent();
                    // Test 3: Create trigger for care team notifications
                    return [4 /*yield*/, (0, testing_1.async_test)('create trigger - care team notification', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var trigger;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 4:
                    ...
                    _b.sent();
                    // Test 4: Submit form and verify notification
                    return [4 /*yield*/, (0, testing_1.async_test)('submit form - verify notification created', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var i, notifications;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
...
exports.create_user_notifications_trigger_simple_tests = create_user_notifications_trigger_simple_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.create_user_notifications_trigger_simple_tests)({ sdk: sdk_2 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
