...
exports.purchase_made_trigger_tests = void 0;
var sdk_1 = require("../../sdk");
var testing_1 = require("@tellescope/testing");
var setup_1 = require("../setup");
var host = process.env.API_URL || "http://localhost:8080";
var purchase_made_trigger_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Automation Trigger Tests (Purchase Made)");
                ...
                case 27:
                    purchase1 = _b.sent();
                    return [4 /*yield*/, (0, testing_1.wait)(undefined, 500)]; // Brief wait for trigger processing
                case 28:
                    _b.sent(); // Brief wait for trigger processing
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Any Purchase", function () { return sdk.api.endusers.getOne(enduser1.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Any')); } })
                ...
                case 31:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Exact Title Match", function () { return sdk.api.endusers.getOne(enduser2.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Exact-Title')); } })
                ...
                case 34:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Product ID Match", function () { return sdk.api.endusers.getOne(enduser3.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Product-ID')); } })
                ...
                case 37:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Partial Title Match (case insensitive 'course')", function () { return sdk.api.endusers.getOne(enduser4.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Partial-Course')); } })
                ...
                case 40:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Partial Title Match (case insensitive 'ANALYTICS')", function () { return sdk.api.endusers.getOne(enduser5.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Partial-Analytics')); } })
                ...
                case 43:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - No Partial Title Match", function () { return sdk.api.endusers.getOne(enduser6.id); }, { onResult: function (e) { var _a, _b, _c; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Any')) && !((_b = e.tags) === null || _b === void 0 ? void 0 : _b.includes('Purchase-Partial-Course')) && !((_c = e.tags) === null || _c === void 0 ? void 0 : _c.includes('Purchase-Partial-Analytics')); } })
                ...
                case 46:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Mixed Case Partial Title Match", function () { return sdk.api.endusers.getOne(enduser7.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Partial-Course')); } })
                ...
                case 49:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Multiple Partial Matches (matches 'premium')", function () { return sdk.api.endusers.getOne(enduser8.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Multiple-Partial')); } })
                ...
                case 52:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Multiple Partial Matches (matches 'advanced')", function () { return sdk.api.endusers.getOne(enduser9.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Multiple-Partial')); } })
                ...
                case 55:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Case Insensitive (lowercase filter 'mixed' matches 'MIXED')", function () { return sdk.api.endusers.getOne(enduser10.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Case-Test')); } })
                ...
                case 58:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Case Insensitive (uppercase filter 'UPPER' matches 'upper')", function () { return sdk.api.endusers.getOne(enduser11.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Case-Test')); } })
                ...
                case 61:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Purchase Made - Case Insensitive (mixed case filter 'MiXeD' matches 'MiXeD')", function () { return sdk.api.endusers.getOne(enduser12.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('Purchase-Case-Test')); } })
...
exports.purchase_made_trigger_tests = purchase_made_trigger_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.purchase_made_trigger_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
