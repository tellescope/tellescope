...
exports.calendar_event_limits_tests = exports.calendar_event_limits_unit_tests = void 0;
...
var calendar_event_limits_unit_tests = function () {
    var tests = [];
...
var calendar_event_limits_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Calendar Event Limits Tests");
                    // Run unit tests first
                    (0, testing_1.log_header)("Calendar Event Limits - Unit Tests");
                    unitTests = (0, exports.calendar_event_limits_unit_tests)();
                    _loop_1 = function (test_1) {
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [4 /*yield*/, (0, testing_1.async_test)(test_1.name, function () { return Promise.resolve(test_1.fn()); }, {})];
                                case 1:
                                    _c.sent();
                                    return [2 /*return*/];
                            }
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    (0, testing_1.log_header)("Calendar Event Limits - Integration Tests");
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('After booking 1 event with 1/day limit - Monday availability removed', function () { return Promise.resolve(availabilityAfterBooking_1); }, { onResult: function (r) {
                                ...
                                var mondayBlocks = userBlocks.filter(function (b) {
                                    var blockDate = luxon_1.DateTime.fromMillis(b.startTimeInMS).setZone('America/New_York');
...
exports.calendar_event_limits_tests = calendar_event_limits_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.calendar_event_limits_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
