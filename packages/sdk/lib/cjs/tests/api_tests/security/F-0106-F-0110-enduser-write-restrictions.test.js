...
exports.enduser_write_restrictions_tests = void 0;
 ...
 */
var enduser_write_restrictions_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    (0, testing_1.log_header)("F-0106/F-0110: enduser write restrictions (enduserUpdatesDisabled)");
                    _k.label = 1;
                case 1:
                ...
                case 6:
                    ...
                    _loop_1 = function (field, value) {
                        return __generator(this, function (_l) {
                            switch (_l.label) {
                                case 0: return [4 /*yield*/, (0, testing_1.async_test)("F-0106: enduser cannot self-update endusers.".concat(field), function () {
                                        var _a;
                ...
                return [4 /*yield*/, (0, testing_1.async_test)('F-0106: rejected assignedTo write did not persist', function () { return sdk.api.endusers.getOne(enduser_1.id); }, { onResult: function (e) { var _a, _b; return !((_a = e.assignedTo) === null || _a === void 0 ? void 0 : _a.length) && !((_b = e.tags) === null || _b === void 0 ? void 0 : _b.length) && e.externalId === undefined; } })
                ...
                case 11:
                    ...
                    _loop_2 = function (field, value) {
                        return __generator(this, function (_m) {
                            switch (_m.label) {
                                case 0: return [4 /*yield*/, (0, testing_1.async_test)("F-0110: enduser cannot self-update form_responses.".concat(field), function () {
                                        var _a;
                ...
                case 14:
                    _d++;
                    return [3 /*break*/, 12];
                case 15: return [4 /*yield*/, (0, testing_1.async_test)('F-0110: rejected writes did not persist (markedAsSubmitted, procedureCodes, submittedBy)', function () { return sdk.api.form_responses.getOne(formResponse_1.id); }, { onResult: function (fr) { var _a; return !fr.markedAsSubmitted && !((_a = fr.procedureCodes) === null || _a === void 0 ? void 0 : _a.length) && fr.submittedBy === undefined; } })
                    // ---- Positive controls: intended enduser self-updates still work ----
                ];
                case 16:
                    _k.sent();
                    // ---- Positive controls: intended enduser self-updates still work ----
                    return [4 /*yield*/, (0, testing_1.async_test)('enduser can still update own profile fields (fname/lname)', function () { return enduserSDK_1.api.endusers.updateOne(enduser_1.id, { fname: 'StillAllowed', lname: 'Patient' }); }, { onResult: function (e) { return e.fname === 'StillAllowed' && e.lname === 'Patient'; } })];
                case 17:
                    // ---- Positive controls: intended enduser self-updates still work ----
                    _k.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('enduser can still update own form_response (hideFromEnduserPortal — intended per schema)', function () { return enduserSDK_1.api.form_responses.updateOne(formResponse_1.id, { hideFromEnduserPortal: true }); }, { onResult: function (fr) { return fr.hideFromEnduserPortal === true; } })
                        // ---- Positive controls: staff sessions are unaffected by enduserUpdatesDisabled ----
                    ];
                case 18:
                    _k.sent();
                    // ---- Positive controls: staff sessions are unaffected by enduserUpdatesDisabled ----
                    return [4 /*yield*/, (0, testing_1.async_test)('staff can still update restricted endusers fields (tags, assignedTo, externalId, note, source)', function () { return sdk.api.endusers.updateOne(enduser_1.id, {
                            tags: ['staff-set-tag'],
                ...
                case 19:
                    // ---- Positive controls: staff sessions are unaffected by enduserUpdatesDisabled ----
                    _k.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('staff can still update restricted form_responses fields (procedureCodes, diagnosisCodes, tags)', function () { return sdk.api.form_responses.updateOne(formResponse_1.id, {
...
exports.enduser_write_restrictions_tests = enduser_write_restrictions_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.enduser_write_restrictions_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
