...
exports.mdi_webhooks_tests = void 0;
 ...
 * static Authorization token, then verifies the HMAC Signature, BEFORE any DB
 * write or side effect. These tests assert those rejection paths, which don't
 * require a configured MDI integration.
 *
 ...
 * integration row carrying webhooksSecret + authentication.info.webhook_authorization.
 ...
 */
var mdi_webhooks_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("MD Integrations Webhooks Tests");
                    return [4 /*yield*/, postMDI({ event_type: 'case_approved', case_id: 'mdi-case-test-1' })];
                case 1:
                    status_1 = (_b.sent()).status;
                    (0, testing_1.assert)(status_1 === 401, "missing Authorization should 401 (got ".concat(status_1, ")"), "MDI webhook rejects missing Authorization");
                ...
                case 2:
                    ...
                    (0, testing_1.assert)(status_2 === 401, "unknown Authorization should 401 (got ".concat(status_2, ")"), "MDI webhook rejects unknown Authorization");
                ...
                case 3:
                    ...
                    (0, testing_1.assert)(status_3 === 400 || status_3 === 401, "missing event_type should 400/401 (got ".concat(status_3, ")"), "MDI webhook rejects payload without event_type");
                ...
                case 4:
                    ...
                    (0, testing_1.assert)(status_4 === 401, "message_created with bad auth should 401 (got ".concat(status_4, ")"), "MDI webhook authenticates before patient lookup");
                    return [2 /*return*/];
            }
        });
    });
};
exports.mdi_webhooks_tests = mdi_webhooks_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.mdi_webhooks_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
