...
exports.ai_conversations_tests = void 0;
...
var ai_conversations_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("AI Conversations Tests");
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversation created successfully", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 2:
                    _b.sent();
                    // Test 2: Read the created AIConversation
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversation can be read", function () { return sdk.api.ai_conversations.getOne(conversation.id); }, { onResult: function (c) { return (c.id === conversation.id
                                && c.type === 'test-conversation'
                                && c.messages.length === 1); } })
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversation update appends messages (without replaceObjectFields)", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 4:
                    _b.sent();
                    // Test 4: Verify replaceObjectFields: true is blocked
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversation update with replaceObjectFields: true is blocked", function () { return sdk.api.ai_conversations.updateOne(conversation.id, { messages: [appendedMessage] }, { replaceObjectFields: true }); }, {
                            shouldError: true,
                            onError: function (e) {
                                var _a, _b;
                ...
                case 5:
                    ...
                    _b.sent();
                    // Test 5: Verify messages are still intact after blocked update attempt
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversation messages preserved after blocked replaceObjectFields attempt", function () { return sdk.api.ai_conversations.getOne(conversation.id); }, { onResult: function (c) { return (c.messages.length === 2
                                && c.messages[0].text === testMessage.text
                                && c.messages[1].text === appendedMessage.text); } })
                ...
                case 6:
                    ...
                    _b.sent();
                    // Test 6: Can set orchestrationId via update
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversation orchestrationId can be set via update", function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.ai_conversations.updateOne(conversation.id, {
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("AIConversations can be queried by orchestrationId", function () { return sdk.api.ai_conversations.getSome({ filter: { orchestrationId: testOrchestrationId } }); }, { onResult: function (conversations) { return (conversations.length === 2
...
exports.ai_conversations_tests = ai_conversations_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.ai_conversations_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
