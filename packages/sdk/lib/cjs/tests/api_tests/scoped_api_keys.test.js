        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 8:
                    ...
                    (0, testing_1.assert)(headerResult.status === 200 && !!((_f = headerResult.data) === null || _f === void 0 ? void 0 : _f.formResponseId), "scoped key header auth failed: ".concat(headerResult.status, " ").concat(JSON.stringify(headerResult.data)), "scoped key authenticates the form-ingestion webhook via header");
                ...
                case 9:
                    pathResult = _k.sent();
                    (0, testing_1.assert)(pathResult.status === 200 && !!((_h = pathResult.data) === null || _h === void 0 ? void 0 : _h.formResponseId), "scoped key path auth failed: ".concat(pathResult.status, " ").concat(JSON.stringify(pathResult.data)), "scoped key authenticates the form-ingestion webhook via path segment");
                ...
                case 16:
                    otherSdk_1 = new (_c.apply(sdk_1.Session, [void 0, (_e.authToken = (_k.sent()).authToken,
                            _e)]))();
