...
exports.trigger_set_fields_date_difference_tests = void 0;
...
var trigger_set_fields_date_difference_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Trigger Set Fields Date Difference Tests");
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 9, 10, 18]);
                    // Test 1: Setup - Create enduser with date fields
                    return [4 /*yield*/, (0, testing_1.async_test)('setup - create test enduser with date fields', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var _a, _b;
                ...
                case 2:
                    ...
                    _b.sent();
                    // Test 2: Create trigger with Date Difference - ISO to MM-DD-YYYY
                    return [4 /*yield*/, (0, testing_1.async_test)('create trigger - date difference between two custom fields', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var trigger;
                ...
                case 3:
                    ...
                    _b.sent();
                    // Test 3: Trigger the action and verify calculation
                    return [4 /*yield*/, (0, testing_1.async_test)('trigger action - verify date difference is calculated correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 4:
                    ...
                    _b.sent();
                    // Test 4: Test with $now
                    return [4 /*yield*/, (0, testing_1.async_test)('create trigger - date difference with $now', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var trigger;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                ...
                case 5:
                    ...
                    _b.sent();
                    // Test 5: Trigger with $now and verify
                    return [4 /*yield*/, (0, testing_1.async_test)('trigger action - verify $now works correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 6:
                    ...
                    _b.sent();
                    // Test 6: Test with hardcoded date strings
                    return [4 /*yield*/, (0, testing_1.async_test)('create trigger - date difference with hardcoded dates', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var trigger;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                ...
                case 7:
                    ...
                    _b.sent();
                    // Test 7: Trigger with hardcoded dates and verify
                    return [4 /*yield*/, (0, testing_1.async_test)('trigger action - verify hardcoded dates work correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
...
exports.trigger_set_fields_date_difference_tests = trigger_set_fields_date_difference_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.trigger_set_fields_date_difference_tests)({ sdk: sdk_2 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
