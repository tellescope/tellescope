...
exports.group_event_attendee_status_triggers_tests = void 0;
...
var group_event_attendee_status_triggers_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    (0, testing_1.log_header)("Automation Trigger Tests (Group Event Per-Attendee Status)");
                    createdTriggerIds = [];
                    createdEnduserIds = [];
                    createdEventIds = [];
                ...
                case 5:
                    _loop_1 = function (status_2) {
                        ...
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    (0, testing_1.log_header)("Per-attendee '".concat(status_2, "' in a group event"));
                                ...
                                case 6:
                                    ...
                                    // 1 + 2. True positive / no false negative: target has the correct tag
                                    return [4 /*yield*/, (0, testing_1.async_test)("'".concat(status_2, "' fires its trigger for the target attendee"), function () { return tagsOf(target.id); }, { onResult: function (tags) { return tags.includes(TAG[status_2]); } })
                                ...
                                case 7:
                                    ...
                                    _g.sent();
                                    // 3. No false positive (wrong trigger): target has none of the other status tags
                                    return [4 /*yield*/, (0, testing_1.async_test)("'".concat(status_2, "' does NOT fire any other status trigger for the target"), function () { return tagsOf(target.id); }, { onResult: function (tags) { return ALL_STATUSES.every(function (s) { return s === status_2 || !tags.includes(TAG[s]); }); } })
                                ...
                                case 8:
                                    ...
                                    _g.sent();
                                    // 4. No false positive (collateral): bystanders received zero tags
                                    return [4 /*yield*/, (0, testing_1.async_test)("'".concat(status_2, "' does NOT fire for bystander attendee #1"), function () { return sdk.api.endusers.getOne(bystander1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })];
                                case 9:
                                    // 4. No false positive (collateral): bystanders received zero tags
                                    _g.sent();
                                    return [4 /*yield*/, (0, testing_1.async_test)("'".concat(status_2, "' does NOT fire for bystander attendee #2"), function () { return sdk.api.endusers.getOne(bystander2.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })];
                                case 10:
                                    _g.sent();
                                    return [2 /*return*/];
                            }
                ...
                case 9:
                    ...
                    // ============================================================
                    (0, testing_1.log_header)("Multiple distinct per-attendee statuses in one group event");
                    return [4 /*yield*/, createEnduser()];
                case 10:
                ...
                case 15:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.wait)(undefined, 1000)]; // allow all triggers to fire
                case 16:
                    _f.sent(); // allow all triggers to fire
                    return [4 /*yield*/, (0, testing_1.async_test)("mixed: Completed attendee gets only the Completed tag", function () { return tagsOf(aCompleted_1.id); }, { onResult: function (tags) { return tags.includes(TAG['Completed']) && ALL_STATUSES.every(function (s) { return s === 'Completed' || !tags.includes(TAG[s]); }); } })];
                case 17:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("mixed: No-showed attendee gets only the No-showed tag", function () { return tagsOf(bNoShow_1.id); }, { onResult: function (tags) { return tags.includes(TAG['No-showed']) && ALL_STATUSES.every(function (s) { return s === 'No-showed' || !tags.includes(TAG[s]); }); } })];
                case 18:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("mixed: Cancelled attendee gets only the Cancelled tag", function () { return tagsOf(cCancelled_1.id); }, { onResult: function (tags) { return tags.includes(TAG['Cancelled']) && ALL_STATUSES.every(function (s) { return s === 'Cancelled' || !tags.includes(TAG[s]); }); } })];
                case 19:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("mixed: unset attendee receives no tags", function () { return sdk.api.endusers.getOne(dUnset_1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                        // ============================================================
                ...
                case 20:
                    ...
                    // from the cancelledGroupAttendees add/remove, and bystanders never fire.
                    // ============================================================
                    (0, testing_1.log_header)("Per-attendee status transitions fire the new status only");
                    return [4 /*yield*/, createEnduser()];
                case 21:
                    transA_1 = _f.sent();
                    return [4 /*yield*/, createEnduser()];
                ...
                case 25:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("transition step 1: No-showed fires No-showed", function () { return tagsOf(transA_1.id); }, { onResult: function (tags) { return tags.includes(TAG['No-showed']); } })];
                case 26:
                    _f.sent();
                ...
                case 28:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("transition No-showed -> Completed fires Completed (No-showed tag retained, no Cancelled)", function () { return tagsOf(transA_1.id); }, { onResult: function (tags) {
                ...
                case 29:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("transition (mirrored->unmirrored): bystander never fires", function () { return sdk.api.endusers.getOne(transABystander_1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                        // unmirrored -> mirrored
                    ];
                case 30:
                    _f.sent();
                ...
                case 37:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("transition Completed -> No-showed fires No-showed (Completed tag retained, no Cancelled)", function () { return tagsOf(transB_1.id); }, { onResult: function (tags) {
                ...
                case 38:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("transition (unmirrored->mirrored): bystander never fires", function () { return sdk.api.endusers.getOne(transBBystander_1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                        // ============================================================
                ...
                case 39:
                    ...
                    // note returned with this change about whether by:'user' SHOULD fire here.
                    // ============================================================
                    (0, testing_1.log_header)("Per-attendee Cancelled respects 'by' filter");
                    return [4 /*yield*/, sdk.api.automation_triggers.createOne({
                ...
                case 46:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("per-attendee cancel fires the unfiltered (by: undefined) Cancelled trigger", function () { return tagsOf(byTarget_1.id); }, { onResult: function (tags) { return tags.includes(TAG['Cancelled']); } })];
                case 47:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("per-attendee cancel does NOT fire by:'enduser' Cancelled trigger", function () { return tagsOf(byTarget_1.id); }, { onResult: function (tags) { return !tags.includes('Group Attendee Cancelled by:enduser'); } })];
                case 48:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("per-attendee cancel does NOT fire by:'user' Cancelled trigger (statusChangeSource unset)", function () { return tagsOf(byTarget_1.id); }, { onResult: function (tags) { return !tags.includes('Group Attendee Cancelled by:user'); } })];
                case 49:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("'by' filter case: bystander never fires", function () { return sdk.api.endusers.getOne(byBystander_1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                        // ============================================================
                ...
                case 50:
                    ...
                    // the legacy cancelledGroupAttendees branch is suppressed by the attendeeStatuses filter).
                    // ============================================================
                    (0, testing_1.log_header)("bulk_update cancel_for_attendee fires Cancelled for attendee");
                    return [4 /*yield*/, createEnduser()];
                case 51:
                ...
                case 56:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("cancel_for_attendee fires Cancelled trigger for the target", function () { return tagsOf(bulkTarget_1.id); }, { onResult: function (tags) { return tags.includes(TAG['Cancelled']); } })];
                case 57:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("cancel_for_attendee does NOT fire for the bystander", function () { return sdk.api.endusers.getOne(bulkBystander_1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                        // ============================================================
                ...
                case 58:
                    ...
                    // 'Confirmed' and clearing a status fire nothing.
                    // ============================================================
                    (0, testing_1.log_header)("Confirmed / cleared statuses fire no triggers");
                    return [4 /*yield*/, createEnduser()];
                case 59:
                ...
                case 65:
                    _f.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("'Confirmed' status fires no trigger", function () { return sdk.api.endusers.getOne(confirmEnduser_1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 66:
                    ...
                    // clearEnduser previously got the No-showed tag (that firing is expected); clearing must not
                    // add anything new. Assert it still has exactly the one No-showed tag and nothing else.
                    return [4 /*yield*/, (0, testing_1.async_test)("clearing a status fires no additional trigger", function () { return tagsOf(clearEnduser_1.id); }, { onResult: function (tags) { return tags.length === 1 && tags.includes(TAG['No-showed']); } })];
                case 67:
                    // clearEnduser previously got the No-showed tag (that firing is expected); clearing must not
                    // add anything new. Assert it still has exactly the one No-showed tag and nothing else.
                    _f.sent();
...
exports.group_event_attendee_status_triggers_tests = group_event_attendee_status_triggers_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.group_event_attendee_status_triggers_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
