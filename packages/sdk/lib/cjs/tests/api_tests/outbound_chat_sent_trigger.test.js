...
exports.outbound_chat_sent_trigger_tests = void 0;
...
var outbound_chat_sent_trigger_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                case 0:
                    (0, testing_1.log_header)("Outbound Chat Sent Trigger Tests");
                ...
                case 6:
                    ...
                    endSoloSDK = new sdk_1.EnduserSession({ host: host, authToken: tokenSolo, businessId: sdk.userInfo.businessId });
                    return [4 /*yield*/, sdk.api.endusers.generate_auth_token({ id: endA.id })];
                case 7:
                    tokenA = (_o.sent()).authToken;
                    endASDK = new sdk_1.EnduserSession({ host: host, authToken: tokenA, businessId: sdk.userInfo.businessId });
                ...
                case 32:
                    ...
                    endAutoreplySDK = new sdk_1.EnduserSession({ host: host, authToken: tokenAR, businessId: sdk.userInfo.businessId });
                    return [4 /*yield*/, sdk.api.chat_rooms.createOne({
                            userIds: [sdk.userInfo.id],
                ...
                case 34:
                    ...
                    // Autoreply path involves an extra org/user lookup + insert before
                    // handle_chat_create re-runs against the autoreply chat.
                    return [4 /*yield*/, (0, testing_1.wait)(undefined, 4000)];
                case 35:
                    // Autoreply path involves an extra org/user lookup + insert before
                    // handle_chat_create re-runs against the autoreply chat.
                    _o.sent();
...
exports.outbound_chat_sent_trigger_tests = outbound_chat_sent_trigger_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.outbound_chat_sent_trigger_tests)({ sdk: sdk_2 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
