        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    (0, testing_1.log_header)("Test 0: Healthie proxy_read endpoints reject non-admins");
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("proxy_read healthie patients - should block non-admin user", function () { return sdkNonAdmin.api.integrations.proxy_read({ integration: 'Healthie', type: 'patients' }); }, { shouldError: true, onError: function (e) { return e.message === "Admin access required"; } })];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("proxy_read healthie appointment-types - should block non-admin user", function () { return sdkNonAdmin.api.integrations.proxy_read({ integration: 'Healthie', type: 'appointment-types' }); }, { shouldError: true, onError: function (e) { return e.message === "Admin access required"; } })
