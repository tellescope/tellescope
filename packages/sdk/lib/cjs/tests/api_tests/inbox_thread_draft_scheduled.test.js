        ...
        return __generator(this, function (_x) {
            switch (_x.label) {
                ...
                case 8:
                    ...
                    (0, testing_1.assert)(!smsThread.isDraftOnlyThread, "isDraftOnlyThread should be falsy for threads with sent messages. Got: ".concat(smsThread.isDraftOnlyThread));
                ...
                case 15:
                    ...
                    (0, testing_1.assert)(!emailThread.isDraftOnlyThread, "isDraftOnlyThread should be falsy for threads with sent messages. Got: ".concat(emailThread.isDraftOnlyThread));
                ...
                case 21:
                    ...
                    (0, testing_1.assert)(draftOnlyThread.isDraftOnlyThread === true, "isDraftOnlyThread should be true for draft-only threads. Got: ".concat(draftOnlyThread.isDraftOnlyThread));
                ...
                case 24:
                    ...
                    (0, testing_1.assert)(!!draftOnlyEmailThread, "Draft-only email thread should be found");
                    (0, testing_1.assert)(((_m = draftOnlyEmailThread.draftMessageIds) === null || _m === void 0 ? void 0 : _m.includes(draftOnlyEmail.id)) === true, "Draft Email ID should be in draftMessageIds. Got: ".concat(JSON.stringify(draftOnlyEmailThread.draftMessageIds)));
                    // When only drafts exist, the draft is used as fallback for preview
                    (0, testing_1.assert)(((_o = draftOnlyEmailThread.preview) === null || _o === void 0 ? void 0 : _o.includes("draft-only email")) === true, "Preview should fall back to draft when no sent messages exist. Got: ".concat(draftOnlyEmailThread.preview));
                    (0, testing_1.assert)(draftOnlyEmailThread.isDraftOnlyThread === true, "isDraftOnlyThread should be true for draft-only threads. Got: ".concat(draftOnlyEmailThread.isDraftOnlyThread));
                ...
                case 28:
                    ...
                    (0, testing_1.assert)(!sentOnlyThread.isDraftOnlyThread, "isDraftOnlyThread should be falsy for threads with sent messages. Got: ".concat(sentOnlyThread.isDraftOnlyThread));
                ...
                case 33:
                    ...
                    (0, testing_1.assert)(!chatThreadBefore_1.isDraftOnlyThread, "isDraftOnlyThread should be falsy for chat threads with sent messages. Got: ".concat(chatThreadBefore_1.isDraftOnlyThread));
                ...
                case 35:
                    ...
                    (0, testing_1.assert)(((_p = chatThreadWithDraft.draftMessageIds) === null || _p === void 0 ? void 0 : _p.includes(draftChat.id)) === true, "Draft chat ID should be in draftMessageIds after manual setup. Got: ".concat(JSON.stringify(chatThreadWithDraft.draftMessageIds)));
                ...
                case 38:
                    ...
                    (0, testing_1.assert)(((_q = chatThreadAfter.draftMessageIds) === null || _q === void 0 ? void 0 : _q.includes(draftChat.id)) === false, "Draft chat ID should be REMOVED from draftMessageIds after send. Got: ".concat(JSON.stringify(chatThreadAfter.draftMessageIds)));
                ...
                case 43:
                    ...
                    (0, testing_1.assert)(((_r = smsDeleteThread_1.draftMessageIds) === null || _r === void 0 ? void 0 : _r.includes(draftSmsToDelete.id)) === true, "Draft SMS ID should be in draftMessageIds before deletion. Got: ".concat(JSON.stringify(smsDeleteThread_1.draftMessageIds)));
                ...
                case 46:
                    ...
                    (0, testing_1.assert)(((_s = smsDeleteThreadAfter.draftMessageIds) === null || _s === void 0 ? void 0 : _s.includes(draftSmsToDelete.id)) === false, "Draft SMS ID should be REMOVED from draftMessageIds after deletion. Got: ".concat(JSON.stringify(smsDeleteThreadAfter.draftMessageIds)));
                ...
                case 50:
                    ...
                    (0, testing_1.assert)(((_t = emailDeleteThread_1.draftMessageIds) === null || _t === void 0 ? void 0 : _t.includes(draftEmailToDelete.id)) === true, "Draft Email ID should be in draftMessageIds before deletion. Got: ".concat(JSON.stringify(emailDeleteThread_1.draftMessageIds)));
                ...
                case 53:
                    ...
                    (0, testing_1.assert)(((_u = emailDeleteThreadAfter.draftMessageIds) === null || _u === void 0 ? void 0 : _u.includes(draftEmailToDelete.id)) === false, "Draft Email ID should be REMOVED from draftMessageIds after deletion. Got: ".concat(JSON.stringify(emailDeleteThreadAfter.draftMessageIds)));
                ...
                case 60:
                    ...
                    (0, testing_1.assert)(((_v = chatDeleteThreadWithDraft.draftMessageIds) === null || _v === void 0 ? void 0 : _v.includes(draftChatToDelete.id)) === true, "Draft chat ID should be in draftMessageIds after manual setup. Got: ".concat(JSON.stringify(chatDeleteThreadWithDraft.draftMessageIds)));
                ...
                case 63:
                    ...
                    (0, testing_1.assert)(((_w = chatDeleteThreadAfter.draftMessageIds) === null || _w === void 0 ? void 0 : _w.includes(draftChatToDelete.id)) === false, "Draft Chat ID should be REMOVED from draftMessageIds after deletion. Got: ".concat(JSON.stringify(chatDeleteThreadAfter.draftMessageIds)));
                ...
                case 64:
                    ...
                    _x.sent();
                    // ===== Attachment-Only Preview Tests =====
                    (0, testing_1.log_header)("Attachment-Only Preview Tests");
                ...
                case 70:
                    ...
                    (0, testing_1.assert)(!!attachmentThread, "Attachment test chat thread should be found");
                    (0, testing_1.assert)(attachmentThread.preview === '[Attachment]', "Preview should be \"[Attachment]\" for attachment-only messages. Got: \"".concat(attachmentThread.preview, "\""));
