        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    rbapFull = _b.sent();
                    // Verify color/description persist and round-trip via getOne
                    return [4 /*yield*/, (0, testing_1.async_test)("role_based_access_permissions - color and description persist on create/read", function () { return sdk.api.role_based_access_permissions.getOne(rbapFull.id); }, {
                ...
                case 30:
                    e_1 = _b.sent();
                    return [3 /*break*/, 31];
                case 31: return [4 /*yield*/, (0, testing_1.async_test)("createOne (admin) - all fields should be visible in response", function () { return sdk.api.phone_calls.createOne({
                        enduserId: testEnduser.id,
                        inbound: false,
                        from: '+15553333333',
                        to: '+15554444444',
