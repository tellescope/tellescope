        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 19:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Dashboard with all built-in block types created correctly", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 21:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Unknown top-level block fields stripped, info preserved", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 25:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Dashboard with top-level type created correctly", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 26:
                    _d.sent();
                    // Test 7c: Dashboards without type still work (backwards compatibility)
                    return [4 /*yield*/, (0, testing_1.async_test)("Dashboard without type has undefined type", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 28:
                    updatedType = _d.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Dashboard type updated correctly", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 30:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Dashboards filtered by type via filter", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 31:
                    _d.sent();
                    // Test 7f: Filter dashboards by type via mdbFilter
                    return [4 /*yield*/, (0, testing_1.async_test)("Dashboards filtered by type via mdbFilter", function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                ...
                case 43:
                    sdkRestricted = new (_b.apply(sdk_1.Session, [void 0, (_c.authToken = (_d.sent()).authToken,
                            _c)]))();
                    return [4 /*yield*/, (0, testing_1.async_test)('test_authenticated (restricted dashboard user)', sdkRestricted.test_authenticated, { expectedResult: 'Authenticated!' })];
                case 44:
                    _d.sent();
                    return [4 /*yield*/, sdk.api.custom_dashboards.createOne({
                ...
                case 48:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Restricted user sees org-wide and assigned dashboards only", function () { return sdkRestricted.api.custom_dashboards.getSome({ filter: {} }); }, {
                ...
                case 49:
                    _d.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Restricted user can read org-wide dashboard by id", function () { return sdkRestricted.api.custom_dashboards.getOne(orgWideDashboard.id); }, { onResult: function (r) { return r.id === orgWideDashboard.id && r.visibleToAllUsers === true; } })];
                case 50:
                    _d.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Restricted user cannot read unshared dashboard by id", function () { return sdkRestricted.api.custom_dashboards.getOne(hiddenDashboard.id); }, { shouldError: true, onError: function () { return true; } })
                ...
                case 52:
                    // Toggling the flag on takes effect for the restricted user
                    _d.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Restricted user can read dashboard after visibleToAllUsers enabled", function () { return sdkRestricted.api.custom_dashboards.getOne(hiddenDashboard.id); }, { onResult: function (r) { return r.id === hiddenDashboard.id; } })
                        // Admin continues to see everything, including unshared dashboards
                    ];
                case 53:
                    _d.sent();
                    // Admin continues to see everything, including unshared dashboards
                    return [4 /*yield*/, (0, testing_1.async_test)("Admin still sees explicit-false dashboard", function () { return sdk.api.custom_dashboards.getOne(explicitFalseDashboard.id); }, { onResult: function (r) { return r.id === explicitFalseDashboard.id; } })
                        // Cleanup
                    ];
                case 54:
                    // Admin continues to see everything, including unshared dashboards
