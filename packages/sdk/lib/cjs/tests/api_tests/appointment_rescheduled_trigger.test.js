...
exports.appointment_rescheduled_trigger_tests = void 0;
var sdk_1 = require("../../sdk");
var testing_1 = require("@tellescope/testing");
var setup_1 = require("../setup");
var host = process.env.TEST_HOST || "http://localhost:8080";
var appointment_rescheduled_trigger_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Automation Trigger Tests (Appointment Rescheduled)");
                ...
                case 16:
                    enduser12 = _b.sent();
                    // ===== TRADITIONAL RESCHEDULE TESTS (with rescheduledAt) =====
                    (0, testing_1.log_header)("Traditional Reschedule Tests (rescheduledAt)");
                ...
                case 18:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("No initial triggers for normal appointment", function () { return sdk.api.endusers.getOne(enduser1.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 21:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)("Update to rescheduled triggers automation", function () { return sdk.api.endusers.getOne(enduser1.id); }, { onResult: function (e) {
                                var _a;
                ...
                case 26:
                    _b.sent(); // allow update triggers to happen
                    return [4 /*yield*/, (0, testing_1.async_test)("Cancelled + rescheduled appointment triggers automation", function () { return sdk.api.endusers.getOne(enduser2.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 4
                                    && e.tags.includes('Rescheduled - Any')
                                    && e.tags.includes('Rescheduled - By Title')
                ...
                case 31:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Traditional reschedule with different title only triggers 'Any' automation", function () { return sdk.api.endusers.getOne(enduser3.id); }, { onResult: function (e) {
                                var _a;
                ...
                case 32:
                    _b.sent();
                    // ===== MANUAL RESCHEDULE TESTS (startTimeInMS changes) =====
                    (0, testing_1.log_header)("Manual Reschedule Tests (startTimeInMS changes)");
                ...
                case 34:
                    _b.sent(); // ensure no initial triggers
                    return [4 /*yield*/, (0, testing_1.async_test)("No initial triggers for normal appointment", function () { return sdk.api.endusers.getOne(enduser4.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 37:
                    _b.sent(); // allow update triggers to happen
                    return [4 /*yield*/, (0, testing_1.async_test)("Manual reschedule (startTimeInMS change) triggers automation", function () { return sdk.api.endusers.getOne(enduser4.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 2
                                    && e.tags.includes('Manual Reschedule - Any')
                                    && e.tags.includes('Manual Reschedule - By Title');
                ...
                case 42:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Manual reschedule with different title only triggers 'Any' automation", function () { return sdk.api.endusers.getOne(enduser5.id); }, { onResult: function (e) {
                                var _a;
                ...
                case 47:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Traditional reschedule triggers all automation", function () { return sdk.api.endusers.getOne(enduser6.id); }, { onResult: function (e) {
                                var _a;
                                return ((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length) === 4
                                    && e.tags.includes('Rescheduled - Any')
                                    && e.tags.includes('Rescheduled - By Title')
                ...
                case 52:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Manual reschedule with existing rescheduledAt does NOT trigger manual automation", function () { return sdk.api.endusers.getOne(enduser6.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } } // No tags should be added
                        )
                ...
                case 57:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Manual reschedule of cancelled appointment does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser7.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 62:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Manual reschedule of no-show appointment does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser8.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 67:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Same startTimeInMS update does NOT trigger automation", function () { return sdk.api.endusers.getOne(enduser9.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 72:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Duration change without time change does NOT trigger manual reschedule", function () { return sdk.api.endusers.getOne(enduser10.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.length); } })
                ...
                case 78:
                    _b.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Multiple manual reschedules trigger automation for each enduser", function () { return Promise.all([
...
exports.appointment_rescheduled_trigger_tests = appointment_rescheduled_trigger_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.appointment_rescheduled_trigger_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
