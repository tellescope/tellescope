...
exports.enduser_observations_acknowledge_tests = void 0;
...
var enduser_observations_acknowledge_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    (0, testing_1.log_header)("Enduser Observations Acknowledge Tests");
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('acknowledge - original functionality (mark as reviewed)', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var observation;
                ...
                case 6:
                    ...
                    _c.sent();
                    // Test 4: Bulk operations - set multiple observations exclusion flag
                    return [4 /*yield*/, (0, testing_1.async_test)('acknowledge - bulk set exclusion flag', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var observations;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.enduser_observations.acknowledge({
                ...
                case 7:
                    ...
                    _c.sent();
                    // Test 5: Bulk operations - remove exclusion flag from multiple observations
                    return [4 /*yield*/, (0, testing_1.async_test)('acknowledge - bulk remove exclusion flag', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var observations;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, sdk.api.enduser_observations.acknowledge({
                ...
                case 8:
                    ...
                    _c.sent();
                    // Test 6: Empty ids array should fail with validation error
                    return [4 /*yield*/, (0, testing_1.async_test)('acknowledge - empty ids array validation error', function () { return sdk.api.enduser_observations.acknowledge({
                            ids: [],
                            excludeFromVitalCountLookback: true
                ...
                case 9:
                    ...
                    _c.sent();
                    // Test 7: Verify original acknowledge doesn't affect exclusion flag
                    return [4 /*yield*/, (0, testing_1.async_test)('acknowledge - original functionality preserves exclusion flag', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var observation;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: 
                ...
                case 10:
                    ...
                    // ===== VITAL COUNT TRIGGER INTEGRATION TESTS =====
                    // Test 8: Setup vital configuration and test data BEFORE creating trigger
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - setup configuration and test endusers with observations', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 11:
                    ...
                    _c.sent();
                    // Test 9: Create trigger AFTER all test data is set up
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - create trigger after test data setup', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var trigger;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                case 12:
                    ...
                    _c.sent();
                    // Test 10: Validate trigger processes and SHOULD fire for enduser without exclusions
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - should fire for enduser without exclusion flags', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 13:
                    ...
                    _c.sent();
                    // Test 11: Validate trigger processes but SHOULD NOT fire for enduser with exclusions
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - should NOT fire for enduser with exclusion flags', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 14:
                    ...
                    _c.sent();
                    // Test 12: Validate enduser with NO observations should NOT trigger  
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - enduser with no observations should NOT trigger', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 15:
                    ...
                    _c.sent();
                    // Test 13: Validate enduser with RECENT observations should NOT trigger
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - enduser with recent observations should NOT trigger', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 16:
                    ...
                    _c.sent();
                    // Test 14: Verify normal cutoff behavior (without bypass keyword)
                    return [4 /*yield*/, (0, testing_1.async_test)('vital count trigger - normal cutoff prevents triggering for new endusers', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.enduser_observations_acknowledge_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
