...
exports.calendar_event_references_update_tests = void 0;
 ...
 */
var calendar_event_references_update_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    (0, testing_1.log_header)("Calendar Event References Update (enduserUpdatesDisabled)");
                    _d.label = 1;
                case 1:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('staff can update calendar_events.references', function () { return sdk.api.calendar_events.updateOne(event_1.id, { references: staffReferences_1 }); }, { onResult: function (e) { var _a; return ((_a = e.references) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.references[0].type === 'Elation' && e.references[0].id === 'elation-appointment-123'; } })];
                case 5:
                    _d.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('staff references update persisted', function () { return sdk.api.calendar_events.getOne(event_1.id); }, { onResult: function (e) { var _a; return ((_a = e.references) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.references[0].type === 'Elation' && e.references[0].id === 'elation-appointment-123'; } })
                        // ---- Enduser session (attendee with update access) is still blocked on references ----
                    ];
                case 6:
                    _d.sent();
                    // ---- Enduser session (attendee with update access) is still blocked on references ----
                    return [4 /*yield*/, (0, testing_1.async_test)('enduser cannot update calendar_events.references', function () { return enduserSDK_1.api.calendar_events.updateOne(event_1.id, { references: [{ type: 'Attacker', id: 'attacker-reference' }] }); }, { shouldError: true, onError: function (e) { return e.message === "references cannot be updated by endusers"; } })];
                case 7:
                    // ---- Enduser session (attendee with update access) is still blocked on references ----
                    _d.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)('rejected enduser references update did not persist', function () { return sdk.api.calendar_events.getOne(event_1.id); }, { onResult: function (e) { var _a; return ((_a = e.references) === null || _a === void 0 ? void 0 : _a.length) === 1 && e.references[0].type === 'Elation' && e.references[0].id === 'elation-appointment-123'; } })
                        // ---- Positive control: the guard is field-scoped — enduser can still cancel the event ----
                    ];
                case 8:
                    _d.sent();
                    // ---- Positive control: the guard is field-scoped — enduser can still cancel the event ----
                    return [4 /*yield*/, (0, testing_1.async_test)('enduser can still perform allowed update (cancelledAt)', function () { return enduserSDK_1.api.calendar_events.updateOne(event_1.id, { cancelledAt: new Date() }); }, { onResult: function (e) { return !!e.cancelledAt; } })];
                case 9:
                    // ---- Positive control: the guard is field-scoped — enduser can still cancel the event ----
                    _d.sent();
                    return [3 /*break*/, 19];
...
exports.calendar_event_references_update_tests = calendar_event_references_update_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.calendar_event_references_update_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
