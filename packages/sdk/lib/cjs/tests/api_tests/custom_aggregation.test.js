...
exports.custom_aggregation_tests = void 0;
...
var custom_aggregation_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Custom Aggregation Tests");
                ...
                case 4:
                    ...
                    _b.sent();
                    // Test 2: Aggregation returns enduser data
                    return [4 /*yield*/, (0, testing_1.async_test)("Custom aggregation - returns enduser fields", function () { return sdk.api.analytics_frames.custom_aggregation({
                            modelName: 'endusers',
                            aggregation: [
                                { $match: { fname: 'CustomAgg' } },
                ...
                case 5:
                    ...
                    _b.sent();
                    // Test 3: CRITICAL - hashedPassword is redacted even if requested
                    return [4 /*yield*/, (0, testing_1.async_test)("Custom aggregation - hashedPassword is redacted (explicit project)", function () { return sdk.api.analytics_frames.custom_aggregation({
                            modelName: 'endusers',
                            aggregation: [
                                { $match: { fname: 'CustomAgg' } },
                ...
                case 6:
                    ...
                    _b.sent();
                    // Test 4: hashedPassword is redacted even without explicit project
                    return [4 /*yield*/, (0, testing_1.async_test)("Custom aggregation - hashedPassword is redacted (no project)", function () { return sdk.api.analytics_frames.custom_aggregation({
                            modelName: 'endusers',
                            aggregation: [
                                { $match: { fname: 'CustomAgg' } },
                                { $limit: 1 }
                ...
                case 7:
                    ...
                    _b.sent();
                    // Test 5: Aggregation with grouping doesn't leak hashedPassword
                    return [4 /*yield*/, (0, testing_1.async_test)("Custom aggregation - hashedPassword redacted in grouped results", function () { return sdk.api.analytics_frames.custom_aggregation({
                            modelName: 'endusers',
                            aggregation: [
                                { $match: { fname: 'CustomAgg' } },
...
exports.custom_aggregation_tests = custom_aggregation_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.custom_aggregation_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
