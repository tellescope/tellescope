...
exports.translations_tests = void 0;
...
var translations_tests = function (_a) {
    var sdk = _a.sdk;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    (0, testing_1.log_header)("Translations Framework Tests");
                ...
                case 5:
                    updated = _j.sent();
                    (0, testing_1.assert)(((_c = (_b = updated.translations) === null || _b === void 0 ? void 0 : _b.transcription) === null || _c === void 0 ? void 0 : _c.en) === translations.transcription.en, "translations not persisted: ".concat(JSON.stringify(updated.translations)), 'translations field persisted correctly');
                ...
                case 7:
                    updated2 = _j.sent();
                    (0, testing_1.assert)(!!((_f = (_e = updated2.translations) === null || _e === void 0 ? void 0 : _e.transcription) === null || _f === void 0 ? void 0 : _f.en) && !!((_h = (_g = updated2.translations) === null || _g === void 0 ? void 0 : _g.transcription) === null || _h === void 0 ? void 0 : _h.es), "translations did not accumulate: ".concat(JSON.stringify(updated2.translations)), 'multiple language translations accumulate under one field');
                    return [3 /*break*/, 12];
                case 8:
...
exports.translations_tests = translations_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.translations_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
