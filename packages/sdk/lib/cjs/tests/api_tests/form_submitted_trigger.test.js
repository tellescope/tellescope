...
exports.form_submitted_trigger_tests = void 0;
require('source-map-support').install();
var sdk_1 = require("../../sdk");
var testing_1 = require("@tellescope/testing");
var setup_1 = require("../setup");
var host = process.env.API_URL || "http://localhost:8080";
var form_submitted_trigger_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_o) {
            switch (_o.label) {
                case 0:
                    (0, testing_1.log_header)("Form Submitted Trigger Tests (Multi-Form & Per-Form Conditions)");
                ...
                case 15:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 1: Global conditions on primary form still work (backwards compat)", function () { return sdk.api.endusers.getOne(enduserA1.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('global-cond-primary')); } })];
                case 16:
                    _o.sent();
                ...
                case 20:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 2: Trigger fires when secondary form (otherFormIds) is submitted", function () { return sdk.api.endusers.getOne(enduserB1.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('multi-form-secondary')); } })];
                case 21:
                    _o.sent();
                ...
                case 25:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 3: Per-form conditions match on primary form", function () { return sdk.api.endusers.getOne(enduserA2.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('per-form-primary')); } })];
                case 26:
                    _o.sent();
                ...
                case 30:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 4: Per-form conditions match on secondary form", function () { return sdk.api.endusers.getOne(enduserB2.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('per-form-secondary')); } })];
                case 31:
                    _o.sent();
                ...
                case 35:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 5: Conditions on FormA do not block FormB (no cross-form blocking)", function () { return sdk.api.endusers.getOne(enduserB3.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('no-cross-block')); } })];
                case 36:
                    _o.sent();
                ...
                case 40:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 6a: conditionsByFormId match fires trigger (overrides global)", function () { return sdk.api.endusers.getOne(enduserA3.id); }, { onResult: function (e) { var _a; return !!((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('override-test')); } })
                ...
                case 43:
                    _o.sent();
                    return [4 /*yield*/, (0, testing_1.async_test)("Scenario 6b: Global conditions ignored when conditionsByFormId exists", function () { return sdk.api.endusers.getOne(enduserA4.id); }, { onResult: function (e) { var _a; return !((_a = e.tags) === null || _a === void 0 ? void 0 : _a.includes('override-test')); } })];
                case 44:
                    _o.sent();
...
exports.form_submitted_trigger_tests = form_submitted_trigger_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.form_submitted_trigger_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
