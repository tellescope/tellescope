...
exports.journey_delete_cancels_actions_tests = void 0;
var sdk_1 = require("../../sdk");
var testing_1 = require("@tellescope/testing");
var constants_1 = require("@tellescope/constants");
var host = process.env.API_URL || 'http://localhost:8080';
var journey_delete_cancels_actions_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Journey Delete Cancels Pending Actions Tests");
                    _b.label = 1;
                case 1:
                ...
                case 8:
                    ...
                    expectedReason_1 = constants_1.AUTOMATED_ACTION_CANCEL_REASONS.indexOf('Journey Deleted');
...
exports.journey_delete_cancels_actions_tests = journey_delete_cancels_actions_tests;
...
if (require.main === module) {
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../setup")); })];
                case 1:
                    setup_tests = (_a.sent()).setup_tests;
                    return [4 /*yield*/, setup_tests(sdk_2, sdkNonAdmin_1)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.journey_delete_cancels_actions_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
