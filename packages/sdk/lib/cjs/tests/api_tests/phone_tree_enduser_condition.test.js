...
exports.phone_tree_enduser_condition_tests = void 0;
...
var phone_tree_enduser_condition_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Phone Tree Enduser Condition Split Tests");
                    treeIds = [];
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, , 8, 13]);
                ...
                case 2:
                    ...
                    (0, testing_1.assert)(!!tree.id, 'failed to create tree with Enduser Condition Split', 'create tree with Enduser Condition Split');
                ...
                case 3:
                    ...
                    (0, testing_1.assert)((loadedSplit === null || loadedSplit === void 0 ? void 0 : loadedSplit.action.type) === 'Enduser Condition Split'
                ...
                case 4:
                    ...
                    (0, testing_1.assert)(!!conditionalSplitTree.id, 'failed to create Conditional Split tree', 'existing Conditional Split still saves (regression)');
                    // invalid: enduserCondition must be an object
                    return [4 /*yield*/, (0, testing_1.async_test)("non-object enduserCondition is rejected", function () { return sdk.api.phone_trees.createOne({
                            number: '+15005550006',
                            isActive: false,
                            nodes: [{
                                    id: SPLIT_NODE_ID,
                ...
                case 5:
                    ...
                    _b.sent();
                    // invalid: branches must include a name
                    return [4 /*yield*/, (0, testing_1.async_test)("branch without a name is rejected", function () { return sdk.api.phone_trees.createOne({
                            number: '+15005550006',
                            isActive: false,
                            nodes: [{
                                    id: SPLIT_NODE_ID,
                        ...
                        }).then(function (t) { treeIds.push(t.id); return t; }); }, testing_1.handleAnyError)
                ...
                case 6:
                    ...
                    _b.sent();
                    // invalid: On Condition Branch events must include a branch value
                    return [4 /*yield*/, (0, testing_1.async_test)("On Condition Branch event without branch is rejected", function () { return sdk.api.phone_trees.createOne({
                            number: '+15005550006',
                            isActive: false,
...
exports.phone_tree_enduser_condition_tests = phone_tree_enduser_condition_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.phone_tree_enduser_condition_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
