...
exports.healthie_force_sync_tests = void 0;
...
var healthie_force_sync_tests = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    (0, testing_1.log_header)("Healthie Force Sync Field Tests");
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, , 5, 8]);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, testing_1.async_test)('force sync field - initial set succeeds', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var updated;
                            var _a;
                            var _b, _c, _d;
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0: return [4 /*yield*/, sdk.api.endusers.updateOne(enduser_1.id, {
                                            fields: __assign(__assign({}, ((_b = enduser_1.fields) !== null && _b !== void 0 ? _b : {})), (_a = {}, _a[constants_1.HEALTHIE_FORCE_SYNC_FIELD] = 1, _a)),
                                        })];
                                    case 1:
                                        updated = _e.sent();
                                        return [2 /*return*/, (_d = (_c = updated.fields) === null || _c === void 0 ? void 0 : _c[constants_1.HEALTHIE_FORCE_SYNC_FIELD]) === null || _d === void 0 ? void 0 : _d.toString()];
                                }
                            });
                ...
                case 3:
                    ...
                    _b.sent();
                    // Test 2: incrementing the force-sync field succeeds (value -> new value)
                    return [4 /*yield*/, (0, testing_1.async_test)('force sync field - increment succeeds', function () { return __awaiter(void 0, void 0, void 0, function () {
                            var current, updated;
                            var _a;
                            var _b, _c, _d;
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, sdk.api.endusers.updateOne(enduser_1.id, {
                                                fields: __assign(__assign({}, ((_b = current.fields) !== null && _b !== void 0 ? _b : {})), (_a = {}, _a[constants_1.HEALTHIE_FORCE_SYNC_FIELD] = 2, _a)),
                                            })];
                                    case 2:
                                        updated = _e.sent();
                                        return [2 /*return*/, (_d = (_c = updated.fields) === null || _c === void 0 ? void 0 : _c[constants_1.HEALTHIE_FORCE_SYNC_FIELD]) === null || _d === void 0 ? void 0 : _d.toString()];
...
exports.healthie_force_sync_tests = healthie_force_sync_tests;
    ...
    var runTests = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, exports.healthie_force_sync_tests)({ sdk: sdk_2, sdkNonAdmin: sdkNonAdmin_1 })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
