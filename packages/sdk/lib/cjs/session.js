            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 4]);
                            return [4 /*yield*/, axios_1.default.get(this.host + endpoint, __assign({ params: __assign(__assign({}, params), this.getAuthInfo(authenticated)), headers: this.config.headers, paramsSerializer: defaultParamsSerializer }, options))];
                        case 1: return [2 /*return*/, (_a.sent()).data];
                        case 2:
                            err_2 = _a.sent();
