...
exports.Session = exports.SOCKET_POLLING_DELAY = exports.wait = exports.DEFAULT_HOST = void 0;
var axios_1 = __importDefault(require("axios"));
var form_data_1 = __importDefault(require("form-data"));
var socket_io_client_1 = require("socket.io-client");
exports.DEFAULT_HOST = 'https://api.tellescope.com';
...
exports.SOCKET_POLLING_DELAY = 250;
var Session = /** @class */ (function () {
    function Session(o) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 4]);
                            return [4 /*yield*/, axios_1.default.post(this.host + endpoint, __assign(__assign({}, args), this.getAuthInfo(authenticated)), __assign(__assign({}, this.config), o))];
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 4]);
                            return [4 /*yield*/, axios_1.default.get(this.host + endpoint, __assign({ params: __assign(__assign({}, params), this.getAuthInfo(authenticated)), headers: this.config.headers }, options))];
                        case 1: return [2 /*return*/, (_a.sent()).data];
                        case 2:
                            err_2 = _a.sent();
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 4]);
                            return [4 /*yield*/, axios_1.default.patch(this.host + endpoint, __assign(__assign({}, params), this.getAuthInfo(authenticated)), this.config)];
                        case 1: return [2 /*return*/, (_a.sent()).data];
                        case 2:
                            err_3 = _a.sent();
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 4]);
                            return [4 /*yield*/, axios_1.default.delete(this.host + endpoint, { data: __assign(__assign({}, args), this.getAuthInfo(authenticated)),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.post(presigned.url, formData, { headers: headers })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.DOWNLOAD = function (downloadURL) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get(downloadURL)];
                    case 1:
                        content = _a.sent();
        ...
        */
        ...
        this.initialize_socket = function () {
            ...
            _this.socket = (0, socket_io_client_1.io)(_this.host, 
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, exports.wait)(undefined, exports.SOCKET_POLLING_DELAY)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 1];
                    case 3:
        ...
        this.host = (_a = o.host) !== null && _a !== void 0 ? _a : exports.DEFAULT_HOST;
