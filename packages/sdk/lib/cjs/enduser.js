...
var loadDefaultQueries = function (s) { return ({
    ...
    configurations: (0, exports.defaultQueries)(s, 'configurations'), // reads reduced to publicRead: true records (form translation maps)
}); };
var EnduserSession = /** @class */ (function (_super) {
    ...
    function EnduserSession(o) {
        ...
        _this.api.integrations.proxy_write = function (args) { return _this._POST("/v1".concat(schema_1.schema.integrations.customActions.proxy_write.path), args); };
