...
export var EmbeddingInfo = (_a = {},
    ...
    _a);
export var MOBILE_BOTTOM_NAVIGATION_DISABLED_POSITION = 1000;
export var DEFAULT_PATIENT_PORTAL_BOTTOM_NAVIGATION_POSITIONS = {
    'Home': 0,
    Communications: 1,
    Documents: 2,
    Education: 3,
    Community: MOBILE_BOTTOM_NAVIGATION_DISABLED_POSITION,
...
export var resource_to_modelName = {
    Endusers: 'endusers',
...
export var is_webhook_supported_model = function (m) { return (WEBHOOK_MODELS[m] !== undefined); };
export var isModelName = function (s) { return modelNameChecker[s]; };
// https://gist.github.com/aviflax/a4093965be1cd008f172/ 
export var TIMEZONE_MAP = {
...
export var TIMEZONES = Object.keys(TIMEZONE_MAP);
export var TIMEZONES_USA = [
    "US/Hawaii",
    "US/Alaska",
    "US/Pacific",
    "US/Arizona",
...
export var USA_STATE_TO_TIMEZONE = {
    "AK": 'US/Alaska',
    "AL": 'US/Central',
    "AR": 'US/Central',
    "AS": 'US/Samoa',
