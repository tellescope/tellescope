 ...
 */
export var readEffectPreference = function () {
    try {
        if (typeof localStorage === 'undefined')
            return 'none';
        var stored = localStorage.getItem(BACKGROUND_EFFECT_STORAGE_KEY);
...
export var writeEffectPreference = function (effect) {
    try {
        if (typeof localStorage !== 'undefined') {
 ...
 * relies on for CORS).
 */
export var loadBackgroundImage = function (url) {
...
export { BackgroundEffectController };
