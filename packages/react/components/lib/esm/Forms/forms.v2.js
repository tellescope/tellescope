...
export var QuestionForField = function (_a) {
    ...
    var AppointmentBooking = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _2 !== void 0 ? _2 : AppointmentBookingInput;
    var Height = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _3 !== void 0 ? _3 : HeightInput;
    var Redirect = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _4 !== void 0 ? _4 : RedirectInput;
    var HiddenValue = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _5 !== void 0 ? _5 : HiddenValueInput;
    var Emotii = (_6 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _6 !== void 0 ? _6 : EmotiiInput;
    var Allergies = (_7 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _7 !== void 0 ? _7 : AllergiesInput;
    var Conditions = (_8 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _8 !== void 0 ? _8 : ConditionsInput;
    var RichText = (_9 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _9 !== void 0 ? _9 : RichTextInput;
    var BelugaPatientPreference = (_10 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Beluga Patient Preference']) !== null && _10 !== void 0 ? _10 : BelugaPatientPreferenceInput;
    var PharmacySearch = (_11 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Pharmacy Search']) !== null && _11 !== void 0 ? _11 : PharmacySearchInput;
    ...
    _jsxs(Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                _jsxs(Typography, __assign({ component: "h4", style: {
                    ...
                    } }, { children: [form_display_text_for_language(form, field.title), !(field.isOptional || field.type === 'description' || field.type === 'Question Group' || field.type === 'Insurance' || field.type === 'Bridge Eligibility' || field.type === 'Candid Eligibility') ? '*' : ''] })), !field.title && (field.type === 'Question Group' || field.type === 'signature') && !((_12 = form === null || form === void 0 ? void 0 : form.customization) === null || _12 === void 0 ? void 0 : _12.hideLogo) &&
                                                                                                                                                    ...
                                                                                                                                                    : field.type === 'Table Input' ? (_jsx(TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                        : field.type === 'Timezone' ? (_jsx(TimezoneInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                            : field.type === 'Time' ? (_jsx(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                                : field.type === 'Question Group' ? (_jsx(Flex, __assign({ column: true, flex: 1 }, { children: ((_16 = (_15 = field.options) === null || _15 === void 0 ? void 0 : _15.subFields) !== null && _16 !== void 0 ? _16 : []).map(function (_a, indexInGroup) {
                                                                                                                                                                        var _b, _c, _d;
                                                                                                                                                                        var id = _a.id;
                                                                                                                                                                    ...
                                                                                                                                                                    : null, ((_17 = field.options) === null || _17 === void 0 ? void 0 : _17.repeat) && (_jsx(Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? (_jsx(String, { field: field, label: "Repeat", value: (_18 = repeats[field.id]) !== null && _18 !== void 0 ? _18 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? (_jsx(StringLong, { field: field, label: "Repeat", value: (_19 = repeats[field.id]) !== null && _19 !== void 0 ? _19 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? (_jsx(Number, { field: field, label: "Repeat", value: (_20 = repeats[field.id]) !== null && _20 !== void 0 ? _20 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
