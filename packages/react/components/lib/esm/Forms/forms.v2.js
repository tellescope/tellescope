...
var TellescopeFormContainerWithThemeV2 = function (_a) {
    ...
    return (_jsx(Flex, __assign({ flex: 1, column: true, alignItems: "center", style: __assign({ backgroundColor: hideBg ? 'transparent' : finalBgColor, overflow: 'auto', boxSizing: 'border-box', paddingTop: window.innerWidth < 600 ? 20 : 40, paddingBottom: window.innerWidth < 600 ? 20 : 40 }, style) }, { children: _jsxs(Flex, __assign({ flex: 1, column: true, style: __assign({ padding: window.innerWidth < 600 ? '0 12px' : '0 20px', maxWidth: maxWidth !== null && maxWidth !== void 0 ? maxWidth : 650, minWidth: 250, width: '100%', height: '100%', boxSizing: 'border-box' }, (window.innerWidth < 600 ? {
                paddingBottom: '80px' // Extra bottom padding on mobile to keep button above Safari navigation
                    ...
                    ? (_jsx(Flex, __assign({ alignItems: "flex-start", style: { marginBottom: '20px', marginTop: '10px' } }, { children: _jsx("img", { src: resolvedLogoURL, alt: theme === null || theme === void 0 ? void 0 : theme.name, style: { height: logoHeight || LOGO_HEIGHT, maxWidth: 225 } }) })))
                    : (theme === null || theme === void 0 ? void 0 : theme.name)
                        ? (_jsx(Typography, __assign({ style: { fontSize: 22, marginBottom: '20px', marginTop: '10px', textAlign: 'left', fontWeight: 600 } }, { children: theme.name })))
                        : null), children] })) })));
};
var LOGO_HEIGHT = 40;
