...
var TellescopeFormContainerWithThemeV2 = function (_a) {
    ...
    return (_jsx(Flex, __assign({ flex: 1, column: true, alignItems: "center", style: __assign({ backgroundColor: finalBgColor, overflow: 'auto', boxSizing: 'border-box', paddingTop: window.innerWidth < 600 ? 20 : 40, paddingBottom: window.innerWidth < 600 ? 20 : 40 }, style) }, { children: _jsxs(Flex, __assign({ flex: 1, column: true, style: __assign({ padding: window.innerWidth < 600 ? '0 12px' : '0 20px', maxWidth: maxWidth !== null && maxWidth !== void 0 ? maxWidth : 650, minWidth: 250, width: '100%', height: '100%', boxSizing: 'border-box' }, (window.innerWidth < 600 ? {
