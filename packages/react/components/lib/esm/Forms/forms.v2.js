...
export var QuestionForField = function (_a) {
    ...
    var BelugaPatientPreference = (_8 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Beluga Patient Preference']) !== null && _8 !== void 0 ? _8 : BelugaPatientPreferenceInput;
    ...
    _jsxs(Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
            ...
            field.disabledWhenPrepopulated && value.answer.value !== undefined && value.answer.value !== null && value.answer.value !== '' ? (_jsx("div", __assign({ style: {
                ...
                : field.type === 'file' ? (_jsx(File, { field: field, value: (_10 = file.blobs) === null || _10 === void 0 ? void 0 : _10[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                                                                                                                                        ...
                                                                                                                                        : field.type === 'Table Input' ? (_jsx(TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                            : field.type === 'Timezone' ? (_jsx(TimezoneInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                : field.type === 'Time' ? (_jsx(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                    : field.type === 'Question Group' ? (_jsx(Flex, __assign({ column: true, flex: 1 }, { children: ((_13 = (_12 = field.options) === null || _12 === void 0 ? void 0 : _12.subFields) !== null && _13 !== void 0 ? _13 : []).map(function (_a, indexInGroup) {
                                                                                                                                                            var _b, _c, _d;
                                                                                                                                                            var id = _a.id;
                                                                                                                                                        ...
                                                                                                                                                        : null, ((_14 = field.options) === null || _14 === void 0 ? void 0 : _14.repeat) && (_jsx(Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? (_jsx(String, { field: field, label: "Repeat", value: (_15 = repeats[field.id]) !== null && _15 !== void 0 ? _15 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? (_jsx(StringLong, { field: field, label: "Repeat", value: (_16 = repeats[field.id]) !== null && _16 !== void 0 ? _16 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? (_jsx(Number, { field: field, label: "Repeat", value: (_17 = repeats[field.id]) !== null && _17 !== void 0 ? _17 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
