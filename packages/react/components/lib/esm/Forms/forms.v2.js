...
var TellescopeFormContainerWithThemeV2 = function (_a) {
    ...
    return (_jsx(Flex, __assign({ flex: 1, column: true, alignItems: "center", style: __assign({ backgroundColor: finalBgColor, overflow: 'auto', paddingTop: window.innerWidth < 600 ? 20 : 40, paddingBottom: window.innerWidth < 600 ? 20 : 40 }, style) }, { children: _jsxs(Flex, __assign({ flex: 1, column: true, style: __assign({ padding: window.innerWidth < 600 ? '0 12px' : '0 20px', maxWidth: maxWidth !== null && maxWidth !== void 0 ? maxWidth : 650, minWidth: 250, width: '100%', height: '100%', boxSizing: 'border-box' }, (window.innerWidth < 600 ? {
...
export var QuestionForField = function (_a) {
    ...
    _jsxs(Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
            ...
            field.disabledWhenPrepopulated && value.answer.value !== undefined && value.answer.value !== null && value.answer.value !== '' ? (_jsx("div", __assign({ style: {
                ...
                : field.type === 'file' ? (_jsx(File, { field: field, value: (_11 = file.blobs) === null || _11 === void 0 ? void 0 : _11[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                                                                                                                                            ...
                                                                                                                                            : field.type === 'Table Input' ? (_jsx(TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                : field.type === 'Timezone' ? (_jsx(TimezoneInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                    : field.type === 'Time' ? (_jsx(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                        : field.type === 'Question Group' ? (_jsx(Flex, __assign({ column: true, flex: 1 }, { children: ((_14 = (_13 = field.options) === null || _13 === void 0 ? void 0 : _13.subFields) !== null && _14 !== void 0 ? _14 : []).map(function (_a, indexInGroup) {
                                                                                                                                                                var _b, _c, _d;
                                                                                                                                                                var id = _a.id;
                                                                                                                                                            ...
                                                                                                                                                            : null, ((_15 = field.options) === null || _15 === void 0 ? void 0 : _15.repeat) && (_jsx(Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? (_jsx(String, { field: field, label: "Repeat", value: (_16 = repeats[field.id]) !== null && _16 !== void 0 ? _16 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? (_jsx(StringLong, { field: field, label: "Repeat", value: (_17 = repeats[field.id]) !== null && _17 !== void 0 ? _17 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? (_jsx(Number, { field: field, label: "Repeat", value: (_18 = repeats[field.id]) !== null && _18 !== void 0 ? _18 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
...
export var TellescopeSingleQuestionFlowV2 = function (_a) {
    ...
    return (submitted
        ...
        : (_jsxs(Flex, __assign({ column: true, flex: 1, style: { justifyContent: 'space-between' } }, { children: [_jsxs(Flex, __assign({ column: true }, { children: [!(customization === null || customization === void 0 ? void 0 : customization.hideProgressBar) &&
                            ...
                            ? (_jsx(Flex, __assign({ alignItems: "flex-start", style: { marginBottom: '20px' } }, { children: _jsx("img", { src: theme.logoURL, alt: theme.name, style: { height: (customization === null || customization === void 0 ? void 0 : customization.logoHeight) || LOGO_HEIGHT, maxWidth: 225 } }) })))
