...
export var RelatedContactsInput = function (_a) {
    ...
    if (value[editing]) {
        ...
        return (_jsxs(Grid, __assign({ container: true, direction: "column", spacing: 1 }, { children: [_jsx(Grid, __assign({ item: true }, { children: _jsxs(Grid, __assign({ container: true, alignItems: "center", wrap: "nowrap", spacing: 1 }, { children: [!((_d = (_b = field.options) === null || _b === void 0 ? void 0 : _b.hiddenDefaultFields) === null || _d === void 0 ? void 0 : _d.includes('First Name')) &&
                                ...
                                _jsx(Grid, __assign({ item: true, xs: 4 }, { children: _jsx(TextField, { label: "Last Name", size: "small", fullWidth: true, InputProps: defaultInputProps, value: lname, onChange: function (e) { return onChange(value.map(function (v, i) { return i === editing ? __assign(__assign({}, v), { lname: e.target.value }) : v; }), field.id); } }) })), _jsx(Grid, __assign({ item: true, xs: 4 }, { children: _jsx(StringSelector, { options: RELATIONSHIP_TYPES, label: "Relationship", size: "small", value: (_h = (_g = relationships === null || relationships === void 0 ? void 0 : relationships[0]) === null || _g === void 0 ? void 0 : _g.type) !== null && _h !== void 0 ? _h : '', onChange: function (type) { return onChange(value.map(function (v, i) { return i === editing ? __assign(__assign({}, v), { relationships: [{ type: type, id: '' /* to be filled on server-side */ }] }) : v; }), field.id); } }) }))] })) })), _jsx(Grid, __assign({ item: true }, { children: _jsxs(Grid, __assign({ container: true, alignItems: "center", wrap: "nowrap", spacing: 1 }, { children: [!((_k = (_j = field.options) === null || _j === void 0 ? void 0 : _j.hiddenDefaultFields) === null || _k === void 0 ? void 0 : _k.includes('Date of Birth')) &&
