...
export var InsuranceInput = function (_a) {
    ...
    useEffect(function () {
        ...
        if (((_d = field === null || field === void 0 ? void 0 : field.options) === null || _d === void 0 ? void 0 : _d.dataSource) === STEDI_TITLE)
    ...
    useEffect(function () {
        ...
        if (((_a = field === null || field === void 0 ? void 0 : field.options) === null || _a === void 0 ? void 0 : _a.dataSource) !== CANVAS_TITLE && ((_b = field === null || field === void 0 ? void 0 : field.options) === null || _b === void 0 ? void 0 : _b.dataSource) !== BRIDGE_TITLE && ((_d = field === null || field === void 0 ? void 0 : field.options) === null || _d === void 0 ? void 0 : _d.dataSource) !== STEDI_TITLE) {
            return;
        }
        if (!query)
            return;
        ...
        var integration = (((_e = field === null || field === void 0 ? void 0 : field.options) === null || _e === void 0 ? void 0 : _e.dataSource) === CANVAS_TITLE ? CANVAS_TITLE
            : ((_f = field === null || field === void 0 ? void 0 : field.options) === null || _f === void 0 ? void 0 : _f.dataSource) === STEDI_TITLE ? STEDI_TITLE
                : BRIDGE_TITLE);
        var type = ((_g = field === null || field === void 0 ? void 0 : field.options) === null || _g === void 0 ? void 0 : _g.dataSource) === CANVAS_TITLE ? 'organizations' : 'payers';
    ...
    return (_jsxs(Grid, __assign({ container: true, spacing: 2, sx: { mt: '0' } }, { children: [_jsx(Grid, __assign({ item: true, xs: 12, sm: 6 }, { children: _jsx(Autocomplete, { freeSolo: !((_e = field.options) === null || _e === void 0 ? void 0 : _e.requirePredefinedInsurer), options: payers.map(function (p) { return p.name; }), value: (value === null || value === void 0 ? void 0 : value.payerName) || '', onChange: function (e, v) {
                        ...
                        var _a, _b, _d;
                        return (_jsx(TextField, __assign({}, params, { InputProps: __assign(__assign({}, params.InputProps), { sx: (inputProps || defaultInputProps).sx }), required: !field.isOptional, size: "small", label: form_display_text_for_language(form, "Insurer"), placeholder: (((_a = field.options) === null || _a === void 0 ? void 0 : _a.dataSource) === CANVAS_TITLE || ((_b = field.options) === null || _b === void 0 ? void 0 : _b.dataSource) === BRIDGE_TITLE || ((_d = field.options) === null || _d === void 0 ? void 0 : _d.dataSource) === STEDI_TITLE) ? form_display_text_for_language(form, "Search insurer...") : form_display_text_for_language(form, "Insurer") })));
...
export var StediEligibilityInput = function (_a) {
    var _b, _d;
    ...
    // User/admin interface (non-enduser sessions)
    return (_jsxs(Grid, __assign({ container: true, spacing: 2, direction: "column" }, { children: [_jsxs(Grid, __assign({ item: true }, { children: [_jsxs(Typography, __assign({ variant: "body2", color: "textSecondary" }, { children: ["Service Code: ", ((_b = field.options) === null || _b === void 0 ? void 0 : _b.stediServiceCode) || 'Not configured'] })), _jsxs(Typography, __assign({ variant: "body2", color: "textSecondary" }, { children: ["Provider NPI: ", ((_d = field.options) === null || _d === void 0 ? void 0 : _d.stediNPI) || 'Not configured'] })), payerId && _jsxs(Typography, __assign({ variant: "body2", color: "textSecondary" }, { children: ["Payer ID: ", payerId] })), memberId && _jsxs(Typography, __assign({ variant: "body2", color: "textSecondary" }, { children: ["Member ID: ", memberId] }))] })), error && (_jsx(Grid, __assign({ item: true }, { children: _jsx(Typography, __assign({ variant: "body2", color: "error" }, { children: error })) }))), _jsx(Grid, __assign({ item: true, container: true, spacing: 2 }, { children: _jsx(Grid, __assign({ item: true }, { children: _jsx(LoadingButton, { variant: "outlined", onClick: checkEligibility, submitText: form_display_text_for_language(form, "Check Eligibility"), submittingText: form_display_text_for_language(form, "Checking..."), submitting: loading, disabled: loading }) })) })), value && (_jsxs(Grid, __assign({ item: true }, { children: [_jsx(Typography, __assign({ variant: "caption", color: "textSecondary" }, { children: "Current Answer:" })), _jsx("pre", __assign({ style: { fontSize: 11, whiteSpace: 'pre-wrap', wordBreak: 'break-word' } }, { children: JSON.stringify(value, null, 2) }))] })))] })));
};
...
export var StripeInput = function (_a) {
    ...
    var _l = useState(''), gtmPurchaseName = _l[0], setGtmPurchaseName = _l[1];
    // set only when the server reports an amount for a real charge, which is what gates the GTM purchase event
    var _m = useState(), purchase = _m[0], setPurchase = _m[1];
    var _o = useState(''), error = _o[0], setError = _o[1];
    var _p = useState([]), selectedProducts = _p[0], setSelectedProducts = _p[1];
    var _q = useState(false), showProductSelection = _q[0], setShowProductSelection = _q[1];
    var _r = useState([]), availableProducts = _r[0], setAvailableProducts = _r[1];
    var _s = useState(false), loadingProducts = _s[0], setLoadingProducts = _s[1];
    ...
    useEffect(function () {
        ...
        session.api.form_responses.stripe_details({ fieldId: field.id, enduserId: enduserId })
            .then(function (_a) {
            var clientSecret = _a.clientSecret, publishableKey = _a.publishableKey, stripeAccount = _a.stripeAccount, businessName = _a.businessName, customerId = _a.customerId, isCheckout = _a.isCheckout, answerText = _a.answerText, amount = _a.amount, currency = _a.currency, gtmPurchaseName = _a.gtmPurchaseName;
    ...
    var handlePaymentSuccess = function (fallbackText) {
        ...
        if (((_a = field.options) === null || _a === void 0 ? void 0 : _a.chargeImmediately) && purchase && !purchaseEmittedRef.current) {
            ...
            emitStripePurchaseEvent(field, __assign(__assign({}, purchase), { name: gtmPurchaseName }));
        }
    ...
    return (_jsx(Elements, __assign({ stripe: stripePromise, options: {
            clientSecret: clientSecret,
        } }, { children: _jsx(StripeForm, { businessName: businessName, onSuccess: function () { return handlePaymentSuccess('Saved card details'); }, cost: cost, field: field, form: form }) })));
};
