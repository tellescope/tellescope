...
export var QuestionForField = function (_a) {
    ...
    var Dropdown = (_u = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Dropdown']) !== null && _u !== void 0 ? _u : DropdownInput;
    var DatabaseSelect = (_v = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Database Select']) !== null && _v !== void 0 ? _v : DatabaseSelectInput;
    var Medications = (_w = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Medications']) !== null && _w !== void 0 ? _w : MedicationsInput;
    var RelatedContacts = (_x = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Related Contacts']) !== null && _x !== void 0 ? _x : RelatedContactsInput;
    var Insurance = (_y = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Insurance']) !== null && _y !== void 0 ? _y : InsuranceInput;
    var AppointmentBooking = (_z = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _z !== void 0 ? _z : AppointmentBookingInput;
    var Height = (_0 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _0 !== void 0 ? _0 : HeightInput;
    var Redirect = (_1 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _1 !== void 0 ? _1 : RedirectInput;
    var HiddenValue = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _2 !== void 0 ? _2 : HiddenValueInput;
    var Emotii = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _3 !== void 0 ? _3 : EmotiiInput;
    var Allergies = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _4 !== void 0 ? _4 : AllergiesInput;
    var Conditions = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _5 !== void 0 ? _5 : ConditionsInput;
    var RichText = (_6 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _6 !== void 0 ? _6 : RichTextInput;
    ...
    _jsxs(Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                ...
                _jsx(Flex, __assign({ column: true, style: { marginBottom: 11, marginTop: 3, } }, { children: feedback.map(function (f, i) { return (_jsx(Typography, __assign({ color: "error", style: { fontSize: 20 } }, { children: f }), i)); }) })), field.type === 'file' ? (_jsx(File, { field: field, value: (_8 = file.blobs) === null || _8 === void 0 ? void 0 : _8[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                                                                                                                            ...
                                                                                                                            : field.type === 'ranking' ? (_jsx(Ranking, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                : field.type === 'Table Input' ? (_jsx(TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                    : field.type === 'Time' ? (_jsx(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                        : field.type === 'Question Group' ? (_jsx(Flex, __assign({ column: true, flex: 1 }, { children: ((_11 = (_10 = field.options) === null || _10 === void 0 ? void 0 : _10.subFields) !== null && _11 !== void 0 ? _11 : []).map(function (_a) {
                                                                                                                                                var _b;
                                                                                                                                                var id = _a.id;
                                                                                                                                            ...
                                                                                                                                            : null, ((_12 = field.options) === null || _12 === void 0 ? void 0 : _12.repeat) && (_jsx(Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? (_jsx(String, { field: field, label: "Repeat", value: (_13 = repeats[field.id]) !== null && _13 !== void 0 ? _13 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? (_jsx(StringLong, { field: field, label: "Repeat", value: (_14 = repeats[field.id]) !== null && _14 !== void 0 ? _14 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? (_jsx(Number, { field: field, label: "Repeat", value: (_15 = repeats[field.id]) !== null && _15 !== void 0 ? _15 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
