...
export var useFormDisplayLanguage = function (_a) {
    ...
    var _b = useState(language_code_for_legacy_form_language(initialLanguage !== null && initialLanguage !== void 0 ? initialLanguage : form === null || form === void 0 ? void 0 : form.language)), languageCode = _b[0], setLanguageCode = _b[1];
