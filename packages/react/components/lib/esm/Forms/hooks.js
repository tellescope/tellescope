...
import { MM_DD_YYYY_to_YYYY_MM_DD, append_current_utm_params, emit_gtm_event, field_can_autoadvance, getLocalTimezone, get_time_values, get_utm_params, mm_dd_yyyy, object_is_empty, read_local_storage, replace_form_field_template_values, responses_satisfy_conditions, update_local_storage } from "@tellescope/utilities";
        ...
        return __generator(this, function (_6) {
            switch (_6.label) {
                ...
                case 13: return [4 /*yield*/, _j.apply(_h, [__assign.apply(void 0, [(_l.accessCode = (_k), _l.responses = __spreadArray(__spreadArray([], responsesToSubmit_3, true), (existingResponses !== null && existingResponses !== void 0 ? existingResponses : []).filter(function (r) {
                            ...
                            , true), _l.automationStepId = automationStepId, _l.customerId = customerId, _l.productIds = responsesToSubmit_3.flatMap(function (r) { var _a, _b, _c; return (_c = (_b = (_a = r.field) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.productIds) !== null && _c !== void 0 ? _c : []; }), _l.utm = get_utm_params(), _l), (getEnduserAISummary && eId === enduserId ? { enduserAISummary: getEnduserAISummary() } : {})])])
