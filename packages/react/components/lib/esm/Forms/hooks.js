...
export var useTellescopeForm = function (_a) {
    ...
    var _o = useState({}), repeats = _o[0], setRepeats = _o[1];
    ...
    var _p = useState(initializeFields()), responses = _p[0], setResponses = _p[1];
    useEffect(function () {
    ...
    var _q = useState(initializeFiles()), selectedFiles = _q[0], setSelectedFiles = _q[1];
    useEffect(function () {
        // Be very careful about refreshing data to avoid losing progress -- only in the case the selected form has changed
    ...
    var validateBasicField = useCallback(function (field) {
        ...
        if (value.answer.type === 'Insurance') {
            if (((_b = (_a = value.answer.value) === null || _a === void 0 ? void 0 : _a.relationshipDetails) === null || _b === void 0 ? void 0 : _b.dateOfBirth) && !isDateString(value.answer.value.relationshipDetails.dateOfBirth)) {
    ...
    var goToNextField = useCallback(function () {
        var _a, _b, _c;
        if (!currentValue)
            return;
