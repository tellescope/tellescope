...
export declare const SaveDraft: ({ selectedFiles, enduserId, responses, existingResponses, fields, onSuccess, formResponseId, includedFieldIds, formId, style, disabled, getResponsesWithQuestionGroupAnswers, isInternalNote, formTitle, rootResponseId, parentResponseId, }: Styled & Pick<TellescopeFormProps, "responses" | "enduserId" | "fields" | "existingResponses" | "selectedFiles" | "onSuccess" | "getResponsesWithQuestionGroupAnswers"> & {
...
export declare const UpdateResponse: ({ selectedFiles, enduserId, responses, onSuccess, formResponseId, includedFieldIds, formId, style, disabled, getResponsesWithQuestionGroupAnswers, existingResponses, fields, }: Styled & Pick<TellescopeFormProps, "responses" | "enduserId" | "fields" | "existingResponses" | "selectedFiles" | "onSuccess" | "getResponsesWithQuestionGroupAnswers"> & {
    disabled?: boolean | undefined;
    formResponseId?: string | undefined;
    formId: string;
    includedFieldIds: string[];
