...
} & Pick<TellescopeFormProps, "enduserId" | "fields" | "rootResponseId" | "groupId" | "groupInstance" | "responses" | "enduser" | "formResponseId" | "goToNextField" | "submit" | "isPreviousDisabled" | "goToPreviousField" | "handleDatabaseSelect" | "onAddFile" | "onFieldChange" | "customInputs" | "selectedFiles" | "validateField">) => JSX.Element | null;
