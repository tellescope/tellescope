...
} & Pick<TellescopeFormProps, "enduserId" | "fields" | "formResponseId" | "rootResponseId" | "groupId" | "groupInstance" | "responses" | "enduser" | "selectedFiles" | "goToNextField" | "submit" | "isPreviousDisabled" | "goToPreviousField" | "handleDatabaseSelect" | "onAddFile" | "onFieldChange" | "customInputs" | "validateField" | "lastNavigationDirectionRef">) => JSX.Element | null;
