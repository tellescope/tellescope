...
} & Pick<TellescopeFormProps, "enduserId" | "fields" | "formResponseId" | "rootResponseId" | "groupId" | "groupInstance" | "responses" | "enduser" | "selectedFiles" | "submit" | "goToPreviousField" | "goToNextField" | "isPreviousDisabled" | "lastNavigationDirectionRef" | "handleDatabaseSelect" | "onAddFile" | "onFieldChange" | "customInputs" | "validateField">) => JSX.Element | null;
