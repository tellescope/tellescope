...
export var FORM_CHROME_ENGLISH_STRINGS = Object.keys(SPANISH_TRANSLATIONS);
...
export var booking_display_text_for_language = function (bookingPage, text, placeholder) {
    var _a, _b;
    if (!bookingPage)
        return text;
