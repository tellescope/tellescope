...
export var Image = function (_a) {
    ...
    return _jsx("img", { src: src, alt: alt, style: __assign(__assign({}, props), style) });
};
...
export var Flex = function (props) {
    ...
    if (props.component === 'span')
        return (_jsx("span", __assign({ style: style, onClick: (_f = props.onClick) !== null && _f !== void 0 ? _f : props.onPress }, { children: children })));
    return (_jsx("div", __assign({ style: style, onClick: (_g = props.onClick) !== null && _g !== void 0 ? _g : props.onPress }, { children: children })));
};
...
export var List = function (_a) {
    ...
    return (_jsx("div", __assign({ style: __assign({ overflowY: 'auto' }, style) }, { children: _jsx(Flex, __assign({ flex: 1, column: true, reverse: reverse }, { children: items.map(function (item, i) {
                var _a, _b;
                return hoveredColor
...
export var ScrollingList = function (_a) {
    ...
    return (_jsxs(Grid, __assign({ container: true, direction: "column", style: style, wrap: noWrap ? 'nowrap' : undefined }, { children: [TitleComponent
                ...
                : (_jsxs(Grid, __assign({ container: true, alignItems: "center", justifyContent: "space-between" }, { children: [typeof title === 'string'
                            ...
                            : title, _jsx(Grid, __assign({ item: true }, { children: titleActionsComponent }))] }))), header, _jsx(Grid, __assign({ container: true, direction: "column", flexWrap: 'nowrap', style: { minHeight: minHeight, maxHeight: maxHeight, maxWidth: maxWidth, overflow: 'auto' }, onScroll: function (e) {
                ...
                } }, { children: _jsxs(Grid, __assign({ container: true, direction: "column", style: itemContainerStyle }, { children: [items.length === 0
                            ? typeof emptyText === 'string'
                                ? _jsx(Typography, { children: emptyText })
                                : emptyText
                            : null, items.map(function (item, index) { return (_jsx(Item, { item: item, index: index }, item.id)); })] })) }))] })));
};
...
export var DraggableList = function (_a) {
    ...
    var fetchRef = useRef(0);
    var titleStyleWithDefaults = __assign({ fontSize: 20, fontWeight: 'bold', marginBottom: 3 }, titleStyle);
    var _c = useState(), optimisticUpdate = _c[0], setOptimisticUpdate = _c[1];
    ...
    return (_jsxs(Grid, __assign({ container: true, direction: "column", style: style, wrap: noWrap ? 'nowrap' : undefined }, { children: [TitleComponent
                ...
                : (_jsxs(Grid, __assign({ container: true, alignItems: "center", justifyContent: "space-between" }, { children: [typeof title === 'string'
                            ? (_jsx(Typography, __assign({ style: titleStyleWithDefaults }, { children: title })))
                            : title, _jsx(Grid, __assign({ item: true }, { children: titleActionsComponent }))] }))), header, _jsx(Grid, __assign({ container: true, direction: "column", flexWrap: 'nowrap', style: { maxWidth: maxWidth, overflow: 'hidden' }, onScroll: function (e) {
                    if ((doneLoading === null || doneLoading === void 0 ? void 0 : doneLoading()) || !loadMore)
                        return;
                    var atBottom = e.currentTarget.scrollHeight - e.currentTarget.scrollTop <= e.currentTarget.clientHeight + 5;
                    if (!atBottom)
                    ...
                    loadMore().catch(console.error);
                            ...
                            ? typeof emptyText === 'string'
                                ? _jsx(Typography, { children: emptyText })
                                : emptyText
                            : null, _jsx(DragDropContext, __assign({ onDragEnd: function (result) { return __awaiter(void 0, void 0, void 0, function () {
                                var updated;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                            ...
                            }); } }, { children: _jsx(Droppable, __assign({ droppableId: "droppable" }, { children: function (provided, snapshot) { return (
                                // <VirtualList
                                ...
                                //   )}
                                // />
                                _jsx("div", __assign({ ref: provided.innerRef }, { children: _jsxs(Grid, __assign({ container: true, direction: "column" }, provided.droppableProps, { sx: getListStyle(snapshot.isDraggingOver) }, { children: [(optimisticUpdate || items).map(function (item, index) { return (_jsx(Draggable, __assign({ draggableId: "draggable-".concat(index), index: index, isDragDisabled: dragDisabled }, { children: function (provided, snapshot) { return (_jsxs(Grid, __assign({ container: true, alignItems: "center", wrap: "nowrap", ref: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { sx: __assign({}, getItemStyle(snapshot.isDragging, provided.draggableProps.style)) }, { children: [_jsx(Grid, __assign({ item: true, sx: { width: DRAG_ICON_WIDTH, height: DRAG_ICON_WIDTH, ml: '2px' } }, { children: _jsx(DragIndicatorIcon, { fontSize: 'small', color: optimisticUpdate ? 'inherit' : "primary" }) })), _jsx(Item, { item: item, index: index }, item.id)] }))); } }), "draggable-".concat(index))); }), provided.placeholder] })) }))); } })) }))] })) }))] })));
};
//# sourceMappingURL=layout%20copy.js.map