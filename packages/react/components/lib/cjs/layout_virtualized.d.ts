...
export declare const Image: ({ src, alt, style, ...props }: ImageProps) => JSX.Element;
...
export declare const List: <T extends Item, P = {}>({ items, hoveredColor, notHoveredColor, emptyComponent, render, renderProps, onClick, reverse, style, rowStyle, }: List_T<T, {}> & Styled) => JSX.Element;
...
export declare const ScrollingList: <T extends {
    id: string | number;
}>({ title, maxHeight, maxWidth, minHeight, titleStyle, items, emptyText, doneLoading, loadMore, Item, TitleComponent, titleActionsComponent, style, noWrap, header, itemContainerStyle, }: ScrollingListProps<T>) => JSX.Element;
export declare const DraggableList: <T extends {
    id: string | number;
}>({ title, maxHeight, maxWidth, minHeight, titleStyle, items, emptyText, doneLoading, loadMore, Item, TitleComponent, titleActionsComponent, style, noWrap, header, itemContainerStyle, onReorder, rowHeight, }: ScrollingListProps<T> & {
    onReorder?: ((updated: {
        id: string;
        index: number;
    }[]) => any) | undefined;
...
export {};
//# sourceMappingURL=layout_virtualized.d.ts.map