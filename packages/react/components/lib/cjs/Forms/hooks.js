...
exports.useFlattenedTree = useFlattenedTree;
var useNodeInTree = function (root, nodeId) {
    var _a;
...
exports.useNodeInTree = useNodeInTree;
// only need to consider a newly added edge if run on every newly added edge
var loopDetected = function (edges, startId, endId) {
...
var default_label_for_compound_logic = function (f) {
    try {
        if (f.$and) {
            return "[".concat(f.$and.map(exports.default_label_for_compound_logic).join(' AND '), "]");
        }
        if (f.$or) {
            return "(".concat(f.$or.map(exports.default_label_for_compound_logic).join(' OR '), ")");
        }
        if (f.condition) {
...
exports.default_label_for_compound_logic = default_label_for_compound_logic;
exports.COMPOUND_LOGIC_LABEL_SENTINEL = "___compound___";
var useGraphForFormFields = function (fields) {
    var _a;
    var edges = [];
                ...
                edges.push({
                    ...
                    label: (parent_1.type === 'previousEquals'
                        ...
                        : parent_1.type === 'compoundLogic'
                            ? (parent_1.info.label || (0, exports.default_label_for_compound_logic)(parent_1.info.condition)) // 'Advanced Logic')
                            : "Default"),
                });
            }
        }
...
var getNextField = function (activeField, currentValue, responses, options) {
    ...
    try {
        ...
        for (var _i = 0, advancedLogic_1 = advancedLogic; _i < advancedLogic_1.length; _i++) {
            ...
            if ((0, utilities_1.responses_satisfy_conditions)(responses, logic.info.condition, options)) {
                return node;
            }
        }
    }
...
var useListForFormFields = function (fields, responses, options) {
    var list = [];
    ...
    var _loop_4 = function () {
        ...
        if (!currentValue)
            return "break";
        var nextField = (0, exports.getNextField)({
            value: lastField,
...
exports.useListForFormFields = useListForFormFields;
...
var useLoadTreeForFormFields = function (formId) {
    var _a = (0, index_1.useFormFields)({ loadFilter: { formId: formId } }), filtered = _a[1].filtered;
    var formFieldsLoading = filtered(function (f) { return f.formId === formId; });
    if (!(0, index_1.value_is_loaded)(formFieldsLoading))
        return undefined;
    return (0, exports.useTreeForFormFields)(formFieldsLoading.value);
};
exports.useLoadTreeForFormFields = useLoadTreeForFormFields;
var useFieldsForForm = function (formId) {
    var _a = (0, index_1.useFormFields)({ loadFilter: { formId: formId !== null && formId !== void 0 ? formId : '' } }), _b = _a[1], filtered = _b.filtered, reload = _b.reload;
...
exports.useFieldsForForm = useFieldsForForm;
var OrganizationThemeContext = (0, react_1.createContext)(null);
var WithOrganizationTheme = function (_a) {
    var businessId = _a.businessId, organizationIds = _a.organizationIds, children = _a.children;
    var _b = (0, react_1.useState)({}), theme = _b[0], setTheme = _b[1];
    return ((0, jsx_runtime_1.jsx)(OrganizationThemeContext.Provider, __assign({ value: { businessId: businessId, organizationIds: organizationIds, theme: theme, setTheme: setTheme } }, { children: (0, jsx_runtime_1.jsx)(index_1.WithTheme, __assign({ theme: {
                primary: theme.themeColor,
                secondary: theme.themeColorSecondary
            } }, { children: children })) })));
};
exports.WithOrganizationTheme = WithOrganizationTheme;
// uses context if provided, otherwise fetches separately for each hook call (but doesn't fail)
var useOrganizationTheme = function () {
    var _a, _b;
    var context = (0, react_1.useContext)(OrganizationThemeContext);
    if (context === null) {
    ...
    var _c = (0, react_1.useState)((_a = context.theme) !== null && _a !== void 0 ? _a : {}), theme = _c[0], setTheme = _c[1];
    (0, react_1.useEffect)(function () {
        var _a, _b;
        if (theme.name)
...
exports.useOrganizationTheme = useOrganizationTheme;
...
var useTellescopeForm = function (_a) {
    ...
    var getNumberOfRemainingPages = (0, react_1.useCallback)(function (field, explored) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (!gaEventRef.current['initialize']) {
            react_ga4_1.default.initialize(ga4measurementId);
            ...
            setResponses(function (rs) { return rs.map(function (r) {
                ...
                if (!((_a = field === null || field === void 0 ? void 0 : field.prepopulateFromDatabase) === null || _a === void 0 ? void 0 : _a.overwrite)) {
                    if (r.answer.type === 'Address') {
                        if (!(0, utilities_1.object_is_empty)((_b = r.answer.value) !== null && _b !== void 0 ? _b : {})) {
                            return r;
                        }
                    }
    ...
    var updateInclusion = (0, react_1.useCallback)(function (includeInSubmit) {
    ...
    var validateBasicField = (0, react_1.useCallback)(function (field) {
        ...
        if (value.answer.type === 'Insurance') {
            if (((_e = (_d = value.answer.value) === null || _d === void 0 ? void 0 : _d.relationshipDetails) === null || _e === void 0 ? void 0 : _e.dateOfBirth) && !(0, validation_1.is_valid_mm_dd_yyyy)(value.answer.value.relationshipDetails.dateOfBirth)) {
        ...
        if (value.answer.type === 'email') {
            if (!(0, isEmail_1.default)(value.answer.value)) {
            ...
            if (!(0, validation_1.is_valid_mm_dd_yyyy)(value.answer.value)) {
    ...
    var validateField = (0, react_1.useCallback)(function (field) {
    ...
    var validateResponsesForFields = (0, react_1.useCallback)(function (_fields) {
    ...
    var nextField = (!currentValue ? undefined
        : ((0, exports.getNextField)(activeField, currentValue, responses, logicOptions)));
    var showSubmit = activeField.children.length === 0 || !nextField;
    var getResponsesWithQuestionGroupAnswers = (0, react_1.useCallback)(function (responsesToSubmit) {
        ...
        return __generator(this, function (_6) {
            switch (_6.label) {
                ...
                case 9:
                    ...
                    for (_a = 0, responsesToSubmit_2 = responsesToSubmit_3; _a < responsesToSubmit_2.length; _a++) {
                        ...
                        _loop_11 = function (f) {
                            ...
                            if ((match.field.groupShowCondition && !(0, utilities_1.object_is_empty)(match.field.groupShowCondition)
                                && !(0, utilities_1.responses_satisfy_conditions)(responses, match.field.groupShowCondition, logicOptions)))
                                return "continue";
                ...
                case 11:
                    ...
                    (0, utilities_1.update_local_storage)('redirecting_public_group', '');
                ...
                case 14:
                    ...
                    if (isPublicForm && nextFormGroupPublicURL) {
                        (0, utilities_1.update_local_storage)('redirecting_public_group', 'true');
                    }
                    if (!((_v = options === null || options === void 0 ? void 0 : options.otherEnduserIds) === null || _v === void 0 ? void 0 : _v.length)) { // only track for signle submission
                        ...
                        (0, utilities_1.emit_gtm_event)({ event: 'form_submitted', formId: formResponse.formId, fieldId: '', title: '', status: '', previousTitle: '', });
                ...
                case 17:
                    ...
                    if (goBackURL) {
                        ((_2 = window === null || window === void 0 ? void 0 : window.top) !== null && _2 !== void 0 ? _2 : window).location.href = (0, utilities_1.append_current_utm_params)(goBackURL);
                    }
                    if (submitRedirectURL) {
                        ((_3 = window === null || window === void 0 ? void 0 : window.top) !== null && _3 !== void 0 ? _3 : window).location.href = (0, utilities_1.append_current_utm_params)(submitRedirectURL);
                    }
                    if (form === null || form === void 0 ? void 0 : form.redirectToBookedAppointmentOnSubmit) {
                        url = (0, utilities_1.read_local_storage)('tellescope_last_booking_page_join_link');
                        if (url) {
                            ((_4 = window === null || window === void 0 ? void 0 : window.top) !== null && _4 !== void 0 ? _4 : window).location.href = (0, utilities_1.append_current_utm_params)(url);
                        }
                    }
                    return [3 /*break*/, 20];
                case 18:
    ...
    var onFieldChange = (0, react_1.useCallback)(function (value, fieldId, touched) {
        var _a;
        if (touched === void 0) { touched = true; }
        var field = fields.find(function (f) { return f.id === fieldId; });
        if (((_a = field === null || field === void 0 ? void 0 : field.options) === null || _a === void 0 ? void 0 : _a.autoAdvance) && (0, utilities_1.field_can_autoadvance)(field)) {
    ...
    var onAddFile = (0, react_1.useCallback)(function (blobs, fieldId) {
