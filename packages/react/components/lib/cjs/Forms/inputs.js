...
var StripeInput = function (_a) {
    ...
    var _l = (0, react_2.useState)(''), gtmPurchaseName = _l[0], setGtmPurchaseName = _l[1];
    // set only when the server reports an amount for a real charge, which is what gates the GTM purchase event
    var _m = (0, react_2.useState)(), purchase = _m[0], setPurchase = _m[1];
    var _o = (0, react_2.useState)(''), error = _o[0], setError = _o[1];
    var _p = (0, react_2.useState)([]), selectedProducts = _p[0], setSelectedProducts = _p[1];
    var _q = (0, react_2.useState)(false), showProductSelection = _q[0], setShowProductSelection = _q[1];
    var _r = (0, react_2.useState)([]), availableProducts = _r[0], setAvailableProducts = _r[1];
    var _s = (0, react_2.useState)(false), loadingProducts = _s[0], setLoadingProducts = _s[1];
...
var ChargeebeeInput = function (_a) {
    ...
    if (value || loadCount === 2) {
        return ((0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, alignItems: "center", wrap: "nowrap" }, { children: [(0, jsx_runtime_1.jsx)(icons_material_1.CheckCircleOutline, { color: "success" }), (0, jsx_runtime_1.jsx)(material_1.Typography, __assign({ sx: { ml: 1, fontSize: 20 } }, { children: collectOnly
    ...
    if (!url)
        return (0, jsx_runtime_1.jsx)(LinearProgress_1.default, {});
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("iframe", { src: url, title: "Checkout", style: { border: 'none', width: '100%', height: 700 }, onLoad: function () { return setLoadCount(function (l) { return l + 1; }); } }), collectOnly && !field.isOptional &&
                (0, jsx_runtime_1.jsxs)(material_1.Grid, __assign({ container: true, direction: "column", alignItems: "center", spacing: 1, sx: { mt: 1 } }, { children: [(0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ item: true }, { children: (0, jsx_runtime_1.jsx)(__1.LoadingButton, { variant: "contained", onClick: handleVerify, submitting: verifying, submitText: "Done" }) })), error && typeof error === 'string' &&
                            (0, jsx_runtime_1.jsx)(material_1.Grid, __assign({ item: true }, { children: (0, jsx_runtime_1.jsx)(material_1.Typography, __assign({ color: "error" }, { children: error })) }))] })), !collectOnly && error && typeof error === 'string' &&
                (0, jsx_runtime_1.jsx)(material_1.Typography, __assign({ color: "error" }, { children: error }))] }));
};
