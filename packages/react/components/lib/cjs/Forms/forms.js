...
var QuestionForField = function (_a) {
    ...
    var RichText = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _5 !== void 0 ? _5 : inputs_1.RichTextInput;
    ...
    (0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                ...
                (0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ column: true, style: { marginBottom: 11, marginTop: 3, } }, { children: feedback.map(function (f, i) { return ((0, jsx_runtime_1.jsx)(index_1.Typography, __assign({ color: "error", style: { fontSize: 20 } }, { children: f }), i)); }) })), field.type === 'file' ? ((0, jsx_runtime_1.jsx)(File, { field: field, value: (_7 = file.blobs) === null || _7 === void 0 ? void 0 : _7[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                                                                                                                        ...
                                                                                                                        : field.type === 'ranking' ? ((0, jsx_runtime_1.jsx)(Ranking, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                            : field.type === 'Table Input' ? ((0, jsx_runtime_1.jsx)(inputs_1.TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                : field.type === 'Time' ? ((0, jsx_runtime_1.jsx)(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                    : field.type === 'Question Group' ? ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ column: true, flex: 1 }, { children: ((_10 = (_9 = field.options) === null || _9 === void 0 ? void 0 : _9.subFields) !== null && _10 !== void 0 ? _10 : []).map(function (_a) {
                                                                                                                                            var _b;
                                                                                                                                            var id = _a.id;
                                                                                                                                        ...
                                                                                                                                        : null, ((_11 = field.options) === null || _11 === void 0 ? void 0 : _11.repeat) && ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? ((0, jsx_runtime_1.jsx)(String, { field: field, label: "Repeat", value: (_12 = repeats[field.id]) !== null && _12 !== void 0 ? _12 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? ((0, jsx_runtime_1.jsx)(StringLong, { field: field, label: "Repeat", value: (_13 = repeats[field.id]) !== null && _13 !== void 0 ? _13 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? ((0, jsx_runtime_1.jsx)(Number, { field: field, label: "Repeat", value: (_14 = repeats[field.id]) !== null && _14 !== void 0 ? _14 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
