...
var QuestionForField = function (_a) {
    ...
    var File = (_l = customInputs === null || customInputs === void 0 ? void 0 : customInputs['file']) !== null && _l !== void 0 ? _l : inputs_1.FileInput;
    var Files = (_m = customInputs === null || customInputs === void 0 ? void 0 : customInputs['files']) !== null && _m !== void 0 ? _m : inputs_1.FilesInput;
    var Ranking = (_o = customInputs === null || customInputs === void 0 ? void 0 : customInputs['ranking']) !== null && _o !== void 0 ? _o : inputs_1.RankingInput;
    var Rating = (_p = customInputs === null || customInputs === void 0 ? void 0 : customInputs['rating']) !== null && _p !== void 0 ? _p : inputs_1.RatingInput;
    var Address = (_q = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Address']) !== null && _q !== void 0 ? _q : inputs_1.AddressInput;
    var Time = (_s = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Time']) !== null && _s !== void 0 ? _s : inputs_1.TimeInput;
    var Dropdown = (_t = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Dropdown']) !== null && _t !== void 0 ? _t : inputs_1.DropdownInput;
    var DatabaseSelect = (_u = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Database Select']) !== null && _u !== void 0 ? _u : inputs_1.DatabaseSelectInput;
    var Medications = (_v = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Medications']) !== null && _v !== void 0 ? _v : inputs_1.MedicationsInput;
    var RelatedContacts = (_w = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Related Contacts']) !== null && _w !== void 0 ? _w : inputs_1.RelatedContactsInput;
    var Insurance = (_x = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Insurance']) !== null && _x !== void 0 ? _x : inputs_1.InsuranceInput;
    var AppointmentBooking = (_y = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _y !== void 0 ? _y : inputs_1.AppointmentBookingInput;
    var Height = (_z = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _z !== void 0 ? _z : inputs_1.HeightInput;
    var Redirect = (_0 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _0 !== void 0 ? _0 : inputs_1.RedirectInput;
    var HiddenValue = (_1 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _1 !== void 0 ? _1 : inputs_1.HiddenValueInput;
    var Emotii = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _2 !== void 0 ? _2 : inputs_1.EmotiiInput;
    var Allergies = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _3 !== void 0 ? _3 : inputs_1.AllergiesInput;
    var Conditions = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _4 !== void 0 ? _4 : inputs_1.ConditionsInput;
    ...
    (0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                ...
                (0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ column: true, style: { marginBottom: 11, marginTop: 3, } }, { children: feedback.map(function (f, i) { return ((0, jsx_runtime_1.jsx)(index_1.Typography, __assign({ color: "error", style: { fontSize: 20 } }, { children: f }), i)); }) })), field.type === 'file' ? ((0, jsx_runtime_1.jsx)(File, { field: field, value: (_6 = file.blobs) === null || _6 === void 0 ? void 0 : _6[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                ...
                : field.type === 'files' ? ((0, jsx_runtime_1.jsx)(Files, { field: field, value: file.blobs, onChange: onAddFile, form: form }))
                    : field.type === 'dateString' ? ((0, jsx_runtime_1.jsx)(inputs_1.DateStringInput, { field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                        : field.type === 'Hidden Value' ? ((0, jsx_runtime_1.jsx)(HiddenValue, { isSinglePage: isSinglePage, goToNextField: goToNextField, goToPreviousField: goToPreviousField, field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                    ...
                                    : field.type === 'Allergies' ? ((0, jsx_runtime_1.jsx)(Allergies, { enduser: enduser, enduserId: enduserId, field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                                        : field.type === 'Conditions' ? ((0, jsx_runtime_1.jsx)(Conditions, { enduser: enduser, enduserId: enduserId, field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                                            : field.type === 'Height' ? ((0, jsx_runtime_1.jsx)(Height, { field: field, disabled: value.disabled, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                : field.type === 'Redirect' ? ((0, jsx_runtime_1.jsx)(Redirect, { rootResponseId: rootResponseId, formResponseId: formResponseId, responses: responses, enduser: enduser, groupId: groupId, groupInsance: groupInstance, submit: submit, field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                        ...
                                                                                        : field.type === 'signature' ? ((0, jsx_runtime_1.jsx)(Signature, { enduser: enduser, field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                            : field.type === 'multiple_choice' ? ((0, jsx_runtime_1.jsx)(MultipleChoice, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                : field.type === 'Dropdown' ? ((0, jsx_runtime_1.jsx)(Dropdown, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                    : field.type === 'Database Select' ? ((0, jsx_runtime_1.jsx)(DatabaseSelect, { field: field, value: value.answer.value, onChange: onFieldChange, onDatabaseSelect: handleDatabaseSelect, responses: responses, form: form }))
                                                                                                        : field.type === 'Medications' ? ((0, jsx_runtime_1.jsx)(Medications, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                            : field.type === 'Insurance' ? ((0, jsx_runtime_1.jsx)(Insurance, { field: field, value: value.answer.value, form: form, enduser: enduser, responses: responses, onChange: function (v, fieldId) { return onFieldChange(__assign(__assign({}, v), { relationship: (v === null || v === void 0 ? void 0 : v.relationship) || 'Self' }), fieldId); } }))
                                                                                                                    ...
                                                                                                                    : field.type === 'ranking' ? ((0, jsx_runtime_1.jsx)(Ranking, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                        : field.type === 'Table Input' ? ((0, jsx_runtime_1.jsx)(inputs_1.TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                            : field.type === 'Time' ? ((0, jsx_runtime_1.jsx)(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                : field.type === 'Question Group' ? ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ column: true, flex: 1 }, { children: ((_9 = (_8 = field.options) === null || _8 === void 0 ? void 0 : _8.subFields) !== null && _9 !== void 0 ? _9 : []).map(function (_a) {
                                                                                                                                        var _b;
                                                                                                                                        var id = _a.id;
                                                                                                                                    ...
                                                                                                                                    : null, ((_10 = field.options) === null || _10 === void 0 ? void 0 : _10.repeat) && ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? ((0, jsx_runtime_1.jsx)(String, { field: field, label: "Repeat", value: (_11 = repeats[field.id]) !== null && _11 !== void 0 ? _11 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? ((0, jsx_runtime_1.jsx)(StringLong, { field: field, label: "Repeat", value: (_12 = repeats[field.id]) !== null && _12 !== void 0 ? _12 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? ((0, jsx_runtime_1.jsx)(Number, { field: field, label: "Repeat", value: (_13 = repeats[field.id]) !== null && _13 !== void 0 ? _13 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
