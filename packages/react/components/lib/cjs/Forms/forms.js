...
var QuestionForField = function (_a) {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18;
    ...
    (0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                (0, jsx_runtime_1.jsxs)(index_1.Typography, __assign({ component: "h4", style: {
                    ...
                    } }, { children: [field.title, !(field.isOptional || field.type === 'description' || field.type === 'Question Group' || field.type === 'Insurance' || field.type === 'Bridge Eligibility') ? '*' : ''] })), !field.title && (field.type === 'Question Group' || field.type === 'signature') && !((_10 = form === null || form === void 0 ? void 0 : form.customization) === null || _10 === void 0 ? void 0 : _10.hideLogo) &&
            ...
            field.disabledWhenPrepopulated && value.answer.value !== undefined && value.answer.value !== null && value.answer.value !== '' ? ((0, jsx_runtime_1.jsx)("div", __assign({ style: {
                ...
                : field.type === 'file' ? ((0, jsx_runtime_1.jsx)(File, { field: field, value: (_11 = file.blobs) === null || _11 === void 0 ? void 0 : _11[0], onChange: onAddFile, form: form, existingFileName: value.answer.type === 'file'
                        ? (_12 = value.answer.value) === null || _12 === void 0 ? void 0 : _12.name
                                                                                                                                            ...
                                                                                                                                            : field.type === 'Table Input' ? ((0, jsx_runtime_1.jsx)(inputs_1.TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                : field.type === 'Timezone' ? ((0, jsx_runtime_1.jsx)(inputs_1.TimezoneInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                    : field.type === 'Time' ? ((0, jsx_runtime_1.jsx)(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                        : field.type === 'Question Group' ? ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ column: true, flex: 1 }, { children: ((_14 = (_13 = field.options) === null || _13 === void 0 ? void 0 : _13.subFields) !== null && _14 !== void 0 ? _14 : []).map(function (_a, indexInGroup) {
                                                                                                                                                                var _b, _c, _d;
                                                                                                                                                                var id = _a.id;
                                                                                                                                                            ...
                                                                                                                                                            : null, ((_15 = field.options) === null || _15 === void 0 ? void 0 : _15.repeat) && ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? ((0, jsx_runtime_1.jsx)(String, { field: field, label: "Repeat", value: (_16 = repeats[field.id]) !== null && _16 !== void 0 ? _16 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? ((0, jsx_runtime_1.jsx)(StringLong, { field: field, label: "Repeat", value: (_17 = repeats[field.id]) !== null && _17 !== void 0 ? _17 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? ((0, jsx_runtime_1.jsx)(Number, { field: field, label: "Repeat", value: (_18 = repeats[field.id]) !== null && _18 !== void 0 ? _18 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
