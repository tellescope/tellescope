...
var QuestionForField = function (_a) {
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20;
    ...
    var AppointmentBooking = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _2 !== void 0 ? _2 : inputs_1.AppointmentBookingInput;
    var Height = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _3 !== void 0 ? _3 : inputs_1.HeightInput;
    var Redirect = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _4 !== void 0 ? _4 : inputs_1.RedirectInput;
    var HiddenValue = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _5 !== void 0 ? _5 : inputs_1.HiddenValueInput;
    var Emotii = (_6 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _6 !== void 0 ? _6 : inputs_1.EmotiiInput;
    var Allergies = (_7 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _7 !== void 0 ? _7 : inputs_1.AllergiesInput;
    var Conditions = (_8 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _8 !== void 0 ? _8 : inputs_1.ConditionsInput;
    var RichText = (_9 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _9 !== void 0 ? _9 : inputs_1.RichTextInput;
    var BelugaPatientPreference = (_10 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Beluga Patient Preference']) !== null && _10 !== void 0 ? _10 : inputs_1.BelugaPatientPreferenceInput;
    var PharmacySearch = (_11 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Pharmacy Search']) !== null && _11 !== void 0 ? _11 : inputs_1.PharmacySearchInput;
    ...
    (0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
            ...
            field.disabledWhenPrepopulated && value.answer.value !== undefined && value.answer.value !== null && value.answer.value !== '' ? ((0, jsx_runtime_1.jsx)("div", __assign({ style: {
                ...
                : field.type === 'file' ? ((0, jsx_runtime_1.jsx)(File, { field: field, value: (_13 = file.blobs) === null || _13 === void 0 ? void 0 : _13[0], onChange: onAddFile, form: form, enduserId: enduserId, existingFileName: value.answer.type === 'file'
                                                                                                                                                    ...
                                                                                                                                                    : field.type === 'Table Input' ? ((0, jsx_runtime_1.jsx)(inputs_1.TableInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                        : field.type === 'Timezone' ? ((0, jsx_runtime_1.jsx)(inputs_1.TimezoneInput, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                            : field.type === 'Time' ? ((0, jsx_runtime_1.jsx)(Time, { field: field, value: value.answer.value, onChange: onFieldChange, form: form }))
                                                                                                                                                                : field.type === 'Question Group' ? ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ column: true, flex: 1 }, { children: ((_16 = (_15 = field.options) === null || _15 === void 0 ? void 0 : _15.subFields) !== null && _16 !== void 0 ? _16 : []).map(function (_a, indexInGroup) {
                                                                                                                                                                        var _b, _c, _d;
                                                                                                                                                                        var id = _a.id;
                                                                                                                                                                    ...
                                                                                                                                                                    : null, ((_17 = field.options) === null || _17 === void 0 ? void 0 : _17.repeat) && ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ style: { marginTop: '8px' } }, { children: field.type === 'string' ? ((0, jsx_runtime_1.jsx)(String, { field: field, label: "Repeat", value: (_18 = repeats[field.id]) !== null && _18 !== void 0 ? _18 : '', onChange: function (u) {
                        var _a;
                        return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                    }, form: form }))
                    : field.type === 'stringLong' ? ((0, jsx_runtime_1.jsx)(StringLong, { field: field, label: "Repeat", value: (_19 = repeats[field.id]) !== null && _19 !== void 0 ? _19 : '', onChange: function (u) {
                            var _a;
                            return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                        }, form: form }))
                        : field.type === 'number' ? ((0, jsx_runtime_1.jsx)(Number, { field: field, label: "Repeat", value: (_20 = repeats[field.id]) !== null && _20 !== void 0 ? _20 : '', onChange: function (u) {
                                var _a;
                                return onRepeatsChange(__assign(__assign({}, repeats), (_a = {}, _a[field.id] = u, _a)));
                            }, form: form }))
