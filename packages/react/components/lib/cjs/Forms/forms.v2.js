...
var QuestionForField = function (_a) {
    ...
    var StediEligibility = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Stedi Eligibility']) !== null && _2 !== void 0 ? _2 : inputs_v2_1.StediEligibilityInput;
    var AppointmentBooking = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _3 !== void 0 ? _3 : inputs_v2_1.AppointmentBookingInput;
    var Height = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _4 !== void 0 ? _4 : inputs_v2_1.HeightInput;
    var Redirect = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _5 !== void 0 ? _5 : inputs_v2_1.RedirectInput;
    var HiddenValue = (_6 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _6 !== void 0 ? _6 : inputs_v2_1.HiddenValueInput;
    var Emotii = (_7 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _7 !== void 0 ? _7 : inputs_v2_1.EmotiiInput;
    var Allergies = (_8 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _8 !== void 0 ? _8 : inputs_v2_1.AllergiesInput;
    var Conditions = (_9 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _9 !== void 0 ? _9 : inputs_v2_1.ConditionsInput;
    var RichText = (_10 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _10 !== void 0 ? _10 : inputs_v2_1.RichTextInput;
    var BelugaPatientPreference = (_11 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Beluga Patient Preference']) !== null && _11 !== void 0 ? _11 : inputs_v2_1.BelugaPatientPreferenceInput;
    var PharmacySearch = (_12 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Pharmacy Search']) !== null && _12 !== void 0 ? _12 : inputs_v2_1.PharmacySearchInput;
    ...
    (0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true, flex: 1, style: { marginBottom: spacing !== null && spacing !== void 0 ? spacing : 25 }, id: field.id }, { children: [field.type !== 'Redirect' && field.title &&
                (0, jsx_runtime_1.jsxs)(index_1.Typography, __assign({ component: "h4", style: {
                    ...
                    } }, { children: [(0, index_1.form_display_text_for_language)(form, field.title), !(field.isOptional || field.type === 'description' || field.type === 'Question Group' || field.type === 'Insurance' || field.type === 'Bridge Eligibility' || field.type === 'Candid Eligibility' || field.type === 'Stedi Eligibility') ? '*' : ''] })), !field.title && (field.type === 'Question Group' || field.type === 'signature') && !((_13 = form === null || form === void 0 ? void 0 : form.customization) === null || _13 === void 0 ? void 0 : _13.hideLogo) &&
