...
var QuestionForField = function (_a) {
    ...
    var AppointmentBooking = (_1 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _1 !== void 0 ? _1 : inputs_v2_1.AppointmentBookingInput;
    var Height = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _2 !== void 0 ? _2 : inputs_v2_1.HeightInput;
    var Redirect = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _3 !== void 0 ? _3 : inputs_v2_1.RedirectInput;
    var HiddenValue = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _4 !== void 0 ? _4 : inputs_v2_1.HiddenValueInput;
    var Emotii = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _5 !== void 0 ? _5 : inputs_v2_1.EmotiiInput;
    var Allergies = (_6 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _6 !== void 0 ? _6 : inputs_v2_1.AllergiesInput;
    var Conditions = (_7 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _7 !== void 0 ? _7 : inputs_v2_1.ConditionsInput;
    var RichText = (_8 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _8 !== void 0 ? _8 : inputs_v2_1.RichTextInput;
    var BelugaPatientPreference = (_9 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Beluga Patient Preference']) !== null && _9 !== void 0 ? _9 : inputs_v2_1.BelugaPatientPreferenceInput;
    var PharmacySearch = (_10 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Pharmacy Search']) !== null && _10 !== void 0 ? _10 : inputs_v2_1.PharmacySearchInput;
...
var TellescopeSingleQuestionFlowV2 = function (_a) {
    ...
    return (submitted
        ...
        : ((0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true, flex: 1, style: { justifyContent: 'space-between' } }, { children: [(0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ column: true }, { children: [!(customization === null || customization === void 0 ? void 0 : customization.hideProgressBar) &&
                            ...
                            ? ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ alignItems: "flex-start", style: { marginBottom: '20px' } }, { children: (0, jsx_runtime_1.jsx)("img", { src: theme.logoURL, alt: theme.name, style: { height: (customization === null || customization === void 0 ? void 0 : customization.logoHeight) || LOGO_HEIGHT, maxWidth: 225 } }) })))
