...
var TellescopeFormContainerWithThemeV2 = function (_a) {
    var _b = _a.paperMinHeight, paperMinHeight = _b === void 0 ? 575 : _b, children = _a.children, language = _a.language, onChangeLanguage = _a.onChangeLanguage, style = _a.style, hideBg = _a.hideBg, backgroundColor = _a.backgroundColor, hideLogo = _a.hideLogo, showLogo = _a.showLogo, logoURL = _a.logoURL, logoHeight = _a.logoHeight, maxWidth = _a.maxWidth;
    ...
    return ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ flex: 1, column: true, alignItems: "center", style: __assign({ backgroundColor: finalBgColor, overflow: 'auto', boxSizing: 'border-box', paddingTop: window.innerWidth < 600 ? 20 : 40, paddingBottom: window.innerWidth < 600 ? 20 : 40 }, style) }, { children: (0, jsx_runtime_1.jsxs)(index_1.Flex, __assign({ flex: 1, column: true, style: __assign({ padding: window.innerWidth < 600 ? '0 12px' : '0 20px', maxWidth: maxWidth !== null && maxWidth !== void 0 ? maxWidth : 650, minWidth: 250, width: '100%', height: '100%', boxSizing: 'border-box' }, (window.innerWidth < 600 ? {
                paddingBottom: '80px' // Extra bottom padding on mobile to keep button above Safari navigation
                    ...
                    ? ((0, jsx_runtime_1.jsx)(index_1.Flex, __assign({ alignItems: "flex-start", style: { marginBottom: '20px', marginTop: '10px' } }, { children: (0, jsx_runtime_1.jsx)("img", { src: resolvedLogoURL, alt: theme === null || theme === void 0 ? void 0 : theme.name, style: { height: logoHeight || LOGO_HEIGHT, maxWidth: 225 } }) })))
                    : (theme === null || theme === void 0 ? void 0 : theme.name)
                        ? ((0, jsx_runtime_1.jsx)(index_1.Typography, __assign({ style: { fontSize: 22, marginBottom: '20px', marginTop: '10px', textAlign: 'left', fontWeight: 600 } }, { children: theme.name })))
                        : null), children] })) })));
};
var LOGO_HEIGHT = 40;
...
var QuestionForField = function (_a) {
    ...
    var BridgeEligibility = (_0 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Bridge Eligibility']) !== null && _0 !== void 0 ? _0 : inputs_v2_1.BridgeEligibilityInput;
    var CandidEligibility = (_1 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Candid Eligibility']) !== null && _1 !== void 0 ? _1 : inputs_v2_1.CandidEligibilityInput;
    var AppointmentBooking = (_2 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Appointment Booking']) !== null && _2 !== void 0 ? _2 : inputs_v2_1.AppointmentBookingInput;
    var Height = (_3 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Height']) !== null && _3 !== void 0 ? _3 : inputs_v2_1.HeightInput;
    var Redirect = (_4 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Redirect']) !== null && _4 !== void 0 ? _4 : inputs_v2_1.RedirectInput;
    var HiddenValue = (_5 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Hidden Value']) !== null && _5 !== void 0 ? _5 : inputs_v2_1.HiddenValueInput;
    var Emotii = (_6 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Emotii']) !== null && _6 !== void 0 ? _6 : inputs_v2_1.EmotiiInput;
    var Allergies = (_7 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Allergies']) !== null && _7 !== void 0 ? _7 : inputs_v2_1.AllergiesInput;
    var Conditions = (_8 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Conditions']) !== null && _8 !== void 0 ? _8 : inputs_v2_1.ConditionsInput;
    var RichText = (_9 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Rich Text']) !== null && _9 !== void 0 ? _9 : inputs_v2_1.RichTextInput;
    var BelugaPatientPreference = (_10 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Beluga Patient Preference']) !== null && _10 !== void 0 ? _10 : inputs_v2_1.BelugaPatientPreferenceInput;
    var PharmacySearch = (_11 = customInputs === null || customInputs === void 0 ? void 0 : customInputs['Pharmacy Search']) !== null && _11 !== void 0 ? _11 : inputs_v2_1.PharmacySearchInput;
