...
import { AddToDatabaseProps } from "./inputs.v2";
import { FormResponse, FormField, Form, Enduser } from "@tellescope/types-client";
import { OrganizationTheme } from "@tellescope/types-models";
export declare const TellescopeFormContainerV2: ({ businessId, organizationIds, ...props }: {
...
} & Pick<TellescopeFormProps, "rootResponseId" | "enduserId" | "formResponseId" | "fields" | "enduser" | "groupId" | "groupInstance" | "responses" | "goToNextField" | "submit" | "isPreviousDisabled" | "goToPreviousField" | "handleDatabaseSelect" | "onAddFile" | "onFieldChange" | "customInputs" | "selectedFiles" | "validateField" | "lastNavigationDirectionRef">) => JSX.Element | null;
...
export declare const SaveDraft: ({ selectedFiles, enduserId, responses, existingResponses, fields, onSuccess, formResponseId, includedFieldIds, formId, style, disabled, getResponsesWithQuestionGroupAnswers, isInternalNote, formTitle, rootResponseId, parentResponseId, }: Styled & Pick<TellescopeFormProps, "existingResponses" | "enduserId" | "fields" | "responses" | "selectedFiles" | "onSuccess" | "getResponsesWithQuestionGroupAnswers"> & {
...
export declare const UpdateResponse: ({ selectedFiles, enduserId, responses, onSuccess, formResponseId, includedFieldIds, formId, style, disabled, getResponsesWithQuestionGroupAnswers, existingResponses, fields, }: Styled & Pick<TellescopeFormProps, "existingResponses" | "enduserId" | "fields" | "responses" | "selectedFiles" | "onSuccess" | "getResponsesWithQuestionGroupAnswers"> & {
    disabled?: boolean | undefined;
    formResponseId?: string | undefined;
    formId: string;
    includedFieldIds: string[];
...
//# sourceMappingURL=forms.v2.d.ts.map