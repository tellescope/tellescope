...
} & Pick<TellescopeFormProps, "enduserId" | "fields" | "formResponseId" | "rootResponseId" | "groupId" | "groupInstance" | "responses" | "enduser" | "goToNextField" | "submit" | "isPreviousDisabled" | "goToPreviousField" | "handleDatabaseSelect" | "onAddFile" | "onFieldChange" | "customInputs" | "selectedFiles" | "validateField" | "lastNavigationDirectionRef">) => JSX.Element | null;
