...
var ticketTemplatesSlice = (0, exports.createSliceForList)('ticket_templates');
...
var organizationPaymentsSlice = (0, exports.createSliceForList)('organization_payments');
...
var aiConversationsSlice = (0, exports.createSliceForList)('ai_conversations');
...
var useListStateHook = function (modelName, state, session, slice, apiCalls, options) {
    ...
    var updateElement = (0, react_1.useCallback)(function (id, e, o, _overrideUnique) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
...
var useAIConversations = function (options) {
    if (options === void 0) { options = {}; }
    var session = (0, index_1.useSession)();
    return (0, exports.useListStateHook)('ai_conversations', useTypedSelector(function (s) { return s.ai_conversations; }), session, aiConversationsSlice, {
...
var useOrganizationPayments = function (options) {
    if (options === void 0) { options = {}; }
    var session = (0, index_1.useSession)();
    return (0, exports.useListStateHook)('organization_payments', useTypedSelector(function (s) { return s.organization_payments; }), session, organizationPaymentsSlice, {
...
exports.useOrganizationPayments = useOrganizationPayments;
...
var useTicketTemplates = function (options) {
    if (options === void 0) { options = {}; }
    var session = (0, index_1.useSession)();
    return (0, exports.useListStateHook)('ticket_templates', useTypedSelector(function (s) { return s.ticket_templates; }), session, ticketTemplatesSlice, {
...
exports.useTicketTemplates = useTicketTemplates;
