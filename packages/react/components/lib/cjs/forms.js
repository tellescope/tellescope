...
exports.FormBuilder = exports.SubmitButton = exports.LoadingButton = exports.FormikSubmitButton = exports.passwordInput = exports.emailInput = exports.validators = exports.initial_values_for_formik = exports.initial_values_for_input_schema = exports.validation_for_input_schema = exports.create_input_schema = void 0;
...
var create_input_schema = function (o) { return o; };
exports.create_input_schema = create_input_schema;
var validation_for_input_schema = function (schema) {
...
exports.validation_for_input_schema = validation_for_input_schema;
var initial_values_for_input_schema = function (schema, dynamicallySet) {
    var _a;
...
exports.initial_values_for_input_schema = initial_values_for_input_schema;
// formik requires string signature but will cast numbers appropriately
var initial_values_for_formik = function (schema, dynamicallySet) {
    if (dynamicallySet === void 0) { dynamicallySet = {}; }
    return (0, exports.initial_values_for_input_schema)(schema, dynamicallySet);
};
exports.initial_values_for_formik = initial_values_for_formik;
...
var emailInput = function (_a) {
    ...
    return ({
        ...
        validation: exports.validators.email,
        Component: mui_1.TextField,
...
var FormikSubmitButton = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(exports.SubmitButton, __assign({ onClick: onClick, submitText: submitText, submittingText: submittingText, disabled: !enabled && (disabled || !formik.isValid || (disabledIfUnchanged && !formik.dirty)), style: style, submitting: formik.isSubmitting, muiColor: muiColor }, props)));
};
...
var LoadingButton = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(mui_1.Button, __assign({ color: muiColor || "primary", variant: variant, type: type, onClick: function () { return handleAPIError(function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                }); }); }, style: style, disabled: loading || submitting || disabled || formLoading }, { children: [(0, jsx_runtime_1.jsx)(mui_1.Typography, __assign({ component: "span" }, { children: submitting ? submittingText : submitText })), (submitting || loading) && (0, jsx_runtime_1.jsx)(mui_1.CircularProgress, { size: 11, style: { marginLeft: 5, marginBottom: 1 } })] })), !(onError || throwOnError) && errorDisplay] }));
};
...
var SubmitButton = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(exports.LoadingButton, __assign({ throwOnError: true }, props, { type: "submit", onClick: layout_1.SUPPORTS_FORMS ? undefined : onClick })));
};
...
var FormBuilder = function (_a) {
    ...
    var _b = react_2.default.useState(''), error = _b[0], setError = _b[1];
    ...
    return ((0, jsx_runtime_1.jsx)(formik_1.Formik, __assign({ initialValues: initialValues, validationSchema: Yup.object(validationSchema), onSubmit: function (v, o) { return __awaiter(void 0, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4: return [2 /*return*/];
        ...
        }); } }, { children: function (formik) { return ((0, jsx_runtime_1.jsx)(layout_1.Flex, __assign({ column: true, flex: 1, style: style }, { children: (0, jsx_runtime_1.jsxs)(layout_1.Form, __assign({ onSubmit: formik.handleSubmit }, { children: [(0, jsx_runtime_1.jsx)(layout_1.Flex, __assign({ column: true }, { children: Object.keys(fields).map(function (fieldName) {
                            var _a;
                            var id = fieldName;
                        ...
                        }) })), (0, jsx_runtime_1.jsxs)(layout_1.Flex, __assign({ column: true }, { children: [(0, jsx_runtime_1.jsx)(layout_1.Flex, { children: (0, jsx_runtime_1.jsx)(exports.FormikSubmitButton, __assign({ formik: formik, disabledIfUnchanged: disabledIfUnchanged, onClick: formik.handleSubmit }, options)) }), (0, jsx_runtime_1.jsx)(layout_1.Flex, { children: error ? (0, jsx_runtime_1.jsx)(mui_1.Typography, __assign({ color: "error" }, { children: error === null || error === void 0 ? void 0 : error.toString() })) : null })] }))] })) }))); } })));
};
