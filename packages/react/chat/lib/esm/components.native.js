...
var SendImageOrVideo = function (_a) {
    ...
    var _d = useFileUpload({ enduserId: session.userInfo.id }), handleUpload = _d.handleUpload, uploading = _d.uploading;
            ...
            switch (_e.label) {
                case 0:
                    if (uploading)
                        return [2 /*return*/];
                    setErrorMessage('');
                    return [4 /*yield*/, (type === 'library' ? launchImageLibrary : launchCamera)({
                            mediaType: 'mixed',
                            maxWidth: 500,
                            maxHeight: 500,
                        })];
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Modal, __assign({ animationType: 'fade', transparent: true, visible: menuOpen, onRequestClose: function () { return setMenuOpen(false); } }, { children: _jsx(Flex, __assign({ flex: 1, alignItems: "center", justifyContent: "center" }, { children: _jsxs(Paper, __assign({ flex: true, style: { padding: 25, margin: 10, } }, { children: [_jsx(Button, __assign({ disabled: menuDisabled, variant: "contained", onPress: function () { return handleImageSelect('library'); }, style: { marginBottom: 20, fontSize: 18, padding: 10 } }, { children: "Upload Photo or Video" })), _jsx(Button, __assign({ disabled: menuDisabled, variant: "contained", onPress: function () { return handleImageSelect('camera'); }, style: { fontSize: 18, padding: 10 } }, { children: "Take Photo" })), _jsx(Button, __assign({ variant: 'outlined', onPress: function () { return setMenuOpen(false); }, style: { marginTop: 25 } }, { children: "Cancel" })), _jsx(Typography, __assign({ style: { marginTop: 5, color: '#ff4444' } }, { children: errorMessage }))] })) })) })), _jsx(LabeledIconButton, { label: "attach image", disabled: menuDisabled, onClick: function () { return setMenuOpen(true); }, Icon: function () { return _jsx(Avatar.Icon, { icon: 'image', size: CHAT_ICON_SIZE }); } })] }));
};
export var SendMessage = function (_a) {
    ...
    var _f = useChats(roomId), createMessage = _f[1].createElement;
    return (_jsxs(Flex, __assign({ row: true, flex: 1, alignContent: "center", style: __assign({ marginTop: 8 }, style) }, { children: [_jsx(Flex, __assign({ column: true, flex: 1, style: { marginLeft: 5, marginRight: 5 } }, { children: _jsx(TextInput, { value: message, onChangeText: setMessage, style: {
                        width: '100%',
                        borderColor: '#0f0f0f',
                        borderWidth: 1,
                        padding: 10,
                        borderRadius: 5,
                    }, "aria-label": "Enter a message...", placeholder: placeholderText }) })), _jsxs(Flex, __assign({ alignSelf: "center" }, { children: [_jsx(Flex, __assign({ style: { marginRight: 5 } }, { children: _jsx(AsyncIconButton, { label: "send", Icon: function () { return _jsx(SendIcon, { size: CHAT_ICON_SIZE }); }, disabled: message === '', action: function () { return createMessage({ message: message, roomId: roomId }); }, onSuccess: function () { return setMessage(''); }, onChange: setSending }) })), _jsx(Flex, __assign({ style: { marginRight: 5 } }, { children: _jsx(SendImageOrVideo, { disabled: sending, onUpload: function (_a, type) {
