...
import { ConsoleLogger, DefaultDeviceController, isVideoTransformDevice, LogLevel, MeetingSessionConfiguration } from "amazon-chime-sdk-js";
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    setMeeting(meeting);
                    meetingSessionConfiguration = new MeetingSessionConfiguration(meeting, host.info);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    _b.label = 3;
                case 3:
                    meetingSessionConfiguration = new MeetingSessionConfiguration(meeting.meetingInfo, attendeeInfo);
                    return [4 /*yield*/, meetingManager.join(meetingSessionConfiguration)];
                case 4:
                    _b.sent(); // Use the join API to create a meeting session
                    return [4 /*yield*/, meetingManager.start()];
...
var useHandleDataMessages = function () {
    var _a;
    try {
        var session_1 = useResolvedSession();
        var audioVideo_1 = useAudioVideo();
        var _b = useToggleLocalMute(), muted_1 = _b.muted, toggleMute_1 = _b.toggleMute;
        useEffect(function () {
            if (!audioVideo_1) {
                return;
            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    meetingSessionConfiguration = new MeetingSessionConfiguration(meeting_1, host.info);
                    return [4 /*yield*/, meetingManager.join(meetingSessionConfiguration)];
                case 3:
                    _b.sent(); // Use the join API to create a meeting session
                    return [4 /*yield*/, meetingManager.start()];
...
export var useJoinVideoCall = function (props) {
            ...
            switch (_d.label) {
                ...
                case 2:
                    if (!meetingInfo || typeof meetingInfo === 'string' || !attendeeInfo)
                        return [2 /*return*/];
                    meetingSessionConfiguration = new MeetingSessionConfiguration(meetingInfo, attendeeInfo);
                    return [4 /*yield*/, meetingManager.join(meetingSessionConfiguration)];
                case 3:
...
export var SelfView = function (_a) {
    var style = _a.style;
    return _jsx("div", __assign({ style: style }, { children: _jsx(LocalVideo, {}) }));
};
...
export var LocalPreview = function (_a) {
    var _b = _a.style, style = _b === void 0 ? defaultPreviewStyle : _b;
    useEffect(function () {
        var videoElement = document.getElementById(PREVIEW_ELEMENT_ID);
        if (!videoElement)
            return;
        var deviceController = new DefaultDeviceController(new SwappableLogger(new ConsoleLogger('SDK', LogLevel.WARN)), { enableWebAudio: true });
    ...
    return (_jsx(_Fragment, { children: _jsx("video", { id: PREVIEW_ELEMENT_ID, style: style }) }));
};
export { VideoTileGrid };
// unimplemented for web
export var VideoCallNative = function () { return (null); };
export var ScreenShareIcon = function () { return (_jsx(ContentShareControl, { iconTitle: "Screen Share", label: "Share Screen" })); };
export var BlurToggleIcon = function () { return (_jsx(VideoInputBackgroundBlurControl, {})); };
export var ToggleBackgroundImageButton = function () {
    var meetingManager = useMeetingManager();
    var selectedDevice = useVideoInputs().selectedDevice;
    var _a = useState(false), isVideoTransformCheckBoxOn = _a[0], setisVideoTransformCheckBoxOn = _a[1];
    var _b = useBackgroundReplacement(), isBackgroundReplacementSupported = _b.isBackgroundReplacementSupported, createBackgroundReplacementDevice = _b.createBackgroundReplacementDevice;
    useEffect(function () {
    ...
    return (_jsx("div", { children: isBackgroundReplacementSupported && (_jsx("button", __assign({ onClick: onClick }, { children: isVideoTransformDevice(selectedDevice)
