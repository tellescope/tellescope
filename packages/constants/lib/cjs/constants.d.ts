...
export declare const OKTA_INTEGRATIONS_TITLE = "Okta";
...
export declare const USDA_TITLE = "USDA";
...
export declare const MDI_FLAG_ALL_ANSWERS = "*";
...
export declare const SELECTABLE_AI_MODELS: readonly ["Claude Sonnet 5", "Claude Opus 4.8"];
