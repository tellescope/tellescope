...
exports.DEFAULT_VOICE_AGENT_MAX_TOKENS = 300; // per-turn maxTokens (voice replies are 1-2 sentences)
exports.VOICE_AGENT_MAX_TOOL_ROUNDS = 5; // hard cap on tool-loop rounds within one caller turn
