...
export var PROVIDER_PERMISSIONS = {
    inbox_threads: ASSIGNED_AND_DEFAULT_ACCESS,
    ...
    organization_payments: READ_ONLY_ALL,
...
export var DOCUMENT_TYPE_CODINGS = [
...
export var DEFAULT_CALL_SUMMARY_PROMPT = "Summarize this phone call transcription. Include the key topics discussed, any action items or follow-ups mentioned, and the overall outcome of the call. Keep the summary concise (2-4 paragraphs).";
export var DEFAULT_CALL_SUMMARY_MAX_TOKENS = 500;
export var MAX_AI_SUMMARY_INPUT_TOKENS = 150000;
export var AI_SUMMARY_CACHE_TTL_MS = 10 * 60 * 1000;
...
export var SMS_AGENT_CONVERSATION_TYPE = "sms_agent"; // ai_conversations.type for SMS agent conversations (Start AI Conversation journey action)
export var SMS_AGENT_FORM_RESPONSE_SOURCE = "AI Text Agent"; // form_responses.source + booking provenance for SMS-agent-collected data
...
export var VOICE_FORM_SUPPORTED_FIELD_TYPES = [
