...
// for undefined.
export var parse_phone_number = function (phone) {
    if (!phone)
        return undefined;
    try {
...
export var automationActionValidator = orValidator({
    ...
    metriportPushFormResponse: objectValidator(__assign(__assign({}, sharedAutomationActionValidators), { type: exactMatchValidator(['metriportPushFormResponse']), info: objectValidator({
...
export var formFieldOptionsValidator = objectValidator({
    ...
    historicalDataSources: listValidatorOptionalOrEmptyOk(objectValidator({
        type: exactMatchValidator(['Observations', 'Medications']),
        limit: numberValidatorOptional,
        filter: objectAnyFieldsAnyValuesValidator,
    })),
});
...
export var portalBlockValidator = orValidator({
    ...
    "Appointment Booking Pages": objectValidator({
...
export var automationTriggerEventValidator = orValidator({
    ...
    "Fields Changed": objectValidator({
    ...
    "Subscription Paused": objectValidator({
    ...
    "Subscription Resumed": objectValidator({
    ...
    "Stripe: Payment Intent Failed": objectValidator({
...
export var accessPermissionsValidator = objectValidator({
    ...
    ticket_templates: accessPermissionValidator,
...
export var organizationLimitsValidator = objectValidator({
    ...
    ticket_templates: numberValidatorOptional,
...
export var analyticsQueryValidator = orValidator({
    Endusers: objectValidator({
        ...
        grouping: objectValidator({
            ...
            "Access Tags": booleanValidatorOptional,
...
export var phoneTreeEventValidator = orValidator({
    ...
    "On Agent Outcome": objectValidator({
