...
export declare const stringValidator100Optional: ValidatorDefinition<string>;
export declare const stringValidator100EscapeHTML: ValidatorDefinition<string>;
export declare const stringValidator105: ValidatorDefinition<string>;
export declare const stringValidator210: ValidatorDefinition<string>;
...
export declare const sipUrlValidatorOptional: ValidatorDefinition<string>;
...
export declare const linkedAccountAccessEntryValidator: ValidatorDefinition<LinkedAccountAccessEntry>;
export declare const linkedAccountAccessValidator: ValidatorDefinition<LinkedAccountAccessEntry[]>;
...
export declare const pharmacyValidator: ValidatorDefinition<Pharmacy>;
export declare const formResponseAnswerValidator: ValidatorDefinition<(FormResponseAnswerHeight & {
    ...
    type: "Beluga Patient Preference";
...
export declare const videoCallParticipantEventValidator: ValidatorDefinition<VideoCallParticipantEvent>;
export declare const listOfVideoCallParticipantEventsValidator: ValidatorDefinition<VideoCallParticipantEvent[]>;
...
export declare const observationComponentsValidator: ValidatorDefinition<ObservationComponent[]>;
...
export declare const calendarEventLimitValidator: ValidatorDefinition<CalendarEventLimit>;
export declare const calendarEventLimitsValidator: ValidatorDefinition<CalendarEventLimit[]>;
...
export declare const DEPRECATED_AUTOMATION_TRIGGER_EVENT_TYPES: AutomationTriggerEventType[];
export declare const ACTIVE_AUTOMATION_TRIGGER_EVENT_TYPES: (keyof AutomationTriggerEvents)[];
export declare const automationTriggerEventValidator: ValidatorDefinition<import("@tellescope/types-models").AutomationTriggerEventBuilder<"Form Submitted", {
    ...
    formIds?: string[] | undefined;
    sources?: ("Public Form" | "Formsort")[] | undefined;
...
}, {}> | import("@tellescope/types-models").AutomationTriggerEventBuilder<"Beluga Visit Sync Failed", {
    formIds?: string[] | undefined;
}, {}>>;
...
export declare const analyticsQueryValidator: ValidatorDefinition<{
    ...
    filter?: {
        ...
        deliveryStatus?: "All" | "Delivered" | "Failed" | undefined;
    } | undefined;
    grouping?: ({
...
export declare const portalSchemaRestrictionsValidator: ValidatorDefinition<PortalSchemaRestrictions>;
...
export declare const customDashboardBlockValidator: ValidatorDefinition<CustomDashboardBlock>;
export declare const customDashboardBlocksValidator: ValidatorDefinition<CustomDashboardBlock[]>;
...
export declare const userOutOfOfficeValidator: ValidatorDefinition<UserOutOfOffice>;
export declare const userOutOfOfficesValidator: ValidatorDefinition<UserOutOfOffice[]>;
export declare const emailCCValidator: ValidatorDefinition<{
    email: string;
    name?: string | undefined;
}>;
export declare const listOfEmailCCsValidator: ValidatorDefinition<{
    email: string;
    name?: string | undefined;
}[]>;
