...
exports.stringValidator100Optional = {
    validate: function (o) {
        if (o === void 0) { o = {}; }
        return (0, exports.build_validator)((0, exports.escapeString)(o), __assign(__assign({}, o), { maxLength: 100, listOf: false, isOptional: true, emptyStringOk: true }));
    },
    getExample: getExampleString,
    getType: getTypeString
};
...
exports.stringValidator105 = {
    validate: function (o) {
        if (o === void 0) { o = {}; }
        return (0, exports.build_validator)((0, exports.escapeString)(o), __assign(__assign({}, o), { maxLength: 105, listOf: false }));
    },
    getExample: getExampleString,
    getType: getTypeString,
};
exports.stringValidator210 = {
    validate: function (o) {
        if (o === void 0) { o = {}; }
        return (0, exports.build_validator)((0, exports.escapeString)(o), __assign(__assign({}, o), { maxLength: 210, listOf: false }));
    },
    getExample: getExampleString,
    getType: getTypeString,
};
...
exports.stringValidator100000 = {
    validate: function (o) {
        if (o === void 0) { o = {}; }
        return (0, exports.build_validator)((0, exports.escapeString)(o), __assign(__assign({}, o), { maxLength: 100000, listOf: false }));
    },
    getExample: getExampleString,
    getType: getTypeString,
};
...
exports.listOfListsOfMongoIdStringsValidatorOptionalOrEmptyOk = (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.listValidator)(exports.mongoIdStringRequired));
...
exports.nonNegNumberValidatorOptional = (0, exports.numberValidatorBuilder)({ lower: 0, upper: 10000000000000, isOptional: true }); // max is 2286 in UTC MS
...
exports.inclusionProjectionValidator = (0, exports.objectAnyFieldsValidator)((0, exports.numberValidatorBuilder)({ lower: 1, upper: 1 }));
// Day of month and time validators for automation events
exports.numberValidatorMin1Max31 = (0, exports.numberValidatorBuilder)({ lower: 1, upper: 31 });
exports.numberValidatorMin0Max23Optional = (0, exports.numberValidatorBuilder)({ lower: 0, upper: 23, isOptional: true });
exports.numberValidatorMin0Max59Optional = (0, exports.numberValidatorBuilder)({ lower: 0, upper: 59, isOptional: true });
exports.externalIdNumberValidator = (0, exports.numberValidatorBuilder)({ lower: 0, upper: Number.MAX_SAFE_INTEGER });
exports.externalIdNumberValidatorOptional = (0, exports.numberValidatorBuilder)({ lower: 0, upper: Number.MAX_SAFE_INTEGER, isOptional: true });
exports.fileSizeValidator = (0, exports.numberValidatorBuilder)({ lower: 0, upper: exports.MAX_FILE_SIZE });
exports.numberValidatorMin1Max100Optional = (0, exports.numberValidatorBuilder)({ lower: 1, upper: 100, isOptional: true });
...
// for undefined.
var parse_phone_number = function (phone) {
    if (!phone)
        return undefined;
    try {
        return exports.phoneValidator.validate()(phone);
    }
    catch (err) {
        return undefined;
    }
...
exports.sipUrlValidator = {
    validate: function (options) {
        if (options === void 0) { options = {}; }
        return (0, exports.build_validator)(validate_sip_url, __assign(__assign({}, options), { maxLength: 256, listOf: false }));
    },
    getExample: function () { return "sip:agent@pbx.example.com"; },
    getType: getTypeString,
};
exports.sipUrlValidatorOptional = {
    validate: function (options) {
        if (options === void 0) { options = {}; }
        return (0, exports.build_validator)(validate_sip_url, __assign(__assign({}, options), { maxLength: 256, listOf: false, isOptional: true, emptyStringOk: true }));
    },
    getExample: function () { return "sip:agent@pbx.example.com"; },
    getType: getTypeString,
};
...
exports.linkedAccountAccessEntryValidator = (0, exports.objectValidator)({
    ...
    orgName: exports.stringValidatorOptional,
    status: (0, exports.exactMatchValidator)(['pending', 'accepted']),
    createdAt: exports.dateValidator,
    requestExpiresAt: exports.dateValidator,
});
exports.linkedAccountAccessValidator = (0, exports.listValidatorOptionalOrEmptyOk)(exports.linkedAccountAccessEntryValidator);
...
exports.fieldTranslationsValidator = (0, exports.indexableValidator)(exports.stringValidator100, exports.stringValidator25000);
exports.translationsValidator = (0, exports.indexableValidator)(exports.stringValidator100, exports.fieldTranslationsValidator);
// todo: move preference to FIELD_TYPES with drop-down option in user-facing forms
...
exports.pharmacyValidator = (0, exports.objectValidator)({
    ...
    ncpdpId: exports.stringValidator,
    businessName: exports.stringValidator,
    primaryTelephone: exports.stringValidator,
    addressLine1: exports.stringValidatorOptional,
    city: exports.stringValidatorOptional,
    stateProvince: exports.stringValidatorOptional,
    postalCode: exports.stringValidatorOptional,
}, { isOptional: true, emptyOk: true });
...
exports.formResponseAnswerValidator = (0, exports.orValidator)({
    ...
    "Pharmacy Search": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Pharmacy Search']),
        value: exports.pharmacyValidator
    })
});
...
exports.videoCallParticipantEventValidator = (0, exports.objectValidator)({
    id: exports.stringValidator250,
    type: (0, exports.exactMatchValidator)(['connected', 'disconnected']),
    timestamp: exports.dateValidator,
    meetingId: exports.mongoIdStringRequired,
    participantSid: exports.stringValidatorOptional,
    durationSeconds: exports.nonNegNumberValidatorOptional,
});
exports.listOfVideoCallParticipantEventsValidator = (0, exports.listValidator)(exports.videoCallParticipantEventValidator);
...
exports.coldTransfersValidator = (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.objectValidator)({
    transferredAt: exports.dateValidator,
    userId: exports.mongoIdStringRequired,
}, { emptyOk: false }));
var delayValidation = {
    automationStepId: exports.mongoIdStringRequired,
...
exports.automationEventValidator = (0, exports.orValidator)({
    ...
    afterAction: (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)(__assign(__assign({}, delayValidation), { formCondition: (0, exports.objectValidator)({
                ...
                before: exports.booleanValidatorOptional,
            }, { isOptional: true, emptyOk: true }), dayOfMonthCondition: (0, exports.objectValidator)({
                dayOfMonth: exports.numberValidatorMin1Max31,
                hour: exports.numberValidatorMin0Max23Optional,
                minute: exports.numberValidatorMin0Max59Optional,
    ...
    onAIDecision: (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['onAIDecision']),
        info: (0, exports.objectValidator)({
            automationStepId: exports.mongoIdStringRequired,
            outcomes: exports.listOfStringsValidator,
        }, { emptyOk: false }),
    }),
    onAIConversationOutcome: (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['onAIConversationOutcome']),
        info: (0, exports.objectValidator)({
            automationStepId: exports.mongoIdStringRequired,
            outcome: exports.stringValidator,
        }, { emptyOk: false }),
    }),
    onError: (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['onError']),
        info: (0, exports.objectValidator)({
            automationStepId: exports.mongoIdStringRequired,
        }, { emptyOk: false }),
    }),
...
exports.ticketActionValidator = (0, exports.orValidator)({
    ...
    "Send Chat": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            ...
            enableChatReply: exports.booleanValidatorOptional,
        }, { emptyOk: false }),
        completedAt: exports.dateOptionalOrEmptyStringValidator,
        optional: exports.booleanValidatorOptional,
    }),
...
var sendWebhookInfoValidator = (0, exports.objectValidator)({
    ...
    rawJSONBody: exports.stringValidator25000OptionalEmptyOkay,
}, { emptyOk: false });
exports.AI_SUMMARY_DATA_SOURCES = [
...
exports.aiSummaryDataSourceConfigValidator = (0, exports.objectValidator)({
    type: exports.aiSummaryDataSourceTypeValidator,
...
exports.aiSummaryConfigurationValidator = (0, exports.objectValidator)({
    ...
    prompt: exports.stringValidator5000OptionalEmptyOkay,
    dataSources: (0, exports.listValidatorOptionalOrEmptyOk)(exports.aiSummaryDataSourceConfigValidator),
    maxOutputTokens: exports.nonNegNumberValidatorOptional,
    includeProfileFields: exports.booleanValidatorOptional,
    model: exports.selectableAIModelValidator,
}, { isOptional: true, emptyOk: true });
exports.AIDecisionSourceValidator = (0, exports.objectValidator)({
    limit: exports.numberValidator,
    type: exports.stringValidator,
});
exports.AIMessageInputValidator = (0, exports.objectValidator)({
    role: (0, exports.exactMatchValidator)(['user', 'assistant']),
    text: exports.stringValidator100000,
}, { emptyOk: false });
...
exports.phoneTreeAgentToolValidator = (0, exports.orValidator)({
    "Submit Form": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Submit Form']),
        info: (0, exports.objectValidator)({
            formId: exports.mongoIdStringRequired,
            useWhen: exports.stringValidator1000Optional,
        }),
    }),
    "Book Appointment": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Book Appointment']),
        info: (0, exports.objectValidator)({
            appointmentBookingPageId: exports.mongoIdStringRequired,
            useWhen: exports.stringValidator1000Optional,
        }),
    }),
});
exports.automationActionValidator = (0, exports.orValidator)({
    ...
    setEnduserFields: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['setEnduserFields']), info: (0, exports.objectValidator)({
            fields: (0, exports.listValidator)((0, exports.objectValidator)({
                ...
                dateDifferenceOptions: (0, exports.objectValidator)({
                    date1: exports.stringValidator,
                    date2: exports.stringValidator,
                }, { isOptional: true }),
            }))
        }, { emptyOk: false }) })),
    ...
    zendeskCreateTicket: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['zendeskCreateTicket']), info: (0, exports.objectValidator)({
            ...
            isInternalNote: exports.booleanValidatorOptional,
        }, { emptyOk: false }) })),
    ...
    belugaAutoRx: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['belugaAutoRx']), info: (0, exports.objectValidator)({
            ...
            patientPreference: (0, exports.objectValidator)({
                ...
                refills: exports.stringValidatorOptional,
                quantity: exports.stringValidatorOptional,
                medId: exports.stringValidatorOptional,
            }, { isOptional: true, emptyOk: true }),
            pharmacyId: exports.stringValidatorOptional,
            useOrganizationMapping: exports.booleanValidatorOptional,
            customFieldName: exports.stringValidatorOptional,
        }) })),
    belugaUpdateVisit: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['belugaUpdateVisit']), info: (0, exports.objectValidator)({
            ...
            patientPreferences: (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.objectValidator)({
                ...
                refills: exports.stringValidatorOptional,
                quantity: exports.stringValidatorOptional,
                daysSupply: exports.stringValidatorOptional,
                medId: exports.stringValidatorOptional,
            })),
            pharmacyId: exports.stringValidatorOptional,
            useOrganizationMapping: exports.booleanValidatorOptional,
    ...
    belugaTriggerRefill: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['belugaTriggerRefill']), info: (0, exports.objectValidator)({
            formId: exports.mongoIdStringRequired,
            patientPreferences: (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.objectValidator)({
                medId: exports.stringValidatorOptional,
            })),
    ...
    mdiTriggerRefill: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['mdiTriggerRefill']), info: (0, exports.objectValidator)({
            onlySubmitWhenDue: exports.booleanValidatorOptional,
        }) })),
    ...
    canvasCreateNote: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['canvasCreateNote']), info: (0, exports.objectValidator)({
            ...
            syncAllFormResponses: exports.booleanValidatorOptional,
        }) })),
    canvasAddToGroup: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['canvasAddToGroup']), info: (0, exports.objectValidator)({
            groupId: exports.stringValidator100,
        }) })),
    ...
    stripeCancelSubscription: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['stripeCancelSubscription']), info: (0, exports.objectValidator)({
            stripeKey: exports.stringValidatorOptionalEmptyOkay,
            metadataKey: exports.stringValidator100,
            metadataValue: exports.stringValidator100,
            cancelImmediately: exports.booleanValidatorOptional,
        }, { emptyOk: false }) })),
    chargebeeChargeCardOnFile: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['chargebeeChargeCardOnFile']), info: (0, exports.objectValidator)({
            chargebeeEnvironment: exports.stringValidator,
    ...
    aiDecision: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['aiDecision']), info: (0, exports.objectValidator)({
            outcomes: exports.listOfStringsValidator,
            prompt: exports.stringValidator5000OptionalEmptyOkay,
            sources: (0, exports.listValidatorOptionalOrEmptyOk)(exports.AIDecisionSourceValidator),
            aiSummaryConfiguration: exports.aiSummaryConfigurationValidator, // new shared config (optional)
    ...
    startAIConversation: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['startAIConversation']), info: (0, exports.objectValidator)({
            ...
            senderId: exports.mongoIdStringRequired,
            fromNumber: exports.phoneValidatorOptional,
            initialMessage: exports.SMSMessageValidator,
            ...
            tools: (0, exports.listValidatorOptionalOrEmptyOk)(exports.phoneTreeAgentToolValidator),
            model: exports.selectableAIModelValidator,
            ...
            inactivityTimeoutHours: exports.numberValidatorOptional,
        }, { emptyOk: false }) })),
    assignInboxItem: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['assignInboxItem']), info: (0, exports.objectValidator)({
            tags: exports.listOfStringsWithQualifierValidator,
    ...
    createScriptSureDraft: (0, exports.objectValidator)(__assign(__assign({}, sharedAutomationActionValidators), { type: (0, exports.exactMatchValidator)(['createScriptSureDraft']), info: (0, exports.objectValidator)({
            prescriptionRouteId: exports.mongoIdStringOptional,
            matchMedicationTitle: exports.stringValidatorOptional,
            matchEnduserState: exports.booleanValidatorOptional,
        }, { emptyOk: false }) })),
...
exports.searchOptionsValidator = (0, exports.objectValidator)({
    ...
    minSearchScore: exports.nonNegNumberValidatorOptional,
});
...
exports.userPortalSettingsValidator = (0, exports.indexableValidator)(exports.stringValidator250, (0, exports.orValidator)({ boolean: exports.booleanValidator, string: exports.stringValidator250 }, { isOptional: true }));
...
exports.observationComponentsValidator = (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.objectValidator)({
    code: (0, exports.objectValidator)({
        text: exports.stringValidator,
        coding: (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.objectValidator)({
            system: exports.stringValidator,
            code: exports.stringValidator,
            display: exports.stringValidatorOptional,
        })),
    }, { emptyOk: false }),
    valueQuantity: exports.FHIRObservationValueValidator,
}));
...
exports.portalSettingsValidator = (0, exports.objectValidator)({
    authentication: (0, exports.objectValidator)({
        ...
        loginBottomHTML: exports.stringValidator5000OptionalEmptyOkay,
    ...
    documents: (0, exports.objectValidator)({
        ...
        hidePinnedFormStartsFromOutstandingBanner: exports.booleanValidatorOptional,
    }, { isOptional: true, emptyOk: true }),
    hideSettingsPage: exports.booleanValidatorOptional,
});
...
exports.formFieldOptionDetailsValidator = (0, exports.objectValidator)({
    option: exports.stringValidator,
    description: exports.stringValidator5000Optional,
...
exports.formFieldOptionsValidator = (0, exports.objectValidator)({
    ...
    optionDetails: (0, exports.listValidatorOptionalOrEmptyOk)(exports.formFieldOptionDetailsValidator),
    ...
    maxFileSize: exports.numberValidatorOptional,
    hideFromPortal: exports.booleanValidatorOptional,
    productIds: exports.listOfStringsValidatorOptionalOrEmptyOk,
    chargeImmediately: exports.booleanValidatorOptional,
    saveCardOnFile: exports.booleanValidatorOptional,
    ...
    filterByEnduserState: exports.booleanValidatorOptional,
    ...
    prefillCurrentDate: exports.booleanValidatorOptional,
    ...
    chargebeeBusinessEntityId: exports.stringValidatorOptional,
    chargebeePlanId: exports.stringValidatorOptional,
    chargebeeItemId: exports.stringValidatorOptional,
    chargebeeCollectPaymentMethodOnly: exports.booleanValidatorOptional,
    chargebeeCouponIds: exports.listOfStringsValidatorOptionalOrEmptyOk,
...
exports.blockStyleValidator = (0, exports.objectValidator)({
    ...
    backgroundColor: exports.stringValidatorOptional,
    borderColor: exports.stringValidatorOptional,
    borderWidth: exports.numberValidatorOptional,
    textColor: exports.stringValidatorOptional,
}, { isOptional: true, emptyOk: true });
exports.blockValidator = (0, exports.orValidator)({
    ...
    image: (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            ...
            name: exports.stringValidatorOptional,
            alt: exports.stringValidatorOptional,
            height: exports.numberValidatorOptional,
...
exports.portalBlockValidator = (0, exports.orValidator)({
    ...
    careTeam: (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            ...
            hideContactButton: exports.booleanValidatorOptional,
    ...
    pinnedForms: (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['pinnedForms']),
        info: (0, exports.objectValidator)({
...
exports.monthlyRestrictionValidator = (0, exports.objectValidator)({
    occurrences: (0, exports.listValidator)(monthlyOccurrenceValidator),
});
exports.monthlyRestrictionOptionalValidator = (0, exports.objectValidator)({
    occurrences: (0, exports.listValidator)(monthlyOccurrenceValidator),
}, { isOptional: true, emptyOk: true });
exports.weeklyAvailabilityValidator = (0, exports.objectValidator)({
    ...
    monthlyRestriction: exports.monthlyRestrictionOptionalValidator,
});
...
exports.calendarEventLimitsValidator = (0, exports.listValidatorEmptyOk)(exports.calendarEventLimitValidator);
...
exports.customDashboardViewValidator = ((0, exports.objectValidator)({
    blocks: (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.objectValidator)({
        ...
        type: exports.stringValidator100,
        info: exports.objectAnyFieldsAnyValuesValidator,
    }))
}, { isOptional: true, emptyOk: true }));
exports.organizationSettingsValidator = (0, exports.objectValidator)({
    ...
    tickets: (0, exports.objectValidator)({
        ...
        showMedications: exports.booleanValidatorOptional,
        showObservations: exports.booleanValidatorOptional,
    ...
    users: (0, exports.objectValidator)({
        ...
        enableResourceAccessTags: exports.booleanValidatorOptional,
    }, { isOptional: true, emptyOk: true, }),
    ...
    timeTracking: (0, exports.objectValidator)({
        enabled: exports.booleanValidatorOptional,
        setAppointmentDurationOnTimeTrackClose: exports.booleanValidatorOptional,
        inactivityThresholdInSeconds: exports.numberValidatorOptional,
    }, { isOptional: true, emptyOk: true, }),
});
...
exports.DEPRECATED_AUTOMATION_TRIGGER_EVENT_TYPES = [
    'Form Unsubmitted'
];
// Active event types for UI when creating new triggers
exports.ACTIVE_AUTOMATION_TRIGGER_EVENT_TYPES = exports.AUTOMATION_TRIGGER_EVENT_TYPES.filter(function (t) { return !exports.DEPRECATED_AUTOMATION_TRIGGER_EVENT_TYPES.includes(t); });
exports.automationTriggerEventValidator = (0, exports.orValidator)({
    ...
    "Form Started": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            formIds: exports.listOfMongoIdStringValidatorOptionalOrEmptyOk,
            sources: (0, exports.listValidatorOptionalOrEmptyOk)((0, exports.exactMatchValidator)(['Public Form', 'Formsort'])),
        }),
        conditions: exports.optionalEmptyObjectValidator,
    }),
    ...
    "Purchase Made": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            ...
            titlePartialMatches: exports.listOfStringsValidatorOptionalOrEmptyOk,
            couponCodes: exports.listOfStringsValidatorOptionalOrEmptyOk,
        }),
        conditions: exports.optionalEmptyObjectValidator,
    }),
    ...
    "Outbound Chat Sent": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Outbound Chat Sent']),
        info: exports.optionalEmptyObjectValidator,
        conditions: exports.optionalEmptyObjectValidator,
    }),
    ...
    "Appointment Rescheduled": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            titles: exports.listOfStringsValidatorOptionalOrEmptyOk,
            detectManualReschedules: exports.booleanValidatorOptional,
        }),
        conditions: exports.optionalEmptyObjectValidator,
    }),
    "Medication Added": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            ...
            titleCondition: exports.optionalAnyObjectValidator,
        }),
        conditions: exports.optionalEmptyObjectValidator,
    }),
    ...
    "Order Status Equals": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            ...
            status: exports.stringValidator100Optional,
            ...
            frequencies: exports.listOfStringsValidatorOptionalOrEmptyOk,
        }),
        conditions: exports.optionalEmptyObjectValidator,
    }),
    ...
    "Beluga Visit Sync Failed": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Beluga Visit Sync Failed']),
        info: (0, exports.objectValidator)({
            formIds: exports.listOfMongoIdStringValidatorOptionalOrEmptyOk,
        }, { emptyOk: true }),
        conditions: exports.optionalEmptyObjectValidator,
...
exports.automationTriggerActionValidator = (0, exports.orValidator)({
    ...
    "Zendesk: Update Ticket Assignee": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Zendesk: Update Ticket Assignee']),
        info: (0, exports.objectValidator)({}),
    }),
});
...
exports.accessPermissionsValidator = (0, exports.objectValidator)({
    ...
    ticket_templates: exports.accessPermissionValidator,
    ...
    custom_dashboards: exports.accessPermissionValidator,
...
exports.organizationLimitsValidator = (0, exports.objectValidator)({
    ...
    ticket_templates: exports.numberValidatorOptional,
    ...
    custom_dashboards: exports.numberValidatorOptional,
...
exports.analyticsQueryValidator = (0, exports.orValidator)({
    Endusers: (0, exports.objectValidator)({
        ...
        grouping: (0, exports.objectValidator)({
            ...
            "Access Tags": exports.booleanValidatorOptional,
    ...
    "Calendar Events": (0, exports.objectValidator)({
        ...
        grouping: (0, exports.objectValidator)({
            ...
            "Completed By": exports.booleanValidatorOptional,
    ...
    "SMS Messages": (0, exports.objectValidator)({
        ...
        filter: (0, exports.objectValidator)({
            ...
            deliveryStatus: (0, exports.exactMatchValidatorOptional)(['All', 'Delivered', 'Failed']),
        }, { isOptional: true, emptyOk: true }),
        info: (0, exports.orValidator)({
            "Total": (0, exports.objectValidator)({
                method: (0, exports.exactMatchValidator)(['Total']),
    ...
    "Chat Rooms": (0, exports.objectValidator)({
        resource: (0, exports.exactMatchValidator)(['Chat Rooms']),
        filter: (0, exports.objectValidator)({}, { isOptional: true, emptyOk: true }),
        info: (0, exports.orValidator)({
            "Total": (0, exports.objectValidator)({
                method: (0, exports.exactMatchValidator)(['Total']),
...
exports.userUIRestrictionsValidator = (0, exports.objectValidator)({
    ...
    hideNotificationsIcon: exports.booleanValidatorOptional,
...
exports.portalSchemaRestrictionsValidator = (0, exports.objectValidator)({
    disableEditContent: exports.booleanValidatorOptional,
    disableEditTheming: exports.booleanValidatorOptional,
    disableEditSnippets: exports.booleanValidatorOptional,
}, { emptyOk: true });
...
exports.enduserProfileViewBlockValidator = (0, exports.orValidator)({
    ...
    "iFrame": (0, exports.objectValidator)(__assign(__assign({}, exports.sharedEnduserProfileViewBlockFields), { type: (0, exports.exactMatchValidator)(['iFrame']), info: (0, exports.objectValidator)({
            title: exports.stringValidator100,
            url: exports.stringValidator5000,
            height: exports.positiveNumberValidator,
        }) })),
});
exports.enduserProfileViewBlocksValidator = (0, exports.listValidator)(exports.enduserProfileViewBlockValidator);
exports.customDashboardBlockValidator = (0, exports.objectValidator)({
    type: exports.stringValidator100,
    info: exports.objectAnyFieldsAnyValuesValidator,
    colSpan: exports.numberValidatorOptional,
    rowSpan: exports.numberValidatorOptional,
    responsive: exports.objectAnyFieldsAnyValuesValidator,
    style: exports.objectAnyFieldsAnyValuesValidator,
}, { emptyOk: true });
exports.customDashboardBlocksValidator = (0, exports.listValidatorEmptyOk)(exports.customDashboardBlockValidator);
...
exports.phoneTreeEventValidator = (0, exports.orValidator)({
    ...
    "On Condition Branch": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['On Condition Branch']),
        parentId: exports.stringValidator100,
        info: (0, exports.objectValidator)({
            branch: exports.stringValidator250,
        }),
    }),
});
...
exports.phoneTreeActionValidator = (0, exports.orValidator)({
    ...
    "Forward Call": (0, exports.objectValidator)({
        ...
        info: (0, exports.objectValidator)({
            to: exports.phoneValidatorOptional,
            sipUrl: exports.sipUrlValidatorOptional,
            sipUsername: exports.stringValidatorOptional,
            sipPassword: exports.stringValidatorOptional,
            playback: exports.phonePlaybackValidatorOptional,
        }, {
            inputModifier: function (o) {
    ...
    "Enduser Condition Split": (0, exports.objectValidator)({
        type: (0, exports.exactMatchValidator)(['Enduser Condition Split']),
        info: (0, exports.objectValidator)({
            branches: (0, exports.listValidator)((0, exports.objectValidator)({
                name: exports.stringValidator250,
                enduserCondition: exports.optionalAnyObjectValidator,
            })),
        }),
    }),
...
exports.formCustomizationValidator = (0, exports.objectValidator)({
    ...
    logoAlignment: (0, exports.exactMatchValidatorOptional)(['left', 'center', 'right']),
});
...
exports.mmsMessageValidator = (0, exports.objectValidator)({
    ...
    logOnly: exports.booleanValidatorOptional,
});
exports.mmsMessagesValidator = (0, exports.listValidatorEmptyOk)(exports.mmsMessageValidator);
...
exports.outOfOfficeBlockValidator = (0, exports.objectValidator)({
    from: exports.dateValidator,
    to: exports.dateValidator,
    autoreplyText: exports.stringValidator5000,
});
exports.outOfOfficeBlocksValidator = (0, exports.listValidatorEmptyOk)(exports.outOfOfficeBlockValidator);
exports.userOutOfOfficeValidator = (0, exports.objectValidator)({
    userId: exports.mongoIdStringRequired,
    startTimeInMS: exports.nonNegNumberValidator,
    endTimeInMS: exports.nonNegNumberValidator,
});
exports.userOutOfOfficesValidator = (0, exports.listValidatorEmptyOk)(exports.userOutOfOfficeValidator);
exports.emailCCValidator = (0, exports.objectValidator)({
    email: exports.emailValidator,
    name: exports.stringValidatorOptional,
});
exports.listOfEmailCCsValidator = (0, exports.listValidatorOptionalOrEmptyOk)(exports.emailCCValidator);
