...
exports.schema = (0, exports.build_schema)({
        ...
        customActions: {
            ...
            load_inbox_data: {
                ...
                parameters: {
                    ...
                    lastChatRoomUpdatedAt: { validator: validation_1.dateValidatorOptional },
                    lastGroupMMSUpdatedAt: { validator: validation_1.dateValidatorOptional },
    ...
    sms_messages: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { hiddenFromTimeline: { validator: validation_1.booleanValidator }, copyOf: { validator: validation_1.mongoIdStringRequired }, relatedContactId: { validator: validation_1.mongoIdStringRequired }, autoResolveToFrom: { validator: validation_1.booleanValidator }, markedUnreadForAll: { validator: validation_1.booleanValidator }, inboxStatus: { validator: validation_1.stringValidator100 }, logOnly: {
                ...
                examples: [true],
                initializer: function () { return false; },
            }, templatedMessage: { validator: validation_1.stringValidator5000EmptyOkay }, translations: { validator: validation_1.translationsValidator }, message: {
            ...
            relationship: [
                {
                    ...
                    evaluate: function (doc, _, session) {
                        var _a;
                        if (session.type !== constants_1.ENDUSER_SESSION_TYPE)
                            return;
    ...
    users: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { billingTags: { validator: validation_1.labeledFieldsValidator }, defaultLocationId: { validator: validation_1.mongoIdStringRequired }, email: {
                ...
                validator: validation_1.userPortalSettingsValidator,
    ...
    templates: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: validation_1.listOfStringsValidatorEmptyOk }, archivedAt: { validator: validation_1.dateOptionalOrEmptyStringValidator }, mmsAttachmentURLs: { validator: validation_1.listOfUniqueStringsValidatorEmptyOk }, title: {
            ...
            }, isMarketing: { validator: validation_1.booleanValidator }, hideFromCompose: { validator: validation_1.booleanValidator }, forChannels: { validator: validation_1.listOfStringsValidatorEmptyOk }, forRoles: { validator: validation_1.listOfStringsValidatorEmptyOk }, forEntityTypes: { validator: validation_1.listOfStringsValidatorUniqueOptionalOrEmptyOkay }, forUserTags: { validator: validation_1.listOfStringsWithQualifierValidatorOptionalValuesEmptyOkay }, tags: { validator: validation_1.listOfStringsValidatorUniqueOptionalOrEmptyOkay } }),
    },
    files: {
        info: {},
        constraints: { unique: [], relationship: [] },
        ...
        customActions: {
            prepare_file_upload: {
                ...
                parameters: {
                    ...
                    tags: { validator: validation_1.listOfStringsValidatorUniqueOptionalOrEmptyOkay },
                },
                returns: {
                    presignedUpload: {
            ...
            confirm_file_upload: {
                ...
                parameters: {
                    ...
                    syncToMDI: { validator: validation_1.booleanValidator },
            ...
            push: {
                ...
                parameters: {
                    ...
                    canvasCategory: { validator: validation_1.stringValidator },
                    canvasType: { validator: validation_1.canvasCodingValidator },
                    canvasReviewMode: { validator: validation_1.stringValidator },
                    canvasComment: { validator: validation_1.stringValidator5000 },
                },
                returns: {
                    file: { validator: 'file' },
                },
        ...
        customActions: {
            bulk_assign: {
                ...
                parameters: {
                    ids: { validator: validation_1.listOfMongoIdStringValidator, required: true },
                    userId: { validator: validation_1.mongoIdStringRequired, required: true },
                    addToCareTeam: { validator: validation_1.booleanValidatorOptional },
                    queueId: { validator: validation_1.mongoIdStringRequired },
                },
                returns: {
                    assigned: { validator: validation_1.nonNegNumberValidator },
                    skipped: { validator: validation_1.nonNegNumberValidator },
                },
            },
            bulk_delete: {
                op: "custom", access: 'delete', method: "delete",
    ...
    form_responses: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { discussionRoomId: { validator: validation_1.mongoIdStringRequired }, hiddenFromTimeline: { validator: validation_1.booleanValidator, enduserUpdatesDisabled: true }, lockedAt: { validator: validation_1.dateValidator, enduserUpdatesDisabled: true }, formId: {
            ...
            }, canvasEncounterId: { validator: validation_1.stringValidator100 }, pushedToPortalAt: { validator: validation_1.dateValidatorOptional }, belugaScheduleLink: { validator: validation_1.stringValidator1000 }, mdiStatus: { validator: validation_1.stringValidator }, fieldViews: {
                validator: (0, validation_1.listValidatorOptionalOrEmptyOk)((0, validation_1.objectValidator)({
                    fieldId: validation_1.mongoIdStringRequired,
                    fieldTitle: validation_1.stringValidator250,
                    timestamp: validation_1.dateValidator,
                }))
            }, startedViaPinnedForm: { validator: validation_1.booleanValidator }, enduserAISummary: { validator: validation_1.stringValidator25000, redactions: ['enduser'], enduserUpdatesDisabled: true }, responsesAISummary: { validator: validation_1.stringValidator25000, redactions: ['enduser'], enduserUpdatesDisabled: true }, responsesAISummaryGeneratedAt: { validator: validation_1.dateValidator, redactions: ['enduser'], enduserUpdatesDisabled: true }, procedureCodes: { validator: procedureCodesValidator, enduserUpdatesDisabled: true }, diagnosisCodes: { validator: diagnosisCodesValidator, enduserUpdatesDisabled: true } }),
        defaultActions: constants_1.DEFAULT_OPERATIONS,
        enduserActions: {
        ...
        customActions: {
            ...
            push_to_EHR: {
                ...
                parameters: {
                    ...
                    target: { validator: validation_1.stringValidator },
                },
                returns: {},
            },
            create_canvas_note: {
            ...
            stripe_details: {
                ...
                parameters: {
                    fieldId: { validator: validation_1.mongoIdStringRequired, required: true },
                    enduserId: { validator: validation_1.mongoIdStringRequired },
                    selectedProductIds: { validator: validation_1.listOfStringsValidatorOptionalOrEmptyOk },
                },
                returns: {
                    clientSecret: { validator: validation_1.stringValidator, required: true },
    ...
    calendar_events: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { sendIcsEmail: { validator: validation_1.booleanValidator }, athenaDepartmentId: { validator: validation_1.stringValidator1000 }, generateAthenaTelehealthLink: { validator: validation_1.booleanValidator }, athenaTypeId: { validator: validation_1.stringValidator1000 }, athenaBookingTypeId: { validator: validation_1.stringValidator1000 }, preventCancelMinutesInAdvance: { validator: validation_1.numberValidator }, preventRescheduleMinutesInAdvance: { validator: validation_1.numberValidator }, preventCancelInPortal: { validator: validation_1.booleanValidator }, preventRescheduleInPortal: { validator: validation_1.booleanValidator }, actualDuration: { validator: validation_1.nonNegNumberValidator }, dontSyncToCanvas: { validator: validation_1.booleanValidator }, title: {
            ...
            }, cancelReason: { validator: validation_1.stringValidator5000 }, dontAutoSyncPatientToHealthie: { validator: validation_1.booleanValidator }, healthieInsuranceBillingEnabled: { validator: validation_1.booleanValidator }, dontBlockAvailability: { validator: validation_1.booleanValidator }, outOfOffice: { validator: validation_1.booleanValidator }, previousStartTimes: { validator: validation_1.listOfNumbersValidatorUniqueOptionalOrEmptyOkay }, requirePortalCancelReason: { validator: validation_1.booleanValidator }, startLinkToken: { validator: validation_1.stringValidator250, enduserUpdatesDisabled: true, redactions: ['all'] }, canvasEncounterId: { validator: validation_1.stringValidator100 }, allowGroupReschedule: { validator: validation_1.booleanValidator }, joinedVideoCall: {
                validator: (0, validation_1.listValidatorOptionalOrEmptyOk)((0, validation_1.objectValidator)({
                    id: validation_1.mongoIdStringRequired,
                    at: validation_1.dateValidator,
                }))
            }, createAndBookAthenaSlot: { validator: validation_1.booleanValidator }, dontSyncToElation: { validator: validation_1.booleanValidator }, resendRemindersOnAttendeeAdd: { validator: validation_1.booleanValidator } })
    },
    calendar_event_templates: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: validation_1.listOfStringsValidatorEmptyOk }, dontSyncToElation: { validator: validation_1.booleanValidator }, sendIcsEmail: { validator: validation_1.booleanValidator }, createAndBookAthenaSlot: { validator: validation_1.booleanValidator }, athenaDepartmentId: { validator: validation_1.stringValidator1000 }, generateAthenaTelehealthLink: { validator: validation_1.booleanValidator }, athenaTypeId: { validator: validation_1.stringValidator1000 }, athenaBookingTypeId: { validator: validation_1.stringValidator1000 }, preventCancelMinutesInAdvance: { validator: validation_1.numberValidator }, preventRescheduleMinutesInAdvance: { validator: validation_1.numberValidator }, preventCancelInPortal: { validator: validation_1.booleanValidator }, preventRescheduleInPortal: { validator: validation_1.booleanValidator }, dontSyncToCanvas: { validator: validation_1.booleanValidator }, archivedAt: { validator: validation_1.dateOptionalOrEmptyStringValidator }, allowGroupReschedule: { validator: validation_1.booleanValidator }, dontAutoSyncPatientToHealthie: { validator: validation_1.booleanValidator }, title: {
            ...
            carePlanForms: { validator: validation_1.listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanContent: { validator: validation_1.listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanFiles: { validator: validation_1.listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanTasks: { validator: validation_1.listOfStringsValidatorOptionalOrEmptyOk }, videoIntegration: { validator: validation_1.videoIntegrationTypesValidator }, generateZoomLinkWhenBooked: { validator: validation_1.booleanValidator }, color: { validator: validation_1.stringValidator1000 }, apiOnly: { validator: validation_1.booleanValidator }, enduserAttendeeLimit: { validator: validation_1.numberValidator }, bufferEndMinutes: { validator: validation_1.numberValidator }, bufferStartMinutes: { validator: validation_1.numberValidator }, canvasCoding: { validator: validation_1.canvasCodingValidatorOptional }, canvasReasonCoding: { validator: validation_1.canvasCodingValidatorOptional }, tags: { validator: validation_1.listOfStringsValidatorUniqueOptionalOrEmptyOkay }, matchToHealthieTemplate: { validator: validation_1.booleanValidator }, healthieTemplateId: { validator: validation_1.stringValidator }, healthieInsuranceBillingEnabled: { validator: validation_1.booleanValidator }, useUserURL: { validator: validation_1.booleanValidator }, instructions: { validator: validation_1.stringValidator5000EmptyOkay }, requiresEnduser: { validator: validation_1.booleanValidator }, requirePortalCancelReason: { validator: validation_1.booleanValidator }, replaceHostOnReschedule: { validator: validation_1.booleanValidator }, resendRemindersOnAttendeeAdd: { validator: validation_1.booleanValidator } })
    },
    ...
    automated_actions: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { cancelConditions: {
                ...
                required: true,
                examples: [Date.now()],
            }, journeyContext: { validator: validation_1.journeyContextValidator }, externalId: { validator: validation_1.stringValidator100 } })
    },
    user_logs: {
        info: {},
        constraints: {
    ...
    enduser_observations: {
        ...
        customActions: {
            ...
            acknowledge: {
                ...
                parameters: {
                    ids: { validator: validation_1.listOfMongoIdStringValidator, required: true },
                    excludeFromVitalCountLookback: { validator: validation_1.booleanValidator },
                },
                returns: {},
            },
        },
    ...
    organizations: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { inboxThreadsBuiltFrom: { validator: validation_1.dateOptionalOrEmptyStringValidator }, inboxThreadsBuiltTo: { validator: validation_1.dateOptionalOrEmptyStringValidator }, outOfOfficeHours: { validator: validation_1.outOfOfficeBlocksValidator }, bedrockAIAllowed: { validator: validation_1.booleanValidator }, stediAllowed: { validator: validation_1.booleanValidator }, plan: {
            ...
            }, fieldsToAdminNote: { validator: validation_1.listOfStringsValidatorOptionalOrEmptyOk }, incomingCallDisplayFields: { validator: validation_1.listOfStringsValidatorOptionalOrEmptyOk }, canvasMessageSync: {
                validator: (0, validation_1.objectValidator)({
                    id: validation_1.stringValidator100,
            ...
            }, skipActivePatientBilling: { validator: validation_1.booleanValidator }, portalV2SchemaURL: { validator: validation_1.stringValidator }, timeTrackingPrograms: {
                validator: (0, validation_1.listValidatorOptionalOrEmptyOk)((0, validation_1.objectValidator)({
                ...
                validator: (0, validation_1.listValidatorOptionalOrEmptyOk)((0, validation_1.objectValidator)({
                    title: validation_1.stringValidator5000OptionalEmptyOkay,
    ...
    databases: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { title: {
            ...
            visibleForRoles: { validator: validation_1.listOfStringsValidatorOptionalOrEmptyOk }, isReferralDatabase: { validator: validation_1.booleanValidator } }),
    },
    database_records: {
        info: {},
        constraints: {
    ...
    phone_calls: {
        ...
        customActions: {
            ...
            cold_transfer: {
                ...
                parameters: {
                    callSid: { validator: validation_1.stringValidator100, required: true },
                    targetUserId: { validator: validation_1.mongoIdStringRequired, required: true },
                },
                returns: {},
            },
            ...
            modify_conference_attendee_status: {
                ...
                parameters: {
                    conferenceId: { validator: validation_1.stringValidator100, required: true },
                    label: { validator: validation_1.stringValidator100 },
                    hold: { validator: validation_1.booleanValidator },
                },
                returns: {},
            },
            end_conference: {
    ...
    ticket_threads: {
        ...
        customActions: {
            ...
            update_status: {
                ...
                parameters: {
                    ticketThreadId: { validator: validation_1.mongoIdStringRequired, required: true },
                    status: { validator: validation_1.stringValidator100, required: true },
                    resolutionFieldId: { validator: validation_1.stringValidator250 },
                    closeReason: { validator: validation_1.stringValidator250 },
                },
                returns: {
                    success: { validator: validation_1.booleanValidator, required: true },
                },
    ...
    ticket_templates: {
        ...
        customActions: {},
        enduserActions: {},
        fields: __assign(__assign({}, BuiltInFields), { title: { validator: validation_1.stringValidator250, required: true, examples: ['Template Title'] }, type: { validator: validation_1.stringValidator100 }, stage: { validator: validation_1.stringValidator100 }, priority: { validator: validation_1.numberValidator }, tags: { validator: validation_1.listOfStringsValidatorUniqueOptionalOrEmptyOkay }, archivedAt: { validator: validation_1.dateOptionalOrEmptyStringValidator }, actions: { validator: validation_1.ticketActionsValidator }, closeOnFinishedActions: { validator: validation_1.booleanValidator }, contextFormIds: { validator: validation_1.listOfMongoIdStringValidatorOptionalOrEmptyOk }, contextContentIds: { validator: validation_1.listOfMongoIdStringValidatorOptionalOrEmptyOk }, contextEnduserFields: { validator: validation_1.listOfUniqueStringsValidatorEmptyOk } }),
    },
        ...
        customActions: {
            ...
            send_message: {
                ...
                parameters: {
                    ...
                    sender: { validator: validation_1.mongoIdStringRequired, required: true },
                    conversationId: { validator: validation_1.mongoIdStringRequired, required: true },
                    logOnly: { validator: validation_1.booleanValidatorOptional }
                },
                returns: {
                    conversation: { validator: 'group_mms_conversations' },
                }
    ...
    ai_conversations: {
        ...
        customActions: {
            send_message: {
                ...
                parameters: {
                    message: { validator: validation_1.stringValidator100000 },
                    ...
                    journeyId: { validator: validation_1.mongoIdStringRequired },
                    automationStepId: { validator: validation_1.mongoIdStringRequired },
                    model: { validator: validation_1.selectableAIModelValidator }, // 'Claude Sonnet 5' (default) | 'Claude Opus 4.8'; must match the conversation's model when continuing
                },
                returns: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { type: { validator: validation_1.stringValidator, required: true, examples: ['HTML Template Generation'] }, modelName: { validator: validation_1.stringValidator, required: true, examples: ['Claude Sonnet 4', 'Claude Sonnet 4.5', 'Claude Sonnet 4.6', 'Claude Sonnet 5', 'Claude Opus 4.8'] }, orchestrationId: { validator: validation_1.stringValidatorOptional, examples: ['workflow-123', 'batch-456'] }, enduserId: {
                validator: validation_1.mongoIdStringOptional,
                examples: [constants_1.PLACEHOLDER_ID],
                dependencies: [{
                        dependsOn: ['endusers'],
    ...
    inbox_threads: {
        ...
        customActions: {
            ...
            load_threads: {
                ...
                parameters: {
                    ids: { validator: validation_1.listOfMongoIdStringValidatorOptionalOrEmptyOk },
                ...
                returns: {
                    ...
                    count: { validator: validation_1.numberValidatorOptional },
                },
            },
            reset_threads: {
                op: "custom", access: 'delete', method: "post",
                ...
                parameters: {},
                returns: {
                    deletedCount: { validator: validation_1.numberValidator, required: true },
                },
            },
        },
