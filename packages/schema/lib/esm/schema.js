...
var procedureCodesValidator = listValidatorOptionalOrEmptyOk(objectValidator({
...
export var schema = build_schema({
    endusers: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { sharedWithOrganizations: __assign(__assign({}, BuiltInFields.sharedWithOrganizations), { enduserUpdatesDisabled: true }), recentViewers: { validator: recentViewersValidator }, healthie_dietitian_id: { validator: stringValidator100, enduserUpdatesDisabled: true }, healthieIntegrationId: { validator: stringValidator100, enduserUpdatesDisabled: true }, mergedIds: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk, readonly: true, redactions: ['enduser'] }, externalId: {
                validator: stringValidator250,
                ...
                validator: dateValidator,
            }, lastLogout: { validator: dateValidator }, invalidateSessionsBefore: { validator: dateValidator }, termsSigned: { validator: dateValidator }, termsVersion: { validator: stringValidator100 }, lastCommunication: {
                redactions: ['enduser'],
                validator: dateValidator,
            }, avatar: {
            ...
            dailyCalorieTarget: { validator: nonNegNumberValidator }, dailyProteinTarget: { validator: nonNegNumberValidator }, dailyCarbTarget: { validator: nonNegNumberValidator }, dailyFatTarget: { validator: nonNegNumberValidator }, dailyFiberTarget: { validator: nonNegNumberValidator }, dailyWaterTarget: { validator: nonNegNumberValidator }, source: { validator: stringValidator1000Optional, enduserUpdatesDisabled: true }, addressLineOne: { validator: stringValidator5000EmptyOkay, redactions: ['enduser'] }, addressLineTwo: { validator: stringValidator5000EmptyOkay, redactions: ['enduser'] }, city: { validator: stringValidator5000EmptyOkay, redactions: ['enduser'] }, state: { validator: stateValidator, redactions: ['enduser'] }, zipCode: { validator: stringValidator25000EmptyOkay, redactions: ['enduser'] }, zipPlusFour: { validator: stringValidator100, redactions: ['enduser'] }, timezone: { validator: timezoneValidator }, humanReadableId: { validator: stringValidator100 }, displayName: { validator: stringValidator250 }, unsubscribedFromPortalChatNotifications: { validator: booleanValidator }, triggeredEvents: { validator: objectAnyFieldsValidator(numberValidator) }, customTypeId: { validator: mongoIdStringValidator, enduserUpdatesDisabled: true }, language: { validator: languageValidator }, relationships: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
                    id: mongoIdStringRequired,
                    type: stringValidator100,
                }))
            }, markedReadAt: { validator: dateOptionalOrEmptyStringValidator }, markedUnreadAt: { validator: dateOptionalOrEmptyStringValidator }, note: { validator: stringValidator25000EmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, noteIsFlagged: { validator: booleanValidator }, insurance: { validator: insuranceOptionalValidator, redactions: ['enduser'], enduserUpdatesDisabled: true }, insuranceSecondary: { validator: insuranceOptionalValidator, redactions: ['enduser'], enduserUpdatesDisabled: true }, bookingNotes: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
            ...
            chargebeeId: { validator: stringValidatorOptionalEmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, chargebeeEnvironment: { validator: stringValidatorOptionalEmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, chargebeeBusinessEntityId: { validator: stringValidatorOptionalEmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, diagnoses: {
                ...
                redactions: ['enduser'],
                enduserUpdatesDisabled: true,
            }, unsubscribedFromPhones: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay, redactions: ['enduser'] }, lockedFromPortal: { validator: booleanValidator, enduserUpdatesDisabled: true }, eligibleForAutoMerge: { validator: booleanValidator, enduserUpdatesDisabled: true }, preferredPharmacy: { validator: pharmacyValidator, redactions: ['enduser'] }, aiSummary: { validator: stringValidator25000, redactions: ['enduser'], enduserUpdatesDisabled: true }, aiSummaryUpdatedAt: { validator: dateValidator, redactions: ['enduser'], enduserUpdatesDisabled: true } }),
        customActions: {
    ...
    api_keys: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { hashedKey: {
                ...
                validator: exactMatchListValidator(__spreadArray([], API_KEY_SCOPES, true)),
                readonly: true,
            } }),
        ...
        customActions: {
            create: {
                ...
                parameters: {
                    scopes: { validator: exactMatchListValidator(__spreadArray([], API_KEY_SCOPES, true)) },
                },
                returns: {
                    id: {
                        validator: mongoIdStringValidator,
        ...
        customActions: {
            ...
            proxy_read: {
                ...
                parameters: {
                    ...
                    healthieIntegrationId: { validator: stringValidator100 },
                    target: { validator: exactMatchValidatorOptional(['home', 'plan', 'results', 'care', 'shop', 'account']) }, // Welle SSO launch deep-link target
                },
                returns: {
            ...
            load_redacted: {
                ...
                returns: {
                    integrations: {
                        validator: listValidatorEmptyOk(optionalAnyObjectValidator),
                        required: true,
                    },
                },
            },
            update_settings: {
                ...
                returns: {
                    integration: { validator: optionalAnyObjectValidator, required: true },
                },
            },
        }
    },
    ...
    journeys: {
        info: {},
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, title: {
                validator: stringValidator100,
                required: true,
                examples: ['Test']
            }, defaultState: {
    ...
    emails: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { hiddenFromTimeline: { validator: booleanValidator }, copyOf: { validator: mongoIdStringValidator }, relatedContactId: { validator: mongoIdStringValidator }, markedUnreadForAll: { validator: booleanValidator }, inboxStatus: { validator: stringValidator100 }, logOnly: {
            ...
            }, journeyContext: { validator: journeyContextValidator }, sendAt: { validator: dateOptionalOrEmptyStringValidator }, pinnedAt: { validator: dateOptionalOrEmptyStringValidator }, isDraft: { validator: booleanValidator }, cc: { validator: listOfStringsValidatorEmptyOk }, fromEmailOverride: { validator: stringValidator100 }, ticketIds: { validator: listOfStringsValidatorEmptyOk }, alternateToAddress: { validator: emailValidator }, 
            // staff-facing draft (may be AI-generated and unreviewed) — never expose it to the patient
            suggestedReply: { validator: stringValidator5000EmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, suggestedReplyIsAIGenerated: { validator: booleanValidator, redactions: ['enduser'], enduserUpdatesDisabled: true }, tags: { validator: listOfStringsValidatorOptionalOrEmptyOk }, batchId: { validator: stringValidator250 }, isMarketing: { validator: booleanValidator }, assignedTo: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, canvasId: { validator: stringValidator100 }, discussionRoomId: { validator: mongoIdStringValidator }, journeyId: { validator: mongoIdStringValidator }, calendarEventId: { validator: mongoIdStringValidator }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, trashedAt: { validator: dateOptionalOrEmptyStringValidator } }),
        customActions: {
            sync_integrations: {
                op: "custom", access: 'read', method: "post",
    ...
    sms_messages: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { hiddenFromTimeline: { validator: booleanValidator }, copyOf: { validator: mongoIdStringValidator }, relatedContactId: { validator: mongoIdStringValidator }, autoResolveToFrom: { validator: booleanValidator }, markedUnreadForAll: { validator: booleanValidator }, inboxStatus: { validator: stringValidator100 }, logOnly: {
                ...
                validator: listOfStringsValidatorEmptyOk,
                initializer: function () { return []; },
            }, journeyContext: { validator: journeyContextValidator }, sendAt: { validator: dateOptionalOrEmptyStringValidator }, pinnedAt: { validator: dateOptionalOrEmptyStringValidator }, isDraft: { validator: booleanValidator }, timestamp: { validator: dateValidator }, ticketIds: { validator: listOfStringsValidatorEmptyOk }, 
            // staff-facing draft (may be AI-generated and unreviewed) — never expose it to the patient
            suggestedReply: { validator: stringValidator5000EmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, suggestedReplyIsAIGenerated: { validator: booleanValidator, redactions: ['enduser'], enduserUpdatesDisabled: true }, phoneNumber: { validator: stringValidatorOptionalEmptyOkay }, enduserPhoneNumber: { validator: phoneValidator }, tags: { validator: listOfStringsValidatorOptionalOrEmptyOk }, batchId: { validator: stringValidator250 }, assignedTo: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, canvasId: { validator: stringValidator100 }, discussionRoomId: { validator: mongoIdStringValidator }, journeyId: { validator: mongoIdStringValidator }, calendarEventId: { validator: mongoIdStringValidator }, mediaURLs: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, trashedAt: { validator: dateOptionalOrEmptyStringValidator } }),
    },
    chat_rooms: {
        info: {},
        constraints: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { markedUnreadForAll: { validator: booleanValidator }, inboxStatus: { validator: stringValidator100 }, journeyId: { validator: mongoIdStringValidator }, assignedTo: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, title: {
            ...
            }, pinnedAt: { validator: dateOptionalOrEmptyStringValidator }, fields: { validator: fieldsValidator }, 
            ...
            suggestedReply: { validator: stringValidator5000EmptyOkay, redactions: ['enduser'], enduserUpdatesDisabled: true }, suggestedReplyIsAIGenerated: { validator: booleanValidator, redactions: ['enduser'], enduserUpdatesDisabled: true }, discussionRoomId: { validator: mongoIdStringValidator }, identifier: { validator: stringValidator100 }, externalId: { validator: stringValidator100 }, emoji: { validator: stringValidator100 }, source: { validator: stringValidator100 }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, trashedAt: { validator: dateOptionalOrEmptyStringValidator }, groupMentions: { validator: listOfUniqueStringsValidatorEmptyOk } }),
        defaultActions: DEFAULT_OPERATIONS,
        ...
        customActions: {
            ...
            configure_MFA: {
                ...
                parameters: {
                    ...
                    method: { validator: exactMatchValidator(['email', 'authenticator']) },
                },
                returns: {
    ...
    templates: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, mmsAttachmentURLs: { validator: listOfUniqueStringsValidatorEmptyOk }, title: {
                validator: stringValidator100,
                required: true,
    ...
    files: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, source: { validator: stringValidator100 }, tags: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, name: {
                validator: stringValidator250,
                required: true,
            }, size: {
        ...
        publicActions: {
            public_form_details: {
                ...
                returns: {
                    ...
                    translations: { validator: objectAnyFieldsAnyValuesValidator },
                },
            },
        },
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, showByUserTags: { validator: listOfStringsValidatorOptionalOrEmptyOk }, belugaVisitType: { validator: stringValidator }, belugaVerificationId: { validator: stringValidator }, belugaPharmacyMappings: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
    ...
    form_responses: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { discussionRoomId: { validator: mongoIdStringValidator }, hiddenFromTimeline: { validator: booleanValidator, enduserUpdatesDisabled: true }, lockedAt: { validator: dateValidator, enduserUpdatesDisabled: true }, formId: {
                validator: stringValidator100,
                required: true,
                dependencies: [
                    {
                ...
                validator: dateValidator,
            }, copiedFrom: { validator: mongoIdStringOptional }, copiedFromEnduserId: { validator: mongoIdStringOptional }, publicSubmit: { validator: booleanValidator }, submittedBy: { validator: stringValidator250, enduserUpdatesDisabled: true }, submittedByIsPlaceholder: { validator: booleanValidator, enduserUpdatesDisabled: true }, markedAsSubmitted: { validator: booleanValidator, enduserUpdatesDisabled: true }, viewedInLanguage: { validator: stringValidator100, enduserUpdatesDisabled: true }, accessCode: { validator: stringValidator250 }, userEmail: { validator: emailValidator, enduserUpdatesDisabled: true }, submittedAt: { validator: dateValidator, enduserUpdatesDisabled: true }, formTitle: { validator: stringValidator250, enduserUpdatesDisabled: true }, responses: { validator: formResponsesValidator }, draftSavedAt: { validator: dateValidator }, draftSavedBy: { validator: mongoIdStringValidator }, hideFromEnduserPortal: { validator: booleanValidator }, sharedVia: { validator: communicationsChannelValidator }, isInternalNote: { validator: booleanValidator, enduserUpdatesDisabled: true }, pinnedAt: { validator: dateOptionalOrEmptyStringValidator, enduserUpdatesDisabled: true }, publicIdentifier: { validator: stringValidator250 }, source: { validator: stringValidator250 }, externalId: { validator: stringValidator250 }, rootResponseId: { validator: mongoIdStringValidator }, parentResponseId: { validator: mongoIdStringValidator }, tags: { validator: listOfStringsValidatorOptionalOrEmptyOk, enduserUpdatesDisabled: true }, carePlanId: { validator: mongoIdStringValidator }, context: { validator: stringValidator1000 }, logoURL: { validator: stringValidator5000, enduserUpdatesDisabled: true }, logoHeight: { validator: numberValidator, enduserUpdatesDisabled: true }, calendarEventId: { validator: mongoIdStringValidator }, references: { validator: listOfRelatedRecordsValidator, readonly: true }, groupId: { validator: mongoIdStringValidator }, groupInstance: { validator: stringValidator100 }, groupPosition: { validator: nonNegNumberValidator }, hideAfterUnsubmittedInMS: { validator: numberValidator }, addenda: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
            ...
            }, canvasEncounterId: { validator: stringValidator100 }, pushedToPortalAt: { validator: dateValidatorOptional }, belugaScheduleLink: { validator: stringValidator1000 }, mdiStatus: { validator: stringValidator }, fieldViews: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
    ...
    calendar_event_templates: {
        ...
        customActions: {},
        enduserActions: { read: {}, readMany: {} },
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, dontSyncToElation: { validator: booleanValidator }, sendIcsEmail: { validator: booleanValidator }, createAndBookAthenaSlot: { validator: booleanValidator }, athenaDepartmentId: { validator: stringValidator1000 }, generateAthenaTelehealthLink: { validator: booleanValidator }, athenaTypeId: { validator: stringValidator1000 }, athenaBookingTypeId: { validator: stringValidator1000 }, preventCancelMinutesInAdvance: { validator: numberValidator }, preventRescheduleMinutesInAdvance: { validator: numberValidator }, preventCancelInPortal: { validator: booleanValidator }, preventRescheduleInPortal: { validator: booleanValidator }, dontSyncToCanvas: { validator: booleanValidator }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, allowGroupReschedule: { validator: booleanValidator }, dontAutoSyncPatientToHealthie: { validator: booleanValidator }, title: {
                validator: stringValidator250,
                required: true,
                examples: ["Text"],
            ...
            carePlanForms: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanContent: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanFiles: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanTasks: { validator: listOfStringsValidatorOptionalOrEmptyOk }, videoIntegration: { validator: videoIntegrationTypesValidator }, generateZoomLinkWhenBooked: { validator: booleanValidator }, color: { validator: stringValidator1000 }, apiOnly: { validator: booleanValidator }, enduserAttendeeLimit: { validator: numberValidator }, bufferEndMinutes: { validator: numberValidator }, bufferStartMinutes: { validator: numberValidator }, canvasCoding: { validator: canvasCodingValidatorOptional }, canvasReasonCoding: { validator: canvasCodingValidatorOptional }, tags: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, matchToHealthieTemplate: { validator: booleanValidator }, healthieTemplateId: { validator: stringValidator }, healthieInsuranceBillingEnabled: { validator: booleanValidator }, useUserURL: { validator: booleanValidator }, instructions: { validator: stringValidator5000EmptyOkay }, requiresEnduser: { validator: booleanValidator }, requirePortalCancelReason: { validator: booleanValidator }, replaceHostOnReschedule: { validator: booleanValidator }, resendRemindersOnAttendeeAdd: { validator: booleanValidator } })
    },
    ...
    managed_content_records: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, slug: { validator: stringValidator250 }, title: {
                validator: stringValidator1000,
                required: true,
                examples: ["Template Name"],
            }, category: {
    ...
    organizations: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { inboxThreadsBuiltFrom: { validator: dateOptionalOrEmptyStringValidator }, inboxThreadsBuiltTo: { validator: dateOptionalOrEmptyStringValidator }, outOfOfficeHours: { validator: outOfOfficeBlocksValidator }, bedrockAIAllowed: { validator: booleanValidator }, stediAllowed: { validator: booleanValidator }, plan: {
                validator: objectValidator({
                    type: stringValidatorOptional,
                }),
            }, onboardingStatus: { validator: userPortalSettingsValidator }, creditCount: { validator: numberValidator, readonly: true }, stripeKeyDetails: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
            ...
            }, healthieIntegrationIds: { validator: listOfStringsValidatorOptionalOrEmptyOk, readonly: true }, chargebeeBusinessEntities: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
            ...
            }, faxCoverPageEnabled: { validator: booleanValidator }, faxCoverPageId: { validator: stringValidator250 }, athenaFieldsSync: { validator: fieldsSyncValidator }, athenaDepartments: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
    ...
    role_based_access_permissions: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { role: {
            ...
            }, uiRestrictions: { validator: userUIRestrictionsValidator }, fieldRedactions: { validator: userFieldRedactionsValidator }, portalSchemaRestrictions: {
            ...
            }, color: { validator: stringValidator1000 }, description: { validator: stringValidator1000Optional } })
    },
    appointment_booking_pages: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, dontRestrictRescheduleToOriginalHost: { validator: booleanValidator }, gtmTag: { validator: stringValidator100EscapeHTML }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, title: {
                validator: stringValidator100,
                required: true,
    ...
    automation_triggers: {
            ...
            relationship: [{
                    ...
                    evaluate: function (trigger, _deps, _session, method, options) {
                        ...
                        if (eventType === undefined)
                            return;
                        if (!DEPRECATED_AUTOMATION_TRIGGER_EVENT_TYPES.includes(eventType))
                            return;
                        if (method === 'create') {
        ...
        enduserActions: {},
        fields: __assign(__assign({}, BuiltInFields), { accessTags: { redactions: ['enduser'], validator: listOfStringsValidatorEmptyOk }, title: {
                validator: stringValidator100,
                required: true,
    ...
    configurations: {
        ...
        enduserActions: { read: {}, readMany: {} },
        fields: __assign(__assign({}, BuiltInFields), { type: { validator: stringValidator250, examples: ['string'] }, value: { validator: stringValidator100000OptionalEmptyOkayEscapeHTML, examples: ['string'] }, publicRead: { validator: booleanValidator } }),
    },
    time_tracks: {
        info: {},
        constraints: {
    ...
    integration_logs: {
        ...
        customActions: {},
        enduserActions: {},
        fields: __assign(__assign({}, BuiltInFields), { integration: { validator: stringValidator, readonly: true, examples: ['Canvas'] }, status: { validator: exactMatchValidator(['Success', 'Error', 'Info']), readonly: true, examples: ['Error'] }, type: { validator: stringValidator, readonly: true, examples: ['Patient Create'] }, payload: { validator: stringValidator, readonly: true, examples: ['{}'] }, response: { validator: stringValidator, readonly: true, examples: ['{}'] }, url: { validator: stringValidator, readonly: true, examples: ['https://www.tellescope.com'] }, enduserId: { validator: mongoIdStringValidator, readonly: true } })
    },
    ...
    ai_conversations: {
        ...
        customActions: {
            send_message: {
                ...
                parameters: {
                    message: { validator: stringValidator100000 },
                    ...
                    orchestrationId: { validator: stringValidatorOptional },
                    enduserId: { validator: mongoIdStringValidator },
        ...
        fields: __assign(__assign({}, BuiltInFields), { type: { validator: stringValidator, required: true, examples: ['HTML Template Generation'] }, modelName: { validator: stringValidator, required: true, examples: ['Claude Sonnet 4', 'Claude Sonnet 4.5', 'Claude Sonnet 4.6', 'Claude Sonnet 5', 'Claude Opus 4.8'] }, orchestrationId: { validator: stringValidatorOptional, examples: ['workflow-123', 'batch-456'] }, enduserId: {
                validator: mongoIdStringOptional,
                examples: [PLACEHOLDER_ID],
                dependencies: [{
                        dependsOn: ['endusers'],
    ...
    inbox_threads: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { type: { validator: exactMatchValidator(['Chat', 'Email', 'GroupMMS', 'Phone', 'SMS', 'Zendesk']), required: true, examples: ['Email'] }, assignedTo: { validator: listOfMongoIdStringValidatorEmptyOk, required: true, examples: [[PLACEHOLDER_ID]] }, enduserIds: { validator: listOfMongoIdStringValidator, required: true, examples: [[PLACEHOLDER_ID]] }, userIds: { validator: listOfMongoIdStringValidatorEmptyOk, required: true, examples: [[PLACEHOLDER_ID]] }, inboxStatus: { validator: stringValidator, required: true, examples: ['In Progress'] }, preview: { validator: stringValidator25000, required: true, examples: ['Preview of the message'] }, threadId: { validator: stringValidator, required: true, examples: ['Thread ID'] }, timestamp: { validator: dateValidator, required: true, examples: [new Date().toISOString()] }, title: { validator: stringValidator, required: true, examples: ['Title or Subject Here'] }, tags: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, readBy: { validator: idStringToDateValidator }, outboundTimestamp: { validator: dateValidator }, outboundPreview: { validator: stringValidator25000 }, phoneNumber: { validator: phoneValidator }, enduserPhoneNumber: { validator: phoneValidator }, archivedAt: { validator: dateOptionalOrEmptyStringValidator }, trashedAt: { validator: dateOptionalOrEmptyStringValidator }, recentOutboundUserId: { validator: mongoIdStringOptional }, recentInboundEnduserId: { validator: mongoIdStringOptional }, draftMessageIds: {
                validator: listOfMongoIdStringValidatorOptionalOrEmptyOk,
                dependencies: [{
