...
export var schema = build_schema({
    endusers: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { healthie_dietitian_id: { validator: stringValidator100 }, externalId: {
