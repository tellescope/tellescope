...
export var schema = build_schema({
    ...
    enduser_orders: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { externalId: { validator: stringValidator100, examples: ['externalId'], required: true }, source: { validator: stringValidator100, examples: ['source'], required: true }, enduserId: {
                ...
                })) }, tracking: { validator: stringValidatorOptional }, carrier: { validator: stringValidatorOptional }, fill: { validator: stringValidatorOptional }, sku: { validator: stringValidatorOptional }, bookingLink: { validator: stringValidatorOptional } })
    },
