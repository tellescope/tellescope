...
export var schema = build_schema({
    endusers: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { healthie_dietitian_id: { validator: stringValidator100 }, mergedIds: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk, readonly: true, redactions: ['enduser'] }, externalId: {
    ...
    emails: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { logOnly: {
            ...
            }, journeyContext: { validator: journeyContextValidator }, sendAt: { validator: dateOptionalOrEmptyStringValidator }, pinnedAt: { validator: dateOptionalOrEmptyStringValidator }, isDraft: { validator: booleanValidator }, cc: { validator: listOfStringsValidatorEmptyOk }, fromEmailOverride: { validator: stringValidator100 }, ticketIds: { validator: listOfStringsValidatorEmptyOk }, alternateToAddress: { validator: emailValidator }, suggestedReply: { validator: stringValidator5000EmptyOkay }, tags: { validator: listOfStringsValidatorOptionalOrEmptyOk }, batchId: { validator: stringValidator250 }, isMarketing: { validator: booleanValidator }, assignedTo: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, canvasId: { validator: stringValidator100 }, discussionRoomId: { validator: mongoIdStringValidator }, journeyId: { validator: mongoIdStringValidator }, calendarEventId: { validator: mongoIdStringValidator } }),
        customActions: {
            sync_integrations: {
                op: "custom", access: 'read', method: "post",
    ...
    sms_messages: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { autoResolveToFrom: { validator: booleanValidator }, logOnly: {
                validator: booleanValidator,
                examples: [true],
                initializer: function () { return false; },
            }, message: {
    ...
    chat_rooms: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { assignedTo: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, title: {
                validator: stringValidator100,
            }, numMessages: {
                validator: nonNegNumberValidator,
            ...
            }, pinnedAt: { validator: dateOptionalOrEmptyStringValidator }, fields: { validator: fieldsValidator }, suggestedReply: { validator: stringValidator5000EmptyOkay }, discussionRoomId: { validator: mongoIdStringValidator }, identifier: { validator: stringValidator100 }, externalId: { validator: stringValidator100 }, source: { validator: stringValidator100 } }),
        defaultActions: DEFAULT_OPERATIONS,
    ...
    users: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { email: {
            ...
            }, canvasId: { validator: stringValidator100 }, dashboardView: { validator: customDashboardViewValidator }, hideFromCalendarView: { validator: booleanValidator }, requireSSO: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay } })
    },
    templates: {
        info: {},
        constraints: {
    ...
    forms: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { title: {
                ...
                initializer: function () { return 0; },
                examples: [0],
            }, displayTitle: { validator: stringValidator1000 }, description: { validator: stringValidator5000EmptyOkay }, customGreeting: { validator: stringValidator5000 }, customSignature: { validator: stringValidator5000 }, customSubject: { validator: stringValidator5000 }, allowPublicURL: { validator: booleanValidator }, intakePhone: { validator: intakePhoneValidator }, intakeEmailRequired: { validator: booleanValidator }, intakeEmailHidden: { validator: booleanValidator }, intakeDateOfBirth: { validator: intakeDateOfBirthValidator }, intakeState: { validator: intakeDateOfBirthValidator }, intakeGender: { validator: intakeDateOfBirthValidator }, intakeGenderIsSex: { validator: booleanValidator }, thanksMessage: { validator: stringValidator5000EmptyOkay }, htmlThanksMessage: { validator: stringValidator5000EmptyOkay }, type: { validator: formTypeValidator }, scoring: { validator: formScoringValidator }, externalId: { validator: stringValidator100 }, ga4measurementId: { validator: stringValidator100 }, backgroundColor: { validator: stringValidator100 }, productIds: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, submitRedirectURL: { validator: stringValidator5000 }, customization: { validator: formCustomizationValidator }, publicFormIdRedirect: { validator: mongoIdStringOptional }, disabled: { validator: booleanValidatorOptional }, disableAutomaticIntegrationPush: { validator: booleanValidatorOptional }, customTypeIds: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, lockResponsesOnSubmission: { validator: booleanValidatorOptional }, tags: { validator: listOfStringsValidatorOptionalOrEmptyOk }, language: { validator: stringValidator }, isNonVisitElationNote: { validator: booleanValidator }, elationVisitNotePractitionerIds: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, elationVisitNoteType: { validator: stringValidator100 }, publicShowLanguage: { validator: booleanValidator }, publicShowDownload: { validator: booleanValidator }, canvasId: { validator: stringValidator100 }, canvasQuestionId: { validator: stringValidator100 }, syncToOLH: { validator: booleanValidator }, syncWithResponsesFromFormIds: { validator: listOfUniqueStringsValidatorEmptyOk }, scoresSync: {
                validator: listValidatorOptionalOrEmptyOk(objectValidator({
    ...
    form_responses: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { discussionRoomId: { validator: mongoIdStringValidator }, formId: {
                validator: stringValidator100,
                required: true,
                dependencies: [
                    {
    ...
    calendar_event_templates: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { allowGroupReschedule: { validator: booleanValidator }, dontAutoSyncPatientToHealthie: { validator: booleanValidator }, title: {
            ...
            carePlanForms: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanContent: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanFiles: { validator: listOfMongoIdStringValidatorOptionalOrEmptyOk }, carePlanTasks: { validator: listOfStringsValidatorOptionalOrEmptyOk }, videoIntegration: { validator: videoIntegrationTypesValidator }, generateZoomLinkWhenBooked: { validator: booleanValidator }, color: { validator: stringValidator1000 }, apiOnly: { validator: booleanValidator }, enduserAttendeeLimit: { validator: numberValidator }, bufferEndMinutes: { validator: numberValidator }, bufferStartMinutes: { validator: numberValidator }, canvasCoding: { validator: canvasCodingValidator }, canvasReasonCoding: { validator: canvasCodingValidator }, tags: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, matchToHealthieTemplate: { validator: booleanValidator }, useUserURL: { validator: booleanValidator }, instructions: { validator: stringValidator5000EmptyOkay }, requiresEnduser: { validator: booleanValidator }, requirePortalCancelReason: { validator: booleanValidator } })
    },
    ...
    organizations: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { name: {
            ...
            }, fieldsToAdminNote: { validator: listOfStringsValidatorOptionalOrEmptyOk }, canvasMessageSync: {
                validator: objectValidator({
                    id: stringValidator100,
            ...
            }, groups: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, canvasURL: { validator: stringValidator }, observationInvalidationReasons: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay } }),
    },
    databases: {
        info: {},
        constraints: {
    ...
    background_errors: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { title: {
            ...
            }, acknowledgedAt: { validator: dateOptionalOrEmptyStringValidator }, journeyId: { validator: mongoIdStringValidator }, enduserId: { validator: mongoIdStringValidator } })
    },
    automation_triggers: {
        info: {},
        ...
        fields: __assign(__assign({}, BuiltInFields), { title: {
            ...
            //   }]
            // },
            triggerNextAt: { validator: dateValidator }, tags: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay }, availabilityTimezone: { validator: timezoneValidator }, weeklyAvailabilities: { validator: weeklyAvailabilitiesValidator } })
    },
    superbill_providers: {
        info: {},
        constraints: { unique: [], relationship: [], },
    ...
    phone_trees: {
        ...
        fields: __assign(__assign({}, BuiltInFields), { number: {
            ...
            }, testEnduserIds: { validator: listOfStringsValidatorOptionalOrEmptyOk }, enduserCondition: { validator: phoneTreeEnduserConditionValidator }, bypassOOO: { validator: booleanValidator }, defaultEntityType: { validator: stringValidator100 }, tags: { validator: listOfStringsValidatorUniqueOptionalOrEmptyOkay } })
    },
    ...
    ticket_thread_comments: {
        ...
        customActions: {},
        enduserActions: {},
        fields: __assign(__assign({}, BuiltInFields), { externalId: { validator: stringValidator100, }, source: { validator: stringValidator100, }, ticketThreadId: {
    ...
    configurations: {
        ...
        customActions: {},
        enduserActions: {},
        fields: __assign(__assign({}, BuiltInFields), { type: { validator: stringValidator250, examples: ['string'] }, value: { validator: stringValidator100000OptionalEmptyOkay, examples: ['string'] } }),
    },
    ticket_queues: {
        info: {},
        constraints: {
    ...
    portal_brandings: {
        ...
        customActions: {},
        enduserActions: {},
        fields: __assign(__assign({}, BuiltInFields), { title: { validator: stringValidator, required: true, examples: ['Title'] }, enduserField: { validator: stringValidator, required: true, examples: ['Title'] }, enduserValue: { validator: stringValidator, required: true, examples: ['Title'] }, primary: { validator: stringValidator }, secondary: { validator: stringValidator }, logoURL: { validator: stringValidator }, subdomain: { validator: stringValidator }, customPortalURL: { validator: stringValidator } })
    },
