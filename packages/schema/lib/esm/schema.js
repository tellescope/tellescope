...
import { CREATOR_ONLY_ACCESS, DEFAULT_OPERATIONS, PLACEHOLDER_ID, ENDUSER_SESSION_TYPE, USER_SESSION_TYPE, CANDID_TITLE, DEVELOP_HEALTH_TITLE, HEALTHIE_TITLE, } from "@tellescope/constants";
                ...
                // },
                {
                    ...
                    evaluate: function (_v, _deps, _session, method, _a) {
                        ...
                        if ((updates.healthieIntegrationId || '') === ((orig === null || orig === void 0 ? void 0 : orig.healthieIntegrationId) || ''))
                            return; // no-op ok
                        var healthiePatientId = (((_c = (_b = orig === null || orig === void 0 ? void 0 : orig.references) === null || _b === void 0 ? void 0 : _b.find(function (r) { return r.type === HEALTHIE_TITLE; })) === null || _c === void 0 ? void 0 : _c.id)
                            || ((orig === null || orig === void 0 ? void 0 : orig.source) === HEALTHIE_TITLE && (orig === null || orig === void 0 ? void 0 : orig.externalId)));
