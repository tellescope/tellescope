...
export type CustomActions = {
    ...
    files: {
        ...
        push: CustomAction<{
            ...
            canvasType?: CanvasCoding;
            canvasReviewMode?: string;
            canvasComment?: string;
        }, {
            file?: File;
        }>;
    };
    ...
    users: {
        ...
        begin_TOTP_configuration: CustomAction<{}, {
            otpauthURL: string;
            secret: string;
        }>;
        confirm_TOTP_configuration: CustomAction<{
            code: string;
        }, {
            recoveryCodes: string[];
            authToken: string;
    ...
    calendar_events: {
        ...
        out_of_office: CustomAction<{
            userIds?: string[];
        }, {
            outOfOffice: UserOutOfOffice[];
        }>;
